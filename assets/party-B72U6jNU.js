...
`,O=d.div`
  ...
  color: ${e=>e.$theme.primary};
  font-size: 14px;
`,k=(e,t,n)=>Math.max(t,Math.min(n,e)),A=e=>{if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);return Array.isArray(t)?t:null}catch{return null}return null},j=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},M=e=>e.roomMetadata,N=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||h.CURRENT_HP,maxHpBid:n?.attr_bid||h.MAX_HP}},P=e=>e===`bottom`||e===`left`||e===`top`||e===`right`,F=(e,t)=>{let n=t.toLowerCase();if(n===`bool`)return e===!0?`Yes`:e===!1?`No`:`-`;if(n===`resource`){if(e&&typeof e==`object`&&!Array.isArray(e)){let t=Number(e.current),n=Number(e.max);if(Number.isFinite(t)&&Number.isFinite(n))return`${Math.trunc(t)}/${Math.trunc(n)}`}return`-`}return e==null||e===``?`-`:String(e)},I=()=>{let[t,n]=(0,v.useState)({sceneMetadata:{},roomMetadata:{},items:[]}),[r,a]=(0,v.useState)(!1),[o,s]=(0,v.useState)(()=>({width:typeof window<`u`?window.innerWidth:1920,height:typeof window<`u`?window.innerHeight:1080})),[c,d]=(0,v.useState)(``),[p,h]=(0,v.useState)(0),[_,I]=(0,v.useState)(null),[R,z]=(0,v.useState)(null),B=e=>e.filter(e=>e.metadata?.[l.BOSS_MODE]===!0).length;(0,v.useEffect)(()=>{let e=!0,t=async t=>{let n=t[te.SNAPSHOT_PUBLIC_ID];if(typeof n!=`string`||n.trim().length===0){e&&(I(null),z(null));return}let{data:r,error:i}=await u.rpc(`bs_forge_get_snapshot_for_room`,{p_snapshot_public_id:n});if(i){e&&(I(null),z(null));return}let a=Array.isArray(r)?r[0]:r;if(!a||typeof a!=`object`){e&&(I(null),z(null));return}let o=a,s=A(o.attributes);if(typeof o.theme_primary!=`string`||typeof o.theme_offset!=`string`||typeof o.theme_background!=`string`||typeof o.theme_border!=`string`||!Array.isArray(s)){e&&(I(null),z(null));return}e&&(I({primary:o.theme_primary,offset:o.theme_offset,background:o.theme_background,border:o.theme_border,background_url:typeof o.background_url==`string`?o.background_url:``}),z(s))};(async()=>{let[r,o,s,c]=await Promise.all([i.scene.getMetadata(),i.room.getMetadata(),i.scene.items.getItems(),i.player.getId()]);e&&(n({sceneMetadata:r,roomMetadata:o,items:s}),d(c),h(B(s)),await t(o),a(!0))})();let r=i.scene.onMetadataChange(t=>{e&&n(e=>({...e,sceneMetadata:t}))}),o=i.room.onMetadataChange(r=>{e&&(n(e=>({...e,roomMetadata:r})),t(r))}),s=i.scene.items.onChange(t=>{e&&(n(e=>({...e,items:t})),h(B(t)))}),c=i.player.onChange(t=>{e&&d(t.id||``)});return()=>{e=!1,r(),o(),s(),c()}},[]),(0,v.useEffect)(()=>{let e=()=>{s({width:window.innerWidth,height:window.innerHeight})};return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]);let V=(0,v.useMemo)(()=>_||b,[_]),H=(0,v.useMemo)(()=>R||f.attributes,[R]),U=(0,v.useMemo)(()=>M(t),[t]),W=(0,v.useMemo)(()=>{let e=U[ee(m.PARTY_HUD_ORIENTATION,c)]??U[m.PARTY_HUD_ORIENTATION];return P(e)?e:`bottom`},[U,c]),G=U[m.PARTY_HUD_ATTR_ONE]||``,K=U[m.PARTY_HUD_ATTR_TWO]||``,ye=U[m.PARTY_HUD_SHOW_HP_BARS]!==void 0,be=U[m.PARTY_HUD_SHOW_HP_NUMBERS]!==void 0,q=U[m.PARTY_HUD_SHOW_HP_BARS]===!0,xe=U[m.PARTY_HUD_SHOW_HP_NUMBERS]===!0&&!q,J=!ye&&!be,Se=J?!0:q,Ce=J?!1:xe,Y=(0,v.useMemo)(()=>[G,K].filter((e,t,n)=>e&&n.indexOf(e)===t).map(e=>H.find(t=>t.attr_bid===e)||null).filter(e=>e!==null).filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`text`||t===`numb`||t===`bool`||t===`resource`||t===`enum`||t===`derived`}),[H,G,K]),{currentHpBid:we,maxHpBid:Te}=(0,v.useMemo)(()=>{let e=N(H),t=U[m.HP_CURRENT_BID],n=U[m.HP_MAX_BID],r=new Set(H.map(e=>e.attr_bid));return{currentHpBid:t&&r.has(t)?t:e.currentHpBid,maxHpBid:n&&r.has(n)?n:e.maxHpBid}},[H,U]),X=(0,v.useMemo)(()=>t.items.filter(e=>e.metadata?.[l.IN_PARTY]===!0).sort((e,t)=>{let n=String(L(e)),r=String(L(t));return n.localeCompare(r)}),[t.items]),Z=(0,v.useMemo)(()=>{let e=t.sceneMetadata[m.CURRENT_TURN];return typeof e==`string`&&e.trim().length>0?e:null},[t.sceneMetadata]),Q=(0,v.useMemo)(()=>W===`top`?p>=2?re:p===1?ne:x:x,[p,W]),$=(0,v.useMemo)(()=>{let e=Math.max(1,X.length),t=W===`left`||W===`right`,n=t?T:C,r=t?E:w,i=t?n:e*n+(e-1)*S,a=t?e*r+(e-1)*S:r,s=Math.max(1,o.width-Q*2),c=Math.max(1,o.height-Q*2),l=s/i,u=c/a,d=i>s||a>c?Math.min(1,l,u):1;return{contentWidth:i,contentHeight:a,scale:d,scaledWidth:Math.max(1,Math.floor(i*d)),scaledHeight:Math.max(1,Math.floor(a*d))}},[W,X.length,o.height,o.width,Q]);return r?(0,y.jsx)(D,{$theme:V,children:(0,y.jsx)(ie,{$orientation:W,$inset:Q,children:X.length===0?(0,y.jsx)(O,{$theme:V,children:`No party units found.`}):(0,y.jsx)(ae,{$scaledWidth:$.scaledWidth,$scaledHeight:$.scaledHeight,children:(0,y.jsx)(oe,{$contentWidth:$.contentWidth,$contentHeight:$.contentHeight,$scale:$.scale,children:(0,y.jsx)(se,{$orientation:W,children:X.map(t=>{let n=L(t),r=t.metadata?.[l.PORTRAIT_URL]||``,i=(e(t)?t.image.url:void 0)||`/logo.png`,a=r||i,o=t.metadata?.[`${g}/${we}`],s=t.metadata?.[`${g}/${Te}`],c=j(o),u=j(s),d=c!==null&&u!==null&&u>0?k(c/u*100,0,100):0,f=t.id===Z;return(0,y.jsxs)(ce,{$theme:V,$orientation:W,children:[(0,y.jsx)(ue,{$orientation:W,children:(0,y.jsx)(de,{src:a,alt:n,$theme:V,$orientation:W})}),f&&(0,y.jsx)(le,{$theme:V}),(0,y.jsxs)(fe,{$theme:V,$orientation:W,children:[(0,y.jsx)(pe,{$theme:V,title:n,children:n}),Se&&(0,y.jsx)(me,{$theme:V,children:(0,y.jsx)(he,{$percent:d})}),Ce&&(0,y.jsxs)(ge,{$theme:V,children:[`HP: `,c===null?`-`:Math.trunc(c),` / `,u===null?`-`:Math.trunc(u)]}),Y.length>0&&(0,y.jsx)(_e,{children:Y.map(e=>{let n=(e.attr_abbr||e.attr_name||e.attr_bid).trim(),r=t.metadata?.[`com.battle-system.forge/${e.attr_bid}`];return(0,y.jsxs)(ve,{$theme:V,children:[n,`: `,F(r,String(e.attr_type||``))]},`${t.id}-${e.attr_bid}`)})})]})]},t.id)})})})})})}):(0,y.jsx)(D,{$theme:V})},L=e=>{let t=e.metadata?.[l.UNIT_NAME];return typeof t==`string`&&t.trim()?t.trim():typeof e.name==`string`&&e.name.trim()?e.name.trim():`Unknown`},R=I;_.createRoot(document.getElementById(`root`)).render((0,y.jsx)(v.StrictMode,{children:(0,y.jsx)(p,{children:(0,y.jsx)(R,{})})}));