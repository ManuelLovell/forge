...
`,Km=T.p`
  ...
  margin: 0;
  line-height: 1.5;
`;const qm=()=>{let{theme:e}=Rt(),{t:n}=yt(),{attributes:r}=Mm(),i=B(e=>e.roomMetadata);B(e=>e.sceneMetadata);let a=B(e=>e.items),o=B(e=>e.cacheReady),[s,l]=(0,z.useState)(!1),[u,d]=(0,z.useState)(!1),[f,m]=(0,z.useState)(`D20`),[h,g]=(0,z.useState)(!1),[_,v]=(0,z.useState)(``),[y,b]=(0,z.useState)(`@STAT`),[x,S]=(0,z.useState)(!1),[C,w]=(0,z.useState)(!1),[T,E]=(0,z.useState)(!0),[D,ee]=(0,z.useState)(!1),[te,ne]=(0,z.useState)(!0),[re,k]=(0,z.useState)(!0),[ie,oe]=(0,z.useState)(!1),[se,ce]=(0,z.useState)(`bottom`),[le,ue]=(0,z.useState)(!1),[de,fe]=(0,z.useState)(!1),[pe,me]=(0,z.useState)(!1),[he,ge]=(0,z.useState)(!1),[_e,ve]=(0,z.useState)(!1),[ye,j]=(0,z.useState)(!1),[be,xe]=(0,z.useState)(!1),[Se,Ce]=(0,z.useState)(!1),[we,M]=(0,z.useState)(!1),[Ee,De]=(0,z.useState)(!1),[Oe,ke]=(0,z.useState)(!1),[Ae,je]=(0,z.useState)(!1),[Me,Ne]=(0,z.useState)(``),[Pe,Fe]=(0,z.useState)(!1),Ie=(0,z.useRef)(null),Le=(0,z.useRef)(null),[ze,Ve]=(0,z.useState)(()=>dt()),[He,Ue]=(0,z.useState)(()=>Ke()),[We,Ge]=(0,z.useState)(()=>gt()),[qe,Je]=(0,z.useState)(!1),[Ye,Ze]=(0,z.useState)(!1),P=jm(n);(0,z.useEffect)(()=>{let e=!0;return(async()=>{let t=await mt();e&&(Ve(t&&dt()),Ue(Ke()),Ge(gt()))})(),()=>{e=!1}},[]);let F=i;(0,z.useEffect)(()=>{if(o){if(F[O.POPCORN_INITIATIVE]!==void 0&&l(F[O.POPCORN_INITIATIVE]),F[O.REVERSE_INITIATIVE]!==void 0&&d(F[O.REVERSE_INITIATIVE]),F[O.DICE_RANGE]!==void 0&&m(F[O.DICE_RANGE]),F[O.INITIATIVE_MODIFIER_BID]===void 0?v(``):v(F[O.INITIATIVE_MODIFIER_BID]||``),F[O.INITIATIVE_MODIFIER_EXPR]!==void 0){let e=(F[O.INITIATIVE_MODIFIER_EXPR]||`@STAT`).replace(/\bx\b/gi,`@STAT`).trim();b(e.length>0?e:`@STAT`)}else b(`@STAT`);if(F[O.SHOW_CARD_ACCESS]!==void 0&&g(F[O.SHOW_CARD_ACCESS]),F[O.SHOW_PLAYER_VIEW]!==void 0&&S(F[O.SHOW_PLAYER_VIEW]),F[O.SHOW_OWNER_ONLY_EDIT]!==void 0&&ee(F[O.SHOW_OWNER_ONLY_EDIT]),F[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?ne(!0):ne(F[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]),F[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===void 0?k(!0):k(F[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]),F[O.SHOW_NON_PARTY_UNITS]!==void 0&&w(F[O.SHOW_NON_PARTY_UNITS]),F[O.SHOW_LIST_HP_NUMBERS]===void 0?E(!0):E(F[O.SHOW_LIST_HP_NUMBERS]),F[O.SHOW_HP_BARS]!==void 0&&oe(F[O.SHOW_HP_BARS]),F[O.HP_BAR_ORIENTATION]!==void 0&&ce(F[O.HP_BAR_ORIENTATION]),F[O.SHOW_HP_NUMBERS]!==void 0&&ue(F[O.SHOW_HP_NUMBERS]),F[O.SHOW_DEATH_EFFECT]!==void 0&&fe(F[O.SHOW_DEATH_EFFECT]),F[O.SHOW_NAMES]!==void 0&&me(F[O.SHOW_NAMES]),F[O.SHOW_TURN_EFFECT]!==void 0&&ge(F[O.SHOW_TURN_EFFECT]),F[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&ve(F[O.USE_DESCRIPTIVE_DUPLICATES]),F[O.ENABLE_RUMBLE]!==void 0&&j(F[O.ENABLE_RUMBLE]),F[O.ENABLE_BONES]!==void 0&&xe(F[O.ENABLE_BONES]),F[O.ENABLE_DICE_PLUS]!==void 0&&Ce(F[O.ENABLE_DICE_PLUS]),F[O.ENABLE_TEXT_BASED_ROLLS]!==void 0&&M(F[O.ENABLE_TEXT_BASED_ROLLS]),F[O.ENABLE_OBR_NOTIFICATION]!==void 0&&De(F[O.ENABLE_OBR_NOTIFICATION]),F[O.SHOW_NOTIFICATION_TO_ALL]!==void 0&&ke(F[O.SHOW_NOTIFICATION_TO_ALL]),F[O.ENABLE_DISCORD_LOGGING]!==void 0&&je(F[O.ENABLE_DISCORD_LOGGING]),F[O.DISCORD_URL]!==void 0&&Ne(F[O.DISCORD_URL]),F[O.ENABLE_CONSOLE_LOG]!==void 0){let e=F[O.ENABLE_CONSOLE_LOG];Fe(e),A.setEnabled(e)}else Fe(!1)}},[o,F]);let I=async(e,t)=>{await c.room.setMetadata({[e]:t})},L=e=>{let t=(e||``).trim().match(/(\d+)/),n=t?parseInt(t[1],10):NaN;return Number.isFinite(n)&&n>0?n:20},et=r.filter(e=>e.attr_type===`numb`).sort((e,t)=>(e.attr_name||``).localeCompare(t.attr_name||``)),tt=(e,t)=>{let r=e.trim();return r?t?/@STAT/i.test(r)?/\d\s*d\s*\d|\bd\s*\d/i.test(r)?{valid:!1,error:n(`settings.diceNotAllowedError`)}:Qe(r.replace(/@STAT/gi,`@${t}`))?{valid:!0}:{valid:!1,error:n(`settings.invalidSyntaxError`)}:{valid:!1,error:n(`settings.exprMustIncludeStatError`)}:{valid:!1,error:n(`settings.selectNumericAttributeError`)}:{valid:!1,error:n(`settings.exprRequiredError`)}},nt=async(e,t)=>{await I(O.INITIATIVE_MODIFIER_BID,e),await I(O.INITIATIVE_MODIFIER_EXPR,t)},rt=async e=>{if(v(e),!e){await nt(``,y);return}let t=tt(y,e);t.valid||await c.notification.show(t.error||n(`settings.invalidModifierSettingsError`),`WARNING`),await nt(e,y)},it=async()=>{let e=y.trim(),t=(e.length>0?e:`@STAT`).replace(/\bx\b/gi,`@STAT`);if(b(t),!_){await nt(``,t);return}let r=tt(t,_);if(!r.valid){await c.notification.show(r.error||n(`settings.invalidModifierExpressionError`),`WARNING`);return}await nt(_,t)},at=async()=>{if(!_){await c.notification.show(n(`settings.selectAttributeBeforeTestingError`),`WARNING`);return}let e=y.replace(/\bx\b/gi,`@STAT`),t=tt(e,_);if(!t.valid){await c.notification.show(t.error||n(`settings.invalidModifierExpressionError`),`WARNING`);return}let r=L(f),i=Math.floor(Math.random()*r)+1,a=Re(e.replace(/@STAT/gi,`@${_}`),{bidValueMap:{[_]:14},onMissingBid:`useZero`});if(!a.valid||!a.notation){await c.notification.show(n(`settings.couldNotResolveModifierError`),`ERROR`);return}let o=Number(a.notation),s=Number.isFinite(o)?Math.trunc(o):0,l=i+s,u=e.replace(/@STAT/gi,`14`);await c.notification.show(n(`settings.mockInitiativeResult`,{sides:r,baseRoll:i,expression:u,modifier:s,total:l}),`SUCCESS`)},ot=async()=>{try{let e=await Te(),t=JSON.stringify(e,null,2),r=new Blob([t],{type:`text/plain;charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`forge-collection-${new Date().toISOString().slice(0,10)}.txt`,a.click(),URL.revokeObjectURL(i),await c.notification.show(n(`settings.collectionExportComplete`,{count:e.length}),`SUCCESS`)}catch(e){A.log(`Collection export failed`,e),await c.notification.show(n(`settings.collectionExportFailed`),`ERROR`)}},st=()=>{Ze(!0)},ct=()=>{Ze(!1),Ie.current?.click()},lt=async e=>{let t=e.target.files?.[0];if(t)try{let e=await t.text(),r=JSON.parse(e);if(!Array.isArray(r)){await c.notification.show(n(`settings.collectionImportArrayError`),`ERROR`);return}let i=await ae(r);await c.notification.show(n(`settings.collectionImportCompleteSummary`,{created:i.created,updated:i.updated,skipped:i.skipped}),`SUCCESS`)}catch(e){A.log(`Collection import failed`,e),await c.notification.show(n(`settings.collectionImportFailed`),`ERROR`)}finally{e.target.value=``}},ut=async()=>{Je(!0);try{await Be(),await c.broadcast.sendMessage(t.AUTHSYNCCHANNEL,{type:`BS_AUTH_STATE`,source:t.EXTENSIONID,snapshot:$e()},{destination:`LOCAL`}),Ve(dt()),Ue(Ke()),Ge(gt()),await c.notification.show(n(`settings.connectedAccount`),`SUCCESS`)}catch(e){A.error(`Battle-System auth connection failed`,e),await c.notification.show(n(`settings.unableToConnectAccount`),`ERROR`),Ve(dt()),Ue(Ke()),Ge(gt())}finally{Je(!1)}};return(0,V.jsxs)(Xd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},children:[(0,V.jsxs)(ym,{theme:e,children:[(0,V.jsx)(bm,{theme:e,children:n(`settings.pageTitle`)}),(0,V.jsxs)(xm,{theme:e,children:[(0,V.jsx)(Lm,{theme:e,children:n(`settings.accountSectionTitle`)}),(0,V.jsx)(Wm,{children:(0,V.jsx)(Sm,{theme:e,onClick:()=>{ut()},disabled:qe,children:n(qe?`settings.connecting`:ze?`settings.reconnectAccount`:`settings.connectAccount`)})}),(0,V.jsx)(Gm,{theme:e,$connected:ze,children:ze?n(`settings.statusConnected`,{tier:He}):n(`settings.statusDisconnected`)})]}),(0,V.jsxs)(xm,{theme:e,children:[(0,V.jsx)(Lm,{theme:e,children:n(`settings.collectionSectionTitle`)}),(0,V.jsxs)(Wm,{children:[(0,V.jsx)(Sm,{theme:e,onClick:ot,children:n(`settings.export`)}),(0,V.jsx)(Sm,{theme:e,onClick:st,children:n(`settings.import`)})]}),(0,V.jsx)(`input`,{ref:Ie,type:`file`,accept:`.txt,.json,text/plain,application/json`,onChange:lt,style:{display:`none`}})]}),(0,V.jsxs)(xm,{theme:e,children:[(0,V.jsx)(Lm,{theme:e,children:n(`settings.listControlsSectionTitle`)}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.reverseInitiative,children:n(`settings.reverseInitiative`)})}),(0,V.jsx)(Z,{label:n(`settings.reverseInitiative`),isOn:u,onChange:async e=>{d(e),await I(O.REVERSE_INITIATIVE,e),e&&s&&(l(!1),await I(O.POPCORN_INITIATIVE,!1))}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.popcornInitiative,children:n(`settings.popcornInitiative`)})}),(0,V.jsx)(Z,{label:n(`settings.popcornInitiative`),isOn:s,onChange:async e=>{l(e),await I(O.POPCORN_INITIATIVE,e),e&&u&&(d(!1),await I(O.REVERSE_INITIATIVE,!1))}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.initiativeDie,children:n(`settings.initiativeDie`)})}),(0,V.jsx)(Vm,{theme:e,type:`text`,value:f,onChange:async e=>{let t=e.target.value;m(t),await I(O.DICE_RANGE,t),A.log(`Dice Range:`,t)},placeholder:`D20`,maxLength:3})]}),(0,V.jsxs)(Rm,{theme:e,children:[(0,V.jsx)(zm,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.initiativeModifierAttr,children:n(`settings.initiativeModifier`)})}),(0,V.jsxs)(Hm,{theme:e,value:_,onChange:async e=>{await rt(e.target.value)},children:[(0,V.jsx)(`option`,{value:``,children:n(`settings.none`)}),et.map(e=>(0,V.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,V.jsxs)(Rm,{theme:e,children:[(0,V.jsx)(zm,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.initiativeModifierMath,children:n(`settings.math`)})}),(0,V.jsx)(Vm,{theme:e,type:`text`,value:y,onChange:e=>{b(e.target.value)},onBlur:async()=>{await it()},placeholder:`floor((@STAT-10)/2)`,maxLength:120,disabled:!_}),(0,V.jsx)(Um,{theme:e,type:`button`,onClick:()=>{at()},disabled:!_,children:n(`settings.test`)})]}),(0,V.jsx)(Bm,{theme:e,children:n(`settings.initiativeModifierHint`)}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showCardColumn,children:n(`settings.showCardColumn`)})}),(0,V.jsx)(Z,{label:n(`settings.showCardColumn`),isOn:h,onChange:async e=>{g(e),await I(O.SHOW_CARD_ACCESS,e)}})]})]}),(0,V.jsxs)(xm,{theme:e,children:[(0,V.jsx)(Lm,{theme:e,children:n(`settings.playerControlsSectionTitle`)}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showPlayerView,children:n(`settings.showPlayerView`)})}),(0,V.jsx)(Z,{label:n(`settings.showPlayerView`),isOn:x,onChange:async e=>{S(e),await I(O.SHOW_PLAYER_VIEW,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showNonPartyUnits,children:n(`settings.showNonPartyUnits`)})}),(0,V.jsx)(Z,{label:n(`settings.showNonPartyUnits`),isOn:C,onChange:async e=>{w(e),await I(O.SHOW_NON_PARTY_UNITS,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showHpNumbersOnList,children:n(`settings.showHpNumbersOnList`)})}),(0,V.jsx)(Z,{label:n(`settings.showHpNumbersOnList`),isOn:T,onChange:async e=>{E(e),await I(O.SHOW_LIST_HP_NUMBERS,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.ownerOnlyEdit,children:n(`settings.ownerOnlyEdit`)})}),(0,V.jsx)(Z,{label:n(`settings.ownerOnlyEdit`),isOn:D,onChange:async e=>{ee(e),await I(O.SHOW_OWNER_ONLY_EDIT,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showAdjustHpContextMenu,children:n(`settings.showAdjustHpContextMenu`)})}),(0,V.jsx)(Z,{label:n(`settings.showAdjustHpContextMenu`),isOn:te,onChange:async e=>{ne(e),await I(O.SHOW_MODIFY_UNIT_CONTEXT_MENU,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showViewUnitContextMenuForPlayers,children:n(`settings.showViewUnitContextMenuForPlayers`)})}),(0,V.jsx)(Z,{label:n(`settings.showViewUnitContextMenuForPlayers`),isOn:re,onChange:async e=>{k(e),await I(O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS,e)}})]})]}),(0,V.jsxs)(xm,{theme:e,children:[(0,V.jsx)(Lm,{theme:e,children:n(`settings.gameControlsSectionTitle`)}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showHpBarsOnTokens,children:n(`settings.showHpBarsOnTokens`)})}),(0,V.jsx)(Z,{label:n(`settings.showHpBarsOnTokens`),isOn:ie,onChange:async e=>{oe(e),await I(O.SHOW_HP_BARS,e),e&&le&&(ue(!1),await I(O.SHOW_HP_NUMBERS,!1)),e&&F[O.HP_BAR_ORIENTATION]===void 0&&(ce(`bottom`),await I(O.HP_BAR_ORIENTATION,`bottom`))}})]}),(ie||le)&&(0,V.jsxs)(Rm,{theme:e,children:[(0,V.jsx)(zm,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.hpOrientation,children:n(`settings.orientation`)})}),(0,V.jsxs)(Hm,{theme:e,value:se,onChange:async e=>{let t=e.target.value;ce(t),await I(O.HP_BAR_ORIENTATION,t)},children:[(0,V.jsx)(`option`,{value:`top`,children:n(`common.orientation.top`)}),(0,V.jsx)(`option`,{value:`bottom`,children:n(`common.orientation.bottom`)}),(0,V.jsx)(`option`,{value:`left`,children:n(`common.orientation.left`)}),(0,V.jsx)(`option`,{value:`right`,children:n(`common.orientation.right`)})]})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showHpNumbersOnTokens,children:n(`settings.showHpNumbersOnTokens`)})}),(0,V.jsx)(Z,{label:n(`settings.showHpNumbersOnTokens`),isOn:le,onChange:async e=>{ue(e),await I(O.SHOW_HP_NUMBERS,e),e&&ie&&(oe(!1),await I(O.SHOW_HP_BARS,!1)),e&&F[O.HP_BAR_ORIENTATION]===void 0&&(ce(`bottom`),await I(O.HP_BAR_ORIENTATION,`bottom`))}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showDeathEffect,children:n(`settings.showDeathEffect`)})}),(0,V.jsx)(Z,{label:n(`settings.showDeathEffect`),isOn:de,onChange:async e=>{fe(e),await I(O.SHOW_DEATH_EFFECT,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showNamesOnTokens,children:n(`settings.showNamesOnTokens`)})}),(0,V.jsx)(Z,{label:n(`settings.showNamesOnTokens`),isOn:pe,onChange:async e=>{me(e),await I(O.SHOW_NAMES,e);let t=a.filter(e=>e.metadata[p.ON_LIST]===!0);e?(A.log(`Showing names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t.metadata[p.UNIT_NAME],n=t;e&&n.text&&(n.text.plainText=String(e))}})):(A.log(`Hiding names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t;e.text&&(e.text.plainText=``)}}))}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showTurnEffect,children:n(`settings.showTurnEffect`)})}),(0,V.jsx)(Z,{label:n(`settings.showTurnEffect`),isOn:he,onChange:async e=>{ge(e),await I(O.SHOW_TURN_EFFECT,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.useDescriptiveNames,children:n(`settings.useDescriptiveNames`)})}),(0,V.jsx)(Z,{label:n(`settings.useDescriptiveNames`),isOn:_e,onChange:async e=>{ve(e),await I(O.USE_DESCRIPTIVE_DUPLICATES,e)}})]})]}),(0,V.jsxs)(xm,{theme:e,children:[(0,V.jsx)(Lm,{theme:e,children:n(`settings.diceControlsSectionTitle`)}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.enableTextBasedRolls,children:n(`settings.enableTextBasedRolls`)})}),(0,V.jsx)(Z,{label:n(`settings.enableTextBasedRolls`),isOn:we,onChange:async e=>{M(e),await I(O.ENABLE_TEXT_BASED_ROLLS,e),e&&(De(!0),j(!1),xe(!1),Ce(!1),await I(O.ENABLE_OBR_NOTIFICATION,!0),await I(O.ENABLE_RUMBLE,!1),await I(O.ENABLE_BONES,!1),await I(O.ENABLE_DICE_PLUS,!1))}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.enableRumble,children:n(`settings.enableRumble`)})}),(0,V.jsx)(Z,{label:n(`settings.enableRumble`),isOn:ye,onChange:async e=>{j(e),await I(O.ENABLE_RUMBLE,e),e&&(xe(!1),Ce(!1),M(!1),await I(O.ENABLE_BONES,!1),await I(O.ENABLE_DICE_PLUS,!1),await I(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.enableBones,children:n(`settings.enableBones`)})}),(0,V.jsx)(Z,{label:n(`settings.enableBones`),isOn:be,onChange:async e=>{xe(e),await I(O.ENABLE_BONES,e),e&&(j(!1),Ce(!1),M(!1),await I(O.ENABLE_RUMBLE,!1),await I(O.ENABLE_DICE_PLUS,!1),await I(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.enableDicePlus,children:n(`settings.enableDicePlus`)})}),(0,V.jsx)(Z,{label:n(`settings.enableDicePlus`),isOn:Se,onChange:async e=>{Ce(e),await I(O.ENABLE_DICE_PLUS,e),e&&(j(!1),xe(!1),M(!1),await I(O.ENABLE_RUMBLE,!1),await I(O.ENABLE_BONES,!1),await I(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.enableObrNotification,children:n(`settings.enableObrNotification`)})}),(0,V.jsx)(Z,{label:n(`settings.enableObrNotification`),isOn:Ee,onChange:async e=>{De(e),await I(O.ENABLE_OBR_NOTIFICATION,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.showResultsToAll,children:n(`settings.showResultsToAll`)})}),(0,V.jsx)(Z,{label:n(`settings.showResultsToAll`),isOn:Oe,onChange:async e=>{ke(e),await I(O.SHOW_NOTIFICATION_TO_ALL,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.enableDiscordLogging,children:n(`settings.enableDiscordLogging`)})}),(0,V.jsx)(Z,{label:n(`settings.enableDiscordLogging`),isOn:Ae,onChange:async e=>{if(e&&!Xe(Me.trim())){await c.notification.show(n(`settings.invalidDiscordWebhookWarning`),`WARNING`),je(!1),await I(O.ENABLE_DISCORD_LOGGING,!1);return}je(e),await I(O.ENABLE_DISCORD_LOGGING,e)}})]}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)(zm,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.discordUrl,children:n(`settings.discordUrl`)})}),(0,V.jsx)(Vm,{theme:e,type:`text`,value:Me,onChange:async e=>{let t=e.target.value,n=t.trim();Ne(t),await I(O.DISCORD_URL,n),A.log(`Discord URL:`,n)},placeholder:`https://discord.com/api/webhooks/...`,maxLength:200})]})]}),(0,V.jsxs)(xm,{theme:e,children:[(0,V.jsx)(Lm,{theme:e,children:n(`settings.otherSectionTitle`)}),(0,V.jsxs)(Q,{theme:e,children:[(0,V.jsx)($,{theme:e,children:(0,V.jsx)(N,{theme:e,text:P.enableConsoleLog,children:n(`settings.enableConsoleLog`)})}),(0,V.jsx)(Z,{label:n(`settings.enableConsoleLog`),isOn:Pe,onChange:async e=>{Fe(e),A.setEnabled(e),await I(O.ENABLE_CONSOLE_LOG,e)}})]})]}),(0,V.jsxs)(xm,{theme:e,children:[(0,V.jsx)(Lm,{theme:e,children:n(`settings.clashImportSectionTitle`)}),(0,V.jsx)(Wm,{children:(0,V.jsx)(N,{theme:e,text:n(`settings.clashImportTooltip`),children:(0,V.jsx)(Sm,{theme:e,onClick:()=>{Le.current?.click()},children:n(`settings.clashImportLocal`)})})}),(0,V.jsx)(`input`,{ref:Le,type:`file`,accept:`.txt,.json,text/plain,application/json`,onChange:async e=>{let t=e.target.files?.[0];if(t)try{let e=await t.text(),r=JSON.parse(e);if(!Array.isArray(r)){await c.notification.show(n(`settings.clashImportArrayError`),`ERROR`);return}let{migrateClashCollectionFromJson:i}=await Im(async()=>{let{migrateClashCollectionFromJson:e}=await import(`./clashToForgeMapper-CwNRRzoH.js`);return{migrateClashCollectionFromJson:e}},[]),a=i(r);if(a.records.length===0){await c.notification.show(n(`settings.clashImportFailed`),`ERROR`);return}let o=await ae(a.records);await c.notification.show(n(`settings.clashImportCompleteSummary`,{created:o.created,updated:o.updated,skipped:o.skipped,failed:a.skipped}),`SUCCESS`)}catch(e){A.log(`Clash collection import failed`,e),await c.notification.show(n(`settings.clashImportFailed`),`ERROR`)}finally{e.target.value=``}},style:{display:`none`}})]})]}),(0,V.jsx)(Am,{isOpen:Ye,title:n(`settings.confirmImportTitle`),onClose:()=>Ze(!1),actions:(0,V.jsxs)(V.Fragment,{children:[(0,V.jsx)(Sm,{theme:e,variant:`secondary`,onClick:()=>Ze(!1),children:n(`settings.cancel`)}),(0,V.jsx)(Sm,{theme:e,onClick:ct,children:n(`settings.continue`)})]}),children:(0,V.jsx)(Km,{theme:e,children:n(`settings.importConfirmMessage`)})})]})};var Jm=T.div`
...
`,Lh={initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20}};const Rh=()=>{let{theme:e,updateThemeFromSystem:t}=Rt(),{t:n,locale:r}=yt(),i=B(e=>e.sceneMetadata),a=B(e=>e.roomMetadata),o=a,s=B(e=>e.systemData),l=B(e=>e.setSystemData),[u,d]=(0,z.useState)(()=>tt().premiumAuthorized),[p,m]=(0,z.useState)(``),[h,g]=(0,z.useState)(!1),[_,v]=(0,z.useState)(null),[y,b]=(0,z.useState)(null),[x,S]=(0,z.useState)(``),[w,T]=(0,z.useState)(null),[D,ee]=(0,z.useState)(null),[te,ne]=(0,z.useState)([]),[re,k]=(0,z.useState)(``),[ie,ae]=(0,z.useState)(``),[oe,se]=(0,z.useState)(eh),[ce,le]=(0,z.useState)(th),[ue,fe]=(0,z.useState)(!1),[pe,me]=(0,z.useState)(!1),[he,ge]=(0,z.useState)(null),[_e,ve]=(0,z.useState)(null),[ye,j]=(0,z.useState)([]),[be,xe]=(0,z.useState)(!1),[Se,Ce]=(0,z.useState)(null),[M,Te]=(0,z.useState)(``),Ee={buff_effect_one:n(`system.buffVisualPreset.buff_effect_one`),buff_effect_two:n(`system.buffVisualPreset.buff_effect_two`)},De={debuff_effect_one:n(`system.debuffVisualPreset.debuff_effect_one`),debuff_effect_two:n(`system.debuffVisualPreset.debuff_effect_two`)};(0,z.useEffect)(()=>{let e=!0,t=async()=>{await mt(),e&&d(tt().premiumAuthorized)},n=Ie(t=>{e&&d(t.premiumAuthorized)});return t(),()=>{e=!1,n()}},[]),(0,z.useEffect)(()=>{Oe(),Me()},[i,a,s,u]);let Oe=()=>{try{if(!u){let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url},t=o[O.BUFF_VISUAL_PRESET],n=o[O.DEBUFF_VISUAL_PRESET],r=ih(t)?t:eh,i=ah(n)?n:th;S(E.name),T(null),ee(e),ne(E.attributes),k(dh.currentHpBid),ae(dh.maxHpBid),se(r),le(i);return}if(s){let e=o[O.HP_CURRENT_BID],t=o[O.HP_MAX_BID],n=o[O.BUFF_VISUAL_PRESET],r=o[O.DEBUFF_VISUAL_PRESET],i=ih(n)?n:null,a=ah(r)?r:null;S(s.systemName),T(s.importDate),ee(s.theme),ne(s.attributes),k(e||``),ae(t||``),he&&i===he&&ge(null),_e&&a===_e&&ve(null),!ue&&!he&&se(e=>i||e),!pe&&!_e&&le(e=>a||e);return}let e=a[uh.SYSTEM_NAME],t=a[uh.IMPORT_DATE],n=o[O.HP_CURRENT_BID],r=o[O.HP_MAX_BID],i=o[O.BUFF_VISUAL_PRESET],c=o[O.DEBUFF_VISUAL_PRESET],l=ih(i)?i:null,d=ah(c)?c:null;S(e||E.name),T(t||null),ee({primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url}),ne(E.attributes),k(n||``),ae(r||``),he&&l===he&&ge(null),_e&&d===_e&&ve(null),!ue&&!he&&se(e=>l||e),!pe&&!_e&&le(e=>d||e)}catch(e){A.error(`Error loading system from cache:`,e)}},ke=async(e,t)=>{await c.room.setMetadata({[e]:t})},Ae=(e,t)=>{if(Array.isArray(e))return e;if(typeof e==`string`){let r;try{r=JSON.parse(e)}catch{throw Error(n(`system.error.invalidJsonField`,{field:t}))}if(!Array.isArray(r))throw Error(n(`system.error.invalidArrayField`,{field:t}));return r}throw Error(n(`system.error.invalidFieldType`,{field:t}))},je=te.filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`numb`||t===`resource`}),Me=()=>{try{let e=[];for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);if(n&&n.startsWith(`${lh}.`)&&n.endsWith(`.backup`)){let t=localStorage.getItem(n);if(t){let n=JSON.parse(t);e.push(n)}}}e.sort((e,t)=>new Date(t.backupDate).getTime()-new Date(e.backupDate).getTime()),j(e)}catch(e){A.error(`Error loading backups:`,e)}},Ne=async e=>{try{if(!s){A.warn(`Cannot create backup: runtime system data is unavailable`);return}let e=s.systemName||E.name,t={name:e,backupDate:new Date().toISOString(),theme_primary:s.theme.primary,theme_offset:s.theme.offset,theme_background:s.theme.background,theme_border:s.theme.border,background_url:s.theme.background_url,card_layout:s.cardLayout,list_layout:s.listLayout,attributes:s.attributes},n=`${lh}.${e}.backup`;localStorage.setItem(n,JSON.stringify(t)),A.log(`Backup created for ${e}`),Me()}catch(e){throw A.error(`Error creating backup:`,e),e}},Pe=e=>{try{let t=`${lh}.${e}.backup`;localStorage.removeItem(t),A.log(`Backup deleted for ${e}`),Me(),b(n(`system.success.backupDeleted`,{name:e}))}catch(e){A.error(`Error deleting backup:`,e),v(n(`system.error.deleteBackup`))}},Fe=(e,t)=>{Te(e),Ce(()=>t),xe(!0)},Le=async()=>{xe(!1),Se&&(await Se(),Ce(null))},Re=()=>{xe(!1),Ce(null),Te(``)},ze=async()=>{if(!p.trim()){v(n(`system.error.enterShareId`));return}Fe(n(`system.confirm.importSystem`),async()=>{await Be()})},Be=async()=>{if(!gt()){v(n(`system.error.premiumImport`));return}g(!0),v(null),b(null);try{await Ue();let{data:e,error:r}=await we(async()=>C.rpc(`bs_forge_import_system_snapshot`,{p_source_share_id:p.trim()}));if(r)throw r;if(!e){v(n(`system.error.noSystemFound`)),g(!1);return}let i=Array.isArray(e)?e[0]:e;if(!i||typeof i.snapshot_public_id!=`string`)throw Error(n(`system.error.snapshotInvalid`));let a=Ae(i.card_layout,`card_layout`),o=Ae(i.list_layout,`list_layout`),s=Ae(i.attributes,`attributes`);if(!Array.isArray(s))throw Error(n(`system.error.attributesInvalid`));await Ne(x);let u={primary:i.theme_primary,offset:i.theme_offset,background:i.theme_background,border:i.theme_border,background_url:i.background_url},d=new Date().toISOString();await c.room.setMetadata({[uh.SNAPSHOT_PUBLIC_ID]:i.snapshot_public_id,[uh.SYSTEM_NAME]:i.system_name,[uh.IMPORT_DATE]:d}),l({theme:u,cardLayout:a,listLayout:o,attributes:s,systemName:i.system_name,importDate:d,snapshotPublicId:i.snapshot_public_id}),S(i.system_name),T(d),ee(u),t(u.primary,u.offset,u.background,u.border,u.background_url),b(n(`system.success.systemImported`,{name:i.system_name})),m(``),A.log(`System snapshot imported and loaded:`,{systemName:i.system_name,snapshotPublicId:i.snapshot_public_id})}catch(e){A.error(`Error fetching system:`,e),v(fh(e,n(`system.error.fetchSystem`)))}finally{g(!1)}},Ve=async e=>{Fe(n(`system.confirm.restoreBackup`,{name:e.name}),async()=>{await He(e)})},He=async e=>{g(!0),v(null),b(null);try{if(!gt()){v(n(`system.error.premiumRestore`));return}await Ue(),await Ne(x);let r={primary:e.theme_primary,offset:e.theme_offset,background:e.theme_background,border:e.theme_border,background_url:e.background_url};if(!Array.isArray(e.card_layout)||!Array.isArray(e.list_layout)||!Array.isArray(e.attributes))throw Error(n(`system.error.backupInvalid`));let i=new Date().toISOString(),a=`forge-backup:${e.name.trim().toLowerCase()}`,{data:o,error:s}=await we(async()=>C.rpc(`bs_forge_upsert_user_snapshot_payload`,{p_source_share_id:a,p_system_name:e.name,p_background_url:e.background_url,p_theme_primary:e.theme_primary,p_theme_offset:e.theme_offset,p_theme_background:e.theme_background,p_theme_border:e.theme_border,p_card_layout:e.card_layout,p_list_layout:e.list_layout,p_attributes:e.attributes}));if(s)throw s;let u=Array.isArray(o)?o[0]:o;if(!u||typeof u.snapshot_public_id!=`string`)throw Error(n(`system.error.backupPublishFailed`));l({theme:r,cardLayout:e.card_layout,listLayout:e.list_layout,attributes:e.attributes,systemName:e.name,importDate:i,snapshotPublicId:u.snapshot_public_id}),await c.room.setMetadata({[uh.SNAPSHOT_PUBLIC_ID]:u.snapshot_public_id,[uh.SYSTEM_NAME]:e.name,[uh.IMPORT_DATE]:i}),S(e.name),T(i),ee(r),t(r.primary,r.offset,r.background,r.border,r.background_url),b(n(`system.success.backupRestored`,{name:e.name})),A.log(`System restored from backup:`,e.name)}catch(e){A.error(`Error restoring backup:`,e),v(n(`system.error.restoreBackup`))}finally{g(!1)}},We=async()=>{g(!0),v(null),b(null);try{let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url};l({theme:e,cardLayout:E.card_layout,listLayout:E.list_layout,attributes:E.attributes,systemName:E.name,importDate:null,snapshotPublicId:null}),await c.room.setMetadata({[uh.SNAPSHOT_PUBLIC_ID]:null,[uh.SYSTEM_NAME]:E.name,[uh.IMPORT_DATE]:null}),S(E.name),T(null),ee(e),t(e.primary,e.offset,e.background,e.border,e.background_url),b(n(`system.success.resetDefault`))}catch(e){v(n(`system.error.resetDefault`)),A.error(`Error resetting to default:`,e)}finally{g(!1)}},Ge=e=>e?new Date(e).toLocaleDateString(r,{year:`numeric`,month:`long`,day:`numeric`,hour:`2-digit`,minute:`2-digit`}):null,Ke=!u,qe=!u;return(0,V.jsxs)(Xd.div,{variants:Lh,initial:`initial`,animate:`animate`,exit:`exit`,children:[(0,V.jsxs)(ym,{theme:e,children:[(0,V.jsx)(bm,{theme:e,children:n(`system.pageTitle`)}),(0,V.jsx)(hh,{theme:e,children:x}),w?(0,V.jsx)(gh,{theme:e,children:n(`system.importedOn`,{value:Ge(w)})}):(0,V.jsx)(gh,{theme:e,children:n(`system.usingDefaultSystem`)}),D&&(0,V.jsxs)(V.Fragment,{children:[(0,V.jsxs)(_h,{children:[(0,V.jsxs)(`div`,{children:[(0,V.jsx)(vh,{color:D.primary,theme:e,children:D.primary}),(0,V.jsx)(yh,{theme:e,children:n(`system.swatch.primary`)})]}),(0,V.jsxs)(`div`,{children:[(0,V.jsx)(vh,{color:D.offset,theme:e,children:D.offset}),(0,V.jsx)(yh,{theme:e,children:n(`system.swatch.offset`)})]}),(0,V.jsxs)(`div`,{children:[(0,V.jsx)(vh,{color:D.background,theme:e,children:D.background}),(0,V.jsx)(yh,{theme:e,children:n(`system.swatch.background`)})]}),(0,V.jsxs)(`div`,{children:[(0,V.jsx)(vh,{color:D.border,theme:e,children:D.border}),(0,V.jsx)(yh,{theme:e,children:n(`system.swatch.border`)})]})]}),(0,V.jsxs)(bh,{theme:e,children:[(0,V.jsx)(xh,{theme:e,children:n(`system.settingsSectionTitle`)}),(0,V.jsxs)(Sh,{children:[(0,V.jsx)(Ch,{theme:e,children:n(`system.currentHp`)}),(0,V.jsxs)(wh,{theme:e,value:re,disabled:qe,onChange:async e=>{if(qe)return;let t=e.target.value;k(t),await ke(O.HP_CURRENT_BID,t)},children:[(0,V.jsx)(`option`,{value:``,children:n(`system.selectAttribute`)}),je.map(e=>(0,V.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name,String(e.attr_type||``).toLowerCase()===`resource`?n(`system.resourceOptionSuffix`):``]},e.attr_bid))]})]}),(0,V.jsxs)(Sh,{children:[(0,V.jsx)(Ch,{theme:e,children:n(`system.maxHp`)}),(0,V.jsxs)(wh,{theme:e,value:ie,disabled:qe,onChange:async e=>{if(qe)return;let t=e.target.value;ae(t),await ke(O.HP_MAX_BID,t)},children:[(0,V.jsx)(`option`,{value:``,children:n(`system.selectAttribute`)}),je.map(e=>(0,V.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name,String(e.attr_type||``).toLowerCase()===`resource`?n(`system.resourceOptionSuffix`):``]},e.attr_bid))]})]}),qe&&(0,V.jsx)(gh,{theme:e,children:n(`system.premiumHpMappingLocked`)}),(0,V.jsxs)(Sh,{children:[(0,V.jsx)(Ch,{theme:e,children:n(`system.buffVisual`)}),(0,V.jsx)(wh,{theme:e,value:oe,onChange:async e=>{let t=e.target.value;if(ih(t)){se(t),ge(t),fe(!0);try{await ke(O.BUFF_VISUAL_PRESET,t)}finally{fe(!1)}}},children:nh.map(e=>(0,V.jsx)(`option`,{value:e.value,children:Ee[e.value]},e.value))})]}),(0,V.jsxs)(Sh,{children:[(0,V.jsx)(Ch,{theme:e,children:n(`system.debuffVisual`)}),(0,V.jsx)(wh,{theme:e,value:ce,onChange:async e=>{let t=e.target.value;if(ah(t)){le(t),ve(t),me(!0);try{await ke(O.DEBUFF_VISUAL_PRESET,t)}finally{me(!1)}}},children:rh.map(e=>(0,V.jsx)(`option`,{value:e.value,children:De[e.value]},e.value))})]})]})]}),(0,V.jsxs)(mh,{theme:e,children:[(0,V.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0},children:n(`system.importSectionTitle`)}),(0,V.jsx)(`p`,{style:{color:f(e.PRIMARY,.8),fontSize:`14px`},children:n(Ke?`system.importLockedDescription`:`system.importDescription`)}),(0,V.jsx)(ph,{children:(0,V.jsx)(Cm,{theme:e,type:`text`,value:p,onChange:e=>m(e.target.value),placeholder:Ke?``:n(`system.shareIdPlaceholder`),disabled:h||Ke,onKeyPress:e=>e.key===`Enter`&&ze()})}),(0,V.jsxs)(Dh,{children:[(0,V.jsx)(Sm,{theme:e,onClick:ze,disabled:h||Ke||!p.trim(),children:n(h?`system.importButtonLoading`:`system.importButton`)}),(0,V.jsx)(Sm,{theme:e,variant:`secondary`,onClick:We,disabled:h,children:n(`system.useDefaultButton`)})]})]}),_&&(0,V.jsxs)(Th,{theme:e,children:[(0,V.jsx)(`strong`,{children:n(`system.errorPrefix`)}),` `,_]}),y&&(0,V.jsxs)(Eh,{theme:e,children:[(0,V.jsx)(`strong`,{children:n(`system.successPrefix`)}),` `,y]}),ye.length>0&&(0,V.jsx)(kh,{children:(0,V.jsxs)(xm,{theme:e,children:[(0,V.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0,marginBottom:`15px`},children:n(`system.backupsSectionTitle`)}),(0,V.jsx)(Ah,{children:ye.map(t=>(0,V.jsxs)(jh,{theme:e,children:[(0,V.jsxs)(Mh,{children:[(0,V.jsx)(Nh,{theme:e,children:t.name}),(0,V.jsx)(Ph,{theme:e,children:n(`system.backedUpOn`,{value:Ge(t.backupDate)})})]}),(0,V.jsxs)(Fh,{children:[(0,V.jsx)(Ih,{theme:e,onClick:()=>Ve(t),disabled:h,title:n(`system.importBackupTitle`),children:(0,V.jsx)(de,{size:18})}),(0,V.jsx)(Ih,{theme:e,$variant:`danger`,onClick:()=>Pe(t.name),disabled:h,title:n(`system.deleteBackupTitle`),children:(0,V.jsx)(Ye,{size:18})})]})]},`${t.name}-${t.backupDate}`))})]})})]}),(0,V.jsx)(Am,{isOpen:be,title:n(`system.confirmActionTitle`),onClose:Re,actions:(0,V.jsxs)(V.Fragment,{children:[(0,V.jsx)(Sm,{theme:e,variant:`secondary`,onClick:Re,children:n(`system.cancel`)}),(0,V.jsx)(Sm,{theme:e,onClick:Le,children:n(`system.confirm`)})]}),children:(0,V.jsx)(Oh,{theme:e,children:M})})]},`system`)};function zh(e,t){let n=e.replace(`#`,``);n.length===3&&(n=n.split(``).map(e=>e+e).join(``));let r=parseInt(n,16);return`rgba(${r>>16&255}, ${r>>8&255}, ${r&255}, ${t})`}var Bh=class{static async CenterViewportOnImage(e){let t=await c.scene.grid.getDpi(),n=await c.viewport.getScale(),r=await c.viewport.getWidth(),i=await c.viewport.getHeight(),a={x:r/2,y:i/2},o={x:a.x/n,y:a.y/n},s=await this.GetImageCenter(e,t),l={x:s.x-o.x,y:s.y-o.y},u={x:l.x*n*-1,y:l.y*n*-1};await c.viewport.animateTo({position:u,scale:n})}static async GetImageCenter(t,n){if(e(t)){let e=n/t.grid.dpi,r=t.image.width*e,i=t.image.height*e,a=t.grid.offset.x/t.image.width*r,o=t.grid.offset.y/t.image.height*i;return{x:t.position.x-a+r/2,y:t.position.y-o+i/2}}else if(o(t)&&t.points.length>0)return{x:t.points[0].x,y:t.points[0].y};else return{x:t.position.x,y:t.position.y}}};const Vh=`${R}/effects`;var Hh=`${R}/effects-expired`,Uh=T.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,Wh=T.div`
...
`;const mg=({theme:e,unit:t,canInteract:n,elevationDraftValue:r,onElevationDraftChange:i,onCommitElevationChange:a})=>(0,V.jsx)(fg,{theme:e,children:(0,V.jsx)(pg,{theme:e,type:`text`,inputMode:`decimal`,min:-999,max:999,step:1,value:r??String(t.elevation??0),readOnly:!n,onChange:n?e=>i(t.id,e.target.value):void 0,onBlur:n?e=>a(t.id,e.target.value):void 0,onKeyDown:e=>{n&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}})}),hg=({theme:e,canInteract:t,icon:n,activeEffectsCount:r,onOpen:i})=>(0,V.jsx)(fg,{theme:e,children:(0,V.jsx)(dg,{activeEffectsCount:r,canInteract:t,icon:n||(0,V.jsx)(ie,{}),onOpen:i})});var gg=`${R}/elevation-badge`,_g=`${R}/elevation-badge-owner`,vg=`${R}/elevation`,yg=200,bg=40,xg=60,Sg=120,Cg=24,wg=(e,t)=>{if(!e)return;if(e.startsWith(`#`))return zh(e,t);let n=e.match(/^rgba\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([\d.]+)\)$/i);if(n){let[,e,r,i]=n;return`rgba(${e}, ${r}, ${i}, ${t})`}let r=e.match(/^rgb\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\)$/i);if(r){let[,e,n,i]=r;return`rgba(${e}, ${n}, ${i}, ${t})`}return e},Tg=e=>`
  ...
  `,Eg=/(\d+)d(\d+)([kd][hl]\d+|!)?/gi,Dg={anchor:ht,aperture:Le,award:_t,batterycharging:Pe,book:qe,calendar:nt,clock:ut,cloudlightning:P,drama:Je,carrot:We,bone:Ge,compass:st,dollarsign:Fe,feather:ct,eye:at,heart:Me,moon:je,music:he,shield:fe,star:Oe,sun:ie,target:_e,users:xe,wind:ve,zap:k,sword:vt,swords:Ce,axe:ft,bowarrow:F,coins:ze,wand:j,flower:He,skull:ke,castle:Ve,cross:et,testtubediagonal:me,squirrel:pe,snowflake:De,shell:ge,pickaxe:rt,heartplus:Se,heartcrack:re,fan:L},Og=T.div`
  padding: 2px;
  width: 100%;
`,kg=T.h1`
  color: ${e=>e.theme.PRIMARY};
