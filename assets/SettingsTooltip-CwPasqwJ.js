import{_ as e}from"./tslib.es6-B50zIwoW.js";import{f as t,m as n,p as r,t as i}from"./styled-components.browser.esm-DHy5LH3R.js";import{t as a}from"./react-dom-kWs4TVWh.js";var o=e(n(),1),s=a(),c=r(),l=i.span`
  display: inline-flex;
  align-items: center;
`,u=i.span`
  position: fixed;
  ...
  padding: 8px 10px;
  border-radius: 8px;
  border: 1px solid ${e=>t(e.theme.BORDER,.9)};
  background: ${e=>t(e.theme.BACKGROUND,.96)};
  color: ${e=>e.theme.PRIMARY};
  font-size: 12px;
  line-height: 1.3;
  text-align: left;
  box-shadow: 0 8px 24px ${e=>t(e.theme.BACKGROUND,.65)};
  ...
  &::before {
    ...
    ${e=>e.$placement===`bottom`?`border-bottom: 6px solid ${t(e.theme.BACKGROUND,.96)};`:`border-top: 6px solid ${t(e.theme.BACKGROUND,.96)};`}
  }
`,d=i.span`
  display: inline-flex;
  align-items: center;
