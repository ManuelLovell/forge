import{P as e,b as t,g as n,h as r,j as i,k as a,m as o,n as s,t as c,v as l,w as u,x as d,y as f}from"./defaultgamesystem-8X0QxZRg.js";import{_ as p,c as m,d as h,g,i as _,l as v,n as ee,o as y,s as te,t as b,u as ne}from"./FormulaParser-DIGh_arX.js";/* empty css               */var re=h(`cloud`,[[`path`,{d:`M17.5 19H9a7 7 0 1 1 6.71-9h1.79a4.5 4.5 0 1 1 0 9Z`,key:`p7xjir`}]]),x=h(`plus`,[[`path`,{d:`M5 12h14`,key:`1ays0h`}],[`path`,{d:`M12 5v14`,key:`s699le`}]]),ie=h(`search`,[[`path`,{d:`m21 21-4.34-4.34`,key:`14j7rj`}],[`circle`,{cx:`11`,cy:`11`,r:`8`,key:`4ej97u`}]]),S=e(a(),1),C=e(i(),1);const ae=e=>{let t=[...Array.isArray(e)?e:[]].sort((e,t)=>e.row===t.row?e.col-t.col:e.row-t.row),n=[];return t.forEach(e=>{let t=n[n.length-1];if(!t||t.row!==e.row){n.push({row:e.row,items:[e]});return}t.items.push(e)}),{sorted:t,rows:n}};var w=d(),T=e=>`
