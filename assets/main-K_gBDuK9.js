...
`,nm=Kp.div({position:`fixed`,bottom:`0`,left:`0`,right:`0`,top:`0`,zIndex:`999`,backgroundColor:`rgba(0, 0, 0, 0.6)`}),rm=Kp.div({position:`fixed`,bottom:`2px`,left:`2px`,zIndex:`1000`,display:`flex`,height:`3rem`,width:`3rem`,alignItems:`center`,justifyContent:`center`,borderRadius:`9999px`,"--tw-backdrop-blur":`blur(8px)`,WebkitBackdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`,backdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`}),im=T.button`
  ...
  border: 2px solid ${e=>e.theme.BORDER};
  color: ${e=>e.theme.PRIMARY};
`,am=({isOpen:e,currentPage:t,onToggle:n,onNavigate:r,canAccessInitiativeList:i=!0})=>{let{theme:a}=Je(),o=I(e=>e.playerData),s=String(o?.role||``).toUpperCase()===`GM`;return(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)(fl,{children:e&&(0,L.jsxs)(Yp,{theme:a,initial:{x:-300},animate:{x:0},exit:{x:-300},transition:{type:`tween`,duration:.3},style:{boxShadow:`4px 0 12px rgba(0, 0, 0, 0.15)`},children:[(0,L.jsxs)(Xp,{theme:a,children:[(0,L.jsx)(Qp,{theme:a,children:`Forge!`}),(0,L.jsx)($p,{theme:a,children:`Beta Testing!`})]}),(0,L.jsxs)(Zp,{theme:a,children:[`Thanks for checking it out!  Please report any bugs/issues to the`,(0,L.jsx)(`a`,{href:`https://discord.gg/Kh9hbHAZnX`,target:`_blank`,rel:`noreferrer`,children:` Battle-System Discord`}),`.`]}),(0,L.jsxs)(em,{theme:a,children:[i&&(0,L.jsx)(tm,{theme:a,$isActive:t===`ForgeMain`,onClick:()=>r(`ForgeMain`),children:`Main`}),(0,L.jsx)(tm,{theme:a,$isActive:t===`Party`,onClick:()=>r(`Party`),children:`Party`}),(0,L.jsx)(tm,{theme:a,$isActive:t===`ChatLog`,onClick:()=>r(`ChatLog`),children:`System Log`}),s&&(0,L.jsx)(tm,{theme:a,$isActive:t===`System`,onClick:()=>r(`System`),children:`System`}),s&&(0,L.jsx)(tm,{theme:a,$isActive:t===`Settings`,onClick:()=>r(`Settings`),children:`Settings`})]})]})}),e&&(0,L.jsx)(nm,{onClick:n}),(0,L.jsx)(rm,{children:(0,L.jsx)(im,{theme:a,onClick:n,children:(0,L.jsx)(re,{size:24})})})]})},om=T.div`
  padding: 20px;
  color: ${e=>e.theme.PRIMARY};
  min-height: 100vh;
`,sm=T.h1`
...
`;const X=({label:e,isOn:t,onChange:n})=>{let{theme:r}=Je();return(0,L.jsx)(dm,{theme:r,$isOn:t,onClick:()=>{let r=!t;M.log(`${e}: ${r}`),n(r)},role:`switch`,"aria-checked":t,"aria-label":e})};var fm=T.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Om=T.p`
  ...
  margin: 0;
  line-height: 1.5;
`;const km=()=>{let{theme:e}=Je(),{attributes:t}=vm();I(e=>e.roomMetadata);let n=I(e=>e.sceneMetadata),r=I(e=>e.items),i=I(e=>e.cacheReady),[a,o]=(0,F.useState)(!1),[s,l]=(0,F.useState)(!1),[u,d]=(0,F.useState)(`D20`),[f,m]=(0,F.useState)(!1),[h,g]=(0,F.useState)(``),[_,v]=(0,F.useState)(`@STAT`),[y,b]=(0,F.useState)(!1),[x,S]=(0,F.useState)(!1),[C,w]=(0,F.useState)(!0),[T,E]=(0,F.useState)(!1),[ee,D]=(0,F.useState)(!0),[te,ne]=(0,F.useState)(!0),[re,ae]=(0,F.useState)(!1),[oe,se]=(0,F.useState)(`bottom`),[ce,le]=(0,F.useState)(!1),[ue,de]=(0,F.useState)(!1),[fe,pe]=(0,F.useState)(!1),[me,ge]=(0,F.useState)(!1),[_e,be]=(0,F.useState)(!1),[A,we]=(0,F.useState)(!1),[Ee,j]=(0,F.useState)(!1),[De,ke]=(0,F.useState)(!1),[je,Me]=(0,F.useState)(!1),[N,P]=(0,F.useState)(!1),[Ne,Pe]=(0,F.useState)(!1),[Fe,Ie]=(0,F.useState)(!1),[Le,Re]=(0,F.useState)(``),[ze,Be]=(0,F.useState)(!1),Ve=(0,F.useRef)(null),[He,Ue]=(0,F.useState)(()=>Ce()),[We,Ge]=(0,F.useState)(()=>xe()),[Ke,qe]=(0,F.useState)(()=>Se()),[Ye,Xe]=(0,F.useState)(!1),[R,Ze]=(0,F.useState)(!1);(0,F.useEffect)(()=>{let e=!0;return(async()=>{let t=await Ae();e&&(Ue(t&&Ce()),Ge(xe()),qe(Se()))})(),()=>{e=!1}},[]);let z=n;(0,F.useEffect)(()=>{if(i){if(z[O.POPCORN_INITIATIVE]!==void 0&&o(z[O.POPCORN_INITIATIVE]),z[O.REVERSE_INITIATIVE]!==void 0&&l(z[O.REVERSE_INITIATIVE]),z[O.DICE_RANGE]!==void 0&&d(z[O.DICE_RANGE]),z[O.INITIATIVE_MODIFIER_BID]===void 0?g(``):g(z[O.INITIATIVE_MODIFIER_BID]||``),z[O.INITIATIVE_MODIFIER_EXPR]!==void 0){let e=(z[O.INITIATIVE_MODIFIER_EXPR]||`@STAT`).replace(/\bx\b/gi,`@STAT`).trim();v(e.length>0?e:`@STAT`)}else v(`@STAT`);if(z[O.SHOW_CARD_ACCESS]!==void 0&&m(z[O.SHOW_CARD_ACCESS]),z[O.SHOW_PLAYER_VIEW]!==void 0&&b(z[O.SHOW_PLAYER_VIEW]),z[O.SHOW_OWNER_ONLY_EDIT]!==void 0&&E(z[O.SHOW_OWNER_ONLY_EDIT]),z[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?D(!0):D(z[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]),z[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===void 0?ne(!0):ne(z[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]),z[O.SHOW_NON_PARTY_UNITS]!==void 0&&S(z[O.SHOW_NON_PARTY_UNITS]),z[O.SHOW_LIST_HP_NUMBERS]===void 0?w(!0):w(z[O.SHOW_LIST_HP_NUMBERS]),z[O.SHOW_HP_BARS]!==void 0&&ae(z[O.SHOW_HP_BARS]),z[O.HP_BAR_ORIENTATION]!==void 0&&se(z[O.HP_BAR_ORIENTATION]),z[O.SHOW_HP_NUMBERS]!==void 0&&le(z[O.SHOW_HP_NUMBERS]),z[O.SHOW_DEATH_EFFECT]!==void 0&&de(z[O.SHOW_DEATH_EFFECT]),z[O.SHOW_NAMES]!==void 0&&pe(z[O.SHOW_NAMES]),z[O.SHOW_TURN_EFFECT]!==void 0&&ge(z[O.SHOW_TURN_EFFECT]),z[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&be(z[O.USE_DESCRIPTIVE_DUPLICATES]),z[O.ENABLE_RUMBLE]!==void 0&&we(z[O.ENABLE_RUMBLE]),z[O.ENABLE_BONES]!==void 0&&j(z[O.ENABLE_BONES]),z[O.ENABLE_DICE_PLUS]!==void 0&&ke(z[O.ENABLE_DICE_PLUS]),z[O.ENABLE_TEXT_BASED_ROLLS]!==void 0&&Me(z[O.ENABLE_TEXT_BASED_ROLLS]),z[O.ENABLE_OBR_NOTIFICATION]!==void 0&&P(z[O.ENABLE_OBR_NOTIFICATION]),z[O.SHOW_NOTIFICATION_TO_ALL]!==void 0&&Pe(z[O.SHOW_NOTIFICATION_TO_ALL]),z[O.ENABLE_DISCORD_LOGGING]!==void 0&&Ie(z[O.ENABLE_DISCORD_LOGGING]),z[O.DISCORD_URL]!==void 0&&Re(z[O.DISCORD_URL]),z[O.ENABLE_CONSOLE_LOG]!==void 0){let e=z[O.ENABLE_CONSOLE_LOG];Be(e),M.setEnabled(e)}else Be(!1)}},[i,z]);let B=async(e,t)=>{await c.scene.setMetadata({[e]:t})},Qe=e=>{let t=(e||``).trim().match(/(\d+)/),n=t?parseInt(t[1],10):NaN;return Number.isFinite(n)&&n>0?n:20},$e=t.filter(e=>e.attr_type===`numb`).sort((e,t)=>(e.attr_name||``).localeCompare(t.attr_name||``)),et=(e,t)=>{let n=e.trim();return n?t?/@STAT/i.test(n)?/\d\s*d\s*\d|\bd\s*\d/i.test(n)?{valid:!1,error:`Dice notation is not allowed in initiative modifiers.`}:ye(n.replace(/@STAT/gi,`@${t}`))?{valid:!0}:{valid:!1,error:`Invalid expression syntax.`}:{valid:!1,error:`Expression must include @STAT (the selected attribute value).`}:{valid:!1,error:`Select a numeric attribute first.`}:{valid:!1,error:`Expression is required.`}},tt=async(e,t)=>{await B(O.INITIATIVE_MODIFIER_BID,e),await B(O.INITIATIVE_MODIFIER_EXPR,t)},nt=async e=>{if(g(e),!e){await tt(``,_);return}let t=et(_,e);t.valid||await c.notification.show(t.error||`Invalid initiative modifier settings.`,`WARNING`),await tt(e,_)},rt=async()=>{let e=_.trim(),t=(e.length>0?e:`@STAT`).replace(/\bx\b/gi,`@STAT`);if(v(t),!h){await tt(``,t);return}let n=et(t,h);if(!n.valid){await c.notification.show(n.error||`Invalid initiative modifier expression.`,`WARNING`);return}await tt(h,t)},it=async()=>{if(!h){await c.notification.show(`Select an Initiative Modifier attribute before testing.`,`WARNING`);return}let e=_.replace(/\bx\b/gi,`@STAT`),t=et(e,h);if(!t.valid){await c.notification.show(t.error||`Invalid initiative modifier expression.`,`WARNING`);return}let n=Qe(u),r=Math.floor(Math.random()*n)+1,i=Oe(e.replace(/@STAT/gi,`@${h}`),{bidValueMap:{[h]:14},onMissingBid:`useZero`});if(!i.valid||!i.notation){await c.notification.show(`Could not resolve initiative modifier expression.`,`ERROR`);return}let a=Number(i.notation),o=Number.isFinite(a)?Math.trunc(a):0,s=r+o,l=e.replace(/@STAT/gi,`14`);await c.notification.show(`Mock Initiative: 1d${n}(${r}) + ${l}(${o}) = ${s}`,`SUCCESS`)},at=async()=>{try{let e=await he(),t=JSON.stringify(e,null,2),n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`forge-collection-${new Date().toISOString().slice(0,10)}.txt`,i.click(),URL.revokeObjectURL(r),await c.notification.show(`Collection export complete. ${e.length} record(s) written.`,`SUCCESS`)}catch(e){M.log(`Collection export failed`,e),await c.notification.show(`Collection export failed. See console log for details.`,`ERROR`)}},ot=()=>{Ze(!0)},st=()=>{Ze(!1),Ve.current?.click()},ct=async e=>{let t=e.target.files?.[0];if(t)try{let e=await t.text(),n=JSON.parse(e);if(!Array.isArray(n)){await c.notification.show(`Import file must contain a JSON array of collection records.`,`ERROR`);return}let r=await ve(n);await c.notification.show(`Collection import complete. Created: ${r.created}, Updated: ${r.updated}, Skipped: ${r.skipped}.`,`SUCCESS`)}catch(e){M.log(`Collection import failed`,e),await c.notification.show(`Collection import failed. Ensure the file is valid JSON and try again.`,`ERROR`)}finally{e.target.value=``}},lt=async()=>{Xe(!0);try{await Te(),Ue(Ce()),Ge(xe()),qe(Se()),await c.notification.show(`Connected to Battle-System account.`,`SUCCESS`)}catch(e){M.error(`Battle-System auth connection failed`,e),await c.notification.show(`Unable to connect to Battle-System account. Please try again.`,`ERROR`),Ue(Ce()),Ge(xe()),qe(Se())}finally{Xe(!1)}};return(0,L.jsxs)(rd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},children:[(0,L.jsxs)(om,{theme:e,children:[(0,L.jsx)(sm,{theme:e,children:`Settings`}),(0,L.jsxs)(cm,{theme:e,children:[(0,L.jsx)(ym,{theme:e,children:`Battle-System Account`}),(0,L.jsx)(Em,{children:(0,L.jsx)(lm,{theme:e,onClick:()=>{lt()},disabled:Ye,children:Ye?`Connecting...`:He?`Reconnect to Battle-System`:`Connect to Battle-System`})}),(0,L.jsx)(Dm,{theme:e,$connected:He,children:He?`Status: Connected (${We} tier)`:`Status: Disconnected`})]}),(0,L.jsxs)(cm,{theme:e,children:[(0,L.jsx)(ym,{theme:e,children:`Collection Management`}),(0,L.jsxs)(Em,{children:[(0,L.jsx)(lm,{theme:e,onClick:at,children:`Export`}),(0,L.jsx)(lm,{theme:e,onClick:ot,children:`Import`})]}),(0,L.jsx)(`input`,{ref:Ve,type:`file`,accept:`.txt,.json,text/plain,application/json`,onChange:ct,style:{display:`none`}})]}),(0,L.jsxs)(cm,{theme:e,children:[(0,L.jsx)(ym,{theme:e,children:`List Controls`}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.reverseInitiative,children:`Reverse Initiative`})}),(0,L.jsx)(X,{label:`Reverse Initiative`,isOn:s,onChange:async e=>{l(e),await B(O.REVERSE_INITIATIVE,e),e&&a&&(o(!1),await B(O.POPCORN_INITIATIVE,!1))}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.popcornInitiative,children:`Popcorn Initiative`})}),(0,L.jsx)(X,{label:`Popcorn Initiative`,isOn:a,onChange:async e=>{o(e),await B(O.POPCORN_INITIATIVE,e),e&&s&&(l(!1),await B(O.REVERSE_INITIATIVE,!1))}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.initiativeDie,children:`Initiative Die:`})}),(0,L.jsx)(Cm,{theme:e,type:`text`,value:u,onChange:async e=>{let t=e.target.value;d(t),await B(O.DICE_RANGE,t),M.log(`Dice Range:`,t)},placeholder:`D20`,maxLength:3})]}),(0,L.jsxs)(bm,{theme:e,children:[(0,L.jsx)(xm,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.initiativeModifierAttr,children:`Initiative Modifier:`})}),(0,L.jsxs)(wm,{theme:e,value:h,onChange:async e=>{await nt(e.target.value)},children:[(0,L.jsx)(`option`,{value:``,children:`None`}),$e.map(e=>(0,L.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,L.jsxs)(bm,{theme:e,children:[(0,L.jsx)(xm,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.initiativeModifierMath,children:`Math:`})}),(0,L.jsx)(Cm,{theme:e,type:`text`,value:_,onChange:e=>{v(e.target.value)},onBlur:async()=>{await rt()},placeholder:`floor((@STAT-10)/2)`,maxLength:120,disabled:!h}),(0,L.jsx)(Tm,{theme:e,type:`button`,onClick:()=>{it()},disabled:!h,children:`Test`})]}),(0,L.jsx)(Sm,{theme:e,children:`Use @STAT as the selected attribute value. Example: floor((@STAT-10)/2)`}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showCardColumn,children:`Show Card Column`})}),(0,L.jsx)(X,{label:`Show Stat Block Access`,isOn:f,onChange:async e=>{m(e),await B(O.SHOW_CARD_ACCESS,e)}})]})]}),(0,L.jsxs)(cm,{theme:e,children:[(0,L.jsx)(ym,{theme:e,children:`Player Controls`}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showPlayerView,children:`Show Player View`})}),(0,L.jsx)(X,{label:`Show Player View`,isOn:y,onChange:async e=>{b(e),await B(O.SHOW_PLAYER_VIEW,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showNonPartyUnits,children:`Show Non-Party Units`})}),(0,L.jsx)(X,{label:`Show Non-Party Units`,isOn:x,onChange:async e=>{S(e),await B(O.SHOW_NON_PARTY_UNITS,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showHpNumbersOnList,children:`Show HP Numbers on List`})}),(0,L.jsx)(X,{label:`Show HP Numbers on List`,isOn:C,onChange:async e=>{w(e),await B(O.SHOW_LIST_HP_NUMBERS,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.ownerOnlyEdit,children:`GM/Owner Only Edit`})}),(0,L.jsx)(X,{label:`Owner Only Edit`,isOn:T,onChange:async e=>{E(e),await B(O.SHOW_OWNER_ONLY_EDIT,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showAdjustHpContextMenu,children:`Show Adjust HP Context Menu`})}),(0,L.jsx)(X,{label:`Show Adjust HP Context Menu`,isOn:ee,onChange:async e=>{D(e),await B(O.SHOW_MODIFY_UNIT_CONTEXT_MENU,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showViewUnitContextMenuForPlayers,children:`Show View Unit Context Menu for Players`})}),(0,L.jsx)(X,{label:`Show View Unit Context Menu for Players`,isOn:te,onChange:async e=>{ne(e),await B(O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS,e)}})]})]}),(0,L.jsxs)(cm,{theme:e,children:[(0,L.jsx)(ym,{theme:e,children:`Game Controls`}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showHpBarsOnTokens,children:`Show HP Bars on tokens`})}),(0,L.jsx)(X,{label:`Show HP Bars on tokens`,isOn:re,onChange:async e=>{ae(e),await B(O.SHOW_HP_BARS,e),e&&ce&&(le(!1),await B(O.SHOW_HP_NUMBERS,!1)),e&&z[O.HP_BAR_ORIENTATION]===void 0&&(se(`bottom`),await B(O.HP_BAR_ORIENTATION,`bottom`))}})]}),(re||ce)&&(0,L.jsxs)(bm,{theme:e,children:[(0,L.jsx)(xm,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.hpOrientation,children:`Orientation:`})}),(0,L.jsxs)(wm,{theme:e,value:oe,onChange:async e=>{let t=e.target.value;se(t),await B(O.HP_BAR_ORIENTATION,t)},children:[(0,L.jsx)(`option`,{value:`top`,children:`Top`}),(0,L.jsx)(`option`,{value:`bottom`,children:`Bottom`}),(0,L.jsx)(`option`,{value:`left`,children:`Left`}),(0,L.jsx)(`option`,{value:`right`,children:`Right`})]})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showHpNumbersOnTokens,children:`Show HP Numbers on tokens`})}),(0,L.jsx)(X,{label:`Show HP Numbers on tokens`,isOn:ce,onChange:async e=>{le(e),await B(O.SHOW_HP_NUMBERS,e),e&&re&&(ae(!1),await B(O.SHOW_HP_BARS,!1)),e&&z[O.HP_BAR_ORIENTATION]===void 0&&(se(`bottom`),await B(O.HP_BAR_ORIENTATION,`bottom`))}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showDeathEffect,children:`Show Death Effect`})}),(0,L.jsx)(X,{label:`Show Death Effect`,isOn:ue,onChange:async e=>{de(e),await B(O.SHOW_DEATH_EFFECT,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showNamesOnTokens,children:`Show Names on Tokens`})}),(0,L.jsx)(X,{label:`Show names on tokens`,isOn:fe,onChange:async e=>{pe(e),await B(O.SHOW_NAMES,e);let t=r.filter(e=>e.metadata[p.ON_LIST]===!0);e?(M.log(`Showing names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t.metadata[p.UNIT_NAME],n=t;e&&n.text&&(n.text.plainText=String(e))}})):(M.log(`Hiding names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t;e.text&&(e.text.plainText=``)}}))}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showTurnEffect,children:`Show Turn Effect`})}),(0,L.jsx)(X,{label:`Show Turn Effect`,isOn:me,onChange:async e=>{ge(e),await B(O.SHOW_TURN_EFFECT,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.useDescriptiveNames,children:`Use Descriptive Names`})}),(0,L.jsx)(X,{label:`Use Descriptive Duplicates Names`,isOn:_e,onChange:async e=>{be(e),await B(O.USE_DESCRIPTIVE_DUPLICATES,e)}})]})]}),(0,L.jsxs)(cm,{theme:e,children:[(0,L.jsx)(ym,{theme:e,children:`Dice Controls`}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.enableTextBasedRolls,children:`Enable Text-Based Rolls`})}),(0,L.jsx)(X,{label:`Enable Text-Based Rolls`,isOn:je,onChange:async e=>{Me(e),await B(O.ENABLE_TEXT_BASED_ROLLS,e),e&&(P(!0),we(!1),j(!1),ke(!1),await B(O.ENABLE_OBR_NOTIFICATION,!0),await B(O.ENABLE_RUMBLE,!1),await B(O.ENABLE_BONES,!1),await B(O.ENABLE_DICE_PLUS,!1))}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.enableRumble,children:`Enable Rumble! Integration`})}),(0,L.jsx)(X,{label:`Enable Rumble! Integration`,isOn:A,onChange:async e=>{we(e),await B(O.ENABLE_RUMBLE,e),e&&(j(!1),ke(!1),Me(!1),await B(O.ENABLE_BONES,!1),await B(O.ENABLE_DICE_PLUS,!1),await B(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.enableBones,children:`Enable Bones! Integration`})}),(0,L.jsx)(X,{label:`Enable Bones! Integration`,isOn:Ee,onChange:async e=>{j(e),await B(O.ENABLE_BONES,e),e&&(we(!1),ke(!1),Me(!1),await B(O.ENABLE_RUMBLE,!1),await B(O.ENABLE_DICE_PLUS,!1),await B(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.enableDicePlus,children:`Enable Dice+ Integration`})}),(0,L.jsx)(X,{label:`Enable Dice+ Integration`,isOn:De,onChange:async e=>{ke(e),await B(O.ENABLE_DICE_PLUS,e),e&&(we(!1),j(!1),Me(!1),await B(O.ENABLE_RUMBLE,!1),await B(O.ENABLE_BONES,!1),await B(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.enableObrNotification,children:`Enable OBR Notification`})}),(0,L.jsx)(X,{label:`Enable OBR Notification`,isOn:N,onChange:async e=>{P(e),await B(O.ENABLE_OBR_NOTIFICATION,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.showResultsToAll,children:`Show Results to All`})}),(0,L.jsx)(X,{label:`Show Results to All`,isOn:Ne,onChange:async e=>{Pe(e),await B(O.SHOW_NOTIFICATION_TO_ALL,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.enableDiscordLogging,children:`Enable Discord Logging`})}),(0,L.jsx)(X,{label:`Enable Discord Logging`,isOn:Fe,onChange:async e=>{if(e&&!ie(Le.trim())){await c.notification.show(`Please enter a valid Discord webhook URL before enabling Discord logging.`,`WARNING`),Ie(!1),await B(O.ENABLE_DISCORD_LOGGING,!1);return}Ie(e),await B(O.ENABLE_DISCORD_LOGGING,e)}})]}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)(xm,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.discordUrl,children:`Discord Url:`})}),(0,L.jsx)(Cm,{theme:e,type:`text`,value:Le,onChange:async e=>{let t=e.target.value,n=t.trim();Re(t),await B(O.DISCORD_URL,n),M.log(`Discord URL:`,n)},placeholder:`https://discord.com/api/webhooks/...`,maxLength:200})]})]}),(0,L.jsxs)(cm,{theme:e,children:[(0,L.jsx)(ym,{theme:e,children:`Other`}),(0,L.jsxs)(Q,{theme:e,children:[(0,L.jsx)($,{theme:e,children:(0,L.jsx)(k,{theme:e,text:Z.enableConsoleLog,children:`Enable Console Log`})}),(0,L.jsx)(X,{label:`Enable Console Log`,isOn:ze,onChange:async e=>{Be(e),M.setEnabled(e),await B(O.ENABLE_CONSOLE_LOG,e)}})]})]})]}),(0,L.jsx)(_m,{isOpen:R,title:`Confirm Import`,onClose:()=>Ze(!1),actions:(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)(lm,{theme:e,variant:`secondary`,onClick:()=>Ze(!1),children:`Cancel`}),(0,L.jsx)(lm,{theme:e,onClick:st,children:`Continue`})]}),children:(0,L.jsx)(Om,{theme:e,children:`Import will overwrite duplicate records that share the same Name and Author. Continue?`})})]})};var Am=T.div`
...
`;const Fm=()=>{let e=Ve(e=>e.messages),t=(0,F.useRef)(null),{theme:n}=Je();return(0,F.useEffect)(()=>{t.current?.scrollIntoView({behavior:`smooth`})},[e]),(0,L.jsx)(rd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,L.jsxs)(Am,{children:[(0,L.jsx)(sm,{theme:n,children:`System Log`}),(0,L.jsxs)(jm,{children:[e.map(e=>(0,L.jsxs)(Mm,{children:[(0,L.jsx)(Nm,{children:e.timestamp}),(0,L.jsx)(Pm,{children:e.text})]},e.id)),(0,L.jsx)(`div`,{ref:t})]})]})})},Im=`buff_effect_one`,Lm=`debuff_effect_one`,Rm=[{value:`buff_effect_one`,label:`Buff Effect One`},{value:`buff_effect_two`,label:`Buff Effect Two`}],zm=[{value:`debuff_effect_one`,label:`Debuff Effect One`},{value:`debuff_effect_two`,label:`Debuff Effect Two`}],Bm=e=>Rm.some(t=>t.value===e),Vm=e=>zm.some(t=>t.value===e),Hm=e=>{switch(e){case`buff_effect_two`:return`
uniform float2 size;
uniform float time;
...
`,yh={initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20}};const bh=()=>{let{theme:e,updateThemeFromSystem:t}=Je(),n=I(e=>e.sceneMetadata),r=I(e=>e.roomMetadata),i=I(e=>e.systemData),a=I(e=>e.setSystemData),[o,s]=(0,F.useState)(()=>be().premiumAuthorized),[l,u]=(0,F.useState)(``),[d,p]=(0,F.useState)(!1),[m,h]=(0,F.useState)(null),[g,_]=(0,F.useState)(null),[v,y]=(0,F.useState)(``),[b,x]=(0,F.useState)(null),[S,w]=(0,F.useState)(null),[T,ee]=(0,F.useState)([]),[D,te]=(0,F.useState)(``),[ne,re]=(0,F.useState)(``),[ie,ae]=(0,F.useState)(Im),[k,se]=(0,F.useState)(Lm),[ce,le]=(0,F.useState)([]),[ue,de]=(0,F.useState)(!1),[pe,me]=(0,F.useState)(null),[he,ge]=(0,F.useState)(``);(0,F.useEffect)(()=>{let e=!0,t=async()=>{await Ae(),e&&s(be().premiumAuthorized)},n=_e(t=>{e&&s(t.premiumAuthorized)});return t(),()=>{e=!1,n()}},[]),(0,F.useEffect)(()=>{ve(),A()},[n,r,i,o]);let ve=()=>{try{if(!o){let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url};y(E.name),x(null),w(e),ee(E.attributes),te(qm.currentHpBid),re(qm.maxHpBid),ae(Im),se(Lm);return}if(i){let e=n[O.HP_CURRENT_BID],t=n[O.HP_MAX_BID],r=n[O.BUFF_VISUAL_PRESET],a=n[O.DEBUFF_VISUAL_PRESET];y(i.systemName),x(i.importDate),w(i.theme),ee(i.attributes),te(e||``),re(t||``),ae(Bm(r)?r:Im),se(Vm(a)?a:Lm);return}let e=r[Km.SYSTEM_NAME],t=r[Km.IMPORT_DATE],a=n[O.HP_CURRENT_BID],s=n[O.HP_MAX_BID],c=n[O.BUFF_VISUAL_PRESET],l=n[O.DEBUFF_VISUAL_PRESET];y(e||E.name),x(t||null),w({primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url}),ee(E.attributes),te(a||``),re(s||``),ae(Bm(c)?c:Im),se(Vm(l)?l:Lm)}catch(e){M.error(`Error loading system from cache:`,e)}},ye=async(e,t)=>{await c.scene.setMetadata({[e]:t})},xe=(e,t)=>{if(Array.isArray(e))return e;if(typeof e==`string`){let n;try{n=JSON.parse(e)}catch{throw Error(`Imported ${t} is not valid JSON`)}if(!Array.isArray(n))throw Error(`Imported ${t} is not a JSON array`);return n}throw Error(`Imported ${t} has invalid type`)},Ce=T.filter(e=>e.attr_type===`numb`),A=()=>{try{let e=[];for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);if(n&&n.startsWith(`${Gm}.`)&&n.endsWith(`.backup`)){let t=localStorage.getItem(n);if(t){let n=JSON.parse(t);e.push(n)}}}e.sort((e,t)=>new Date(t.backupDate).getTime()-new Date(e.backupDate).getTime()),le(e)}catch(e){M.error(`Error loading backups:`,e)}},we=async e=>{try{if(!i){M.warn(`Cannot create backup: runtime system data is unavailable`);return}let e=i.systemName||E.name,t={name:e,backupDate:new Date().toISOString(),theme_primary:i.theme.primary,theme_offset:i.theme.offset,theme_background:i.theme.background,theme_border:i.theme.border,background_url:i.theme.background_url,card_layout:i.cardLayout,list_layout:i.listLayout,attributes:i.attributes},n=`${Gm}.${e}.backup`;localStorage.setItem(n,JSON.stringify(t)),M.log(`Backup created for ${e}`),A()}catch(e){throw M.error(`Error creating backup:`,e),e}},Te=e=>{try{let t=`${Gm}.${e}.backup`;localStorage.removeItem(t),M.log(`Backup deleted for ${e}`),A(),_(`Backup for "${e}" deleted successfully`)}catch(e){M.error(`Error deleting backup:`,e),h(`Failed to delete backup`)}},Ee=(e,t)=>{ge(e),me(()=>t),de(!0)},j=async()=>{de(!1),pe&&(await pe(),me(null))},De=()=>{de(!1),me(null),ge(``)},Oe=async()=>{if(!l.trim()){h(`Please enter a share_id`);return}Ee(`This will overwrite your current system data. A backup of your current system will be saved to local storage. Do you want to continue?`,async()=>{await je()})},je=async()=>{if(!Se()){h(`Premium account required. Connect and use a premium Battle-System account before importing systems.`);return}p(!0),h(null),_(null);try{await ke();let{data:e,error:n}=await Me(async()=>C.rpc(`bs_forge_import_system_snapshot`,{p_source_share_id:l.trim()}));if(n)throw n;if(!e){h(`No system found with that share_id`),p(!1);return}let r=Array.isArray(e)?e[0]:e;if(!r||typeof r.snapshot_public_id!=`string`)throw Error(`Snapshot import did not return a valid record`);let i=xe(r.card_layout,`card_layout`),o=xe(r.list_layout,`list_layout`),s=xe(r.attributes,`attributes`);if(!Array.isArray(s))throw Error(`Imported attributes are not a valid array`);await we(v);let d={primary:r.theme_primary,offset:r.theme_offset,background:r.theme_background,border:r.theme_border,background_url:r.background_url},f=new Date().toISOString();await c.room.setMetadata({[Km.SNAPSHOT_PUBLIC_ID]:r.snapshot_public_id,[Km.SYSTEM_NAME]:r.system_name,[Km.IMPORT_DATE]:f}),a({theme:d,cardLayout:i,listLayout:o,attributes:s,systemName:r.system_name,importDate:f,snapshotPublicId:r.snapshot_public_id}),y(r.system_name),x(f),w(d),t(d.primary,d.offset,d.background,d.border,d.background_url),_(`System "${r.system_name}" loaded successfully! Backup created.`),u(``),M.log(`System snapshot imported and loaded:`,{systemName:r.system_name,snapshotPublicId:r.snapshot_public_id})}catch(e){M.error(`Error fetching system:`,e),h(Jm(e,`An error occurred while fetching the system`))}finally{p(!1)}},N=async e=>{Ee(`This will restore the system "${e.name}" from backup. A backup of your current system will be created. Do you want to continue?`,async()=>{await P(e)})},P=async e=>{p(!0),h(null),_(null);try{if(!Se()){h(`Premium account required. Connect and use a premium Battle-System account before restoring backups for room sharing.`);return}await ke(),await we(v);let n={primary:e.theme_primary,offset:e.theme_offset,background:e.theme_background,border:e.theme_border,background_url:e.background_url};if(!Array.isArray(e.card_layout)||!Array.isArray(e.list_layout)||!Array.isArray(e.attributes))throw Error(`Backup data is invalid`);let r=new Date().toISOString(),i=`forge-backup:${e.name.trim().toLowerCase()}`,{data:o,error:s}=await Me(async()=>C.rpc(`bs_forge_upsert_user_snapshot_payload`,{p_source_share_id:i,p_system_name:e.name,p_background_url:e.background_url,p_theme_primary:e.theme_primary,p_theme_offset:e.theme_offset,p_theme_background:e.theme_background,p_theme_border:e.theme_border,p_card_layout:e.card_layout,p_list_layout:e.list_layout,p_attributes:e.attributes}));if(s)throw s;let l=Array.isArray(o)?o[0]:o;if(!l||typeof l.snapshot_public_id!=`string`)throw Error(`Backup restore snapshot publish failed`);a({theme:n,cardLayout:e.card_layout,listLayout:e.list_layout,attributes:e.attributes,systemName:e.name,importDate:r,snapshotPublicId:l.snapshot_public_id}),await c.room.setMetadata({[Km.SNAPSHOT_PUBLIC_ID]:l.snapshot_public_id,[Km.SYSTEM_NAME]:e.name,[Km.IMPORT_DATE]:r}),y(e.name),x(r),w(n),t(n.primary,n.offset,n.background,n.border,n.background_url),_(`System "${e.name}" restored from backup successfully!`),M.log(`System restored from backup:`,e.name)}catch(e){M.error(`Error restoring backup:`,e),h(`Failed to restore system from backup`)}finally{p(!1)}},Ne=async()=>{p(!0),h(null),_(null);try{let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url};a({theme:e,cardLayout:E.card_layout,listLayout:E.list_layout,attributes:E.attributes,systemName:E.name,importDate:null,snapshotPublicId:null}),await c.room.setMetadata({[Km.SNAPSHOT_PUBLIC_ID]:null,[Km.SYSTEM_NAME]:E.name,[Km.IMPORT_DATE]:null}),y(E.name),x(null),w(e),t(e.primary,e.offset,e.background,e.border,e.background_url),_(`Reset to default system successfully!`)}catch(e){h(`Failed to reset to default system`),M.error(`Error resetting to default:`,e)}finally{p(!1)}},Pe=e=>e?new Date(e).toLocaleDateString(`en-US`,{year:`numeric`,month:`long`,day:`numeric`,hour:`2-digit`,minute:`2-digit`}):null,Fe=!o,Ie=!o;return(0,L.jsxs)(rd.div,{variants:yh,initial:`initial`,animate:`animate`,exit:`exit`,children:[(0,L.jsxs)(om,{theme:e,children:[(0,L.jsx)(sm,{theme:e,children:`System Configuration`}),(0,L.jsx)(Zm,{theme:e,children:v}),b?(0,L.jsxs)(Qm,{theme:e,children:[`Imported: `,Pe(b)]}):(0,L.jsx)(Qm,{theme:e,children:`Using Default System`}),S&&(0,L.jsxs)(L.Fragment,{children:[(0,L.jsxs)($m,{children:[(0,L.jsxs)(`div`,{children:[(0,L.jsx)(eh,{color:S.primary,theme:e,children:S.primary}),(0,L.jsx)(th,{theme:e,children:`PRIMARY`})]}),(0,L.jsxs)(`div`,{children:[(0,L.jsx)(eh,{color:S.offset,theme:e,children:S.offset}),(0,L.jsx)(th,{theme:e,children:`OFFSET`})]}),(0,L.jsxs)(`div`,{children:[(0,L.jsx)(eh,{color:S.background,theme:e,children:S.background}),(0,L.jsx)(th,{theme:e,children:`BG`})]}),(0,L.jsxs)(`div`,{children:[(0,L.jsx)(eh,{color:S.border,theme:e,children:S.border}),(0,L.jsx)(th,{theme:e,children:`BORDER`})]})]}),(0,L.jsxs)(nh,{theme:e,children:[(0,L.jsx)(rh,{theme:e,children:`System Settings`}),(0,L.jsxs)(ih,{children:[(0,L.jsx)(ah,{theme:e,children:`Current HP`}),(0,L.jsxs)(oh,{theme:e,value:D,disabled:Ie,onChange:async e=>{if(Ie)return;let t=e.target.value;te(t),await ye(O.HP_CURRENT_BID,t)},children:[(0,L.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),Ce.map(e=>(0,L.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,L.jsxs)(ih,{children:[(0,L.jsx)(ah,{theme:e,children:`Max HP`}),(0,L.jsxs)(oh,{theme:e,value:ne,disabled:Ie,onChange:async e=>{if(Ie)return;let t=e.target.value;re(t),await ye(O.HP_MAX_BID,t)},children:[(0,L.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),Ce.map(e=>(0,L.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),Ie&&(0,L.jsx)(Qm,{theme:e,children:`Premium account required to edit HP mapping.`}),(0,L.jsxs)(ih,{children:[(0,L.jsx)(ah,{theme:e,children:`Buff Visual`}),(0,L.jsx)(oh,{theme:e,value:ie,onChange:async e=>{let t=e.target.value;Bm(t)&&(ae(t),await ye(O.BUFF_VISUAL_PRESET,t))},children:Rm.map(e=>(0,L.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,L.jsxs)(ih,{children:[(0,L.jsx)(ah,{theme:e,children:`Debuff Visual`}),(0,L.jsx)(oh,{theme:e,value:k,onChange:async e=>{let t=e.target.value;Vm(t)&&(se(t),await ye(O.DEBUFF_VISUAL_PRESET,t))},children:zm.map(e=>(0,L.jsx)(`option`,{value:e.value,children:e.label},e.value))})]})]})]}),(0,L.jsxs)(Xm,{theme:e,children:[(0,L.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0},children:`Import New System`}),(0,L.jsx)(`p`,{style:{color:f(e.PRIMARY,.8),fontSize:`14px`},children:Fe?`Premium account required to import new/custom systems.`:`Enter a share_id to download and activate a new game system configuration.`}),(0,L.jsx)(Ym,{children:(0,L.jsx)(um,{theme:e,type:`text`,value:l,onChange:e=>u(e.target.value),placeholder:Fe?``:`Enter Share Id...`,disabled:d||Fe,onKeyPress:e=>e.key===`Enter`&&Oe()})}),(0,L.jsxs)(lh,{children:[(0,L.jsx)(lm,{theme:e,onClick:Oe,disabled:d||Fe||!l.trim(),children:d?`....!`:`Import System`}),(0,L.jsx)(lm,{theme:e,variant:`secondary`,onClick:Ne,disabled:d,children:`Use Default`})]})]}),m&&(0,L.jsxs)(sh,{theme:e,children:[(0,L.jsx)(`strong`,{children:`Error:`}),` `,m]}),g&&(0,L.jsxs)(ch,{theme:e,children:[(0,L.jsx)(`strong`,{children:`Success:`}),` `,g]}),ce.length>0&&(0,L.jsx)(dh,{children:(0,L.jsxs)(cm,{theme:e,children:[(0,L.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0,marginBottom:`15px`},children:`System Backups`}),(0,L.jsx)(fh,{children:ce.map(t=>(0,L.jsxs)(ph,{theme:e,children:[(0,L.jsxs)(mh,{children:[(0,L.jsx)(hh,{theme:e,children:t.name}),(0,L.jsxs)(gh,{theme:e,children:[`Backed up: `,Pe(t.backupDate)]})]}),(0,L.jsxs)(_h,{children:[(0,L.jsx)(vh,{theme:e,onClick:()=>N(t),disabled:d,title:`Import this backup`,children:(0,L.jsx)(fe,{size:18})}),(0,L.jsx)(vh,{theme:e,$variant:`danger`,onClick:()=>Te(t.name),disabled:d,title:`Delete this backup`,children:(0,L.jsx)(oe,{size:18})})]})]},`${t.name}-${t.backupDate}`))})]})})]}),(0,L.jsx)(_m,{isOpen:ue,title:`Confirm Action`,onClose:De,actions:(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)(lm,{theme:e,variant:`secondary`,onClick:De,children:`Cancel`}),(0,L.jsx)(lm,{theme:e,onClick:j,children:`Confirm`})]}),children:(0,L.jsx)(uh,{theme:e,children:he})})]},`system`)};function xh(e,t){let n=e.replace(`#`,``);n.length===3&&(n=n.split(``).map(e=>e+e).join(``));let r=parseInt(n,16);return`rgba(${r>>16&255}, ${r>>8&255}, ${r&255}, ${t})`}var Sh=class{static async CenterViewportOnImage(e){let t=await c.scene.grid.getDpi(),n=await c.viewport.getScale(),r=await c.viewport.getWidth(),i=await c.viewport.getHeight(),a={x:r/2,y:i/2},o={x:a.x/n,y:a.y/n},s=await this.GetImageCenter(e,t),l={x:s.x-o.x,y:s.y-o.y},u={x:l.x*n*-1,y:l.y*n*-1};await c.viewport.animateTo({position:u,scale:n})}static async GetImageCenter(t,n){if(e(t)){let e=n/t.grid.dpi,r=t.image.width*e,i=t.image.height*e,a=t.grid.offset.x/t.image.width*r,o=t.grid.offset.y/t.image.height*i;return{x:t.position.x-a+r/2,y:t.position.y-o+i/2}}else if(o(t)&&t.points.length>0)return{x:t.points[0].x,y:t.points[0].y};else return{x:t.position.x,y:t.position.y}}};const Ch=`${P}/effects`;var wh=`${P}/effects-expired`,Th=T.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,Eh=T.div`
...
`,Uh=T.span`
  ...
  font-weight: 700;
  padding: 0 3px;
`,Wh=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const Gh=({items:e,units:t,setItems:n,playerData:r})=>{let[i,a]=(0,F.useState)(null),[o,s]=(0,F.useState)(``),[l,u]=(0,F.useState)(`1`),[d,f]=(0,F.useState)(`rounds`),[m,h]=(0,F.useState)(`start`),[g,_]=(0,F.useState)(`neutral`),[v,y]=(0,F.useState)([]),[b,x]=(0,F.useState)(null),S=(0,F.useMemo)(()=>{let t=new Map;return e.forEach(e=>{e.metadata?.[p.ON_LIST]===!0&&t.set(e.id,Wh(e.metadata?.[Ch]))}),t},[e]),C=e=>S.get(e)||[],w=async(t,r)=>{let i=r.filter(e=>e.remaining>0);n(e.map(e=>{if(e.id!==t)return e;let n={...e.metadata||{}};return i.length>0?n[Ch]=i:delete n[Ch],{...e,metadata:n}})),await c.scene.items.updateItems([t],e=>{let t={...e[0].metadata||{}};i.length>0?t[Ch]=i:delete t[Ch],e[0].metadata=t})},T=async e=>{try{await c.broadcast.sendMessage(wh,{message:e},{destination:`ALL`})}catch(t){M.error(`Failed to broadcast expired effect message`,t),await c.notification.show(e,`WARNING`)}},E=async(t,n)=>{if(String(r?.role||``).toUpperCase()!==`GM`)return;let i=[],a=[];e.forEach(e=>{if(e.metadata?.[p.ON_LIST]!==!0)return;let r=Wh(e.metadata?.[Ch]);if(r.length===0)return;let o=!1,s=[];r.forEach(r=>{if(!(r.endTiming===t&&(r.durationType===`turns`||e.id===n))){s.push(r);return}let i=r.remaining-1;if(o=!0,i<=0){a.push(`${e.name||`Unit`}: ${r.name} expired`);return}s.push({...r,remaining:i})}),o&&i.push({unitId:e.id,effects:s})});for(let e of i)await w(e.unitId,e.effects);if(a.length>0)for(let e of a)await T(e)},ee=(0,F.useMemo)(()=>i&&t.find(e=>e.id===i)||null,[i,t]),D=(0,F.useMemo)(()=>i?C(i):[],[i,S]);return(0,F.useEffect)(()=>{let e=c.broadcast.onMessage(wh,async e=>{let t=e.data?.message;typeof t!=`string`||!t.trim()||await c.notification.show(t,`WARNING`)});return()=>{e()}},[]),{effectsModalUnitId:i,selectedEffectsUnit:ee,activeEffectsForSelectedUnit:D,effectNameInput:o,setEffectNameInput:s,effectDurationInput:l,setEffectDurationInput:u,effectDurationType:d,setEffectDurationType:f,effectEndTiming:m,setEffectEndTiming:h,effectType:g,setEffectType:_,effectTargetIds:v,setEffectTargetIds:e=>{y(Array.from(new Set(e)))},effectsModalError:b,units:t,getEffectsForUnit:C,handleOpenEffectsModal:e=>{x(null),s(``),u(`1`),f(`rounds`),h(`start`),_(`neutral`),y([e]),a(e)},handleCloseEffectsModal:()=>{a(null),x(null)},handleAddEffect:async()=>{if(!i)return;let n=o.trim(),r=parseInt(l,10);if(!n){x(`Enter an effect name.`);return}if(!Number.isFinite(r)||r<=0){x(`Duration must be a positive number.`);return}let a=Array.from(new Set(v.filter(e=>t.some(t=>t.id===e))));if(a.length===0){x(`Select at least one target.`);return}let c=C(i),f=ee?.name||e.find(e=>e.id===i)?.name||`Unknown`,p={id:crypto.randomUUID(),name:n,remaining:r,durationType:d,endTiming:m,effectType:g,targets:a,createdByName:f,createdById:i};await w(i,[...c,p]),x(null),s(``),u(`1`),_(`neutral`),y([i])},handleDeleteEffect:async e=>{i&&await w(i,C(i).filter(t=>t.id!==e))},processEffectsForTurnEvent:E}},Kh=({manager:e})=>{let{theme:t}=Je(),n=(0,F.useMemo)(()=>{let t=new Map;return e.units.forEach(e=>{t.set(e.id,e.name)}),t},[e.units]),r=e=>e===`buff`?`Buff`:e===`debuff`?`Debuff`:`Neutral`,i=e=>{if(e.length===0)return`No targets`;let t=e.map(e=>n.get(e)).filter(e=>typeof e==`string`&&e.length>0);return t.length===0?`${e.length} target${e.length===1?``:`s`}`:t.length<=2?t.join(`, `):`${t.slice(0,2).join(`, `)} +${t.length-2}`};return(0,L.jsx)(_m,{isOpen:!!e.effectsModalUnitId,title:e.selectedEffectsUnit?`Effects: ${e.selectedEffectsUnit.name}`:`Effects`,onClose:e.handleCloseEffectsModal,minWidth:`520px`,maxWidth:`600px`,children:(0,L.jsxs)(Th,{children:[(0,L.jsxs)(Eh,{children:[(0,L.jsxs)(Dh,{children:[(0,L.jsxs)(Oh,{style:{flex:`0 0 120px`},children:[(0,L.jsx)(Ah,{theme:t,children:`Effect`}),(0,L.jsx)(jh,{theme:t,type:`text`,placeholder:`Name`,value:e.effectNameInput,onChange:t=>e.setEffectNameInput(t.target.value)})]}),(0,L.jsxs)(Oh,{style:{flex:`0 0 140px`},children:[(0,L.jsx)(Ah,{theme:t,children:`Duration`}),(0,L.jsx)(jh,{theme:t,type:`number`,min:1,value:e.effectDurationInput,onChange:t=>e.setEffectDurationInput(t.target.value)})]}),(0,L.jsxs)(Oh,{style:{flex:`0 0 120px`},children:[(0,L.jsx)(Ah,{theme:t,children:`By`}),(0,L.jsxs)(Mh,{theme:t,value:e.effectDurationType,onChange:t=>e.setEffectDurationType(t.target.value),children:[(0,L.jsx)(`option`,{value:`turns`,children:`Turns`}),(0,L.jsx)(`option`,{value:`rounds`,children:`Rounds`})]})]})]}),(0,L.jsxs)(Dh,{children:[(0,L.jsxs)(Oh,{style:{flex:`0 0 120px`},children:[(0,L.jsx)(Ah,{theme:t,children:`Type`}),(0,L.jsxs)(Mh,{theme:t,value:e.effectType,onChange:t=>e.setEffectType(t.target.value),children:[(0,L.jsx)(`option`,{value:`neutral`,children:`Neutral`}),(0,L.jsx)(`option`,{value:`buff`,children:`Buff`}),(0,L.jsx)(`option`,{value:`debuff`,children:`Debuff`})]})]}),(0,L.jsxs)(Oh,{style:{flex:`0 0 140px`},children:[(0,L.jsx)(Ah,{theme:t,children:`Ends at`}),(0,L.jsxs)(Mh,{theme:t,value:e.effectEndTiming,onChange:t=>e.setEffectEndTiming(t.target.value),children:[(0,L.jsx)(`option`,{value:`start`,children:`Start of turn`}),(0,L.jsx)(`option`,{value:`end`,children:`End of turn`})]})]}),(0,L.jsx)(kh,{children:(0,L.jsx)(Ph,{theme:t,onClick:e.handleAddEffect,style:{width:`100%`},children:`Add`})})]})]}),(0,L.jsxs)(Oh,{children:[(0,L.jsx)(Ah,{theme:t,children:`Targets`}),(0,L.jsx)(Nh,{theme:t,multiple:!0,value:e.effectTargetIds,onChange:t=>{let n=Array.from(t.target.selectedOptions).map(e=>e.value);e.setEffectTargetIds(n)},children:e.units.map(e=>(0,L.jsx)(`option`,{value:e.id,children:e.name},e.id))})]}),e.effectsModalError&&(0,L.jsx)(Bh,{theme:t,children:e.effectsModalError}),e.activeEffectsForSelectedUnit.length===0?(0,L.jsx)(zh,{theme:t,children:`No active effects.`}):(0,L.jsx)(Fh,{children:e.activeEffectsForSelectedUnit.map(n=>(0,L.jsxs)(Ih,{theme:t,children:[(0,L.jsxs)(`div`,{children:[(0,L.jsx)(Rh,{theme:t,children:n.name}),(0,L.jsxs)(Lh,{theme:t,children:[r(n.effectType),` • `,n.remaining,` `,n.durationType,` • ends at `,n.endTiming===`start`?`start of turn`:`end of turn`,` • by `,n.createdByName]}),(0,L.jsxs)(Lh,{theme:t,children:[`Targets: `,i(n.targets)]})]}),(0,L.jsx)(Ph,{theme:t,onClick:()=>{e.handleDeleteEffect(n.id)},children:`Delete`})]},n.id))})]})})},qh=({activeEffectsCount:e,canInteract:t,onOpen:n,icon:r})=>{let{theme:i}=Je();return(0,L.jsxs)(Vh,{children:[(0,L.jsx)(Hh,{theme:i,$active:e>0,disabled:!t,onClick:()=>{t&&n()},children:r||(0,L.jsx)(qd,{})}),e>0&&(0,L.jsx)(Uh,{theme:i,children:e>99?`99+`:e})]})};var Jh=T.td`
  color: ${e=>e.theme.PRIMARY};
  padding: 2px 6px;
  text-align: center;
  font-size: 14px;
...
`;const Xh=({theme:e,unit:t,canInteract:n,elevationDraftValue:r,onElevationDraftChange:i,onCommitElevationChange:a})=>(0,L.jsx)(Jh,{theme:e,children:(0,L.jsx)(Yh,{theme:e,type:`text`,inputMode:`decimal`,min:-999,max:999,step:1,value:r??String(t.elevation??0),readOnly:!n,onChange:n?e=>i(t.id,e.target.value):void 0,onBlur:n?e=>a(t.id,e.target.value):void 0,onKeyDown:e=>{n&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}})}),Zh=({theme:e,canInteract:t,icon:n,activeEffectsCount:r,onOpen:i})=>(0,L.jsx)(Jh,{theme:e,children:(0,L.jsx)(qh,{activeEffectsCount:r,canInteract:t,icon:n||(0,L.jsx)(qd,{}),onOpen:i})});var Qh=`${P}/elevation-badge`,$h=`${P}/elevation-badge-owner`,eg=`${P}/elevation`,tg=200,ng=40,rg=60,ig=120,ag=24,og=(e,t)=>{if(!e)return;if(e.startsWith(`#`))return xh(e,t);let n=e.match(/^rgba\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([\d.]+)\)$/i);if(n){let[,e,r,i]=n;return`rgba(${e}, ${r}, ${i}, ${t})`}let r=e.match(/^rgb\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\)$/i);if(r){let[,e,n,i]=r;return`rgba(${e}, ${n}, ${i}, ${t})`}return e},sg=e=>`
...
`,h_=T.div`
  ...
  border: 1px solid ${e=>f(e.theme.BORDER,.8)};
  background: ${e=>f(e.theme.BACKGROUND,.55)};
`,g_=(e,t)=>{let n=[{id:crypto.randomUUID(),type:`initiative`,description:`Initiative value used for turn order. Can be edited via Right-Click or rolled with Click.`},{id:crypto.randomUUID(),type:`name`,description:`Name of the unit or character.`}],r=t?[{id:`card-column`,type:`card-column`}]:[];if(!e||e.length===0)return[...n,...r];let i=[...e].sort((e,t)=>e.col-t.col).map(e=>({id:e.id,type:e.type,name:e.styles?.labelName,useIcon:e.styles?.labelMode===`icon`,iconType:e.styles?.labelIcon,description:e.styles?.description,styles:e.styles}));return[...n,...i,...r]};const __=()=>{let{theme:r}=Je(),{listLayout:i,attributes:a,isLoading:o}=vm();I(e=>e.roomMetadata);let s=I(e=>e.sceneMetadata),l=I(e=>e.items),u=I(e=>e.partyData),d=I(e=>e.playerData),f=I(e=>e.gridDpi),m=I(e=>e.setItems),[h,g]=(0,F.useState)([]),[_,v]=(0,F.useState)([]),[y,b]=(0,F.useState)(null),[x,S]=(0,F.useState)(1),[C,w]=(0,F.useState)(new Set),[T,E]=(0,F.useState)(null),[ee,D]=(0,F.useState)(null),[te,re]=(0,F.useState)(!1),[ie,ae]=(0,F.useState)(!1),[oe,k]=(0,F.useState)(!1),[se,ce]=(0,F.useState)({}),[ue,de]=(0,F.useState)({}),[fe,pe]=(0,F.useState)({}),[me,he]=(0,F.useState)(null),[ge,_e]=(0,F.useState)({}),[ve,ye]=(0,F.useState)(null),[be,xe]=(0,F.useState)(!1),[Se,Ce]=(0,F.useState)(!1),[A,we]=(0,F.useState)(!1),[Te,Ee]=(0,F.useState)(()=>window.innerWidth<400),[j,De]=(0,F.useState)(null),ke=(0,F.useRef)(null),Ae=(0,F.useRef)({}),je=(0,F.useRef)({}),Me=(0,F.useRef)(null);(0,F.useEffect)(()=>{let e=()=>{Ee(window.innerWidth<400)};return window.addEventListener(`resize`,e),()=>{window.removeEventListener(`resize`,e)}},[]);let N=s,Ne=N[O.REVERSE_INITIATIVE]||!1,Pe=N[O.POPCORN_INITIATIVE]||!1,Fe=N[O.SHOW_CARD_ACCESS]||!1,Ie=N[O.SHOW_NON_PARTY_UNITS]||!1,Le=N[O.SHOW_LIST_HP_NUMBERS],Re=typeof Le==`boolean`?Le:!0,ze=N[O.DICE_RANGE]||``,Be=N[O.INITIATIVE_MODIFIER_BID]||``,Ve=N[O.INITIATIVE_MODIFIER_EXPR]||`@STAT`,He=Ve.trim().length>0?Ve:`@STAT`,Ue=N[O.SHOW_OWNER_ONLY_EDIT]||!1,We=String(d?.role||``).toUpperCase()===`GM`,Ge=d?.id||``,Ke=ne(O.INITIATIVE_LIST_COMPACT,Ge);(0,F.useEffect)(()=>{let e=s[Ke],t=s[O.INITIATIVE_LIST_COMPACT];we(typeof e==`boolean`?e:typeof t==`boolean`?t:!1)},[s,Ke]);let qe=async()=>{let e=!A;we(e);try{await c.scene.setMetadata({[Ke]:e})}catch(t){M.error(`Failed to persist initiative list compact mode`,t),we(!e)}},Ye=async({notation:e,actionName:t,tokenName:n,senderId:r,senderColor:i})=>{try{await le({notation:e,actionName:t,senderName:n,senderId:r,senderColor:i},N)}catch(t){M.error(`Failed to send dice roll from InitiativeList`,e,t),M.log(e)}},Xe=e=>{let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return[]}return Array.isArray(t)?t.map((e,t)=>{let n=e&&typeof e==`object`?e:{},r=n.inUse,i=typeof r==`boolean`?r:typeof r==`string`?[`true`,`1`,`yes`].includes(r.trim().toLowerCase()):typeof r==`number`?r===1:void 0;return{id:typeof n.id==`string`&&n.id?n.id:`entry-${t}`,name:typeof n.name==`string`?n.name:``,description:typeof n.description==`string`?n.description:``,...i===void 0?{}:{inUse:i}}}):[]};(0,F.useEffect)(()=>{g(l.filter(e=>e.metadata?.[p.ON_LIST]===!0).map(e=>{let t=e.metadata?.[p.INITIATIVE]||0,n=e.metadata[p.UNIT_NAME]||e.name||`Unknown`,r=e.metadata?.[p.BOSS_MODE]===!0,i=e.metadata?.[eg]||0,a=u.find(t=>t.id===e.createdUserId)||(d?.id===e.createdUserId?d:void 0),o=String(a?.role||``).toUpperCase()===`GM`,s=a?.color||(d?.id===e.createdUserId?d?.color:void 0),c=o?void 0:og(s,1),l={};return Object.keys(e.metadata||{}).forEach(t=>{t.startsWith(`com.battle-system.forge`)&&(l[t]=e.metadata?.[t])}),{id:e.id,initiative:t,name:n,isBoss:r,elevation:i,attributes:l,createdUserId:e.createdUserId,ownerNameOutlineColor:c,isInParty:e.metadata?.[p.IN_PARTY]===!0,isVisible:e.visible!==!1}}))},[l,u,d]);let R=(0,F.useMemo)(()=>Pe?[...h].sort((e,t)=>e.name.localeCompare(t.name)):[...h].sort((e,t)=>e.initiative===t.initiative?e.name.localeCompare(t.name):Ne?e.initiative-t.initiative:t.initiative-e.initiative),[h,Ne,Pe]),Ze=Gh({items:l,units:R,setItems:m,playerData:d}),z=(0,F.useMemo)(()=>{let e=new Map;return u.forEach(t=>{e.set(t.id,t)}),d&&!e.has(d.id)&&e.set(d.id,d),Array.from(e.values()).sort((e,t)=>e.name.localeCompare(t.name))},[u,d]),B=(e,t)=>{let n=parseInt(t)||0;g(t=>t.map(t=>t.id===e?{...t,initiative:n}:t))},Qe=(e,t)=>{m(l.map(n=>n.id===e?{...n,metadata:{...n.metadata,[p.INITIATIVE]:t}}:n)),c.scene.items.updateItems([e],e=>{e[0].metadata[p.INITIATIVE]=t})},$e=e=>{let t=(e||``).trim().match(/(\d+)/),n=t?parseInt(t[1],10):NaN;return Number.isFinite(n)&&n>0?n:20},et=(e,t,n)=>(typeof t==`number`&&(e=Math.max(t,e)),typeof n==`number`&&(e=Math.min(n,e)),e),tt=(e,t,n)=>{let r=e.trim(),{min:i,max:a}=n||{};if(r.length===0)return et(0,i,a);let o=r.match(/^([+\-*/])\s*(-?\d+(?:\.\d+)?)$/),s=r.match(/^(-?\d+(?:\.\d+)?)\s*([+\-*/])\s*(-?\d+(?:\.\d+)?)$/),c=null;if(o){let e=o[1],n=parseFloat(o[2]);switch(e){case`+`:c=t+n;break;case`-`:c=t-n;break;case`*`:c=t*n;break;case`/`:c=n===0?t:t/n;break}}else if(s){let e=parseFloat(s[1]),t=s[2],n=parseFloat(s[3]);switch(t){case`+`:c=e+n;break;case`-`:c=e-n;break;case`*`:c=e*n;break;case`/`:c=n===0?e:e/n;break}}else{let e=parseFloat(r);Number.isNaN(e)||(c=e)}return et(c===null||!Number.isFinite(c)?t:Math.trunc(c),i,a)},nt=e=>{let t=0;if(Be){let n=h.find(t=>t.id===e);if(n){let e=n.attributes?.[`${P}/${Be}`],r=Number(e),i=Number.isFinite(r)?r:0,a=Oe(He.replace(/@STAT/gi,`@${Be}`).replace(/\bx\b/gi,`@${Be}`),{bidValueMap:{[Be]:i},onMissingBid:`useZero`});if(a.valid&&a.notation){let e=Number(a.notation);Number.isFinite(e)&&(t=Math.trunc(e))}}}return t},rt=(e,t=`normal`)=>{let n=$e(ze),r=Math.floor(Math.random()*n)+1,i=t===`normal`?null:Math.floor(Math.random()*n)+1,a=(i===null?r:t===`advantage`?Math.max(r,i):Math.min(r,i))+nt(e);B(e,String(a)),Qe(e,a)},it=(e,t)=>{ce(n=>({...n,[e]:t}))},at=(e,t)=>{let n=tt(t,h.find(t=>t.id===e)?.initiative??0);ce(t=>{let{[e]:n,...r}=t;return r}),g(t=>t.map(t=>t.id===e?{...t,initiative:n}:t)),Qe(e,n)},ot=e=>`ELE${e.slice(3)}`,st=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o}},ct=async(t,r)=>{let i=ot(t);try{await c.scene.items.deleteItems([i])}catch{}if(r===0)return;let a=l.find(e=>e.id===t);if(!a||!e(a))return;let o=st(a,f),s=`${r>0?`🡹`:`🡻`}${Math.abs(r)}`,u=n().id(i).name(`Elevation Badge`).plainText(s).textType(`PLAIN`).fontWeight(900).fillOpacity(.95).fillColor(`white`).strokeWidth(8).strokeColor(`black`).strokeOpacity(1).fontSize(36).fontFamily(`Segoe UI`).textAlign(`CENTER`).position({x:o.minX-40,y:o.minY}).metadata({[Qh]:!0,[$h]:t}).attachedTo(t).visible(a.visible).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).layer(`TEXT`).build();try{await c.scene.items.addItems([u])}catch(e){M.error(`Failed to add elevation badge`,t,e)}},lt=(e,t)=>{de(n=>({...n,[e]:t}))},ut=(e,t,n)=>{let r=e.trim(),{min:i,max:a}=n||{};if(!r)return et(0,i,a);let o=parseFloat(r);return et(Number.isFinite(o)?Math.trunc(o):t,i,a)},dt=(e,t)=>{let n=ut(t,h.find(t=>t.id===e)?.elevation??0,{min:-999,max:999});de(t=>{let{[e]:n,...r}=t;return r}),g(t=>t.map(t=>t.id===e?{...t,elevation:n}:t)),m(l.map(t=>t.id===e?{...t,metadata:{...t.metadata,[eg]:n}}:t)),c.scene.items.updateItems([e],e=>{e[0].metadata[eg]=n}),ct(e,n)},ft=(e,t)=>{let n=e.trim();if(!n)return e;let r=/^([+\-*/])\s*-?\d+(?:\.\d+)?$/.test(n),i=/^-?\d+(?:\.\d+)?\s*[+\-*/]\s*-?\d+(?:\.\d+)?$/.test(n),a=/^-?\d+(?:\.\d+)?$/.test(n);if(!r&&!i&&!a)return e;let o=typeof t==`number`?t:parseFloat(String(t)),s=Number.isFinite(o)?o:0;return String(tt(n,s))},pt=(e,t,n)=>{let r=`${P}/${t}`,i=l.find(t=>t.id===e)?.metadata?.[r],a=ft(n,i);g(t=>t.map(t=>t.id===e?{...t,attributes:{...t.attributes,[r]:a}}:t)),m(l.map(t=>t.id===e?{...t,metadata:{...t.metadata,[r]:a}}:t)),c.scene.items.updateItems([e],e=>{e[0].metadata[r]=a})},mt=e=>a.find(t=>t.attr_bid===e)||null,ht=e=>{let t=mt(e);return typeof t?.attr_func==`string`&&t.attr_func.trim().length>0},gt=e=>{let t={};for(let n of a){let r=`${P}/${n.attr_bid}`,i=e.attributes?.[r];if(i==null||i===``)continue;let a=Number(i);Number.isFinite(a)&&(t[n.attr_bid]=a)}return t},_t=e=>{let t={};for(let n of a){let r=`${P}/${n.attr_bid}`,i=e.attributes?.[r];if(i==null||i===``)continue;let a=Number(i);Number.isFinite(a)&&(n.attr_name&&(t[n.attr_name]=a),n.attr_abbr&&(t[n.attr_abbr]=a))}return t},vt=(e,t)=>{let n=Array.from(e.matchAll(cg));if(n.length!==1)return null;let r=n[0],i=r[0]||``,a=r[1]||``,o=r[2]||``,s=r[3]||``,c=r.index;if(!i||!a||!o||typeof c!=`number`)return null;let l=Number(a);if(!Number.isFinite(l)||l!==1||s)return null;let u=`2d${o}${t===`advantage`?`kh1`:`kl1`}`;return`${e.slice(0,c)}${u}${e.slice(c+i.length)}`},yt=(e,t)=>{let n=mt(t)?.attr_func;if(typeof n!=`string`||n.trim().length===0)return null;let r=Oe(n,{bidValueMap:gt(e),nameValueMap:_t(e),onMissingBid:`error`});return!r.valid||!r.notation?(M.warn(`Could not resolve notation for initiative list value-column`,{unitId:e.id,bid:t,error:r.error}),null):{notation:r.notation,actionName:mt(t)?.attr_name||t}},bt=async(e,t)=>{let n=yt(e,t);if(!n)return;let r=u.find(t=>t.id===e.createdUserId);await Ye({notation:n.notation,actionName:n.actionName,tokenName:e.name,senderId:e.createdUserId||d?.id||`unknown`,senderColor:r?.color||d?.color||`#ffffff`})},xt=async(e,t,n)=>{let r=yt(e,t);if(!r)return;let i=n===`normal`?r.notation:vt(r.notation,n);if(!i)return;let a=u.find(t=>t.id===e.createdUserId),o=n===`normal`?``:n===`advantage`?` (Advantage)`:` (Disadvantage)`;await Ye({notation:i,actionName:`${r.actionName}${o}`,tokenName:e.name,senderId:e.createdUserId||d?.id||`unknown`,senderColor:a?.color||d?.color||`#ffffff`})};(0,F.useEffect)(()=>()=>{Object.values(Ae.current).forEach(e=>{window.clearTimeout(e)})},[]),(0,F.useEffect)(()=>{if(!ve)return;let e=e=>{e.key===`Escape`&&ye(null)};return window.addEventListener(`keydown`,e),()=>{window.removeEventListener(`keydown`,e)}},[ve]);let St=(e,t)=>`value-column:${e}:${t}`,Ct=(e,t)=>`${e}:${t}`,wt=e=>!!ge[e],Tt=(e,t)=>{_e(t=>({...t,[e]:!0})),window.setTimeout(()=>{t?.focus(),t?.select()},0)},Et=e=>{ye(e)},Dt=()=>{ye(null)},Ot=e=>{_e(t=>{let{[e]:n,...r}=t;return r})},kt=(e,t)=>{let n=Ae.current[e];n&&window.clearTimeout(n),Ae.current[e]=window.setTimeout(()=>{je.current[e]=!0,Tt(e,t),delete Ae.current[e]},500)},At=e=>{let t=Ae.current[e];t&&(window.clearTimeout(t),delete Ae.current[e])},jt=e=>je.current[e]?(delete je.current[e],!0):!1,Mt=e=>{if(!Ue||We)return!0;let t=d?.id;return t?e.createdUserId===t:!1},Nt=e=>We?!0:e.isVisible,Pt=e=>We||Ie?!1:!e.isInParty;(0,F.useEffect)(()=>{o||v(g_(i,Fe))},[i,o,Fe]),(0,F.useEffect)(()=>{let e=s[O.CURRENT_TURN],t=s[O.CURRENT_ROUND];e?b(e):R.length>0&&b(R[0].id),t&&S(t)},[s,R]);let Ft=async()=>{if(R.length===0)return;y&&await Ze.processEffectsForTurnEvent(`end`,y);let e=R.findIndex(e=>e.id===y)+1;if(e>=R.length){let e=x+1;S(e),b(R[0].id),await c.scene.setMetadata({[O.CURRENT_TURN]:R[0].id,[O.CURRENT_ROUND]:e}),await Ze.processEffectsForTurnEvent(`start`,R[0].id)}else b(R[e].id),await c.scene.setMetadata({[O.CURRENT_TURN]:R[e].id}),await Ze.processEffectsForTurnEvent(`start`,R[e].id)},It=async()=>{if(R.length===0)return;let e=R.findIndex(e=>e.id===y)-1;if(e<0){let e=Math.max(1,x-1);S(e),b(R[R.length-1].id),await c.scene.setMetadata({[O.CURRENT_TURN]:R[R.length-1].id,[O.CURRENT_ROUND]:e})}else b(R[e].id),await c.scene.setMetadata({[O.CURRENT_TURN]:R[e].id})},Lt=async e=>{Pe&&(C.has(e)||(b(e),await c.scene.setMetadata({[O.CURRENT_TURN]:e}),await Ze.processEffectsForTurnEvent(`start`,e)))},Rt=async()=>{y&&(await Ze.processEffectsForTurnEvent(`end`,y),w(e=>new Set([...e,y])),C.size+1,R.length)},zt=async()=>{let e=x+1;S(e),w(new Set),b(null),await c.scene.setMetadata({[O.CURRENT_TURN]:null,[O.CURRENT_ROUND]:e})},V=async e=>{Ce(!0);try{if(e===`clear-list`){let e=l.filter(e=>e.metadata?.[p.ON_LIST]===!0).map(e=>e.id);e.length>0&&(await c.scene.items.updateItems(e,e=>{e.forEach(e=>{e.metadata&&p.ON_LIST in e.metadata&&delete e.metadata[p.ON_LIST]})}),m(l.map(e=>{if(e.metadata?.[p.ON_LIST]!==!0)return e;let t={...e.metadata||{}};return delete t[p.ON_LIST],{...e,metadata:t}})))}if(e===`reset-initiative`){let e=l.filter(e=>e.metadata?.[p.ON_LIST]===!0).map(e=>e.id);e.length>0&&(await c.scene.items.updateItems(e,e=>{e.forEach(e=>{e.metadata[p.INITIATIVE]=0})}),m(l.map(e=>e.metadata?.[p.ON_LIST]===!0?{...e,metadata:{...e.metadata||{},[p.INITIATIVE]:0}}:e)),g(e=>e.map(e=>l.some(t=>t.id===e.id&&t.metadata?.[p.ON_LIST]===!0)?{...e,initiative:0}:e)),ce({}))}let t=e===`clear-list`?null:e===`reset-initiative`?[...R].sort((e,t)=>e.name.localeCompare(t.name))[0]?.id??null:R[0]?.id??null;S(1),b(t),w(new Set),await c.scene.setMetadata({[O.CURRENT_TURN]:t,[O.CURRENT_ROUND]:1}),xe(!1)}catch(t){M.error(`Failed to reset encounter state`,{mode:e,error:t})}finally{Ce(!1)}},Bt=async e=>{let t=l.find(t=>t.id===e);if(t)try{await Sh.CenterViewportOnImage(t)}catch(t){M.error(`Failed to center viewport on unit`,e,t)}},Vt=async(e,n)=>{try{let r=await c.viewport.getHeight(),i=r>800?700:r-100;await c.popover.open({id:t.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(n)}`,height:i,width:350,anchorElementId:e,hidePaper:!0,disableClickAway:!0})}catch(e){M.error(`Failed to open cards popover`,e)}},Ht=(e,t)=>{e.preventDefault(),e.stopPropagation(),D(null),E(t)},Ut=async e=>{if(T){if(!l.find(e=>e.id===T)){D(`Token not found in scene cache.`);return}re(!0),D(null);try{await c.scene.items.updateItems([T],t=>{let n=t[0];n.createdUserId=e}),m(l.map(t=>t.id===T?{...t,createdUserId:e}:t)),E(null)}catch(t){M.error(`Failed to reassign token owner`,T,e,t),D(`Unable to assign token owner. Ensure you have permission to edit this token.`)}finally{re(!1)}}},Wt=async()=>{if(!T)return;let e=l.find(e=>e.id===T);if(!e){D(`Token not found in scene cache.`);return}let t=e.metadata?.[p.BOSS_MODE]!==!0;if(t&&l.filter(e=>e.id!==T&&e.metadata?.[p.ON_LIST]===!0&&e.metadata?.[p.BOSS_MODE]===!0).length>=2){D(`A maximum of 2 bosses can be enabled at once.`);return}ae(!0),D(null);try{await c.scene.items.updateItems([T],e=>{let n={...e[0].metadata||{}};n[p.BOSS_MODE]=t,e[0].metadata=n}),m(l.map(e=>e.id===T?{...e,metadata:{...e.metadata||{},[p.BOSS_MODE]:t}}:e))}catch(e){M.error(`Failed to toggle boss mode`,T,e),D(`Unable to update boss mode for this token.`)}finally{ae(!1)}},Gt=async()=>{if(T){if(!l.find(e=>e.id===T)){D(`Token not found in scene cache.`);return}k(!0),D(null);try{await c.scene.items.updateItems([T],e=>{let t={...e[0].metadata||{}};p.ON_LIST in t&&delete t[p.ON_LIST],e[0].metadata=t}),m(l.map(e=>{if(e.id!==T)return e;let t={...e.metadata||{}};return delete t[p.ON_LIST],{...e,metadata:t}})),E(null)}catch(e){M.error(`Failed to remove token from initiative list`,T,e),D(`Unable to remove token from initiative list.`)}finally{k(!1)}}},Kt=(0,F.useMemo)(()=>T&&R.find(e=>e.id===T)||null,[T,R]),qt=(0,F.useMemo)(()=>T&&l.find(e=>e.id===T)||null,[T,l]),Jt=qt?.metadata?.[p.BOSS_MODE]===!0,Yt=(0,F.useMemo)(()=>me&&R.find(e=>e.id===me.unitId)||null,[me,R]),Xt=(0,F.useMemo)(()=>me&&a.find(e=>e.attr_bid===me.bid)||null,[a,me]),Zt=(0,F.useMemo)(()=>{if(!me||!Yt)return[];let e=Yt.attributes[`${P}/${me.bid}`];return Xe(e)},[me,Yt]),Qt=(0,F.useMemo)(()=>Zt.some(e=>typeof e.inUse==`boolean`),[Zt]),$t=(0,F.useMemo)(()=>ve&&R.find(e=>e.id===ve.unitId)||null,[ve,R]),en=(0,F.useMemo)(()=>A?_.filter(e=>e.type===`initiative`||e.type===`name`?!0:e.type===`card-column`&&Fe):_,[A,_,Fe]),tn=(0,F.useMemo)(()=>{let e=a.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),t=a.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`}),n=e?.attr_bid,r=t?.attr_bid,i=N[O.HP_CURRENT_BID],o=N[O.HP_MAX_BID],s=new Set(a.map(e=>e.attr_bid));return{currentHpBid:i&&s.has(i)?i:n,maxHpBid:o&&s.has(o)?o:r}},[a,N]),nn=(0,F.useMemo)(()=>R.filter(e=>Nt(e)),[R,We]),rn=(0,F.useMemo)(()=>{if(!Yt)return{};let e={};for(let t of a){let n=`${P}/${t.attr_bid}`,r=Yt.attributes?.[n];if(r==null||r===``)continue;let i=Number(r);Number.isFinite(i)&&(e[t.attr_bid]=i)}return e},[Yt,a]),an=(0,F.useMemo)(()=>{if(!Yt)return{};let e={};for(let t of a){let n=`${P}/${t.attr_bid}`,r=Yt.attributes?.[n];if(r==null||r===``)continue;let i=Number(r);Number.isFinite(i)&&(t.attr_name&&(e[t.attr_name]=i),t.attr_abbr&&(e[t.attr_abbr]=i))}return e},[Yt,a]),on=e=>{let t=[],n=e.matchAll(/\[([^\[\]]+)\]/g);for(let e of n){let n=(e[1]||``).trim();if(!n)continue;let r=Oe(n,{bidValueMap:rn,nameValueMap:an,onMissingBid:`error`});!r.valid||!r.notation||t.push(r.notation)}return t};(0,F.useEffect)(()=>{Me.current&&en.length>0&&(M.debug(`Adjusting window width based on table size`),setTimeout(()=>{if(Me.current){let e=Me.current.offsetWidth+4,t=Math.min(e,800);c.action.setWidth(t),M.log(`Adjusted window width to `+t)}},100))},[A,en.length,R.length]);let sn=e=>{if(!e)return null;let t=lg[e.toLowerCase()];return t?(0,L.jsx)(t,{}):null},cn=(e,t)=>{let n=window.innerWidth-t-8,r=Math.min(Math.max(e-t/2,8),Math.max(8,n));return{left:r,arrowX:e-r}},ln=e=>{let t=e.currentTarget.getBoundingClientRect(),n=`clientX`in e?e.clientX:t.left+t.width/2,r=t.top>72?`top`:`bottom`;return{anchorX:n,y:r===`top`?t.top:t.bottom,placement:r}},un=(e,t)=>{let n=ln(e),r=Math.min(320,Math.max(140,t.length*7+28)),i=cn(n.anchorX,r);De({text:t,...n,...i})},dn=()=>{De(null)};(0,F.useLayoutEffect)(()=>{if(!j||!ke.current)return;let e=ke.current.getBoundingClientRect().width,t=cn(j.anchorX,e);(Math.abs(t.left-j.left)>.5||Math.abs(t.arrowX-j.arrowX)>.5)&&De(e=>e&&{...e,...t})},[j]);let fn=e=>e.type===`initiative`?(0,L.jsx)(Qd,{}):e.type===`roller`?null:e.type===`name`?`Name`:e.type===`card-column`?(0,L.jsx)(jd,{}):e.type===`divider-column`?null:e.useIcon&&e.iconType?sn(e.iconType):e.name||e.type,pn=e=>e.type===`divider-column`?{fixedWidth:ag}:e.type===`initiative`?{minWidth:rg}:e.type===`name`?{minWidth:ig}:{minWidth:ng},mn=(e,t)=>{let n=Mt(t),i=Pt(t),a=!We&&!Re;if(i&&e.type!==`initiative`&&e.type!==`name`&&e.type!==`divider-column`)return(0,L.jsx)(Dg,{theme:r,children:(0,L.jsx)(m_,{theme:r})});switch(e.type){case`initiative`:if(Pe)return(0,L.jsx)(Og,{theme:r,children:(0,L.jsx)(Mg,{onClick:e=>{e.stopPropagation(),n&&(C.has(t.id)||(t.id===y?Rt():Lt(t.id)))},children:C.has(t.id)?(0,L.jsx)(yd,{color:r.OFFSET}):t.id===y?(0,L.jsx)(vd,{color:r.PRIMARY}):(0,L.jsx)(bd,{color:r.BORDER})})});let i=`initiative:${t.id}`,o=wt(i);return(0,L.jsx)(Og,{theme:r,children:(0,L.jsx)(Ng,{theme:r,$isRollable:n&&!o,type:`text`,inputMode:`decimal`,value:se[t.id]??String(t.initiative),readOnly:!n||!o,onChange:!n||!o?void 0:e=>it(t.id,e.target.value),onBlur:!n||!o?void 0:e=>{at(t.id,e.target.value),Ot(i)},onClick:()=>{n&&(o||jt(i)||rt(t.id))},onContextMenu:e=>{n&&(e.preventDefault(),Et({kind:`initiative`,fieldKey:i,unitId:t.id,input:e.currentTarget}))},onTouchStart:e=>{n&&(o||kt(i,e.currentTarget))},onTouchEnd:()=>{At(i)},onTouchCancel:()=>{At(i)},onKeyDown:e=>{if(n){if(!o&&(e.key===`Enter`||e.key===` `)){e.preventDefault(),rt(t.id);return}o&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}}})});case`name`:return(0,L.jsx)(Pg,{theme:r,title:`Right-click to assign owner`,$outlineColor:t.ownerNameOutlineColor,onDoubleClick:()=>Bt(t.id),onContextMenu:n?e=>Ht(e,t.id):void 0,children:t.isBoss?`💀 ${t.name}`:t.name});case`roller`:return(0,L.jsx)(kg,{theme:r,children:(0,L.jsx)(Ag,{theme:r,disabled:!n,onClick:e=>{e.stopPropagation(),n&&rt(t.id)},title:`Roll initiative (1-${$e(ze)})`,children:(0,L.jsx)(jg,{src:`/dice.svg`,alt:`Roll`})})});case`card-column`:return(0,L.jsx)(Dg,{theme:r,children:(0,L.jsx)(Rg,{id:`card-access-${t.id}`,theme:r,disabled:!n,onClick:e=>{e.stopPropagation(),n&&Vt(e.currentTarget.id,t.id)},title:`Open card for ${t.name}`,children:(0,L.jsx)(vd,{})})});case`value-column`:return(0,L.jsx)(Dg,{theme:r,children:(0,L.jsx)(Lg,{children:e.styles?.bidList?.map((i,o)=>{let s=ht(i),c=St(t.id,i),l=Ct(t.id,i),u=s&&wt(c),d=t.attributes[`${P}/${i}`],f=fe[l]??(d==null||d===``?`0`:String(d)),p=i===tn.currentHpBid||i===tn.maxHpBid,m=!!Ge&&t.createdUserId===Ge,h=a&&p&&!m;return(0,L.jsxs)(F.Fragment,{children:[o>0&&(0,L.jsx)(Ig,{theme:r,children:e.styles?.dividers?.[o-1]||`/`}),h?(0,L.jsx)(h_,{theme:r,$small:e.styles?.bidList&&e.styles.bidList.length>2}):(0,L.jsx)(Fg,{theme:r,$isRollable:n&&s,value:f,$small:e.styles?.bidList&&e.styles.bidList.length>2,readOnly:!n||s&&!u,onChange:!n||s&&!u?void 0:e=>{let t=e.target.value;pe(e=>({...e,[l]:t}))},onBlur:!n||s&&!u?void 0:e=>{pt(t.id,i,e.target.value),pe(e=>{let{[l]:t,...n}=e;return n}),s&&Ot(c)},onClick:s?()=>{n&&(u||jt(c)||bt(t,i))}:void 0,onContextMenu:s?e=>{n&&(e.preventDefault(),Et({kind:`attribute`,fieldKey:c,unitId:t.id,bid:i,input:e.currentTarget}))}:void 0,onTouchStart:s?e=>{n&&(u||kt(c,e.currentTarget))}:void 0,onTouchEnd:s?()=>{At(c)}:void 0,onTouchCancel:s?()=>{At(c)}:void 0,onKeyDown:e=>{if(n){if(s&&!u&&(e.key===`Enter`||e.key===` `)){e.preventDefault(),bt(t,i);return}(u||!s)&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}}})]},i)})})});case`list-column`:return(0,L.jsx)(Dg,{theme:r,children:(0,L.jsx)(Rg,{theme:r,disabled:!n,onClick:r=>{if(r.stopPropagation(),!n)return;let i=e.styles?.bidList?.[0];i&&he({unitId:t.id,bid:i})},title:`Open list reference`,children:(0,L.jsx)(fd,{})})});case`checkbox-column`:return(0,L.jsx)(Dg,{theme:r,children:(0,L.jsx)(Lg,{children:e.styles?.bidList?.map(i=>{let a=!!t.attributes[`${P}/${i}`],o=e.styles?.inputType===`slider`,s=e=>{g(n=>n.map(n=>n.id===t.id?{...n,attributes:{...n.attributes,[`${P}/${i}`]:e}}:n)),m(l.map(n=>n.id===t.id?{...n,metadata:{...n.metadata,[`${P}/${i}`]:e}}:n)),c.scene.items.updateItems([t.id],t=>{t[0].metadata[`${P}/${i}`]=e})};return o?(0,L.jsx)(Bg,{type:`button`,theme:r,$active:a,disabled:!n,onClick:n?()=>{s(!a)}:void 0,children:(0,L.jsx)(Vg,{theme:r,$active:a})},i):(0,L.jsx)(zg,{theme:r,type:`checkbox`,checked:a,disabled:!n,onChange:n?e=>{s(e.target.checked)}:void 0},i)})})});case`special-column`:let s=sn(e.iconType);if(e.styles?.specialType===`elevation`){let e=ue[t.id];return(0,L.jsx)(Xh,{theme:r,unit:t,canInteract:n,elevationDraftValue:e,onElevationDraftChange:lt,onCommitElevationChange:dt})}else{let e=Ze.getEffectsForUnit(t.id).length;return(0,L.jsx)(Zh,{theme:r,canInteract:n,icon:s||(0,L.jsx)(qd,{}),activeEffectsCount:e,onOpen:()=>Ze.handleOpenEffectsModal(t.id)})}case`divider-column`:return(0,L.jsx)(Hg,{theme:r,children:(0,L.jsx)(Ug,{children:e.styles?.styleDesign===`zigzag`?(0,L.jsx)(Gg,{children:(0,L.jsx)(Kg,{theme:r})}):(0,L.jsx)(Wg,{theme:r,$style:e.styles?.styleDesign})})});default:return(0,L.jsx)(Dg,{theme:r,children:`-`})}};if(o)return(0,L.jsx)(ug,{children:(0,L.jsx)(dg,{theme:r,children:`Loading...`})});let hn=A||Te,gn=A?`R: ${x}`:`Round: ${x}`;return(0,L.jsxs)(ug,{children:[(0,L.jsx)(fg,{children:(0,L.jsxs)(bg,{ref:Me,theme:r,$compact:A,children:[(0,L.jsx)(xg,{theme:r,children:(0,L.jsx)(Sg,{children:en.map(e=>{let t=e.description??`This has no description.`,n=pn(e);return(0,L.jsx)(Cg,{theme:r,$minWidth:n.minWidth,$fixedWidth:n.fixedWidth,onMouseEnter:e=>un(e,t),onMouseMove:e=>un(e,t),onMouseLeave:dn,onFocus:e=>un(e,t),onBlur:dn,children:fn(e)},e.id)})})}),(0,L.jsx)(Tg,{children:nn.map(e=>(0,L.jsx)(Eg,{$isCurrentTurn:e.id===y,theme:r,children:en.map(t=>(0,L.jsx)(F.Fragment,{children:mn(t,e)},t.id))},e.id))})]})}),(0,L.jsxs)(pg,{theme:r,$compactMode:A,children:[(0,L.jsxs)(mg,{$compactMode:A,children:[A?(0,L.jsxs)(L.Fragment,{children:[We&&(0,L.jsx)(hg,{theme:r,$compact:!0,onClick:It,children:(0,L.jsx)(od,{})}),We&&(0,L.jsx)(hg,{theme:r,$compact:!0,onClick:Ft,children:(0,L.jsx)(sd,{})})]}):Pe?(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)(hg,{theme:r,onClick:Rt,disabled:!y||C.has(y),children:`End Turn`}),(0,L.jsx)(yg,{theme:r,$compactMode:A,children:gn}),(0,L.jsx)(hg,{theme:r,$compact:hn,onClick:zt,disabled:C.size<R.length,children:hn?(0,L.jsx)(sd,{}):`Next`})]}):(0,L.jsxs)(L.Fragment,{children:[We&&(0,L.jsx)(hg,{theme:r,$compact:!0,onClick:It,children:(0,L.jsx)(od,{})}),(0,L.jsx)(yg,{theme:r,$compactMode:A,children:gn}),We&&(0,L.jsx)(hg,{theme:r,$compact:!0,onClick:Ft,children:(0,L.jsx)(sd,{})})]}),A&&(0,L.jsx)(_g,{theme:r,onClick:()=>{qe()},title:`Switch to Fullsize list`,children:(0,L.jsx)(Id,{})})]}),!A&&(0,L.jsx)(vg,{theme:r,$hasReset:We,onClick:()=>{qe()},title:`Switch to Compact list`,children:(0,L.jsx)(Ld,{})}),We&&!A&&(0,L.jsx)(gg,{theme:r,onClick:()=>xe(!0),disabled:Se,title:`Reset round/turn state`,children:(0,L.jsx)(Bd,{})})]}),j&&(0,L.jsx)(wg,{ref:ke,theme:r,$left:j.left,$y:j.y,$placement:j.placement,$arrowX:j.arrowX,role:`tooltip`,children:j.text}),(0,L.jsxs)(_m,{isOpen:!!T,title:Kt?`Unit: ${Kt.name}`:`Unit`,onClose:()=>{te||ie||oe||(E(null),D(null))},closeOnOverlayClick:!te&&!ie&&!oe,maxWidth:`520px`,children:[(0,L.jsx)(Yg,{theme:r,children:`Select a player to become the owner.`}),(0,L.jsxs)(qg,{children:[z.map(e=>(0,L.jsxs)(Jg,{theme:r,$isCurrent:qt?.createdUserId===e.id,onClick:()=>Ut(e.id),disabled:te||ie||oe,children:[e.name,qt?.createdUserId===e.id?` (current)`:``]},e.id)),(0,L.jsx)(Jg,{theme:r,onClick:()=>{Gt()},disabled:te||ie||oe,children:oe?`Removing...`:`Remove Unit from List`})]}),(0,L.jsx)(Zg,{theme:r}),(0,L.jsxs)(Qg,{theme:r,children:[(0,L.jsxs)(`div`,{children:[(0,L.jsx)($g,{theme:r,children:`Boss Mode`}),(0,L.jsx)(e_,{theme:r,children:`Shows a large encounter HP bar in scene (max 2 bosses).`})]}),(0,L.jsx)(t_,{children:(0,L.jsx)(n_,{type:`button`,theme:r,$active:Jt,disabled:te||ie||oe,"aria-label":`Toggle boss mode`,"aria-pressed":Jt,onClick:()=>{Wt()}})})]}),ee&&(0,L.jsx)(Xg,{theme:r,children:ee})]}),(0,L.jsxs)(_m,{isOpen:!!ve,title:ve?.kind===`initiative`?`Initiative: ${$t?.name||`Unit`}`:mt(ve?.bid||``)?.attr_name||`Roll Options`,onClose:Dt,maxWidth:`460px`,children:[(0,L.jsx)(Yg,{theme:r,children:`Choose an action for this rollable field.`}),(0,L.jsxs)(qg,{children:[(0,L.jsx)(Jg,{theme:r,onClick:()=>{ve&&(Dt(),Tt(ve.fieldKey,ve.input))},children:`Edit value`}),(()=>{if(!ve||!$t)return null;if(ve.kind===`initiative`)return(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)(Jg,{theme:r,onClick:()=>{Dt(),rt(ve.unitId,`advantage`)},children:`Roll with Advantage`}),(0,L.jsx)(Jg,{theme:r,onClick:()=>{Dt(),rt(ve.unitId,`disadvantage`)},children:`Roll with Disadvantage`})]});let e=ve.bid||``,t=yt($t,e);if(!t)return null;let n=vt(t.notation,`advantage`),i=vt(t.notation,`disadvantage`);return!n||!i?null:(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)(Jg,{theme:r,onClick:()=>{Dt(),xt($t,e,`advantage`)},children:`Roll with Advantage`}),(0,L.jsx)(Jg,{theme:r,onClick:()=>{Dt(),xt($t,e,`disadvantage`)},children:`Roll with Disadvantage`})]})})()]})]}),(0,L.jsx)(Kh,{manager:Ze}),(0,L.jsxs)(_m,{isOpen:be,title:`Reset Encounter`,onClose:()=>{Se||xe(!1)},closeOnOverlayClick:!Se,maxWidth:`460px`,children:[(0,L.jsx)(Yg,{theme:r,children:`Choose how you want to reset initiative state.`}),(0,L.jsxs)(qg,{children:[(0,L.jsx)(Jg,{theme:r,onClick:()=>{V(`round`)},disabled:Se,children:Se?`Resetting...`:`Reset Round`}),(0,L.jsx)(Jg,{theme:r,onClick:()=>{V(`reset-initiative`)},disabled:Se,children:Se?`Resetting...`:`Reset Round & Initiative`}),(0,L.jsx)(Jg,{theme:r,onClick:()=>{V(`clear-list`)},disabled:Se,children:Se?`Resetting...`:`Reset Round & Clear List`})]})]}),(0,L.jsx)(_m,{isOpen:!!me,title:Yt?`${Xt?.attr_name||`List`} for ${Yt.name}`:`List Reference`,onClose:()=>{he(null)},maxWidth:`620px`,children:(0,L.jsxs)(r_,{children:[(0,L.jsx)(i_,{theme:r}),Zt.length===0?(0,L.jsx)(p_,{theme:r,children:`No entries.`}):(0,L.jsx)(a_,{children:Zt.map(e=>(0,L.jsxs)(o_,{theme:r,children:[(0,L.jsxs)(s_,{children:[Qt?(0,L.jsx)(c_,{type:`checkbox`,checked:!!e.inUse,readOnly:!0,tabIndex:-1}):null,(0,L.jsx)(l_,{theme:r,children:e.name||`(Unnamed)`})]}),e.description?(0,L.jsx)(u_,{theme:r,children:e.description}):null,(()=>{let t=on(e.description||``);return t.length===0?null:(0,L.jsx)(d_,{children:t.map((t,n)=>(0,L.jsx)(f_,{type:`button`,theme:r,onClick:()=>{let n=Yt?.createdUserId?u.find(e=>e.id===Yt.createdUserId):null;Ye({notation:t,actionName:e.name||Xt?.attr_name||`List Roll`,tokenName:Yt?.name||`Unknown`,senderId:Yt?.createdUserId||d?.id||`unknown`,senderColor:n?.color||d?.color||`#ffffff`})},title:t,children:t},`${e.id}-inline-notation-${n}`))})})()]},e.id))})]})})]})},v_=`${t.EXTENSIONID}-partyhud`,y_=async()=>{await c.modal.open({id:v_,url:`/pages/forgeparty.html`,fullScreen:!0,hideBackdrop:!0,hidePaper:!0,disablePointerEvents:!0})},b_=async()=>{await c.modal.close(v_)};var x_=T.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
`,S_=T.div`
...
`,L_=T.p`
  color: ${e=>e.theme.PRIMARY};
  margin: 0;
`,R_=e=>{switch(e){case`bottom`:return`left`;case`left`:return`top`;case`top`:return`right`;case`right`:default:return`bottom`}},z_=e=>e===`bottom`||e===`left`||e===`top`||e===`right`;const B_=()=>{let t=(0,F.useRef)(!1),{theme:n}=Je(),{attributes:r}=vm(),i=I(e=>e.items),a=I(e=>e.sceneMetadata);I(e=>e.roomMetadata);let o=I(e=>e.playerData),s=a,l=String(o?.role||``).toUpperCase()===`GM`,u=o?.id,d=ne(O.PARTY_HUD_OPEN,u),f=ne(O.PARTY_HUD_ORIENTATION,u),m=(s[d]??s[O.PARTY_HUD_OPEN])===!0,h=s[f]??s[O.PARTY_HUD_ORIENTATION],g=z_(h)?h:`bottom`,_=s[O.PARTY_HUD_ATTR_ONE]||``,v=s[O.PARTY_HUD_ATTR_TWO]||``,y=s[O.PARTY_HUD_SHOW_HP_BARS]===!0,b=s[O.PARTY_HUD_SHOW_HP_NUMBERS]===!0&&!y,x=i.filter(e=>e.metadata[p.IN_PARTY]===!0),S=(0,F.useMemo)(()=>r.filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`text`||t===`numb`||t===`bool`}),[r]),C=async(e,t)=>{await c.scene.setMetadata({[e]:t})},w=async()=>{let e=!m;if(await C(d,e),!e){await b_(),t.current=!1;return}await y_(),t.current=!0},T=async()=>{await C(f,R_(g))},E=async(e,t)=>{let n=t.trim();await c.scene.items.updateItems([e],e=>{let t={...e[0].metadata||{}};n?t[p.PORTRAIT_URL]=n:delete t[p.PORTRAIT_URL],e[0].metadata=t})};return(0,L.jsx)(rd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,L.jsxs)(om,{theme:n,children:[(0,L.jsx)(sm,{theme:n,children:`Party`}),(0,L.jsxs)(S_,{theme:n,children:[(0,L.jsxs)(C_,{children:[(0,L.jsxs)(E_,{theme:n,onClick:()=>void T(),children:[`Display: `,g.toUpperCase()]}),(0,L.jsx)(E_,{theme:n,onClick:()=>void w(),children:m?`Close Party HUD`:`Open Party HUD`})]}),l&&(0,L.jsxs)(L.Fragment,{children:[(0,L.jsxs)(w_,{children:[(0,L.jsx)(T_,{theme:n,children:`Show in HUD:`}),(0,L.jsxs)(k_,{$disabled:!l,children:[(0,L.jsx)(A_,{theme:n,children:`Show HP Bars`}),(0,L.jsx)(X,{label:`Party HUD Show HP Bars`,isOn:y,onChange:e=>{l&&(C(O.PARTY_HUD_SHOW_HP_BARS,e),e&&C(O.PARTY_HUD_SHOW_HP_NUMBERS,!1))}})]}),(0,L.jsxs)(k_,{$disabled:!l,children:[(0,L.jsx)(A_,{theme:n,children:`Show HP Numbers`}),(0,L.jsx)(X,{label:`Party HUD Show HP Numbers`,isOn:b,onChange:e=>{l&&(C(O.PARTY_HUD_SHOW_HP_NUMBERS,e),e&&C(O.PARTY_HUD_SHOW_HP_BARS,!1))}})]}),(0,L.jsxs)(D_,{theme:n,disabled:!l,value:_,onChange:e=>{let t=e.target.value;C(O.PARTY_HUD_ATTR_ONE,t),t&&t===v&&C(O.PARTY_HUD_ATTR_TWO,``)},children:[(0,L.jsx)(`option`,{value:``,children:`Extra Slot 1 (None)`}),S.map(e=>(0,L.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]}),(0,L.jsxs)(D_,{theme:n,disabled:!l,value:v,onChange:e=>{let t=e.target.value;C(O.PARTY_HUD_ATTR_TWO,t),t&&t===_&&C(O.PARTY_HUD_ATTR_ONE,``)},children:[(0,L.jsx)(`option`,{value:``,children:`Extra Slot 2 (None)`}),S.map(e=>(0,L.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]})]}),(0,L.jsx)(O_,{theme:n,children:(0,L.jsxs)(L.Fragment,{children:[`Configure Party HUD and portraits.`,(0,L.jsx)(`br`,{}),`LIST attributes are excluded.`]})})]})]}),x.length===0?(0,L.jsx)(L_,{theme:n,children:`No one is in the Party.  Add a unit using the ContextMenu on the token.`}):(0,L.jsx)(x_,{theme:n,children:x.map(t=>{let r=t.metadata?.[p.PORTRAIT_URL]||``,i=e(t)?t.image.url:void 0,a=t.metadata[p.UNIT_NAME]||t.name||`Unknown`,s=t.createdUserId===o?.id,c=l||s,u=i||`/logo.png`,d=!!r;return(0,L.jsxs)(j_,{theme:n,children:[(0,L.jsxs)(M_,{children:[(0,L.jsx)(N_,{theme:n,src:u,alt:a,$full:!d}),d&&(0,L.jsx)(N_,{theme:n,src:d?r:``,alt:`${a} override`,$overlay:!0})]}),(0,L.jsxs)(P_,{children:[(0,L.jsx)(F_,{theme:n,title:a,children:a}),c&&(0,L.jsx)(I_,{theme:n,defaultValue:r,placeholder:`Portrait URL override (optional)`,onBlur:e=>{E(t.id,e.target.value)}})]})]},t.id)})})]})})};var V_=`${P}/hp-bar-effect`,H_=`${P}/hp-bar-owner`,U_=`${P}/hp-number-text`,W_=`${P}/hp-number-owner`,G_=e=>`HPB${e.slice(3)}`,K_=e=>`HPN${e.slice(3)}`,q_=(e,t,n)=>Math.max(t,Math.min(n,e)),J_=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},Y_=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||N.CURRENT_HP,maxHpBid:n?.attr_bid||N.MAX_HP}},X_=(e,t)=>{let n=Y_(t),r=e[O.HP_CURRENT_BID],i=e[O.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},Z_=(e,t,n)=>{let r=e.metadata?.[`${P}/${t}`],i=e.metadata?.[`${P}/${n}`],a=J_(r),o=J_(i);return o===null||o<=0||a===null?null:q_(a/o*100,0,100)},Q_=(e,t,n)=>{let r=e.metadata?.[`${P}/${t}`],i=e.metadata?.[`${P}/${n}`],a=J_(r),o=J_(i);return a===null?null:{currentHp:Math.trunc(a),maxHp:o===null?null:Math.trunc(o)}},$_=e=>{let t=String(e||`bottom`).toLowerCase();return t===`top`||t===`bottom`||t===`left`||t===`right`?t:`bottom`},ev=e=>{switch($_(e)){case`top`:return 0;case`bottom`:return 1;case`left`:return 2;case`right`:return 3;default:return 1}},tv=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o,width:r,height:i}},nv=(e,t,n)=>{let r=tv(e,t),i=r.minX+r.width*.5,a=r.minY+r.height*.5,o;switch(n){case`top`:o={x:i,y:r.minY+r.height*.18};break;case`bottom`:o={x:i,y:r.minY+r.height*.82};break;case`left`:o={x:r.minX+r.width*.18,y:a};break;case`right`:o={x:r.minX+r.width*.82,y:a};break}let s=r.width*.25,c=r.height*.18;return{x:o.x-s,y:o.y-c}};const rv=()=>{let t=I(e=>e.cacheReady),i=I(e=>e.sceneReady),a=I(e=>e.items),o=I(e=>e.localItems),s=I(e=>e.gridDpi),l=I(e=>e.roomMetadata),u=I(e=>e.sceneMetadata),d=I(e=>e.systemData);return(0,F.useEffect)(()=>{if(!t||!i)return;let l=!1;return(async()=>{let t=u,i=t[O.SHOW_HP_BARS]??!1,f=t[O.SHOW_HP_NUMBERS]??!1,m=i,h=!i&&f,g=$_(t[O.HP_BAR_ORIENTATION]),_=ev(t[O.HP_BAR_ORIENTATION]),{currentHpBid:v,maxHpBid:x}=X_(t,d?.attributes||[]),S=o.filter(e=>y(e)&&e.metadata?.[V_]===!0),C=o.filter(e=>b(e)&&e.metadata?.[U_]===!0);if(!m&&S.length>0)try{await c.scene.local.deleteItems(S.map(e=>e.id))}catch(e){M.error(`Failed to remove HP bar effects`,e)}if(!h&&C.length>0)try{await c.scene.local.deleteItems(C.map(e=>e.id))}catch(e){M.error(`Failed to remove HP number texts`,e)}if(!m&&!h)return;let w=a.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),T=new Map,E=new Map;for(let t of w){if(m){let e=Z_(t,v,x);e!==null&&T.set(G_(t.id),{unitId:t.id,hpPercent:e})}if(h&&e(t)){let e=Q_(t,v,x);if(e){let n=e.maxHp===null?`${e.currentHp}`:`${e.currentHp}/${e.maxHp}`;E.set(K_(t.id),{unitId:t.id,text:n,position:nv(t,s,g)})}}}if(m){let e=new Map(S.map(e=>[e.id,e])),t=Array.from(T.entries()).filter(([t])=>!e.has(t)),n=S.filter(e=>!T.has(e.id)),i=S.filter(e=>{let t=T.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`orientation`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return e.attachedTo!==t.unitId||!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-_)>.001});if(l)return;if(n.length>0)try{await c.scene.local.deleteItems(n.map(e=>e.id))}catch(e){M.error(`Failed to remove stale HP bar effects`,e)}if(t.length>0){let e=t.map(([e,t])=>r().id(e).name(`HP Bar Effect`).effectType(`ATTACHMENT`).attachedTo(t.unitId).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).uniforms([{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}]).sksl(`
uniform vec2 size;
uniform float time;
...
`).metadata({[V_]:!0,[H_]:t.unitId}).build());try{await c.scene.local.addItems(e)}catch(e){M.error(`Failed to add HP bar effects`,e)}}if(i.length>0){let e=i.map(e=>e.id);try{await c.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=T.get(e.id);if(!t)return;e.attachedTo=t.unitId;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}],e.metadata={...e.metadata,[V_]:!0,[H_]:t.unitId}})})}catch(e){M.error(`Failed to update HP bar effects`,e)}}}if(h){let e=new Map(C.map(e=>[e.id,e])),t=Array.from(E.entries()).filter(([t])=>!e.has(t)),r=C.filter(e=>!E.has(e.id)),i=C.filter(e=>{let t=E.get(e.id);if(!t)return!1;let n=e.text?.plainText,r=Math.abs(e.position.x-t.position.x)>.01||Math.abs(e.position.y-t.position.y)>.01;return e.attachedTo!==t.unitId||n!==t.text||r});if(l)return;if(r.length>0)try{await c.scene.local.deleteItems(r.map(e=>e.id))}catch(e){M.error(`Failed to remove stale HP number texts`,e)}if(t.length>0){let e=t.map(([e,t])=>{let r=w.find(e=>e.id===t.unitId);return n().id(e).name(`HP Number Text`).plainText(t.text).textType(`PLAIN`).fontWeight(900).fillOpacity(.95).fillColor(`white`).strokeWidth(8).strokeColor(`black`).strokeOpacity(1).fontSize(28).fontFamily(`Segoe UI`).textAlign(`CENTER`).position(t.position).metadata({[U_]:!0,[W_]:t.unitId}).attachedTo(t.unitId).visible(r?.visible??!0).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).layer(`TEXT`).build()});try{await c.scene.local.addItems(e)}catch(e){M.error(`Failed to add HP number texts`,e)}}if(i.length>0){let e=i.map(e=>e.id);try{await c.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=E.get(e.id);if(!t)return;e.attachedTo=t.unitId,e.position=t.position;let n=e;n.text&&(n.text.plainText=t.text),e.metadata={...e.metadata,[U_]:!0,[W_]:t.unitId}})})}catch(e){M.error(`Failed to update HP number texts`,e)}}}})(),()=>{l=!0}},[t,i,a,o,s,l,u,d]),null};var iv=`${P}/death-effect-token`,av=`${P}/death-effect-owner`,ov=e=>`DTH${e.slice(3)}`,sv=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},cv=e=>({currentHpBid:e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`})?.attr_bid||N.CURRENT_HP}),lv=(e,t)=>{let n=cv(t),r=e[O.HP_CURRENT_BID],i=new Set(t.map(e=>e.attr_bid));return r&&i.has(r)?r:n.currentHpBid},uv=(e,t)=>{let n=e.metadata?.[`${P}/${t}`];return sv(n)};const dv=()=>{let t=I(e=>e.cacheReady),n=I(e=>e.sceneReady),i=I(e=>e.items),a=I(e=>e.localItems),o=I(e=>e.roomMetadata),s=I(e=>e.sceneMetadata),l=I(e=>e.systemData);return(0,F.useEffect)(()=>{if(!t||!n)return;let o=!1;return(async()=>{let t=s,n=t[O.SHOW_DEATH_EFFECT]??!1,u=lv(t,l?.attributes||[]),d=a.filter(e=>y(e)&&e.metadata?.[iv]===!0);if(!n){if(d.length>0)try{await c.scene.local.deleteItems(d.map(e=>e.id))}catch(e){M.error(`Failed to remove death token effects`,e)}return}let f=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),m=new Map;f.forEach(e=>{uv(e,u)===0&&m.set(ov(e.id),e.id)});let h=new Map(d.map(e=>[e.id,e])),g=Array.from(m.entries()).filter(([e])=>!h.has(e)),_=d.filter(e=>!m.has(e.id)),v=d.filter(e=>{let t=m.get(e.id);if(!t)return!1;let n=e;return e.attachedTo!==t||n.metadata?.[av]!==t});if(!o){if(_.length>0)try{await c.scene.local.deleteItems(_.map(e=>e.id))}catch(e){M.error(`Failed to remove stale death token effects`,e)}if(g.length>0){let e=g.map(([e,t])=>r().id(e).name(`Death Token Effect`).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(`
uniform float2 size;
uniform float time;
...
`).metadata({[iv]:!0,[av]:t}).build());try{await c.scene.local.addItems(e)}catch(e){M.error(`Failed to add death token effects`,e)}}if(v.length>0)try{await c.scene.local.updateItems(v.map(e=>e.id),e=>{e.forEach(e=>{let t=m.get(e.id);t&&(e.attachedTo=t,e.metadata={...e.metadata,[iv]:!0,[av]:t})})})}catch(e){M.error(`Failed to update death token effects`,e)}}})(),()=>{o=!0}},[t,n,i,a,o,s,l]),null};var fv=`${P}/buff-effect-token`,pv=`${P}/buff-effect-owner`,mv=`${P}/debuff-effect-token`,hv=`${P}/debuff-effect-owner`,gv=`${P}/effect-preset`,_v=e=>`EFB${e.slice(3)}`,vv=e=>`EFD${e.slice(3)}`,yv=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const bv=()=>{let t=I(e=>e.cacheReady),n=I(e=>e.sceneReady),i=I(e=>e.items),a=I(e=>e.localItems),o=I(e=>e.roomMetadata),s=I(e=>e.sceneMetadata);return(0,F.useEffect)(()=>{if(!t||!n)return;let o=!1;return(async()=>{let t=s,n=t[O.BUFF_VISUAL_PRESET],l=t[O.DEBUFF_VISUAL_PRESET],u=Bm(n)?n:Im,d=Vm(l)?l:Lm,f=Hm(u),m=Um(d),h=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),g=new Set(h.map(e=>e.id)),_=new Map,v=(e,t)=>{let n=_.get(e)||{hasBuff:!1,hasDebuff:!1};t===`buff`?n.hasBuff=!0:n.hasDebuff=!0,_.set(e,n)};i.forEach(e=>{if(e.metadata?.[p.ON_LIST]!==!0)return;let t=yv(e.metadata?.[Ch]);t.length!==0&&t.forEach(t=>{t.effectType!==`neutral`&&(t.targets.length>0?t.targets:[e.id]).forEach(e=>{g.has(e)&&(t.effectType===`buff`||t.effectType===`debuff`)&&v(e,t.effectType)})})});let b=new Map,x=new Map;h.forEach(e=>{let t=_.get(e.id);t?.hasBuff&&b.set(_v(e.id),e.id),t?.hasDebuff&&x.set(vv(e.id),e.id)});let S=a.filter(e=>y(e)&&e.metadata?.[fv]===!0),C=a.filter(e=>y(e)&&e.metadata?.[mv]===!0),w=async e=>{let{existing:t,desiredByOverlayId:n,preset:i,shader:a,name:s,flagKey:l,ownerKey:u}=e,d=new Map(t.map(e=>[e.id,e])),f=Array.from(n.entries()).filter(([e])=>!d.has(e)),p=t.filter(e=>!n.has(e.id)),m=t.filter(e=>{let t=n.get(e.id);if(!t)return!1;let r=e.metadata?.[gv];return e.attachedTo!==t||r!==i});if(!o){if(p.length>0)try{await c.scene.local.deleteItems(p.map(e=>e.id))}catch(e){M.error(`Failed to remove stale ${s.toLowerCase()} overlays`,e)}if(f.length>0){let e=f.map(([e,t])=>r().id(e).name(s).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(a).metadata({[l]:!0,[u]:t,[gv]:i}).build());try{await c.scene.local.addItems(e)}catch(e){M.error(`Failed to add ${s.toLowerCase()} overlays`,e)}}if(m.length>0)try{await c.scene.local.updateItems(m.map(e=>e.id),e=>{e.forEach(e=>{let t=n.get(e.id);if(!t)return;e.attachedTo=t;let r=e;r.sksl=a,e.metadata={...e.metadata,[l]:!0,[u]:t,[gv]:i}})})}catch(e){M.error(`Failed to update ${s.toLowerCase()} overlays`,e)}}};await w({existing:S,desiredByOverlayId:b,preset:u,shader:f,name:`Buff Token Effect`,flagKey:fv,ownerKey:pv}),await w({existing:C,desiredByOverlayId:x,preset:d,shader:m,name:`Debuff Token Effect`,flagKey:mv,ownerKey:hv})})(),()=>{o=!0}},[t,n,i,a,o,s]),null};var xv=`${P}/boss-hp-effect`,Sv=`${P}/boss-hp-owner`,Cv=`${P}/boss-hp-slot`,wv=e=>`BOSSHP${e}`,Tv=(e,t,n)=>Math.max(t,Math.min(n,e)),Ev=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},Dv=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||N.CURRENT_HP,maxHpBid:n?.attr_bid||N.MAX_HP}},Ov=(e,t)=>{let n=Dv(t),r=e[O.HP_CURRENT_BID],i=e[O.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},kv=(e,t,n)=>{let r=e.metadata?.[`${P}/${t}`],i=e.metadata?.[`${P}/${n}`],a=Ev(r),o=Ev(i);return o===null||o<=0||a===null?null:Tv(a/o*100,0,100)};const Av=()=>{let t=I(e=>e.cacheReady),n=I(e=>e.sceneReady),i=I(e=>e.items),a=I(e=>e.localItems),o=I(e=>e.roomMetadata),s=I(e=>e.sceneMetadata),l=I(e=>e.systemData);return(0,F.useEffect)(()=>{if(!t||!n)return;let o=!1;return(async()=>{let{currentHpBid:t,maxHpBid:n}=Ov(s,l?.attributes||[]),u=a.filter(e=>y(e)&&e.metadata?.[xv]===!0),d=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0&&t.metadata?.[p.BOSS_MODE]===!0).sort((e,t)=>{let n=Number(e.metadata?.[p.INITIATIVE]??0);return Number(t.metadata?.[p.INITIATIVE]??0)-n}).slice(0,2).map((e,r)=>{let i=kv(e,t,n);return i===null?null:{id:wv(r),unitId:e.id,slot:r,hpPercent:i}}).filter(e=>e!==null),f=new Map(d.map(e=>[e.id,e])),m=new Map(u.map(e=>[e.id,e])),h=u.filter(e=>!f.has(e.id)),g=d.filter(e=>!m.has(e.id)),_=u.filter(e=>{let t=f.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`slot`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-t.slot)>.001||e.metadata?.[Sv]!==t.unitId});if(!o){if(h.length>0)try{await c.scene.local.deleteItems(h.map(e=>e.id))}catch(e){M.error(`Failed to remove stale boss HP viewport effects`,e)}if(g.length>0){let e=g.map(e=>r().id(e.id).name(`Boss HP Bar`).effectType(`VIEWPORT`).locked(!0).disableHit(!0).uniforms([{name:`hpPercent`,value:e.hpPercent},{name:`slot`,value:e.slot}]).sksl(`
uniform float2 size;
...
`).metadata({[xv]:!0,[Sv]:e.unitId,[Cv]:e.slot}).build());try{await c.scene.local.addItems(e)}catch(e){M.error(`Failed to add boss HP viewport effects`,e)}}if(_.length>0)try{await c.scene.local.updateItems(_.map(e=>e.id),e=>{e.forEach(e=>{let t=f.get(e.id);if(!t)return;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`slot`,value:t.slot}],e.metadata={...e.metadata,[xv]:!0,[Sv]:t.unitId,[Cv]:t.slot}})})}catch(e){M.error(`Failed to update boss HP viewport effects`,e)}}})(),()=>{o=!0}},[t,n,i,a,o,s,l]),null};var jv=`${P}/current-turn-effect`;const Mv=()=>{let e=I(e=>e.cacheReady),t=I(e=>e.sceneReady),n=I(e=>e.items),i=I(e=>e.roomMetadata),a=I(e=>e.sceneMetadata);return(0,F.useEffect)(()=>{if(!e||!t)return;let i=!1;return(async()=>{let e=a[O.SHOW_TURN_EFFECT]===!0,t=a[O.CURRENT_TURN];if(!e||!t){try{await c.scene.local.deleteItems([jv])}catch{}return}if(!n.find(e=>e.id===t)){try{await c.scene.local.deleteItems([jv])}catch{}return}if(!i){try{let e=!1;if(await c.scene.local.updateItems([jv],n=>{let r=n[0];r&&(r.attachedTo=t,e=!0)}),e)return}catch{}if(!i)try{let e=r().id(jv).name(`Current Turn Effect`).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).sksl(`
uniform vec2 size;
uniform float time;
...
`).build();await c.scene.local.addItems([e])}catch(e){M.error(`Failed to sync current turn effect`,e)}}})(),()=>{i=!0}},[e,t,n,i,a]),null},Nv=()=>{let[e,t]=(0,F.useState)(!1),{updateThemeFromSystem:n}=Je(),r=I(e=>e.roomMetadata),i=I(e=>e.cacheReady),a=I(e=>e.systemData),o=I(e=>e.setSystemData),s=()=>({theme:{primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url},cardLayout:E.card_layout,listLayout:E.list_layout,attributes:E.attributes,systemName:E.name,importDate:null,snapshotPublicId:null});return(0,F.useEffect)(()=>{!i&&e&&(t(!1),o(null))},[i,e,o]),(0,F.useEffect)(()=>{!i||!a||n(a.theme.primary,a.theme.offset,a.theme.background,a.theme.border,a.theme.background_url)},[i,a,n]),(0,F.useEffect)(()=>{if(e)return;let n=!0,a=async()=>{if(i)try{M.log(`Starting app initialization...`),await c(),n&&(t(!0),M.log(`App initialization complete`))}catch(e){M.error(`Error during app initialization:`,e),n&&t(!0)}},c=async()=>{let e=(e,t)=>{if(Array.isArray(e))return e;if(typeof e==`string`){let n;try{n=JSON.parse(e)}catch{throw Error(`Snapshot ${t} is not valid JSON`)}if(!Array.isArray(n))throw Error(`Snapshot ${t} is not a JSON array`);return n}throw Error(`Snapshot ${t} has invalid type`)},t=async t=>{let{data:n,error:r}=await C.rpc(`bs_forge_get_snapshot_for_room`,{p_snapshot_public_id:t});if(r)return M.error(`Failed to load room snapshot:`,r),!1;let i=Array.isArray(n)?n[0]:n;if(!i||typeof i.snapshot_public_id!=`string`)return M.warn(`Room snapshot reference was set, but no snapshot record was returned`),!1;let a=e(i.card_layout,`card_layout`),s=e(i.list_layout,`list_layout`),c=e(i.attributes,`attributes`);return o({theme:{primary:i.theme_primary,offset:i.theme_offset,background:i.theme_background,border:i.theme_border,background_url:i.background_url},cardLayout:a,listLayout:s,attributes:c,systemName:i.system_name,importDate:i.imported_at,snapshotPublicId:i.snapshot_public_id}),M.log(`System data hydrated from room snapshot`,{snapshotPublicId:i.snapshot_public_id,systemName:i.system_name}),!0};try{let e=r[Km.SNAPSHOT_PUBLIC_ID];if(typeof e==`string`&&e.trim().length>0&&await t(e))return;M.log(`Room snapshot reference missing or unavailable, initializing defaults`),await l()}catch(e){M.error(`Error loading system data:`,e),await l()}},l=async()=>{o(s()),M.log(`Default system initialized`)};return a(),()=>{n=!1}},[i,e,r,o,n]),(0,F.useEffect)(()=>{if(!i||!e)return;let t=e=>{if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);return Array.isArray(t)?t:null}catch{return null}return null},n=r[Km.SNAPSHOT_PUBLIC_ID],c=typeof n==`string`&&n.trim().length>0?n.trim():null;if(c===(a?.snapshotPublicId??null))return;let l=!1;return(async()=>{if(!c){l||(o(s()),M.log(`Room snapshot reference cleared, reverted runtime system to defaults`));return}let{data:e,error:n}=await C.rpc(`bs_forge_get_snapshot_for_room`,{p_snapshot_public_id:c});if(n){M.error(`Failed to refresh system from room snapshot change:`,n);return}let r=Array.isArray(e)?e[0]:e;if(!r||typeof r.snapshot_public_id!=`string`){M.warn(`Room snapshot reference changed, but snapshot record was not found`);return}let i=t(r.card_layout),a=t(r.list_layout),u=t(r.attributes);if(!i||!a||!u){M.warn(`Room snapshot refresh returned invalid payload arrays`);return}l||(o({theme:{primary:r.theme_primary,offset:r.theme_offset,background:r.theme_background,border:r.theme_border,background_url:r.background_url},cardLayout:i,listLayout:a,attributes:u,systemName:r.system_name,importDate:r.imported_at,snapshotPublicId:r.snapshot_public_id}),M.log(`Runtime system refreshed from room snapshot change`,{snapshotPublicId:r.snapshot_public_id,systemName:r.system_name}))})(),()=>{l=!0}},[i,e,r,a,o]),{isInitialized:e}};var Pv=m`
...
`;function Rv(){let{sceneReady:e,cacheReady:t,playerData:n,roomMetadata:r,sceneMetadata:i}=I(),{isInitialized:a}=Nv(),{theme:o}=Je(),[s,l]=(0,F.useState)(`ForgeMain`),[u,d]=(0,F.useState)(!1),f=(0,F.useRef)(!1),p=String(n?.role||``).toUpperCase()===`GM`,m=i,h=n?.id,g=(m[ne(O.PARTY_HUD_OPEN,h)]??m[O.PARTY_HUD_OPEN])===!0,_=m[O.SHOW_PLAYER_VIEW]||!1,v=p||_,y=e&&t&&a;return(0,F.useEffect)(()=>{y&&Ee()},[y]),(0,F.useEffect)(()=>{if(!y)return;let e=!0;return(async()=>{if(g&&!f.current){await y_(),e&&(f.current=!0);return}!g&&f.current&&(await b_(),e&&(f.current=!1))})(),()=>{e=!1}},[y,g]),(0,F.useEffect)(()=>{y&&!v&&s===`ForgeMain`&&l(`Party`)},[y,v,s]),(0,F.useEffect)(()=>{s!==`ForgeMain`&&c.action.setWidth(350)},[s]),(0,L.jsxs)(L.Fragment,{children:[(0,L.jsx)(Pv,{theme:o}),!e||!t||!a?(0,L.jsxs)(Fv,{children:[(0,L.jsx)(Iv,{}),(0,L.jsx)(Lv,{children:e?t?a?`Loading...`:`Initializing system...`:`Loading cache...`:`Connecting to scene...`})]}):(0,L.jsxs)(qp,{children:[(0,L.jsx)(rv,{}),(0,L.jsx)(dv,{}),(0,L.jsx)(bv,{}),(0,L.jsx)(Av,{}),(0,L.jsx)(Mv,{}),(0,L.jsx)(Jp,{theme:o,$backgroundUrl:o.BACKGROUND_URL,children:(0,L.jsx)(fl,{mode:`wait`,children:(()=>{switch(s){case`ForgeMain`:return v?(0,L.jsx)(__,{},`main`):(0,L.jsx)(B_,{},`party`);case`Settings`:return p?(0,L.jsx)(km,{},`settings`):(0,L.jsx)(__,{},`main`);case`Party`:return(0,L.jsx)(B_,{},`party`);case`System`:return p?(0,L.jsx)(bh,{},`system`):(0,L.jsx)(__,{},`main`);case`ChatLog`:return(0,L.jsx)(Fm,{},`chatlog`)}})()})}),(0,L.jsx)(am,{isOpen:u,currentPage:s,onToggle:()=>d(!u),onNavigate:e=>{if(!v&&e===`ForgeMain`){l(`Party`),d(!1);return}if(!p&&(e===`Settings`||e===`System`)){l(`ForgeMain`),d(!1);return}l(e),d(!1)},canAccessInitiativeList:v})]})]})}var zv=Rv,Bv=class{static{this.ALPHANUMERICTEXTMATCH=/\s[\da-zA-Z]$/}};function Vv(e){for(let t of Uv)if(e.includes(t)){let n=Uv[Math.floor(Math.random()*Uv.length)];return e.replace(t,n)}return Hv(e)}function Hv(e){return`${Uv[Math.floor(Math.random()*Uv.length)]} ${e}`}const Uv=`Grizzled.Wily.Stoic.Mellow.Pensive.Shrewd.Cautious.Hardy.Nimble.Tenacious.Gritty.Tolerant.Hardy.Adroit.Resilient.Slight.Stout.Durable.Subtle.Sober.Clever.Brave.Calm.Wise.Cunning.Alert.Swift.Agile.Loyal.Sturdy.Stable.Sneaky.Clever.Resourceful.Shady.Stalwart.Vigilant.Staunch.Fierce.Vigorous.Robust.Fearless.Dauntless.Resolute.Sagacious.Prudent.Judicious.Astute.Savvy.Sharp.Quick.Witty.Smart.Snippy.Crafty.Deft.Sly.Artful.Clever.Sneering.Tough.Rugged.Solid.Strong.Sturdy.Tough.Gritty.Rough.Hardened.Burly.Muscular.Brawny.Rowdy.Forceful.Snorting.Potent.Martial.Speckled.Mottled.Disheveled`.split(`.`);var Wv=`com.battle-system.forge/view-unit`,Gv=`com.battle-system.forge/view-unit-player`,Kv=e=>e.trim().toLowerCase(),qv=e=>{if(typeof e!=`string`)return null;let t=e.trim();return t.length>0?t:null},Jv=e=>{let t=e.trim();return t?Bv.ALPHANUMERICTEXTMATCH.test(t)?t.slice(0,-2):t:e},Yv=e=>{let t=typeof e.text?.plainText==`string`?e.text.plainText.trim():``;if(t.length>0)return t;let n=e.metadata?.[p.UNIT_NAME],r=typeof n==`string`?n.trim():``;if(r.length>0)return r;let i=typeof e.name==`string`?e.name.trim():``;return i.length>0?i:typeof e.name==`string`?e.name:``},Xv=async e=>{let n=await c.viewport.getHeight(),r=n>800?700:n-100;await c.popover.open({id:t.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(e)}`,height:r,width:350,anchorReference:`POSITION`,anchorPosition:{left:await c.viewport.getWidth()/2,top:await c.viewport.getHeight()/2},anchorOrigin:{horizontal:`CENTER`,vertical:`CENTER`},transformOrigin:{horizontal:`CENTER`,vertical:`CENTER`},hidePaper:!0,disableClickAway:!0})},Zv=async e=>{let t=Array.from(new Set(e.map(e=>e.trim()).filter(e=>e.length>0))),n=new Map;if(t.length===0)return n;let r=await je(),i=new Map;for(let e of r){let t=Kv(e.name);if(!t)continue;let n=i.get(t);n?n.push(e):i.set(t,[e])}for(let e of t){let t=Kv(e),r=i.get(t)?.[0];!r||!r.metadata||n.set(t,ae(r.metadata))}try{let e=await j(t);for(let t of e){let e=Kv(t.name);!e||n.has(e)||!t.metadata||n.set(e,ae(t.metadata))}let r=await De(t);for(let e of r){let t=Kv(e.name);!t||n.has(t)||!e.metadata||n.set(t,ae(e.metadata))}}catch(e){M.log(`Remote collection lookup failed, using local collection only`,e)}return n};function Qv({children:e}){I(e=>e.roomMetadata);let t=I(e=>e.sceneMetadata),n=I(e=>e.items),r=I(e=>e.playerData),i=I(e=>e.systemData),a=t,o=i?.attributes??[],s=new Set(o.map(e=>e.attr_bid)),l=o.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`})?.attr_bid,u=o.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`})?.attr_bid,d=qv(a[O.HP_CURRENT_BID]),f=qv(a[O.HP_MAX_BID]),m=d&&(s.size===0||s.has(d))?d:l||(s.size===0?N.CURRENT_HP:``),h=f&&(s.size===0||s.has(f))?f:u||(s.size===0?N.MAX_HP:``),g=!!(m&&h),_=a[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?!0:a[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===!0,v=a[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===void 0?!0:a[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===!0;return(0,F.useEffect)(()=>{c.onReady(()=>{c.contextMenu.create({id:p.ON_LIST,icons:[{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}}],async onClick(e){if(M.info(`Add to Combat Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[p.ON_LIST]===!0))await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[p.ON_LIST],delete t.metadata[p.INITIATIVE]});else{let r=[],i=[],o=new Set(e.items.map(e=>e.id)),s=a[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0,l=new Set(n.filter(e=>{if(o.has(e.id))return!1;let t=e.metadata[p.UNIT_NAME];return typeof t==`string`&&t.trim().length>0}).map(e=>Kv(String(e.metadata[p.UNIT_NAME]))));for(let t of e.items){if(t.metadata[p.FABRICATED]===!0)continue;let e=Jv(t.text?.plainText||t.name);r.push(e)}await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let u=await Zv(r);await c.action.setBadgeText(void 0);for(let t of e.items){let e={},n=t,r=Yv(n);if(t.metadata[p.FABRICATED]!==!0){let i=Jv(n.text?.plainText||t.name),a=u.get(Kv(i));if(a&&Object.assign(e,a),(typeof e[p.UNIT_NAME]!=`string`||!String(e[p.UNIT_NAME]).trim())&&(e[p.UNIT_NAME]=r),e[p.FABRICATED]=!0,s){let n=String(e[p.UNIT_NAME]||i||t.name).trim(),r=Kv(n);if(r){let e=0;for(;l.has(r)&&e<20;)n=Vv(n),r=Kv(n),e+=1;r&&l.add(r)}e[p.UNIT_NAME]=n}}(typeof e[p.UNIT_NAME]!=`string`||!String(e[p.UNIT_NAME]).trim())&&(e[p.UNIT_NAME]=r),e[p.ON_LIST]=!0,e[p.INITIATIVE]=0,i.push({id:t.id,metadata:e})}await c.scene.items.updateItems(e.items,e=>{for(let n of e){let e=i.find(e=>e.id===n.id);if(e&&(Object.assign(n.metadata,e.metadata),t[O.SHOW_NAMES]===!0)){let t=n,r=typeof e.metadata[p.UNIT_NAME]==`string`&&String(e.metadata[p.UNIT_NAME]).trim().length>0?String(e.metadata[p.UNIT_NAME]).trim():Yv(t);t.text&&(t.text.plainText=r)}}})}}}),c.contextMenu.create({id:p.IN_PARTY,icons:[{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`!=`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`!=`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`==`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`==`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){M.info(`Add to Party Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[p.IN_PARTY]===!0)?await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[p.IN_PARTY]}):await c.scene.items.updateItems(e.items,e=>{for(let t of e)t.metadata[p.IN_PARTY]=!0})}}),c.contextMenu.create({id:Wv,icons:[{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}}],async onClick(e){M.info(`View Unit Clicked: ${e.items[0].name}`);let r=e.items[0];if(!r)return;let i={};if(r.metadata[p.FABRICATED]!==!0){let e=r,o=Yv(e),s=Jv(e.text?.plainText||r.name);await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let l=await Zv([s]);await c.action.setBadgeText(void 0);let u=l.get(Kv(s));u&&Object.assign(i,u),(typeof i[p.UNIT_NAME]!=`string`||!String(i[p.UNIT_NAME]).trim())&&(i[p.UNIT_NAME]=o),i[p.FABRICATED]=!0,a[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[p.UNIT_NAME]!=null&&e.id!==r.id).map(e=>e.metadata[p.UNIT_NAME]).includes(s)&&(i[p.UNIT_NAME]=Vv(s)),await c.scene.items.updateItems([r],e=>{let n=e[0];if(Object.assign(n.metadata,i),t[O.SHOW_NAMES]===!0){let e=n,t=typeof i[p.UNIT_NAME]==`string`&&String(i[p.UNIT_NAME]).trim().length>0?String(i[p.UNIT_NAME]).trim():Yv(e);e.text&&(e.text.plainText=t)}})}await Xv(r.id)}}),v?c.contextMenu.create({id:Gv,icons:[{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){M.info(`View Unit Clicked: ${e.items[0].name}`);let r=e.items[0];if(!r)return;let i={};if(r.metadata[p.FABRICATED]!==!0){let e=r,o=Yv(e),s=Jv(e.text?.plainText||r.name);await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let l=await Zv([s]);await c.action.setBadgeText(void 0);let u=l.get(Kv(s));u&&Object.assign(i,u),(typeof i[p.UNIT_NAME]!=`string`||!String(i[p.UNIT_NAME]).trim())&&(i[p.UNIT_NAME]=o),i[p.FABRICATED]=!0,a[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[p.UNIT_NAME]!=null&&e.id!==r.id).map(e=>e.metadata[p.UNIT_NAME]).includes(s)&&(i[p.UNIT_NAME]=Vv(s)),await c.scene.items.updateItems([r],e=>{let n=e[0];if(Object.assign(n.metadata,i),t[O.SHOW_NAMES]===!0){let e=n,t=typeof i[p.UNIT_NAME]==`string`&&String(i[p.UNIT_NAME]).trim().length>0?String(i[p.UNIT_NAME]).trim():Yv(e);e.text&&(e.text.plainText=t)}})}await Xv(r.id)}}):c.contextMenu.remove(Gv).catch(()=>{}),g&&_?c.contextMenu.create({id:p.MODIFY_UNIT,icons:[{icon:`/icon.svg`,label:`Adjust HP`,filter:{some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Adjust HP`,filter:{every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e,t){M.info(`Adjust HP Clicked: ${e.items[0].name}`),await c.popover.open({id:D.CONTEXT_MENU,url:`/pages/forgecontext.html`,height:50,width:180,anchorElementId:t,hidePaper:!0})},embed:{url:`/pages/forgecontext.html?contextmenu=true`,height:70}}):c.contextMenu.remove(p.MODIFY_UNIT).catch(()=>{})})},[a,g,_,v]),(0,L.jsx)(L.Fragment,{children:e})}ze.createRoot(document.getElementById(`root`)).render((0,L.jsx)(F.StrictMode,{children:(0,L.jsx)(te,{children:(0,L.jsx)(Ge,{children:(0,L.jsx)(Qv,{children:(0,L.jsx)(qe,{children:(0,L.jsx)(zv,{})})})})})}));