...
export const getSettingsTooltips = (t: Translate) => ({
  ...
  enableRollResolution: t('settings.tooltips.enableRollResolution'),
  rollResolutionAllUsers: t('settings.tooltips.rollResolutionAllUsers'),
  rollResolutionAttribute: t('settings.tooltips.rollResolutionAttribute'),
