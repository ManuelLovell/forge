import{c as e}from"./tslib.es6-B50zIwoW.js";import{f as t,m as n,p as r,t as i}from"./styled-components.browser.esm-DHy5LH3R.js";import{t as a}from"./Constants-BX77kWGP.js";import{n as o}from"./MetadataKeys-B7ws-e14.js";import{t as s}from"./Logger-DX4jZ06e.js";import{t as c}from"./x-DmwLwxdQ.js";import{t as l}from"./upload-DiyBufU7.js";import{t as u}from"./Translation-BC3yKQtd.js";import{i as d}from"./hpAttributeMapping-DnIk3SMP.js";import{a as ee,c as f,i as te,l as p,n as ne,r as re,t as m}from"./systemKeys-CDLHS-Ai.js";import{a as ie}from"./supabaseClient-7JhD0IQw.js";import{d as ae,f as oe,i as se,m as ce,p as le,r as ue}from"./authHelpers-DZr5j1-Z.js";import"./forgeMetrics-DDxkywL3.js";import{f as h,l as de,o as fe,u as pe}from"./main-Dat9FaFT.js";import{i as g}from"./defaultgamesystem-BSWK_XU6.js";import{a as me,i as he,n as ge,r as _e,t as _}from"./SharedStyledComponents-BQWgKgM2.js";var v=n(),y=r(),ve=`com.battle-system.forge`,ye=(e,t)=>{if(e===`buff`||e===`debuff`||e===`neutral`)return e;let n=t.toLowerCase();return/\b(buff|bless|haste|shield|inspiration|rage|fortif|quicken|resist)\b/.test(n)?`buff`:/\b(debuff|poison\w*|restrain|blind|charm|fright|paraly|stun|slow|exhaust|burn|bleed|daze|curse)\b/.test(n)?`debuff`:`neutral`},be=e=>{let t=Number(e);return!Number.isFinite(t)||t<=0?1:Math.max(1,Math.trunc(t))},xe=e=>e===`turns`?`turns`:`rounds`,Se=e=>e===`end`?`end`:`start`,Ce=e=>Array.isArray(e)?e.filter(e=>!!e&&typeof e==`object`).map((e,t)=>{let n=typeof e.name==`string`?e.name.trim().slice(0,80):``;return n?{id:typeof e.id==`string`&&e.id.trim()?e.id:`default-preset-${t+1}`,name:n,type:ye(e.type,n),duration:be(e.duration),durationType:xe(e.durationType),endTiming:Se(e.endTiming)}:null}).filter(e=>!!e).slice(0,30):[],we=d(g.attributes),Te=(e,t)=>e instanceof Error&&e.message?e.message:t,Ee=i.div`
  display: flex;
  gap: 10px;
  margin-bottom: 20px;
`,De=i.div`
