import{r as e}from"./Constants-BX77kWGP.js";const t=`buff_effect_one`,n=`debuff_effect_one`,r=[{value:`buff_effect_one`,label:`Buff Effect One`},{value:`buff_effect_two`,label:`Buff Effect Two`}],i=[{value:`debuff_effect_one`,label:`Debuff Effect One`},{value:`debuff_effect_two`,label:`Debuff Effect Two`}],a=e=>r.some(t=>t.value===e),o=e=>i.some(t=>t.value===e),s=e=>{switch(e){case`buff_effect_two`:return`
uniform float2 size;
uniform float time;
...
`}},c=e=>{switch(e){case`debuff_effect_two`:return`
uniform float2 size;
uniform float time;
...
`}};var l=e.EXTENSIONID;const u={SYSTEM_NAME:`${l}/SystemName`,IMPORT_DATE:`${l}/ImportDate`,SNAPSHOT_PUBLIC_ID:`${l}/SnapshotPublicId`};export{n as a,a as c,t as i,o as l,r as n,s as o,i as r,c as s,u as t};