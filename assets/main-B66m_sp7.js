...
`,tm=Kp.div({position:`fixed`,bottom:`0`,left:`0`,right:`0`,top:`0`,zIndex:`999`,backgroundColor:`rgba(0, 0, 0, 0.6)`}),nm=Kp.div({position:`fixed`,bottom:`2px`,left:`2px`,zIndex:`1000`,display:`flex`,height:`3rem`,width:`3rem`,alignItems:`center`,justifyContent:`center`,borderRadius:`9999px`,"--tw-backdrop-blur":`blur(8px)`,WebkitBackdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`,backdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`}),rm=T.button`
  ...
  border: 2px solid ${e=>e.theme.BORDER};
  color: ${e=>e.theme.PRIMARY};
`,im=({isOpen:e,currentPage:t,onToggle:n,onNavigate:r,canAccessInitiativeList:i=!0})=>{let{theme:a}=Ft(),o=L(e=>e.playerData),s=String(o?.role||``).toUpperCase()===`GM`;return(0,R.jsxs)(R.Fragment,{children:[(0,R.jsx)(eu,{children:e&&(0,R.jsxs)(Yp,{theme:a,initial:{x:-300},animate:{x:0},exit:{x:-300},transition:{type:`tween`,duration:.3},style:{boxShadow:`4px 0 12px rgba(0, 0, 0, 0.15)`},children:[(0,R.jsx)(Xp,{theme:a,children:(0,R.jsx)(Qp,{theme:a,children:`Forge!`})}),(0,R.jsxs)(Zp,{theme:a,children:[`Good Luck!`,(0,R.jsx)(`br`,{}),(0,R.jsx)(`br`,{}),`Questions?`,(0,R.jsxs)(`a`,{href:`https://discord.gg/Kh9hbHAZnX`,target:`_blank`,rel:`noreferrer`,children:[(0,R.jsx)(`br`,{}),`Battle-System`,(0,R.jsx)(`br`,{}),`Discord`]}),`.`,(0,R.jsx)(`br`,{}),(0,R.jsxs)(`a`,{href:`https://www.patreon.com/c/battlesystem`,target:`_blank`,rel:`noreferrer`,children:[(0,R.jsx)(`br`,{}),`Patreon`]}),`.`]}),(0,R.jsxs)($p,{theme:a,children:[i&&(0,R.jsx)(em,{theme:a,$isActive:t===`ForgeMain`,onClick:()=>r(`ForgeMain`),children:`Main`}),(0,R.jsx)(em,{theme:a,$isActive:t===`Party`,onClick:()=>r(`Party`),children:`Party`}),(0,R.jsx)(em,{theme:a,$isActive:t===`ChatLog`,onClick:()=>r(`ChatLog`),children:`System Log`}),s&&(0,R.jsx)(em,{theme:a,$isActive:t===`System`,onClick:()=>r(`System`),children:`System`}),s&&(0,R.jsx)(em,{theme:a,$isActive:t===`Settings`,onClick:()=>r(`Settings`),children:`Settings`})]})]})}),e&&(0,R.jsx)(tm,{onClick:n}),(0,R.jsx)(nm,{children:(0,R.jsx)(rm,{theme:a,onClick:n,children:(0,R.jsx)(rt,{size:24})})})]})},am=T.div`
  padding: 20px;
  color: ${e=>e.theme.PRIMARY};
  min-height: 100vh;
`,om=T.h1`
...
`;const X=({label:e,isOn:t,onChange:n})=>{let{theme:r}=Ft();return(0,R.jsx)(um,{theme:r,$isOn:t,onClick:()=>{let r=!t;O.log(`${e}: ${r}`),n(r)},role:`switch`,"aria-checked":t,"aria-label":e})};var dm=T.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`;const Pm=()=>{let e=Ot(e=>e.messages),t=(0,I.useRef)(null),{theme:n}=Ft();return(0,I.useEffect)(()=>{t.current?.scrollIntoView({behavior:`smooth`})},[e]),(0,R.jsx)(Gd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,R.jsxs)(km,{children:[(0,R.jsx)(om,{theme:n,children:`System Log`}),(0,R.jsxs)(Am,{children:[e.map(e=>(0,R.jsxs)(jm,{children:[(0,R.jsx)(Mm,{children:e.timestamp}),(0,R.jsx)(Nm,{children:e.text})]},e.id)),(0,R.jsx)(`div`,{ref:t})]})]})})},Fm=`buff_effect_one`,Im=`debuff_effect_one`,Lm=[{value:`buff_effect_one`,label:`Buff Effect One`},{value:`buff_effect_two`,label:`Buff Effect Two`}],Rm=[{value:`debuff_effect_one`,label:`Debuff Effect One`},{value:`debuff_effect_two`,label:`Debuff Effect Two`}],zm=e=>Lm.some(t=>t.value===e),Bm=e=>Rm.some(t=>t.value===e),Vm=e=>{switch(e){case`buff_effect_two`:return`
uniform float2 size;
uniform float time;
...
`,vh={initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20}};const yh=()=>{let{theme:e,updateThemeFromSystem:t}=Ft(),n=L(e=>e.sceneMetadata),r=L(e=>e.roomMetadata),i=r,a=L(e=>e.systemData),o=L(e=>e.setSystemData),[s,l]=(0,I.useState)(()=>ze().premiumAuthorized),[u,d]=(0,I.useState)(``),[p,m]=(0,I.useState)(!1),[h,g]=(0,I.useState)(null),[_,v]=(0,I.useState)(null),[y,b]=(0,I.useState)(``),[x,S]=(0,I.useState)(null),[w,T]=(0,I.useState)(null),[ee,te]=(0,I.useState)([]),[ne,re]=(0,I.useState)(``),[ie,ae]=(0,I.useState)(``),[oe,se]=(0,I.useState)(Fm),[ce,le]=(0,I.useState)(Im),[k,ue]=(0,I.useState)(!1),[de,fe]=(0,I.useState)(!1),[pe,me]=(0,I.useState)(null),[he,ge]=(0,I.useState)(null),[_e,ye]=(0,I.useState)([]),[xe,A]=(0,I.useState)(!1),[Se,Ce]=(0,I.useState)(null),[we,Te]=(0,I.useState)(``);(0,I.useEffect)(()=>{let e=!0,t=async()=>{await dt(),e&&l(ze().premiumAuthorized)},n=Ne(t=>{e&&l(t.premiumAuthorized)});return t(),()=>{e=!1,n()}},[]),(0,I.useEffect)(()=>{Ee(),Ae()},[n,r,a,s]);let Ee=()=>{try{if(!s){let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url},t=i[D.BUFF_VISUAL_PRESET],n=i[D.DEBUFF_VISUAL_PRESET],r=zm(t)?t:Fm,a=Bm(n)?n:Im;b(E.name),S(null),T(e),te(E.attributes),re(Km.currentHpBid),ae(Km.maxHpBid),se(r),le(a);return}if(a){let e=i[D.HP_CURRENT_BID],t=i[D.HP_MAX_BID],n=i[D.BUFF_VISUAL_PRESET],r=i[D.DEBUFF_VISUAL_PRESET],o=zm(n)?n:null,s=Bm(r)?r:null;b(a.systemName),S(a.importDate),T(a.theme),te(a.attributes),re(e||``),ae(t||``),pe&&o===pe&&me(null),he&&s===he&&ge(null),!k&&!pe&&se(e=>o||e),!de&&!he&&le(e=>s||e);return}let e=r[Gm.SYSTEM_NAME],t=r[Gm.IMPORT_DATE],n=i[D.HP_CURRENT_BID],o=i[D.HP_MAX_BID],c=i[D.BUFF_VISUAL_PRESET],l=i[D.DEBUFF_VISUAL_PRESET],u=zm(c)?c:null,d=Bm(l)?l:null;b(e||E.name),S(t||null),T({primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url}),te(E.attributes),re(n||``),ae(o||``),pe&&u===pe&&me(null),he&&d===he&&ge(null),!k&&!pe&&se(e=>u||e),!de&&!he&&le(e=>d||e)}catch(e){O.error(`Error loading system from cache:`,e)}},De=async(e,t)=>{await c.room.setMetadata({[e]:t})},Oe=(e,t)=>{if(Array.isArray(e))return e;if(typeof e==`string`){let n;try{n=JSON.parse(e)}catch{throw Error(`Imported ${t} is not valid JSON`)}if(!Array.isArray(n))throw Error(`Imported ${t} is not a JSON array`);return n}throw Error(`Imported ${t} has invalid type`)},ke=ee.filter(e=>e.attr_type===`numb`),Ae=()=>{try{let e=[];for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);if(n&&n.startsWith(`${Wm}.`)&&n.endsWith(`.backup`)){let t=localStorage.getItem(n);if(t){let n=JSON.parse(t);e.push(n)}}}e.sort((e,t)=>new Date(t.backupDate).getTime()-new Date(e.backupDate).getTime()),ye(e)}catch(e){O.error(`Error loading backups:`,e)}},je=async e=>{try{if(!a){O.warn(`Cannot create backup: runtime system data is unavailable`);return}let e=a.systemName||E.name,t={name:e,backupDate:new Date().toISOString(),theme_primary:a.theme.primary,theme_offset:a.theme.offset,theme_background:a.theme.background,theme_border:a.theme.border,background_url:a.theme.background_url,card_layout:a.cardLayout,list_layout:a.listLayout,attributes:a.attributes},n=`${Wm}.${e}.backup`;localStorage.setItem(n,JSON.stringify(t)),O.log(`Backup created for ${e}`),Ae()}catch(e){throw O.error(`Error creating backup:`,e),e}},Me=e=>{try{let t=`${Wm}.${e}.backup`;localStorage.removeItem(t),O.log(`Backup deleted for ${e}`),Ae(),v(`Backup for "${e}" deleted successfully`)}catch(e){O.error(`Error deleting backup:`,e),g(`Failed to delete backup`)}},Pe=(e,t)=>{Te(e),Ce(()=>t),A(!0)},Fe=async()=>{A(!1),Se&&(await Se(),Ce(null))},Ie=()=>{A(!1),Ce(null),Te(``)},Le=async()=>{if(!u.trim()){g(`Please enter a share_id`);return}Pe(`This will overwrite your current system data. A backup of your current system will be saved to local storage. Do you want to continue?`,async()=>{await Re()})},Re=async()=>{if(!We()){g(`Premium account required. Connect and use a premium Battle-System account before importing systems.`);return}m(!0),g(null),v(null);try{await lt();let{data:e,error:n}=await gt(async()=>C.rpc(`bs_forge_import_system_snapshot`,{p_source_share_id:u.trim()}));if(n)throw n;if(!e){g(`No system found with that share_id`),m(!1);return}let r=Array.isArray(e)?e[0]:e;if(!r||typeof r.snapshot_public_id!=`string`)throw Error(`Snapshot import did not return a valid record`);let i=Oe(r.card_layout,`card_layout`),a=Oe(r.list_layout,`list_layout`),s=Oe(r.attributes,`attributes`);if(!Array.isArray(s))throw Error(`Imported attributes are not a valid array`);await je(y);let l={primary:r.theme_primary,offset:r.theme_offset,background:r.theme_background,border:r.theme_border,background_url:r.background_url},f=new Date().toISOString();await c.room.setMetadata({[Gm.SNAPSHOT_PUBLIC_ID]:r.snapshot_public_id,[Gm.SYSTEM_NAME]:r.system_name,[Gm.IMPORT_DATE]:f}),o({theme:l,cardLayout:i,listLayout:a,attributes:s,systemName:r.system_name,importDate:f,snapshotPublicId:r.snapshot_public_id}),b(r.system_name),S(f),T(l),t(l.primary,l.offset,l.background,l.border,l.background_url),v(`System "${r.system_name}" loaded successfully! Backup created.`),d(``),O.log(`System snapshot imported and loaded:`,{systemName:r.system_name,snapshotPublicId:r.snapshot_public_id})}catch(e){O.error(`Error fetching system:`,e),g(qm(e,`An error occurred while fetching the system`))}finally{m(!1)}},j=async e=>{Pe(`This will restore the system "${e.name}" from backup. A backup of your current system will be created. Do you want to continue?`,async()=>{await Be(e)})},Be=async e=>{m(!0),g(null),v(null);try{if(!We()){g(`Premium account required. Connect and use a premium Battle-System account before restoring backups for room sharing.`);return}await lt(),await je(y);let n={primary:e.theme_primary,offset:e.theme_offset,background:e.theme_background,border:e.theme_border,background_url:e.background_url};if(!Array.isArray(e.card_layout)||!Array.isArray(e.list_layout)||!Array.isArray(e.attributes))throw Error(`Backup data is invalid`);let r=new Date().toISOString(),i=`forge-backup:${e.name.trim().toLowerCase()}`,{data:a,error:s}=await gt(async()=>C.rpc(`bs_forge_upsert_user_snapshot_payload`,{p_source_share_id:i,p_system_name:e.name,p_background_url:e.background_url,p_theme_primary:e.theme_primary,p_theme_offset:e.theme_offset,p_theme_background:e.theme_background,p_theme_border:e.theme_border,p_card_layout:e.card_layout,p_list_layout:e.list_layout,p_attributes:e.attributes}));if(s)throw s;let l=Array.isArray(a)?a[0]:a;if(!l||typeof l.snapshot_public_id!=`string`)throw Error(`Backup restore snapshot publish failed`);o({theme:n,cardLayout:e.card_layout,listLayout:e.list_layout,attributes:e.attributes,systemName:e.name,importDate:r,snapshotPublicId:l.snapshot_public_id}),await c.room.setMetadata({[Gm.SNAPSHOT_PUBLIC_ID]:l.snapshot_public_id,[Gm.SYSTEM_NAME]:e.name,[Gm.IMPORT_DATE]:r}),b(e.name),S(r),T(n),t(n.primary,n.offset,n.background,n.border,n.background_url),v(`System "${e.name}" restored from backup successfully!`),O.log(`System restored from backup:`,e.name)}catch(e){O.error(`Error restoring backup:`,e),g(`Failed to restore system from backup`)}finally{m(!1)}},Ve=async()=>{m(!0),g(null),v(null);try{let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url};o({theme:e,cardLayout:E.card_layout,listLayout:E.list_layout,attributes:E.attributes,systemName:E.name,importDate:null,snapshotPublicId:null}),await c.room.setMetadata({[Gm.SNAPSHOT_PUBLIC_ID]:null,[Gm.SYSTEM_NAME]:E.name,[Gm.IMPORT_DATE]:null}),b(E.name),S(null),T(e),t(e.primary,e.offset,e.background,e.border,e.background_url),v(`Reset to default system successfully!`)}catch(e){g(`Failed to reset to default system`),O.error(`Error resetting to default:`,e)}finally{m(!1)}},He=e=>e?new Date(e).toLocaleDateString(`en-US`,{year:`numeric`,month:`long`,day:`numeric`,hour:`2-digit`,minute:`2-digit`}):null,Ue=!s,Ge=!s;return(0,R.jsxs)(Gd.div,{variants:vh,initial:`initial`,animate:`animate`,exit:`exit`,children:[(0,R.jsxs)(am,{theme:e,children:[(0,R.jsx)(om,{theme:e,children:`System Configuration`}),(0,R.jsx)(Xm,{theme:e,children:y}),x?(0,R.jsxs)(Zm,{theme:e,children:[`Imported: `,He(x)]}):(0,R.jsx)(Zm,{theme:e,children:`Using Default System`}),w&&(0,R.jsxs)(R.Fragment,{children:[(0,R.jsxs)(Qm,{children:[(0,R.jsxs)(`div`,{children:[(0,R.jsx)($m,{color:w.primary,theme:e,children:w.primary}),(0,R.jsx)(eh,{theme:e,children:`PRIMARY`})]}),(0,R.jsxs)(`div`,{children:[(0,R.jsx)($m,{color:w.offset,theme:e,children:w.offset}),(0,R.jsx)(eh,{theme:e,children:`OFFSET`})]}),(0,R.jsxs)(`div`,{children:[(0,R.jsx)($m,{color:w.background,theme:e,children:w.background}),(0,R.jsx)(eh,{theme:e,children:`BG`})]}),(0,R.jsxs)(`div`,{children:[(0,R.jsx)($m,{color:w.border,theme:e,children:w.border}),(0,R.jsx)(eh,{theme:e,children:`BORDER`})]})]}),(0,R.jsxs)(th,{theme:e,children:[(0,R.jsx)(nh,{theme:e,children:`System Settings`}),(0,R.jsxs)(rh,{children:[(0,R.jsx)(ih,{theme:e,children:`Current HP`}),(0,R.jsxs)(ah,{theme:e,value:ne,disabled:Ge,onChange:async e=>{if(Ge)return;let t=e.target.value;re(t),await De(D.HP_CURRENT_BID,t)},children:[(0,R.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),ke.map(e=>(0,R.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,R.jsxs)(rh,{children:[(0,R.jsx)(ih,{theme:e,children:`Max HP`}),(0,R.jsxs)(ah,{theme:e,value:ie,disabled:Ge,onChange:async e=>{if(Ge)return;let t=e.target.value;ae(t),await De(D.HP_MAX_BID,t)},children:[(0,R.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),ke.map(e=>(0,R.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),Ge&&(0,R.jsx)(Zm,{theme:e,children:`Premium account required to edit HP mapping.`}),(0,R.jsxs)(rh,{children:[(0,R.jsx)(ih,{theme:e,children:`Buff Visual`}),(0,R.jsx)(ah,{theme:e,value:oe,onChange:async e=>{let t=e.target.value;if(zm(t)){se(t),me(t),ue(!0);try{await De(D.BUFF_VISUAL_PRESET,t)}finally{ue(!1)}}},children:Lm.map(e=>(0,R.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,R.jsxs)(rh,{children:[(0,R.jsx)(ih,{theme:e,children:`Debuff Visual`}),(0,R.jsx)(ah,{theme:e,value:ce,onChange:async e=>{let t=e.target.value;if(Bm(t)){le(t),ge(t),fe(!0);try{await De(D.DEBUFF_VISUAL_PRESET,t)}finally{fe(!1)}}},children:Rm.map(e=>(0,R.jsx)(`option`,{value:e.value,children:e.label},e.value))})]})]})]}),(0,R.jsxs)(Ym,{theme:e,children:[(0,R.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0},children:`Import New System`}),(0,R.jsx)(`p`,{style:{color:f(e.PRIMARY,.8),fontSize:`14px`},children:Ue?`Premium account required to import new/custom systems.`:`Enter a share_id to download and activate a new game system configuration.`}),(0,R.jsx)(Jm,{children:(0,R.jsx)(lm,{theme:e,type:`text`,value:u,onChange:e=>d(e.target.value),placeholder:Ue?``:`Enter Share Id...`,disabled:p||Ue,onKeyPress:e=>e.key===`Enter`&&Le()})}),(0,R.jsxs)(ch,{children:[(0,R.jsx)(cm,{theme:e,onClick:Le,disabled:p||Ue||!u.trim(),children:p?`....!`:`Import System`}),(0,R.jsx)(cm,{theme:e,variant:`secondary`,onClick:Ve,disabled:p,children:`Use Default`})]})]}),h&&(0,R.jsxs)(oh,{theme:e,children:[(0,R.jsx)(`strong`,{children:`Error:`}),` `,h]}),_&&(0,R.jsxs)(sh,{theme:e,children:[(0,R.jsx)(`strong`,{children:`Success:`}),` `,_]}),_e.length>0&&(0,R.jsx)(uh,{children:(0,R.jsxs)(sm,{theme:e,children:[(0,R.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0,marginBottom:`15px`},children:`System Backups`}),(0,R.jsx)(dh,{children:_e.map(t=>(0,R.jsxs)(fh,{theme:e,children:[(0,R.jsxs)(ph,{children:[(0,R.jsx)(mh,{theme:e,children:t.name}),(0,R.jsxs)(hh,{theme:e,children:[`Backed up: `,He(t.backupDate)]})]}),(0,R.jsxs)(gh,{children:[(0,R.jsx)(_h,{theme:e,onClick:()=>j(t),disabled:p,title:`Import this backup`,children:(0,R.jsx)(ve,{size:18})}),(0,R.jsx)(_h,{theme:e,$variant:`danger`,onClick:()=>Me(t.name),disabled:p,title:`Delete this backup`,children:(0,R.jsx)(be,{size:18})})]})]},`${t.name}-${t.backupDate}`))})]})})]}),(0,R.jsx)(gm,{isOpen:xe,title:`Confirm Action`,onClose:Ie,actions:(0,R.jsxs)(R.Fragment,{children:[(0,R.jsx)(cm,{theme:e,variant:`secondary`,onClick:Ie,children:`Cancel`}),(0,R.jsx)(cm,{theme:e,onClick:Fe,children:`Confirm`})]}),children:(0,R.jsx)(lh,{theme:e,children:we})})]},`system`)};function bh(e,t){let n=e.replace(`#`,``);n.length===3&&(n=n.split(``).map(e=>e+e).join(``));let r=parseInt(n,16);return`rgba(${r>>16&255}, ${r>>8&255}, ${r&255}, ${t})`}var xh=class{static async CenterViewportOnImage(e){let t=await c.scene.grid.getDpi(),n=await c.viewport.getScale(),r=await c.viewport.getWidth(),i=await c.viewport.getHeight(),a={x:r/2,y:i/2},o={x:a.x/n,y:a.y/n},s=await this.GetImageCenter(e,t),l={x:s.x-o.x,y:s.y-o.y},u={x:l.x*n*-1,y:l.y*n*-1};await c.viewport.animateTo({position:u,scale:n})}static async GetImageCenter(t,n){if(e(t)){let e=n/t.grid.dpi,r=t.image.width*e,i=t.image.height*e,a=t.grid.offset.x/t.image.width*r,o=t.grid.offset.y/t.image.height*i;return{x:t.position.x-a+r/2,y:t.position.y-o+i/2}}else if(o(t)&&t.points.length>0)return{x:t.points[0].x,y:t.points[0].y};else return{x:t.position.x,y:t.position.y}}};const Sh=`${F}/effects`;var Ch=`${F}/effects-expired`,wh=T.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,Th=T.div`
...
`,Hh=T.span`
  ...
  font-weight: 700;
  padding: 0 3px;
`,Uh=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const Wh=({items:e,units:t,setItems:n,playerData:r})=>{let[i,a]=(0,I.useState)(null),[o,s]=(0,I.useState)(``),[l,u]=(0,I.useState)(`1`),[d,f]=(0,I.useState)(`rounds`),[m,h]=(0,I.useState)(`start`),[g,_]=(0,I.useState)(`neutral`),[v,y]=(0,I.useState)([]),[b,x]=(0,I.useState)(null),S=(0,I.useMemo)(()=>{let t=new Map;return e.forEach(e=>{e.metadata?.[p.ON_LIST]===!0&&t.set(e.id,Uh(e.metadata?.[Sh]))}),t},[e]),C=e=>S.get(e)||[],w=async(t,r)=>{let i=r.filter(e=>e.remaining>0);n(e.map(e=>{if(e.id!==t)return e;let n={...e.metadata||{}};return i.length>0?n[Sh]=i:delete n[Sh],{...e,metadata:n}})),await c.scene.items.updateItems([t],e=>{let t={...e[0].metadata||{}};i.length>0?t[Sh]=i:delete t[Sh],e[0].metadata=t})},T=async e=>{try{await c.broadcast.sendMessage(Ch,{message:e},{destination:`ALL`})}catch(t){O.error(`Failed to broadcast expired effect message`,t),await c.notification.show(e,`WARNING`)}},E=async(t,n)=>{if(String(r?.role||``).toUpperCase()!==`GM`)return;let i=[],a=[];e.forEach(e=>{if(e.metadata?.[p.ON_LIST]!==!0)return;let r=Uh(e.metadata?.[Sh]);if(r.length===0)return;let o=!1,s=[];r.forEach(r=>{if(!(r.endTiming===t&&(r.durationType===`turns`||e.id===n))){s.push(r);return}let i=r.remaining-1;if(o=!0,i<=0){a.push(`${e.name||`Unit`}: ${r.name} expired`);return}s.push({...r,remaining:i})}),o&&i.push({unitId:e.id,effects:s})});for(let e of i)await w(e.unitId,e.effects);if(a.length>0)for(let e of a)await T(e)},ee=(0,I.useMemo)(()=>i&&t.find(e=>e.id===i)||null,[i,t]),te=(0,I.useMemo)(()=>i?C(i):[],[i,S]);return(0,I.useEffect)(()=>{let e=c.broadcast.onMessage(Ch,async e=>{let t=e.data?.message;typeof t!=`string`||!t.trim()||await c.notification.show(t,`WARNING`)});return()=>{e()}},[]),{effectsModalUnitId:i,selectedEffectsUnit:ee,activeEffectsForSelectedUnit:te,effectNameInput:o,setEffectNameInput:s,effectDurationInput:l,setEffectDurationInput:u,effectDurationType:d,setEffectDurationType:f,effectEndTiming:m,setEffectEndTiming:h,effectType:g,setEffectType:_,effectTargetIds:v,setEffectTargetIds:e=>{y(Array.from(new Set(e)))},effectsModalError:b,units:t,getEffectsForUnit:C,handleOpenEffectsModal:e=>{x(null),s(``),u(`1`),f(`rounds`),h(`start`),_(`neutral`),y([e]),a(e)},handleCloseEffectsModal:()=>{a(null),x(null)},handleAddEffect:async()=>{if(!i)return;let n=o.trim(),r=parseInt(l,10);if(!n){x(`Enter an effect name.`);return}if(!Number.isFinite(r)||r<=0){x(`Duration must be a positive number.`);return}let a=Array.from(new Set(v.filter(e=>t.some(t=>t.id===e))));if(a.length===0){x(`Select at least one target.`);return}let c=C(i),f=ee?.name||e.find(e=>e.id===i)?.name||`Unknown`,p={id:crypto.randomUUID(),name:n,remaining:r,durationType:d,endTiming:m,effectType:g,targets:a,createdByName:f,createdById:i};await w(i,[...c,p]),x(null),s(``),u(`1`),_(`neutral`),y([i])},handleDeleteEffect:async e=>{i&&await w(i,C(i).filter(t=>t.id!==e))},processEffectsForTurnEvent:E}},Gh=({manager:e})=>{let{theme:t}=Ft(),n=(0,I.useMemo)(()=>{let t=new Map;return e.units.forEach(e=>{t.set(e.id,e.name)}),t},[e.units]),r=e=>e===`buff`?`Buff`:e===`debuff`?`Debuff`:`Neutral`,i=e=>{if(e.length===0)return`No targets`;let t=e.map(e=>n.get(e)).filter(e=>typeof e==`string`&&e.length>0);return t.length===0?`${e.length} target${e.length===1?``:`s`}`:t.length<=2?t.join(`, `):`${t.slice(0,2).join(`, `)} +${t.length-2}`};return(0,R.jsx)(gm,{isOpen:!!e.effectsModalUnitId,title:e.selectedEffectsUnit?`Effects: ${e.selectedEffectsUnit.name}`:`Effects`,onClose:e.handleCloseEffectsModal,minWidth:`520px`,maxWidth:`600px`,children:(0,R.jsxs)(wh,{children:[(0,R.jsxs)(Th,{children:[(0,R.jsxs)(Eh,{children:[(0,R.jsxs)(Dh,{style:{flex:`0 0 120px`},children:[(0,R.jsx)(kh,{theme:t,children:`Effect`}),(0,R.jsx)(Ah,{theme:t,type:`text`,placeholder:`Name`,value:e.effectNameInput,onChange:t=>e.setEffectNameInput(t.target.value)})]}),(0,R.jsxs)(Dh,{style:{flex:`0 0 140px`},children:[(0,R.jsx)(kh,{theme:t,children:`Duration`}),(0,R.jsx)(Ah,{theme:t,type:`number`,min:1,value:e.effectDurationInput,onChange:t=>e.setEffectDurationInput(t.target.value)})]}),(0,R.jsxs)(Dh,{style:{flex:`0 0 120px`},children:[(0,R.jsx)(kh,{theme:t,children:`By`}),(0,R.jsxs)(jh,{theme:t,value:e.effectDurationType,onChange:t=>e.setEffectDurationType(t.target.value),children:[(0,R.jsx)(`option`,{value:`turns`,children:`Turns`}),(0,R.jsx)(`option`,{value:`rounds`,children:`Rounds`})]})]})]}),(0,R.jsxs)(Eh,{children:[(0,R.jsxs)(Dh,{style:{flex:`0 0 120px`},children:[(0,R.jsx)(kh,{theme:t,children:`Type`}),(0,R.jsxs)(jh,{theme:t,value:e.effectType,onChange:t=>e.setEffectType(t.target.value),children:[(0,R.jsx)(`option`,{value:`neutral`,children:`Neutral`}),(0,R.jsx)(`option`,{value:`buff`,children:`Buff`}),(0,R.jsx)(`option`,{value:`debuff`,children:`Debuff`})]})]}),(0,R.jsxs)(Dh,{style:{flex:`0 0 140px`},children:[(0,R.jsx)(kh,{theme:t,children:`Ends at`}),(0,R.jsxs)(jh,{theme:t,value:e.effectEndTiming,onChange:t=>e.setEffectEndTiming(t.target.value),children:[(0,R.jsx)(`option`,{value:`start`,children:`Start of turn`}),(0,R.jsx)(`option`,{value:`end`,children:`End of turn`})]})]}),(0,R.jsx)(Oh,{children:(0,R.jsx)(Nh,{theme:t,onClick:e.handleAddEffect,style:{width:`100%`},children:`Add`})})]})]}),(0,R.jsxs)(Dh,{children:[(0,R.jsx)(kh,{theme:t,children:`Targets`}),(0,R.jsx)(Mh,{theme:t,multiple:!0,value:e.effectTargetIds,onChange:t=>{let n=Array.from(t.target.selectedOptions).map(e=>e.value);e.setEffectTargetIds(n)},children:e.units.map(e=>(0,R.jsx)(`option`,{value:e.id,children:e.name},e.id))})]}),e.effectsModalError&&(0,R.jsx)(zh,{theme:t,children:e.effectsModalError}),e.activeEffectsForSelectedUnit.length===0?(0,R.jsx)(Rh,{theme:t,children:`No active effects.`}):(0,R.jsx)(Ph,{children:e.activeEffectsForSelectedUnit.map(n=>(0,R.jsxs)(Fh,{theme:t,children:[(0,R.jsxs)(`div`,{children:[(0,R.jsx)(Lh,{theme:t,children:n.name}),(0,R.jsxs)(Ih,{theme:t,children:[r(n.effectType),` • `,n.remaining,` `,n.durationType,` • ends at `,n.endTiming===`start`?`start of turn`:`end of turn`,` • by `,n.createdByName]}),(0,R.jsxs)(Ih,{theme:t,children:[`Targets: `,i(n.targets)]})]}),(0,R.jsx)(Nh,{theme:t,onClick:()=>{e.handleDeleteEffect(n.id)},children:`Delete`})]},n.id))})]})})},Kh=({activeEffectsCount:e,canInteract:t,onOpen:n,icon:r})=>{let{theme:i}=Ft();return(0,R.jsxs)(Bh,{children:[(0,R.jsx)(Vh,{theme:i,$active:e>0,disabled:!t,onClick:()=>{t&&n()},children:r||(0,R.jsx)(_e,{})}),e>0&&(0,R.jsx)(Hh,{theme:i,children:e>99?`99+`:e})]})};var qh=T.td`
  color: ${e=>e.theme.PRIMARY};
  padding: 2px 6px;
  text-align: center;
  font-size: 14px;
...
`;const Yh=({theme:e,unit:t,canInteract:n,elevationDraftValue:r,onElevationDraftChange:i,onCommitElevationChange:a})=>(0,R.jsx)(qh,{theme:e,children:(0,R.jsx)(Jh,{theme:e,type:`text`,inputMode:`decimal`,min:-999,max:999,step:1,value:r??String(t.elevation??0),readOnly:!n,onChange:n?e=>i(t.id,e.target.value):void 0,onBlur:n?e=>a(t.id,e.target.value):void 0,onKeyDown:e=>{n&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}})}),Xh=({theme:e,canInteract:t,icon:n,activeEffectsCount:r,onOpen:i})=>(0,R.jsx)(qh,{theme:e,children:(0,R.jsx)(Kh,{activeEffectsCount:r,canInteract:t,icon:n||(0,R.jsx)(_e,{}),onOpen:i})});var Zh=`${F}/elevation-badge`,Qh=`${F}/elevation-badge-owner`,$h=`${F}/elevation`,eg=200,tg=40,ng=60,rg=120,ig=24,ag=(e,t)=>{if(!e)return;if(e.startsWith(`#`))return bh(e,t);let n=e.match(/^rgba\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([\d.]+)\)$/i);if(n){let[,e,r,i]=n;return`rgba(${e}, ${r}, ${i}, ${t})`}let r=e.match(/^rgb\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\)$/i);if(r){let[,e,n,i]=r;return`rgba(${e}, ${n}, ${i}, ${t})`}return e},og=e=>`
    0 1px 1px ${f(e.BACKGROUND,.95)},
    0 0 2px ${f(e.BACKGROUND,.85)}
  `,sg=/(\d+)d(\d+)([kd][hl]\d+|!)?/gi,cg={anchor:ft,aperture:Pe,award:Ge,batterycharging:$e,book:Ue,calendar:ut,clock:st,cloudlightning:tt,drama:ct,carrot:M,bone:nt,compass:Je,dollarsign:P,feather:Se,eye:Ve,heart:he,moon:ge,music:fe,shield:pe,star:Ce,sun:_e,target:A,users:Ye,wind:Xe,zap:le,sword:me,swords:de,axe:qe,bowarrow:Be,coins:Fe,wand:ae,flower:Me,skull:Oe,castle:j,cross:at,testtubediagonal:ye,squirrel:vt,snowflake:oe,shell:De,pickaxe:ke,heartplus:je,heartcrack:Ae,fan:ie},lg=T.div`
  padding: 2px;
  width: 100%;
`,ug=T.h1`
  color: ${e=>e.theme.PRIMARY};
...
`,H_=T.span`
  ...
  text-align: center;
  margin-top: 4px;
`,U_=e=>{switch(e){case`bottom`:return`left`;case`left`:return`top`;case`top`:return`right`;case`right`:default:return`bottom`}},W_=e=>e===`bottom`||e===`left`||e===`top`||e===`right`;const G_=()=>{let t=(0,I.useRef)(!1),[n,r]=(0,I.useState)(null),{theme:i}=Ft(),{attributes:a}=_m(),o=L(e=>e.items);L(e=>e.sceneMetadata);let s=L(e=>e.roomMetadata),l=L(e=>e.playerData),u=s,d=String(l?.role||``).toUpperCase()===`GM`,f=l?.id,m=re(D.PARTY_HUD_OPEN,f),h=re(D.PARTY_HUD_ORIENTATION,f),g=(u[m]??u[D.PARTY_HUD_OPEN])===!0,_=u[h]??u[D.PARTY_HUD_ORIENTATION],v=W_(_)?_:`bottom`,y=u[D.PARTY_HUD_ATTR_ONE]||``,b=u[D.PARTY_HUD_ATTR_TWO]||``,x=u[D.PARTY_HUD_SHOW_HP_BARS]===!0,S=u[D.PARTY_HUD_SHOW_HP_NUMBERS]===!0&&!x,C=o.filter(e=>e.metadata[p.IN_PARTY]===!0);(0,I.useEffect)(()=>{try{let e=localStorage.getItem(w_);e&&r(JSON.parse(e).savedAt??null)}catch{}},[]);let w=()=>{let e={savedAt:new Date().toISOString(),items:C};localStorage.setItem(w_,JSON.stringify(e)),r(e.savedAt)},T=async()=>{let e=localStorage.getItem(w_);if(e)try{let t=JSON.parse(e);if(!t.items.length)return;let n=new Set(t.items.map(e=>e.id)),r=o.filter(e=>n.has(e.id)).map(e=>e.id);r.length>0&&await c.scene.items.deleteItems(r);let[i,a]=await Promise.all([c.viewport.getWidth(),c.viewport.getHeight()]),s={x:i*.75,y:a*.6},l=await c.viewport.inverseTransformPoint(s),u={x:s.x-75,y:s.y-75},d=await c.viewport.inverseTransformPoint(u),f=d.x-l.x,p=d.y-l.y,m=t.items.map((e,t)=>({...e,position:{x:l.x+f*t,y:l.y+p*t}}));await c.scene.items.addItems(m)}catch{}},E=(0,I.useMemo)(()=>a.filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`text`||t===`numb`||t===`bool`}),[a]),ee=async(e,t)=>{await c.room.setMetadata({[e]:t})},te=async e=>{await c.room.setMetadata(e)},ne=async()=>{let e=!g;if(await ee(m,e),!e){await C_(),t.current=!1;return}await S_(),t.current=!0},ie=async()=>{await ee(h,U_(v))},ae=async(e,t)=>{let n=t.trim();await c.scene.items.updateItems([e],e=>{let t={...e[0].metadata||{}};n?t[p.PORTRAIT_URL]=n:delete t[p.PORTRAIT_URL],e[0].metadata=t})};return(0,R.jsx)(Gd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,R.jsxs)(am,{theme:i,children:[(0,R.jsx)(om,{theme:i,children:`Party`}),(0,R.jsxs)(E_,{theme:i,children:[(0,R.jsxs)(D_,{children:[(0,R.jsxs)(A_,{theme:i,onClick:()=>void ie(),children:[`Display: `,v.toUpperCase()]}),(0,R.jsx)(A_,{theme:i,onClick:()=>void ne(),children:g?`Close Party HUD`:`Open Party HUD`})]}),d&&(0,R.jsxs)(R.Fragment,{children:[(0,R.jsxs)(O_,{children:[(0,R.jsx)(k_,{theme:i,children:`Show in HUD:`}),(0,R.jsxs)(N_,{$disabled:!d,children:[(0,R.jsx)(P_,{theme:i,children:`Show HP Bars`}),(0,R.jsx)(X,{label:`Party HUD Show HP Bars`,isOn:x,onChange:e=>{if(d){if(e){te({[D.PARTY_HUD_SHOW_HP_BARS]:!0,[D.PARTY_HUD_SHOW_HP_NUMBERS]:!1});return}ee(D.PARTY_HUD_SHOW_HP_BARS,!1)}}})]}),(0,R.jsxs)(N_,{$disabled:!d,children:[(0,R.jsx)(P_,{theme:i,children:`Show HP Numbers`}),(0,R.jsx)(X,{label:`Party HUD Show HP Numbers`,isOn:S,onChange:e=>{if(d){if(e){te({[D.PARTY_HUD_SHOW_HP_NUMBERS]:!0,[D.PARTY_HUD_SHOW_HP_BARS]:!1});return}ee(D.PARTY_HUD_SHOW_HP_NUMBERS,!1)}}})]}),(0,R.jsxs)(j_,{theme:i,disabled:!d,value:y,onChange:e=>{let t=e.target.value;ee(D.PARTY_HUD_ATTR_ONE,t),t&&t===b&&ee(D.PARTY_HUD_ATTR_TWO,``)},children:[(0,R.jsx)(`option`,{value:``,children:`Extra Slot 1 (None)`}),E.map(e=>(0,R.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]}),(0,R.jsxs)(j_,{theme:i,disabled:!d,value:b,onChange:e=>{let t=e.target.value;ee(D.PARTY_HUD_ATTR_TWO,t),t&&t===y&&ee(D.PARTY_HUD_ATTR_ONE,``)},children:[(0,R.jsx)(`option`,{value:``,children:`Extra Slot 2 (None)`}),E.map(e=>(0,R.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]})]}),(0,R.jsx)(M_,{theme:i,children:(0,R.jsxs)(R.Fragment,{children:[`Configure Party HUD and portraits.`,(0,R.jsx)(`br`,{}),`LIST attributes are excluded.`]})})]})]}),d&&(0,R.jsxs)(E_,{theme:i,children:[(0,R.jsxs)(O_,{children:[(0,R.jsx)(A_,{theme:i,onClick:w,disabled:C.length===0,children:`Save Party`}),(0,R.jsx)(A_,{theme:i,onClick:()=>void T(),disabled:n===null,children:`Load Party`})]}),(0,R.jsx)(H_,{theme:i,children:n?`Last saved: ${new Date(n).toLocaleString()}`:`No save available.`})]}),C.length===0?(0,R.jsx)(V_,{theme:i,children:`No one is in the Party.  Add a unit using the ContextMenu on the token.`}):(0,R.jsx)(T_,{theme:i,children:C.map(t=>{let n=t.metadata?.[p.PORTRAIT_URL]||``,r=e(t)?t.image.url:void 0,a=t.metadata[p.UNIT_NAME]||t.name||`Unknown`,o=t.createdUserId===l?.id,s=d||o,c=r||`/logo.png`,u=!!n;return(0,R.jsxs)(F_,{theme:i,children:[(0,R.jsxs)(I_,{children:[(0,R.jsx)(L_,{theme:i,src:c,alt:a,$full:!u}),u&&(0,R.jsx)(L_,{theme:i,src:u?n:``,alt:`${a} override`,$overlay:!0})]}),(0,R.jsxs)(R_,{children:[(0,R.jsx)(z_,{theme:i,title:a,children:a}),s&&(0,R.jsx)(B_,{theme:i,defaultValue:n,placeholder:`Portrait URL override (optional)`,onBlur:e=>{ae(t.id,e.target.value)}})]})]},t.id)})})]})})};var K_=`${F}/hp-bar-effect`,q_=`${F}/hp-bar-owner`,J_=`${F}/hp-number-text`,Y_=`${F}/hp-number-owner`,X_=e=>`HPB${e.slice(3)}`,Z_=e=>`HPN${e.slice(3)}`,Q_=(e,t,n)=>Math.max(t,Math.min(n,e)),$_=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},ev=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||yt.CURRENT_HP,maxHpBid:n?.attr_bid||yt.MAX_HP}},tv=(e,t)=>{let n=ev(t),r=e[D.HP_CURRENT_BID],i=e[D.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},nv=(e,t,n)=>{let r=e.metadata?.[`${F}/${t}`],i=e.metadata?.[`${F}/${n}`],a=$_(r),o=$_(i);return o===null||o<=0||a===null?null:Q_(a/o*100,0,100)},rv=(e,t,n)=>{let r=e.metadata?.[`${F}/${t}`],i=e.metadata?.[`${F}/${n}`],a=$_(r),o=$_(i);return a===null?null:{currentHp:Math.trunc(a),maxHp:o===null?null:Math.trunc(o)}},iv=e=>{let t=String(e||`bottom`).toLowerCase();return t===`top`||t===`bottom`||t===`left`||t===`right`?t:`bottom`},av=e=>{switch(iv(e)){case`top`:return 0;case`bottom`:return 1;case`left`:return 2;case`right`:return 3;default:return 1}},ov=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o,width:r,height:i}},sv=(e,t,n)=>{let r=ov(e,t),i=r.minX+r.width*.5,a=r.minY+r.height*.5,o;switch(n){case`top`:o={x:i,y:r.minY+r.height*.18};break;case`bottom`:o={x:i,y:r.minY+r.height*.82};break;case`left`:o={x:r.minX+r.width*.18,y:a};break;case`right`:o={x:r.minX+r.width*.82,y:a};break}let s=r.width*.25,c=r.height*.18;return{x:o.x-s,y:o.y-c}};const cv=()=>{let t=L(e=>e.cacheReady),i=L(e=>e.sceneReady),a=L(e=>e.items),o=L(e=>e.localItems),s=L(e=>e.gridDpi),l=L(e=>e.roomMetadata),u=L(e=>e.sceneMetadata),d=L(e=>e.systemData);return(0,I.useEffect)(()=>{if(!t||!i)return;let u=!1;return(async()=>{let t=l,i=t[D.SHOW_HP_BARS]??!1,f=t[D.SHOW_HP_NUMBERS]??!1,m=i,h=!i&&f,g=iv(t[D.HP_BAR_ORIENTATION]),_=av(t[D.HP_BAR_ORIENTATION]),{currentHpBid:v,maxHpBid:x}=tv(t,d?.attributes||[]),S=o.filter(e=>y(e)&&e.metadata?.[K_]===!0),C=o.filter(e=>b(e)&&e.metadata?.[J_]===!0);if(!m&&S.length>0)try{await c.scene.local.deleteItems(S.map(e=>e.id))}catch(e){O.error(`Failed to remove HP bar effects`,e)}if(!h&&C.length>0)try{await c.scene.local.deleteItems(C.map(e=>e.id))}catch(e){O.error(`Failed to remove HP number texts`,e)}if(!m&&!h)return;let w=a.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),T=new Map,E=new Map;for(let t of w){if(m){let e=nv(t,v,x);e!==null&&T.set(X_(t.id),{unitId:t.id,hpPercent:e})}if(h&&e(t)){let e=rv(t,v,x);if(e){let n=e.maxHp===null?`${e.currentHp}`:`${e.currentHp}/${e.maxHp}`;E.set(Z_(t.id),{unitId:t.id,text:n,position:sv(t,s,g)})}}}if(m){let e=new Map(S.map(e=>[e.id,e])),t=Array.from(T.entries()).filter(([t])=>!e.has(t)),n=S.filter(e=>!T.has(e.id)),i=S.filter(e=>{let t=T.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`orientation`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return e.attachedTo!==t.unitId||!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-_)>.001});if(u)return;if(n.length>0)try{await c.scene.local.deleteItems(n.map(e=>e.id))}catch(e){O.error(`Failed to remove stale HP bar effects`,e)}if(t.length>0){let e=t.map(([e,t])=>r().id(e).name(`HP Bar Effect`).effectType(`ATTACHMENT`).attachedTo(t.unitId).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).uniforms([{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}]).sksl(`
uniform vec2 size;
uniform float time;
