...
`,dp=tp.div({position:`fixed`,bottom:`0`,left:`0`,right:`0`,top:`0`,zIndex:`999`,backgroundColor:`rgba(0, 0, 0, 0.6)`}),fp=tp.div({position:`fixed`,bottom:`2px`,left:`2px`,zIndex:`1000`,display:`flex`,height:`3rem`,width:`3rem`,alignItems:`center`,justifyContent:`center`,borderRadius:`9999px`,"--tw-backdrop-blur":`blur(8px)`,WebkitBackdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`,backdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`}),pp=b.button`
  ...
  border: 2px solid ${e=>e.theme.BORDER};
  color: ${e=>e.theme.PRIMARY};
`,mp=({isOpen:e,currentPage:t,onToggle:n,onNavigate:r,canAccessInitiativeList:i=!0})=>{let{theme:a}=je(),o=N(e=>e.playerData),s=String(o?.role||``).toUpperCase()===`GM`;return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(Yc,{children:e&&(0,P.jsxs)(ip,{theme:a,initial:{x:-300},animate:{x:0},exit:{x:-300},transition:{type:`tween`,duration:.3},style:{boxShadow:`4px 0 12px rgba(0, 0, 0, 0.15)`},children:[(0,P.jsxs)(ap,{theme:a,children:[(0,P.jsx)(op,{theme:a,children:`Forge!`}),(0,P.jsx)(sp,{theme:a,children:`Alpha Testing!`})]}),(0,P.jsx)(cp,{}),(0,P.jsxs)(lp,{theme:a,children:[i&&(0,P.jsx)(up,{theme:a,$isActive:t===`ForgeMain`,onClick:()=>r(`ForgeMain`),children:`Main`}),(0,P.jsx)(up,{theme:a,$isActive:t===`Party`,onClick:()=>r(`Party`),children:`Party`}),(0,P.jsx)(up,{theme:a,$isActive:t===`ChatLog`,onClick:()=>r(`ChatLog`),children:`System Log`}),s&&(0,P.jsx)(up,{theme:a,$isActive:t===`System`,onClick:()=>r(`System`),children:`System`}),s&&(0,P.jsx)(up,{theme:a,$isActive:t===`Settings`,onClick:()=>r(`Settings`),children:`Settings`})]})]})}),e&&(0,P.jsx)(dp,{onClick:n}),(0,P.jsx)(fp,{children:(0,P.jsx)(pp,{theme:a,onClick:n,children:(0,P.jsx)(he,{size:24})})})]})},hp=b.div`
  padding: 20px;
  color: ${e=>e.theme.PRIMARY};
  min-height: 100vh;
`,gp=b.h1`
...
`;const X=({label:e,isOn:t,onChange:n})=>{let{theme:r}=je();return(0,P.jsx)(bp,{theme:r,$isOn:t,onClick:()=>{let r=!t;D.log(`${e}: ${r}`),n(r)},role:`switch`,"aria-checked":t,"aria-label":e})};var xp=b.h2`
...
`,Ep=tp.div({marginTop:`0.5rem`,display:`flex`,justifyContent:`center`,gap:`0.75rem`});const Dp=()=>{let{theme:e}=je();N(e=>e.roomMetadata);let t=N(e=>e.sceneMetadata),n=N(e=>e.items),r=N(e=>e.cacheReady),[i,a]=(0,j.useState)(!1),[o,s]=(0,j.useState)(!1),[u,d]=(0,j.useState)(`D20`),[f,p]=(0,j.useState)(!1),[h,g]=(0,j.useState)(!1),[_,v]=(0,j.useState)(!1),[y,b]=(0,j.useState)(!0),[x,S]=(0,j.useState)(!1),[C,w]=(0,j.useState)(!0),[T,ee]=(0,j.useState)(!1),[te,ne]=(0,j.useState)(`bottom`),[re,E]=(0,j.useState)(!1),[O,ae]=(0,j.useState)(!1),[oe,se]=(0,j.useState)(!1),[ce,le]=(0,j.useState)(!1),[ue,de]=(0,j.useState)(!1),[fe,k]=(0,j.useState)(!1),[me,he]=(0,j.useState)(!1),[_e,ve]=(0,j.useState)(!1),[A,ye]=(0,j.useState)(!1),[be,xe]=(0,j.useState)(!1),[M,Se]=(0,j.useState)(!1),[Ce,we]=(0,j.useState)(``),[Te,Ee]=(0,j.useState)(!1),De=(0,j.useRef)(null),F=t;(0,j.useEffect)(()=>{if(r)if(F[m.POPCORN_INITIATIVE]!==void 0&&a(F[m.POPCORN_INITIATIVE]),F[m.REVERSE_INITIATIVE]!==void 0&&s(F[m.REVERSE_INITIATIVE]),F[m.DICE_RANGE]!==void 0&&d(F[m.DICE_RANGE]),F[m.SHOW_CARD_ACCESS]!==void 0&&p(F[m.SHOW_CARD_ACCESS]),F[m.SHOW_PLAYER_VIEW]!==void 0&&g(F[m.SHOW_PLAYER_VIEW]),F[m.SHOW_OWNER_ONLY_EDIT]!==void 0&&S(F[m.SHOW_OWNER_ONLY_EDIT]),F[m.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?w(!0):w(F[m.SHOW_MODIFY_UNIT_CONTEXT_MENU]),F[m.SHOW_NON_PARTY_UNITS]!==void 0&&v(F[m.SHOW_NON_PARTY_UNITS]),F[m.SHOW_LIST_HP_NUMBERS]===void 0?b(!0):b(F[m.SHOW_LIST_HP_NUMBERS]),F[m.SHOW_HP_BARS]!==void 0&&ee(F[m.SHOW_HP_BARS]),F[m.HP_BAR_ORIENTATION]!==void 0&&ne(F[m.HP_BAR_ORIENTATION]),F[m.SHOW_HP_NUMBERS]!==void 0&&E(F[m.SHOW_HP_NUMBERS]),F[m.SHOW_DEATH_EFFECT]!==void 0&&ae(F[m.SHOW_DEATH_EFFECT]),F[m.SHOW_NAMES]!==void 0&&se(F[m.SHOW_NAMES]),F[m.SHOW_TURN_EFFECT]!==void 0&&le(F[m.SHOW_TURN_EFFECT]),F[m.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&de(F[m.USE_DESCRIPTIVE_DUPLICATES]),F[m.ENABLE_RUMBLE]!==void 0&&k(F[m.ENABLE_RUMBLE]),F[m.ENABLE_BONES]!==void 0&&he(F[m.ENABLE_BONES]),F[m.ENABLE_DICE_PLUS]!==void 0&&ve(F[m.ENABLE_DICE_PLUS]),F[m.ENABLE_OBR_NOTIFICATION]!==void 0&&ye(F[m.ENABLE_OBR_NOTIFICATION]),F[m.SHOW_NOTIFICATION_TO_ALL]!==void 0&&xe(F[m.SHOW_NOTIFICATION_TO_ALL]),F[m.ENABLE_DISCORD_LOGGING]!==void 0&&Se(F[m.ENABLE_DISCORD_LOGGING]),F[m.DISCORD_URL]!==void 0&&we(F[m.DISCORD_URL]),F[m.ENABLE_CONSOLE_LOG]!==void 0){let e=F[m.ENABLE_CONSOLE_LOG];Ee(e),D.setEnabled(e)}else Ee(!1)},[r,F]);let I=async(e,t)=>{await c.scene.setMetadata({[e]:t})};return(0,P.jsx)(Bu.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},children:(0,P.jsxs)(hp,{theme:e,children:[(0,P.jsx)(gp,{theme:e,children:`Settings`}),(0,P.jsxs)(_p,{theme:e,children:[(0,P.jsx)(xp,{theme:e,children:`Collection Management`}),(0,P.jsxs)(Ep,{children:[(0,P.jsx)(vp,{theme:e,onClick:async()=>{try{let e=await ie(),t=JSON.stringify(e,null,2),n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`forge-collection-${new Date().toISOString().slice(0,10)}.txt`,i.click(),URL.revokeObjectURL(r),alert(`Collection export complete. ${e.length} record(s) written.`)}catch(e){D.log(`Collection export failed`,e),alert(`Collection export failed. See console log for details.`)}},children:`Export`}),(0,P.jsx)(vp,{theme:e,onClick:()=>{window.confirm(`Import will overwrite duplicate records that share the same Name and Author. Continue?`)&&De.current?.click()},children:`Import`})]}),(0,P.jsx)(`input`,{ref:De,type:`file`,accept:`.txt,.json,text/plain,application/json`,onChange:async e=>{let t=e.target.files?.[0];if(t)try{let e=await t.text(),n=JSON.parse(e);if(!Array.isArray(n)){alert(`Import file must contain a JSON array of collection records.`);return}let r=await pe(n);alert(`Collection import complete. Created: ${r.created}, Updated: ${r.updated}, Skipped: ${r.skipped}.`)}catch(e){D.log(`Collection import failed`,e),alert(`Collection import failed. Ensure the file is valid JSON and try again.`)}finally{e.target.value=``}},style:{display:`none`}})]}),(0,P.jsxs)(_p,{theme:e,children:[(0,P.jsx)(xp,{theme:e,children:`List Controls`}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Reverse Initiative`}),(0,P.jsx)(X,{label:`Reverse Initiative`,isOn:o,onChange:async e=>{s(e),await I(m.REVERSE_INITIATIVE,e),e&&i&&(a(!1),await I(m.POPCORN_INITIATIVE,!1))}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Popcorn Initiative`}),(0,P.jsx)(X,{label:`Popcorn Initiative`,isOn:i,onChange:async e=>{a(e),await I(m.POPCORN_INITIATIVE,e),e&&o&&(s(!1),await I(m.REVERSE_INITIATIVE,!1))}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Initiative Die: `}),(0,P.jsx)(wp,{theme:e,type:`text`,value:u,onChange:async e=>{let t=e.target.value;d(t),await I(m.DICE_RANGE,t),D.log(`Dice Range:`,t)},placeholder:`D20`,maxLength:3})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show Card Column`}),(0,P.jsx)(X,{label:`Show Stat Block Access`,isOn:f,onChange:async e=>{p(e),await I(m.SHOW_CARD_ACCESS,e)}})]})]}),(0,P.jsxs)(_p,{theme:e,children:[(0,P.jsx)(xp,{theme:e,children:`Player Controls`}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show Player View`}),(0,P.jsx)(X,{label:`Show Player View`,isOn:h,onChange:async e=>{g(e),await I(m.SHOW_PLAYER_VIEW,e)}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show Non-Party Units`}),(0,P.jsx)(X,{label:`Show Non-Party Units`,isOn:_,onChange:async e=>{v(e),await I(m.SHOW_NON_PARTY_UNITS,e)}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show HP Numbers on List`}),(0,P.jsx)(X,{label:`Show HP Numbers on List`,isOn:y,onChange:async e=>{b(e),await I(m.SHOW_LIST_HP_NUMBERS,e)}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`GM/Owner Only Edit`}),(0,P.jsx)(X,{label:`Owner Only Edit`,isOn:x,onChange:async e=>{S(e),await I(m.SHOW_OWNER_ONLY_EDIT,e)}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show Adjust HP Context Menu`}),(0,P.jsx)(X,{label:`Show Adjust HP Context Menu`,isOn:C,onChange:async e=>{w(e),await I(m.SHOW_MODIFY_UNIT_CONTEXT_MENU,e)}})]})]}),(0,P.jsxs)(_p,{theme:e,children:[(0,P.jsx)(xp,{theme:e,children:`Game Controls`}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show HP Bars on tokens`}),(0,P.jsx)(X,{label:`Show HP Bars on tokens`,isOn:T,onChange:async e=>{ee(e),await I(m.SHOW_HP_BARS,e),e&&re&&(E(!1),await I(m.SHOW_HP_NUMBERS,!1)),e&&F[m.HP_BAR_ORIENTATION]===void 0&&(ne(`bottom`),await I(m.HP_BAR_ORIENTATION,`bottom`))}})]}),(T||re)&&(0,P.jsxs)(Sp,{theme:e,children:[(0,P.jsx)(Cp,{theme:e,children:`Orientation: `}),(0,P.jsxs)(Tp,{theme:e,value:te,onChange:async e=>{let t=e.target.value;ne(t),await I(m.HP_BAR_ORIENTATION,t)},children:[(0,P.jsx)(`option`,{value:`top`,children:`Top`}),(0,P.jsx)(`option`,{value:`bottom`,children:`Bottom`}),(0,P.jsx)(`option`,{value:`left`,children:`Left`}),(0,P.jsx)(`option`,{value:`right`,children:`Right`})]})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show HP Numbers on tokens`}),(0,P.jsx)(X,{label:`Show HP Numbers on tokens`,isOn:re,onChange:async e=>{E(e),await I(m.SHOW_HP_NUMBERS,e),e&&T&&(ee(!1),await I(m.SHOW_HP_BARS,!1)),e&&F[m.HP_BAR_ORIENTATION]===void 0&&(ne(`bottom`),await I(m.HP_BAR_ORIENTATION,`bottom`))}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show Death Effect`}),(0,P.jsx)(X,{label:`Show Death Effect`,isOn:O,onChange:async e=>{ae(e),await I(m.SHOW_DEATH_EFFECT,e)}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show Names on Tokens`}),(0,P.jsx)(X,{label:`Show names on tokens`,isOn:oe,onChange:async e=>{se(e),await I(m.SHOW_NAMES,e);let t=n.filter(e=>e.metadata[l.ON_LIST]===!0);e?(D.log(`Showing names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t.metadata[l.UNIT_NAME],n=t;e&&n.text&&(n.text.plainText=String(e))}})):(D.log(`Hiding names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t;e.text&&(e.text.plainText=``)}}))}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show Turn Effect`}),(0,P.jsx)(X,{label:`Show Turn Effect`,isOn:ce,onChange:async e=>{le(e),await I(m.SHOW_TURN_EFFECT,e)}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Use Descriptive Names`}),(0,P.jsx)(X,{label:`Use Descriptive Duplicates Names`,isOn:ue,onChange:async e=>{de(e),await I(m.USE_DESCRIPTIVE_DUPLICATES,e)}})]})]}),(0,P.jsxs)(_p,{theme:e,children:[(0,P.jsx)(xp,{theme:e,children:`Dice Controls`}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Enable Rumble! Integration`}),(0,P.jsx)(X,{label:`Enable Rumble! Integration`,isOn:fe,onChange:async e=>{k(e),await I(m.ENABLE_RUMBLE,e),e&&(he(!1),ve(!1),await I(m.ENABLE_BONES,!1),await I(m.ENABLE_DICE_PLUS,!1))}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Enable Bones! Integration`}),(0,P.jsx)(X,{label:`Enable Bones! Integration`,isOn:me,onChange:async e=>{he(e),await I(m.ENABLE_BONES,e),e&&(k(!1),ve(!1),await I(m.ENABLE_RUMBLE,!1),await I(m.ENABLE_DICE_PLUS,!1))}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Enable Dice+ Integration`}),(0,P.jsx)(X,{label:`Enable Dice+ Integration`,isOn:_e,onChange:async e=>{ve(e),await I(m.ENABLE_DICE_PLUS,e),e&&(k(!1),he(!1),await I(m.ENABLE_RUMBLE,!1),await I(m.ENABLE_BONES,!1))}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Enable OBR Notification`}),(0,P.jsx)(X,{label:`Enable OBR Notification`,isOn:A,onChange:async e=>{ye(e),await I(m.ENABLE_OBR_NOTIFICATION,e)}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Show Results to All`}),(0,P.jsx)(X,{label:`Show Results to All`,isOn:be,onChange:async e=>{xe(e),await I(m.SHOW_NOTIFICATION_TO_ALL,e)}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Enable Discord Logging`}),(0,P.jsx)(X,{label:`Enable Discord Logging`,isOn:M,onChange:async e=>{if(e&&!ge(Ce.trim())){alert(`Please enter a valid Discord webhook URL before enabling Discord logging.`),Se(!1),await I(m.ENABLE_DISCORD_LOGGING,!1);return}Se(e),await I(m.ENABLE_DISCORD_LOGGING,e)}})]}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Cp,{theme:e,children:`Discord Url: `}),(0,P.jsx)(wp,{theme:e,type:`text`,value:Ce,onChange:async e=>{let t=e.target.value,n=t.trim();we(t),await I(m.DISCORD_URL,n),D.log(`Discord URL:`,n)},placeholder:`https://discord.com/api/webhooks/...`,maxLength:200})]})]}),(0,P.jsxs)(_p,{theme:e,children:[(0,P.jsx)(xp,{theme:e,children:`Other`}),(0,P.jsxs)(Z,{theme:e,children:[(0,P.jsx)(Q,{theme:e,children:`Enable Console Log`}),(0,P.jsx)(X,{label:`Enable Console Log`,isOn:Te,onChange:async e=>{Ee(e),D.setEnabled(e),await I(m.ENABLE_CONSOLE_LOG,e)}})]})]})]})})};var Op=b.div`
...
`;const Np=()=>{let e=Ee(e=>e.messages),t=(0,j.useRef)(null),{theme:n}=je();return(0,j.useEffect)(()=>{t.current?.scrollIntoView({behavior:`smooth`})},[e]),(0,P.jsx)(Bu.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,P.jsxs)(Op,{children:[(0,P.jsx)(gp,{theme:n,children:`System Log`}),(0,P.jsxs)(kp,{children:[e.map(e=>(0,P.jsxs)(Ap,{children:[(0,P.jsx)(jp,{children:e.timestamp}),(0,P.jsx)(Mp,{children:e.text})]},e.id)),(0,P.jsx)(`div`,{ref:t})]})]})})};var Pp=b.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`;const zp=({isOpen:e,title:t,onClose:n,children:r,actions:i,closeOnOverlayClick:a=!0,minWidth:o,maxWidth:s})=>{let{theme:c}=je();return e?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(Pp,{onClick:a?n:void 0}),(0,P.jsxs)(Fp,{theme:c,$minWidth:o,$maxWidth:s,onClick:e=>e.stopPropagation(),children:[t&&(0,P.jsx)(Ip,{theme:c,children:t}),(0,P.jsx)(Lp,{children:r}),i&&(0,P.jsx)(Rp,{children:i})]})]}):null},Bp=`buff_effect_one`,Vp=`debuff_effect_one`,Hp=[{value:`buff_effect_one`,label:`Buff Effect One`},{value:`buff_effect_two`,label:`Buff Effect Two`}],Up=[{value:`debuff_effect_one`,label:`Debuff Effect One`},{value:`debuff_effect_two`,label:`Debuff Effect Two`}],Wp=e=>Hp.some(t=>t.value===e),Gp=e=>Up.some(t=>t.value===e),Kp=e=>{switch(e){case`buff_effect_two`:return`
uniform float2 size;
uniform float time;
...
`,Sm={initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20}};const Cm=()=>{let{theme:e,updateThemeFromSystem:t}=je(),n=N(e=>e.sceneMetadata),[r,i]=(0,j.useState)(``),[a,o]=(0,j.useState)(!1),[s,l]=(0,j.useState)(null),[u,d]=(0,j.useState)(null),[f,p]=(0,j.useState)(``),[h,g]=(0,j.useState)(null),[_,v]=(0,j.useState)(null),[b,x]=(0,j.useState)([]),[S,C]=(0,j.useState)(``),[w,ee]=(0,j.useState)(``),[te,ne]=(0,j.useState)(Bp),[re,E]=(0,j.useState)(Vp),[ie,O]=(0,j.useState)([]),[ae,oe]=(0,j.useState)(!1),[se,le]=(0,j.useState)(null),[de,fe]=(0,j.useState)(``);(0,j.useEffect)(()=>{pe(),he()},[n]),(0,j.useEffect)(()=>{pe(),he()},[n]);let pe=()=>{try{let e=n[$.CURRENT_THEME],t=n[$.CURRENT_ATTR],r=n[$.SYSTEM_NAME]||T.name,i=n[$.IMPORT_DATE]||null,a=n[m.HP_CURRENT_BID],o=n[m.HP_MAX_BID],s=n[m.BUFF_VISUAL_PRESET],c=n[m.DEBUFF_VISUAL_PRESET],l=Array.isArray(t)?t:[];p(r),g(i),v(e||null),x(l),C(a||``),ee(o||``),ne(Wp(s)?s:Bp),E(Gp(c)?c:Vp)}catch(e){D.error(`Error loading system from cache:`,e)}},k=async(e,t)=>{await c.scene.setMetadata({[e]:t})},me=b.filter(e=>e.attr_type===`numb`),he=()=>{try{let e=[];for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);if(n&&n.startsWith(`${Yp}.`)&&n.endsWith(`.backup`)){let t=localStorage.getItem(n);if(t){let n=JSON.parse(t);e.push(n)}}}e.sort((e,t)=>new Date(t.backupDate).getTime()-new Date(e.backupDate).getTime()),O(e)}catch(e){D.error(`Error loading backups:`,e)}},ge=async e=>{try{let e=n[$.CURRENT_THEME],t=n[$.CURRENT_CARD],r=n[$.CURRENT_LIST],i=n[$.CURRENT_ATTR],a=n[$.SYSTEM_NAME]||T.name;if(!e||!Array.isArray(t)||!Array.isArray(r)||!Array.isArray(i)){D.warn(`Cannot create backup: system data incomplete`);return}let o={name:a,backupDate:new Date().toISOString(),theme_primary:e.primary,theme_offset:e.offset,theme_background:e.background,theme_border:e.border,background_url:e.background_url,card_layout:t,list_layout:r,attributes:i},s=`${Yp}.${a}.backup`;localStorage.setItem(s,JSON.stringify(o)),D.log(`Backup created for ${a}`),he()}catch(e){throw D.error(`Error creating backup:`,e),e}},_e=e=>{try{let t=`${Yp}.${e}.backup`;localStorage.removeItem(t),D.log(`Backup deleted for ${e}`),he(),d(`Backup for "${e}" deleted successfully`)}catch(e){D.error(`Error deleting backup:`,e),l(`Failed to delete backup`)}},ve=(e,t)=>{fe(e),le(()=>t),oe(!0)},A=async()=>{oe(!1),se&&(await se(),le(null))},ye=()=>{oe(!1),le(null),fe(``)},be=async()=>{if(!r.trim()){l(`Please enter a share_id`);return}ve(`This will overwrite your current system data. A backup of your current system will be saved to local storage. Do you want to continue?`,async()=>{await xe()})},xe=async()=>{o(!0),l(null),d(null);try{let{data:e,error:n}=await ue.from(`v_bs_system_with_attributes`).select(`*`).eq(`share_id`,r).maybeSingle();if(n)throw n;if(!e){l(`No system found with that share_id`),o(!1);return}let a=e,s=Zp(a.card_layout,`card_layout`),u=Zp(a.list_layout,`list_layout`),m=a.attributes;if(!Array.isArray(m))throw Error(`Imported attributes are not a valid array`);await ge(f);let h={primary:a.theme_primary,offset:a.theme_offset,background:a.theme_background,border:a.theme_border,background_url:a.background_url};await c.scene.setMetadata({[$.CURRENT_THEME]:h,[$.CURRENT_CARD]:s,[$.CURRENT_LIST]:u,[$.CURRENT_ATTR]:m,[$.SYSTEM_NAME]:a.name,[$.IMPORT_DATE]:new Date().toISOString()}),p(a.name),g(new Date().toISOString()),v(h),t(h.primary,h.offset,h.background,h.border,h.background_url),d(`System "${a.name}" loaded successfully! Backup created.`),i(``),D.log(`System loaded:`,a.name)}catch(e){D.error(`Error fetching system:`,e),l(Xp(e,`An error occurred while fetching the system`))}finally{o(!1)}},M=async e=>{ve(`This will restore the system "${e.name}" from backup. A backup of your current system will be created. Do you want to continue?`,async()=>{await Se(e)})},Se=async e=>{o(!0),l(null),d(null);try{await ge(f);let n={primary:e.theme_primary,offset:e.theme_offset,background:e.theme_background,border:e.theme_border,background_url:e.background_url};if(!Array.isArray(e.card_layout)||!Array.isArray(e.list_layout)||!Array.isArray(e.attributes))throw Error(`Backup data is invalid`);await c.scene.setMetadata({[$.CURRENT_THEME]:n,[$.CURRENT_CARD]:e.card_layout,[$.CURRENT_LIST]:e.list_layout,[$.CURRENT_ATTR]:e.attributes,[$.SYSTEM_NAME]:e.name,[$.IMPORT_DATE]:new Date().toISOString()}),p(e.name),g(new Date().toISOString()),v(n),t(n.primary,n.offset,n.background,n.border,n.background_url),d(`System "${e.name}" restored from backup successfully!`),D.log(`System restored from backup:`,e.name)}catch(e){D.error(`Error restoring backup:`,e),l(`Failed to restore system from backup`)}finally{o(!1)}},Ce=async()=>{o(!0),l(null),d(null);try{let e={primary:T.theme_primary,offset:T.theme_offset,background:T.theme_background,border:T.theme_border,background_url:T.background_url};await c.scene.setMetadata({[$.CURRENT_THEME]:e,[$.CURRENT_CARD]:T.card_layout,[$.CURRENT_LIST]:T.list_layout,[$.CURRENT_ATTR]:T.attributes,[$.SYSTEM_NAME]:T.name,[$.IMPORT_DATE]:null}),p(T.name),g(null),v(e),t(e.primary,e.offset,e.background,e.border,e.background_url),d(`Reset to default system successfully!`)}catch(e){l(`Failed to reset to default system`),D.error(`Error resetting to default:`,e)}finally{o(!1)}},we=e=>e?new Date(e).toLocaleDateString(`en-US`,{year:`numeric`,month:`long`,day:`numeric`,hour:`2-digit`,minute:`2-digit`}):null;return(0,P.jsxs)(Bu.div,{variants:Sm,initial:`initial`,animate:`animate`,exit:`exit`,children:[(0,P.jsxs)(hp,{theme:e,children:[(0,P.jsx)(gp,{theme:e,children:`System Configuration`}),(0,P.jsx)(em,{theme:e,children:f}),h?(0,P.jsxs)(tm,{theme:e,children:[`Imported: `,we(h)]}):(0,P.jsx)(tm,{theme:e,children:`Using Default System`}),_&&(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(nm,{children:[(0,P.jsxs)(`div`,{children:[(0,P.jsx)(rm,{color:_.primary,theme:e,children:_.primary}),(0,P.jsx)(im,{theme:e,children:`PRIMARY`})]}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(rm,{color:_.offset,theme:e,children:_.offset}),(0,P.jsx)(im,{theme:e,children:`OFFSET`})]}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(rm,{color:_.background,theme:e,children:_.background}),(0,P.jsx)(im,{theme:e,children:`BG`})]}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(rm,{color:_.border,theme:e,children:_.border}),(0,P.jsx)(im,{theme:e,children:`BORDER`})]})]}),(0,P.jsxs)(am,{theme:e,children:[(0,P.jsx)(om,{theme:e,children:`System Settings`}),(0,P.jsxs)(sm,{children:[(0,P.jsx)(cm,{theme:e,children:`Current HP`}),(0,P.jsxs)(lm,{theme:e,value:S,onChange:async e=>{let t=e.target.value;C(t),await k(m.HP_CURRENT_BID,t)},children:[(0,P.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),me.map(e=>(0,P.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,P.jsxs)(sm,{children:[(0,P.jsx)(cm,{theme:e,children:`Max HP`}),(0,P.jsxs)(lm,{theme:e,value:w,onChange:async e=>{let t=e.target.value;ee(t),await k(m.HP_MAX_BID,t)},children:[(0,P.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),me.map(e=>(0,P.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,P.jsxs)(sm,{children:[(0,P.jsx)(cm,{theme:e,children:`Buff Visual`}),(0,P.jsx)(lm,{theme:e,value:te,onChange:async e=>{let t=e.target.value;Wp(t)&&(ne(t),await k(m.BUFF_VISUAL_PRESET,t))},children:Hp.map(e=>(0,P.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,P.jsxs)(sm,{children:[(0,P.jsx)(cm,{theme:e,children:`Debuff Visual`}),(0,P.jsx)(lm,{theme:e,value:re,onChange:async e=>{let t=e.target.value;Gp(t)&&(E(t),await k(m.DEBUFF_VISUAL_PRESET,t))},children:Up.map(e=>(0,P.jsx)(`option`,{value:e.value,children:e.label},e.value))})]})]})]}),(0,P.jsxs)($p,{theme:e,children:[(0,P.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0},children:`Import New System`}),(0,P.jsx)(`p`,{style:{color:y(e.PRIMARY,.8),fontSize:`14px`},children:`Enter a share_id to download and activate a new game system configuration.`}),(0,P.jsx)(Qp,{children:(0,P.jsx)(yp,{theme:e,type:`text`,value:r,onChange:e=>i(e.target.value),placeholder:`Enter Share Id...`,disabled:a,onKeyPress:e=>e.key===`Enter`&&be()})}),(0,P.jsxs)(fm,{children:[(0,P.jsx)(vp,{theme:e,onClick:be,disabled:a||!r.trim(),children:a?`....!`:`Import System`}),(0,P.jsx)(vp,{theme:e,variant:`secondary`,onClick:Ce,disabled:a,children:`Use Default`})]})]}),s&&(0,P.jsxs)(um,{theme:e,children:[(0,P.jsx)(`strong`,{children:`Error:`}),` `,s]}),u&&(0,P.jsxs)(dm,{theme:e,children:[(0,P.jsx)(`strong`,{children:`Success:`}),` `,u]}),ie.length>0&&(0,P.jsx)(mm,{children:(0,P.jsxs)(_p,{theme:e,children:[(0,P.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0,marginBottom:`15px`},children:`System Backups`}),(0,P.jsx)(hm,{children:ie.map(t=>(0,P.jsxs)(gm,{theme:e,children:[(0,P.jsxs)(_m,{children:[(0,P.jsx)(vm,{theme:e,children:t.name}),(0,P.jsxs)(ym,{theme:e,children:[`Backed up: `,we(t.backupDate)]})]}),(0,P.jsxs)(bm,{children:[(0,P.jsx)(xm,{theme:e,onClick:()=>M(t),disabled:a,title:`Import this backup`,children:(0,P.jsx)(cd,{size:18})}),(0,P.jsx)(xm,{theme:e,$variant:`danger`,onClick:()=>_e(t.name),disabled:a,title:`Delete this backup`,children:(0,P.jsx)(ce,{size:18})})]})]},`${t.name}-${t.backupDate}`))})]})})]}),(0,P.jsx)(zp,{isOpen:ae,title:`Confirm Action`,onClose:ye,actions:(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(vp,{theme:e,variant:`secondary`,onClick:ye,children:`Cancel`}),(0,P.jsx)(vp,{theme:e,onClick:A,children:`Confirm`})]}),children:(0,P.jsx)(pm,{theme:e,children:de})})]},`system`)},wm=()=>{let[e,t]=(0,j.useState)({theme:null,cardLayout:[],listLayout:[],attributes:[],systemName:T.name,importDate:null,isLoading:!0}),n=N(e=>e.sceneMetadata);return(0,j.useEffect)(()=>{try{let e=n[$.CURRENT_THEME],r=n[$.CURRENT_CARD],i=n[$.CURRENT_LIST],a=n[$.CURRENT_ATTR];if(!e||!Array.isArray(r)||!Array.isArray(i)||!Array.isArray(a)){D.log(`System data missing, using defaults`),t({theme:{primary:T.theme_primary,offset:T.theme_offset,background:T.theme_background,border:T.theme_border,background_url:T.background_url},cardLayout:T.card_layout,listLayout:T.list_layout,attributes:T.attributes,systemName:T.name,importDate:null,isLoading:!1});return}t({theme:e,cardLayout:r,listLayout:i,attributes:a,systemName:n[$.SYSTEM_NAME]||T.name,importDate:n[$.IMPORT_DATE]||null,isLoading:!1})}catch(e){D.error(`Error loading system data:`,e),t({theme:{primary:T.theme_primary,offset:T.theme_offset,background:T.theme_background,border:T.theme_border,background_url:T.background_url},cardLayout:T.card_layout,listLayout:T.list_layout,attributes:T.attributes,systemName:T.name,importDate:null,isLoading:!1})}},[n]),e};function Tm(e,t){let n=e.replace(`#`,``);n.length===3&&(n=n.split(``).map(e=>e+e).join(``));let r=parseInt(n,16);return`rgba(${r>>16&255}, ${r>>8&255}, ${r&255}, ${t})`}var Em=class{static async CenterViewportOnImage(e){let t=await c.scene.grid.getDpi(),n=await c.viewport.getScale(),r=await c.viewport.getWidth(),i=await c.viewport.getHeight(),a={x:r/2,y:i/2},o={x:a.x/n,y:a.y/n},s=await this.GetImageCenter(e,t),l={x:s.x-o.x,y:s.y-o.y},u={x:l.x*n*-1,y:l.y*n*-1};await c.viewport.animateTo({position:u,scale:n})}static async GetImageCenter(e,t){if(n(e)){let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{x:e.position.x-a+r/2,y:e.position.y-o+i/2}}else if(_(e)&&e.points.length>0)return{x:e.points[0].x,y:e.points[0].y};else return{x:e.position.x,y:e.position.y}}};const Dm=`${A}/effects`;var Om=`${A}/effects-expired`,km=b.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,Am=b.div`
...
`,qm=b.span`
  ...
  font-weight: 700;
  padding: 0 3px;
`,Jm=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const Ym=({items:e,units:t,setItems:n,playerData:r})=>{let[i,a]=(0,j.useState)(null),[o,s]=(0,j.useState)(``),[u,d]=(0,j.useState)(`1`),[f,p]=(0,j.useState)(`rounds`),[m,h]=(0,j.useState)(`start`),[g,_]=(0,j.useState)(`neutral`),[v,y]=(0,j.useState)([]),[b,x]=(0,j.useState)(null),S=(0,j.useMemo)(()=>{let t=new Map;return e.forEach(e=>{e.metadata?.[l.ON_LIST]===!0&&t.set(e.id,Jm(e.metadata?.[Dm]))}),t},[e]),C=e=>S.get(e)||[],w=async(t,r)=>{let i=r.filter(e=>e.remaining>0);n(e.map(e=>{if(e.id!==t)return e;let n={...e.metadata||{}};return i.length>0?n[Dm]=i:delete n[Dm],{...e,metadata:n}})),await c.scene.items.updateItems([t],e=>{let t={...e[0].metadata||{}};i.length>0?t[Dm]=i:delete t[Dm],e[0].metadata=t})},T=async e=>{try{await c.broadcast.sendMessage(Om,{message:e},{destination:`ALL`})}catch(t){D.error(`Failed to broadcast expired effect message`,t),await c.notification.show(e,`WARNING`)}},ee=async(t,n)=>{if(String(r?.role||``).toUpperCase()!==`GM`)return;let i=[],a=[];e.forEach(e=>{if(e.metadata?.[l.ON_LIST]!==!0)return;let r=Jm(e.metadata?.[Dm]);if(r.length===0)return;let o=!1,s=[];r.forEach(r=>{if(!(r.endTiming===t&&(r.durationType===`turns`||e.id===n))){s.push(r);return}let i=r.remaining-1;if(o=!0,i<=0){a.push(`${e.name||`Unit`}: ${r.name} expired`);return}s.push({...r,remaining:i})}),o&&i.push({unitId:e.id,effects:s})});for(let e of i)await w(e.unitId,e.effects);if(a.length>0)for(let e of a)await T(e)},te=(0,j.useMemo)(()=>i&&t.find(e=>e.id===i)||null,[i,t]),ne=(0,j.useMemo)(()=>i?C(i):[],[i,S]);return(0,j.useEffect)(()=>{let e=c.broadcast.onMessage(Om,async e=>{let t=e.data?.message;typeof t!=`string`||!t.trim()||await c.notification.show(t,`WARNING`)});return()=>{e()}},[]),{effectsModalUnitId:i,selectedEffectsUnit:te,activeEffectsForSelectedUnit:ne,effectNameInput:o,setEffectNameInput:s,effectDurationInput:u,setEffectDurationInput:d,effectDurationType:f,setEffectDurationType:p,effectEndTiming:m,setEffectEndTiming:h,effectType:g,setEffectType:_,effectTargetIds:v,setEffectTargetIds:e=>{y(Array.from(new Set(e)))},effectsModalError:b,units:t,getEffectsForUnit:C,handleOpenEffectsModal:e=>{x(null),s(``),d(`1`),p(`rounds`),h(`start`),_(`neutral`),y([e]),a(e)},handleCloseEffectsModal:()=>{a(null),x(null)},handleAddEffect:async()=>{if(!i)return;let n=o.trim(),r=parseInt(u,10);if(!n){x(`Enter an effect name.`);return}if(!Number.isFinite(r)||r<=0){x(`Duration must be a positive number.`);return}let a=Array.from(new Set(v.filter(e=>t.some(t=>t.id===e))));if(a.length===0){x(`Select at least one target.`);return}let c=C(i),l=te?.name||e.find(e=>e.id===i)?.name||`Unknown`,p={id:crypto.randomUUID(),name:n,remaining:r,durationType:f,endTiming:m,effectType:g,targets:a,createdByName:l,createdById:i};await w(i,[...c,p]),x(null),s(``),d(`1`),_(`neutral`),y([i])},handleDeleteEffect:async e=>{i&&await w(i,C(i).filter(t=>t.id!==e))},processEffectsForTurnEvent:ee}},Xm=({manager:e})=>{let{theme:t}=je(),n=(0,j.useMemo)(()=>{let t=new Map;return e.units.forEach(e=>{t.set(e.id,e.name)}),t},[e.units]),r=e=>e===`buff`?`Buff`:e===`debuff`?`Debuff`:`Neutral`,i=e=>{if(e.length===0)return`No targets`;let t=e.map(e=>n.get(e)).filter(e=>typeof e==`string`&&e.length>0);return t.length===0?`${e.length} target${e.length===1?``:`s`}`:t.length<=2?t.join(`, `):`${t.slice(0,2).join(`, `)} +${t.length-2}`};return(0,P.jsx)(zp,{isOpen:!!e.effectsModalUnitId,title:e.selectedEffectsUnit?`Effects: ${e.selectedEffectsUnit.name}`:`Effects`,onClose:e.handleCloseEffectsModal,minWidth:`520px`,maxWidth:`600px`,children:(0,P.jsxs)(km,{children:[(0,P.jsxs)(Am,{children:[(0,P.jsxs)(jm,{children:[(0,P.jsxs)(Mm,{style:{flex:`0 0 120px`},children:[(0,P.jsx)(Pm,{theme:t,children:`Effect`}),(0,P.jsx)(Fm,{theme:t,type:`text`,placeholder:`Name`,value:e.effectNameInput,onChange:t=>e.setEffectNameInput(t.target.value)})]}),(0,P.jsxs)(Mm,{style:{flex:`0 0 140px`},children:[(0,P.jsx)(Pm,{theme:t,children:`Duration`}),(0,P.jsx)(Fm,{theme:t,type:`number`,min:1,value:e.effectDurationInput,onChange:t=>e.setEffectDurationInput(t.target.value)})]}),(0,P.jsxs)(Mm,{style:{flex:`0 0 120px`},children:[(0,P.jsx)(Pm,{theme:t,children:`By`}),(0,P.jsxs)(Im,{theme:t,value:e.effectDurationType,onChange:t=>e.setEffectDurationType(t.target.value),children:[(0,P.jsx)(`option`,{value:`turns`,children:`Turns`}),(0,P.jsx)(`option`,{value:`rounds`,children:`Rounds`})]})]})]}),(0,P.jsxs)(jm,{children:[(0,P.jsxs)(Mm,{style:{flex:`0 0 120px`},children:[(0,P.jsx)(Pm,{theme:t,children:`Type`}),(0,P.jsxs)(Im,{theme:t,value:e.effectType,onChange:t=>e.setEffectType(t.target.value),children:[(0,P.jsx)(`option`,{value:`neutral`,children:`Neutral`}),(0,P.jsx)(`option`,{value:`buff`,children:`Buff`}),(0,P.jsx)(`option`,{value:`debuff`,children:`Debuff`})]})]}),(0,P.jsxs)(Mm,{style:{flex:`0 0 140px`},children:[(0,P.jsx)(Pm,{theme:t,children:`Ends at`}),(0,P.jsxs)(Im,{theme:t,value:e.effectEndTiming,onChange:t=>e.setEffectEndTiming(t.target.value),children:[(0,P.jsx)(`option`,{value:`start`,children:`Start of turn`}),(0,P.jsx)(`option`,{value:`end`,children:`End of turn`})]})]}),(0,P.jsx)(Nm,{children:(0,P.jsx)(Rm,{theme:t,onClick:e.handleAddEffect,style:{width:`100%`},children:`Add`})})]})]}),(0,P.jsxs)(Mm,{children:[(0,P.jsx)(Pm,{theme:t,children:`Targets`}),(0,P.jsx)(Lm,{theme:t,multiple:!0,value:e.effectTargetIds,onChange:t=>{let n=Array.from(t.target.selectedOptions).map(e=>e.value);e.setEffectTargetIds(n)},children:e.units.map(e=>(0,P.jsx)(`option`,{value:e.id,children:e.name},e.id))})]}),e.effectsModalError&&(0,P.jsx)(Wm,{theme:t,children:e.effectsModalError}),e.activeEffectsForSelectedUnit.length===0?(0,P.jsx)(Um,{theme:t,children:`No active effects.`}):(0,P.jsx)(zm,{children:e.activeEffectsForSelectedUnit.map(n=>(0,P.jsxs)(Bm,{theme:t,children:[(0,P.jsxs)(`div`,{children:[(0,P.jsx)(Hm,{theme:t,children:n.name}),(0,P.jsxs)(Vm,{theme:t,children:[r(n.effectType),` • `,n.remaining,` `,n.durationType,` • ends at `,n.endTiming===`start`?`start of turn`:`end of turn`,` • by `,n.createdByName]}),(0,P.jsxs)(Vm,{theme:t,children:[`Targets: `,i(n.targets)]})]}),(0,P.jsx)(Rm,{theme:t,onClick:()=>{e.handleDeleteEffect(n.id)},children:`Delete`})]},n.id))})]})})},Zm=({activeEffectsCount:e,canInteract:t,onOpen:n,icon:r})=>{let{theme:i}=je();return(0,P.jsxs)(Gm,{children:[(0,P.jsx)(Km,{theme:i,$active:e>0,disabled:!t,onClick:()=>{t&&n()},children:r||(0,P.jsx)(od,{})}),e>0&&(0,P.jsx)(qm,{theme:i,children:e>99?`99+`:e})]})};var Qm=b.td`
  color: ${e=>e.theme.PRIMARY};
  padding: 2px 6px;
  text-align: center;
  font-size: 14px;
...
`;const eh=({theme:e,unit:t,canInteract:n,elevationDraftValue:r,onElevationDraftChange:i,onCommitElevationChange:a})=>(0,P.jsx)(Qm,{theme:e,children:(0,P.jsx)($m,{theme:e,type:`text`,inputMode:`decimal`,min:-999,max:999,step:1,value:r??String(t.elevation??0),readOnly:!n,onChange:n?e=>i(t.id,e.target.value):void 0,onBlur:n?e=>a(t.id,e.target.value):void 0,onKeyDown:e=>{n&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}})}),th=({theme:e,canInteract:t,icon:n,activeEffectsCount:r,onOpen:i})=>(0,P.jsx)(Qm,{theme:e,children:(0,P.jsx)(Zm,{activeEffectsCount:r,canInteract:t,icon:n||(0,P.jsx)(od,{}),onOpen:i})});var nh=`${A}/elevation-badge`,rh=`${A}/elevation-badge-owner`,ih=`${A}/elevation`,ah=200,oh=40,sh=60,ch=120,lh=24,uh=(e,t)=>{if(!e)return;if(e.startsWith(`#`))return Tm(e,t);let n=e.match(/^rgba\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([\d.]+)\)$/i);if(n){let[,e,r,i]=n;return`rgba(${e}, ${r}, ${i}, ${t})`}let r=e.match(/^rgb\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\)$/i);if(r){let[,e,n,i]=r;return`rgba(${e}, ${n}, ${i}, ${t})`}return e},dh=e=>`
...
`,vg=b.div`
  ...
  border: 1px solid ${e=>y(e.theme.BORDER,.8)};
  background: ${e=>y(e.theme.BACKGROUND,.55)};
`,yg=(e,t)=>{let n=[{id:crypto.randomUUID(),type:`initiative`,description:`Initiative value used for turn order. Can be edited via Right-Click or rolled with Click.`},{id:crypto.randomUUID(),type:`name`,description:`Name of the unit or character.`}],r=t?[{id:`card-column`,type:`card-column`}]:[];if(!e||e.length===0)return[...n,...r];let i=[...e].sort((e,t)=>e.col-t.col).map(e=>({id:e.id,type:e.type,name:e.styles?.labelName,useIcon:e.styles?.labelMode===`icon`,iconType:e.styles?.labelIcon,description:e.styles?.description,styles:e.styles}));return[...n,...i,...r]};const bg=()=>{let{theme:e}=je(),{listLayout:t,attributes:r,isLoading:i}=wm();N(e=>e.roomMetadata);let a=N(e=>e.sceneMetadata),o=N(e=>e.items),s=N(e=>e.partyData),d=N(e=>e.playerData),f=N(e=>e.gridDpi),p=N(e=>e.setItems),[h,g]=(0,j.useState)([]),[_,v]=(0,j.useState)([]),[y,b]=(0,j.useState)(null),[x,S]=(0,j.useState)(1),[C,w]=(0,j.useState)(new Set),[T,ee]=(0,j.useState)(null),[re,E]=(0,j.useState)(null),[ie,O]=(0,j.useState)(!1),[ae,se]=(0,j.useState)(!1),[ce,le]=(0,j.useState)(!1),[ue,de]=(0,j.useState)({}),[fe,pe]=(0,j.useState)({}),[k,he]=(0,j.useState)(null),[ge,_e]=(0,j.useState)({}),[ve,ye]=(0,j.useState)(!1),[be,xe]=(0,j.useState)(!1),[M,Se]=(0,j.useState)(!1),[Ce,we]=(0,j.useState)(()=>window.innerWidth<400),[Te,Ee]=(0,j.useState)(null),De=(0,j.useRef)(null),F=(0,j.useRef)({}),I=(0,j.useRef)({}),Oe=(0,j.useRef)(null);(0,j.useEffect)(()=>{let e=()=>{we(window.innerWidth<400)};return window.addEventListener(`resize`,e),()=>{window.removeEventListener(`resize`,e)}},[]);let ke=a,Ae=ke[m.REVERSE_INITIATIVE]||!1,Me=ke[m.POPCORN_INITIATIVE]||!1,Ne=ke[m.SHOW_CARD_ACCESS]||!1,Pe=ke[m.SHOW_NON_PARTY_UNITS]||!1,Fe=ke[m.SHOW_LIST_HP_NUMBERS],Ie=typeof Fe==`boolean`?Fe:!0,Le=ke[m.DICE_RANGE]||``,Re=ke[m.SHOW_OWNER_ONLY_EDIT]||!1,L=String(d?.role||``).toUpperCase()===`GM`,ze=d?.id||``,Be=te(m.INITIATIVE_LIST_COMPACT,ze);(0,j.useEffect)(()=>{let e=a[Be],t=a[m.INITIATIVE_LIST_COMPACT];Se(typeof e==`boolean`?e:typeof t==`boolean`?t:!1)},[a,Be]);let Ve=async()=>{let e=!M;Se(e);try{await c.scene.setMetadata({[Be]:e})}catch(t){D.error(`Failed to persist initiative list compact mode`,t),Se(!e)}},He=async({notation:e,actionName:t,tokenName:n,senderId:r,senderColor:i})=>{try{await oe({notation:e,actionName:t,senderName:n,senderId:r,senderColor:i},ke)}catch(t){D.error(`Failed to send dice roll from InitiativeList`,e,t),D.log(e)}},Ue=e=>{let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return[]}return Array.isArray(t)?t.map((e,t)=>{let n=e&&typeof e==`object`?e:{},r=n.inUse,i=typeof r==`boolean`?r:typeof r==`string`?[`true`,`1`,`yes`].includes(r.trim().toLowerCase()):typeof r==`number`?r===1:void 0;return{id:typeof n.id==`string`&&n.id?n.id:`entry-${t}`,name:typeof n.name==`string`?n.name:``,description:typeof n.description==`string`?n.description:``,...i===void 0?{}:{inUse:i}}}):[]};(0,j.useEffect)(()=>{g(o.filter(e=>e.metadata?.[l.ON_LIST]===!0).map(e=>{let t=e.metadata?.[l.INITIATIVE]||0,n=e.metadata[l.UNIT_NAME]||e.name||`Unknown`,r=e.metadata?.[l.BOSS_MODE]===!0,i=e.metadata?.[ih]||0,a=s.find(t=>t.id===e.createdUserId)||(d?.id===e.createdUserId?d:void 0),o=String(a?.role||``).toUpperCase()===`GM`,c=a?.color||(d?.id===e.createdUserId?d?.color:void 0),u=o?void 0:uh(c,1),f={};return Object.keys(e.metadata||{}).forEach(t=>{t.startsWith(`com.battle-system.forge`)&&(f[t]=e.metadata?.[t])}),{id:e.id,initiative:t,name:n,isBoss:r,elevation:i,attributes:f,createdUserId:e.createdUserId,ownerNameOutlineColor:u,isInParty:e.metadata?.[l.IN_PARTY]===!0,isVisible:e.visible!==!1}}))},[o,s,d]);let R=(0,j.useMemo)(()=>Me?[...h].sort((e,t)=>e.name.localeCompare(t.name)):[...h].sort((e,t)=>e.initiative===t.initiative?e.name.localeCompare(t.name):Ae?e.initiative-t.initiative:t.initiative-e.initiative),[h,Ae,Me]),We=Ym({items:o,units:R,setItems:p,playerData:d}),Ge=(0,j.useMemo)(()=>{let e=new Map;return s.forEach(t=>{e.set(t.id,t)}),d&&!e.has(d.id)&&e.set(d.id,d),Array.from(e.values()).sort((e,t)=>e.name.localeCompare(t.name))},[s,d]),Ke=(e,t)=>{let n=parseInt(t)||0;g(t=>t.map(t=>t.id===e?{...t,initiative:n}:t))},qe=(e,t)=>{p(o.map(n=>n.id===e?{...n,metadata:{...n.metadata,[l.INITIATIVE]:t}}:n)),c.scene.items.updateItems([e],e=>{e[0].metadata[l.INITIATIVE]=t})},Je=e=>{let t=(e||``).trim().match(/(\d+)/),n=t?parseInt(t[1],10):NaN;return Number.isFinite(n)&&n>0?n:20},Ye=(e,t,n)=>(typeof t==`number`&&(e=Math.max(t,e)),typeof n==`number`&&(e=Math.min(n,e)),e),Xe=(e,t,n)=>{let r=e.trim(),{min:i,max:a}=n||{};if(r.length===0)return Ye(0,i,a);let o=r.match(/^([+\-*/])\s*(-?\d+(?:\.\d+)?)$/),s=r.match(/^(-?\d+(?:\.\d+)?)\s*([+\-*/])\s*(-?\d+(?:\.\d+)?)$/),c=null;if(o){let e=o[1],n=parseFloat(o[2]);switch(e){case`+`:c=t+n;break;case`-`:c=t-n;break;case`*`:c=t*n;break;case`/`:c=n===0?t:t/n;break}}else if(s){let e=parseFloat(s[1]),t=s[2],n=parseFloat(s[3]);switch(t){case`+`:c=e+n;break;case`-`:c=e-n;break;case`*`:c=e*n;break;case`/`:c=n===0?e:e/n;break}}else{let e=parseFloat(r);Number.isNaN(e)||(c=e)}return Ye(c===null||!Number.isFinite(c)?t:Math.trunc(c),i,a)},Ze=e=>{let t=Je(Le),n=Math.floor(Math.random()*t)+1;Ke(e,String(n)),qe(e,n)},Qe=(e,t)=>{de(n=>({...n,[e]:t}))},$e=(e,t)=>{let n=Xe(t,h.find(t=>t.id===e)?.initiative??0);de(t=>{let{[e]:n,...r}=t;return r}),g(t=>t.map(t=>t.id===e?{...t,initiative:n}:t)),qe(e,n)},et=e=>`ELE${e.slice(3)}`,tt=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o}},nt=async(e,t)=>{let r=et(e);try{await c.scene.items.deleteItems([r])}catch{}if(t===0)return;let i=o.find(t=>t.id===e);if(!i||!n(i))return;let a=tt(i,f),s=`${t>0?`🡹`:`🡻`}${Math.abs(t)}`,l=ne().id(r).name(`Elevation Badge`).plainText(s).textType(`PLAIN`).fontWeight(900).fillOpacity(.95).fillColor(`white`).strokeWidth(8).strokeColor(`black`).strokeOpacity(1).fontSize(36).fontFamily(`Segoe UI`).textAlign(`CENTER`).position({x:a.minX-40,y:a.minY}).metadata({[nh]:!0,[rh]:e}).attachedTo(e).visible(i.visible).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).layer(`TEXT`).build();try{await c.scene.items.addItems([l])}catch(t){D.error(`Failed to add elevation badge`,e,t)}},rt=(e,t)=>{pe(n=>({...n,[e]:t}))},it=(e,t,n)=>{let r=e.trim(),{min:i,max:a}=n||{};if(!r)return Ye(0,i,a);let o=parseFloat(r);return Ye(Number.isFinite(o)?Math.trunc(o):t,i,a)},at=(e,t)=>{let n=it(t,h.find(t=>t.id===e)?.elevation??0,{min:-999,max:999});pe(t=>{let{[e]:n,...r}=t;return r}),g(t=>t.map(t=>t.id===e?{...t,elevation:n}:t)),p(o.map(t=>t.id===e?{...t,metadata:{...t.metadata,[ih]:n}}:t)),c.scene.items.updateItems([e],e=>{e[0].metadata[ih]=n}),nt(e,n)},ot=(e,t)=>{let n=e.trim();if(!n)return e;let r=/^([+\-*/])\s*-?\d+(?:\.\d+)?$/.test(n),i=/^-?\d+(?:\.\d+)?\s*[+\-*/]\s*-?\d+(?:\.\d+)?$/.test(n),a=/^-?\d+(?:\.\d+)?$/.test(n);if(!r&&!i&&!a)return e;let o=typeof t==`number`?t:parseFloat(String(t)),s=Number.isFinite(o)?o:0;return String(Xe(n,s))},st=(e,t,n)=>{let r=`${A}/${t}`,i=h.find(t=>t.id===e)?.attributes?.[r],a=ot(n,i);g(t=>t.map(t=>t.id===e?{...t,attributes:{...t.attributes,[r]:a}}:t)),p(o.map(t=>t.id===e?{...t,metadata:{...t.metadata,[r]:a}}:t)),c.scene.items.updateItems([e],e=>{e[0].metadata[r]=a})},ct=e=>r.find(t=>t.attr_bid===e)||null,lt=e=>{let t=ct(e);return typeof t?.attr_func==`string`&&t.attr_func.trim().length>0},ut=e=>{let t={};for(let n of r){let r=`${A}/${n.attr_bid}`,i=e.attributes?.[r];if(i==null||i===``)continue;let a=Number(i);Number.isFinite(a)&&(t[n.attr_bid]=a)}return t},dt=async(e,t)=>{let n=ct(t)?.attr_func;if(typeof n!=`string`||n.trim().length===0)return;let r=me(n,{bidValueMap:ut(e),onMissingBid:`error`});if(!r.valid||!r.notation){D.warn(`Could not resolve notation for initiative list value-column`,{unitId:e.id,bid:t,error:r.error});return}let i=ct(t)?.attr_name||t,a=s.find(t=>t.id===e.createdUserId);await He({notation:r.notation,actionName:i,tokenName:e.name,senderId:e.createdUserId||d?.id||`unknown`,senderColor:a?.color||d?.color||`#ffffff`})};(0,j.useEffect)(()=>()=>{Object.values(F.current).forEach(e=>{window.clearTimeout(e)})},[]);let ft=(e,t)=>`value-column:${e}:${t}`,pt=e=>!!ge[e],mt=(e,t)=>{_e(t=>({...t,[e]:!0})),window.setTimeout(()=>{t?.focus(),t?.select()},0)},ht=e=>{_e(t=>{let{[e]:n,...r}=t;return r})},gt=(e,t)=>{let n=F.current[e];n&&window.clearTimeout(n),F.current[e]=window.setTimeout(()=>{I.current[e]=!0,mt(e,t),delete F.current[e]},500)},_t=e=>{let t=F.current[e];t&&(window.clearTimeout(t),delete F.current[e])},vt=e=>I.current[e]?(delete I.current[e],!0):!1,yt=e=>{if(!Re||L)return!0;let t=d?.id;return t?e.createdUserId===t:!1},bt=e=>L?!0:e.isVisible,xt=e=>L||Pe?!1:!e.isInParty;(0,j.useEffect)(()=>{i||v(yg(t,Ne))},[t,i,Ne]),(0,j.useEffect)(()=>{let e=a[m.CURRENT_TURN],t=a[m.CURRENT_ROUND];e?b(e):R.length>0&&b(R[0].id),t&&S(t)},[a,R]);let St=async()=>{if(R.length===0)return;y&&await We.processEffectsForTurnEvent(`end`,y);let e=R.findIndex(e=>e.id===y)+1;if(e>=R.length){let e=x+1;S(e),b(R[0].id),await c.scene.setMetadata({[m.CURRENT_TURN]:R[0].id,[m.CURRENT_ROUND]:e}),await We.processEffectsForTurnEvent(`start`,R[0].id)}else b(R[e].id),await c.scene.setMetadata({[m.CURRENT_TURN]:R[e].id}),await We.processEffectsForTurnEvent(`start`,R[e].id)},Ct=async()=>{if(R.length===0)return;let e=R.findIndex(e=>e.id===y)-1;if(e<0){let e=Math.max(1,x-1);S(e),b(R[R.length-1].id),await c.scene.setMetadata({[m.CURRENT_TURN]:R[R.length-1].id,[m.CURRENT_ROUND]:e})}else b(R[e].id),await c.scene.setMetadata({[m.CURRENT_TURN]:R[e].id})},z=async e=>{Me&&(C.has(e)||(b(e),await c.scene.setMetadata({[m.CURRENT_TURN]:e}),await We.processEffectsForTurnEvent(`start`,e)))},wt=async()=>{y&&(await We.processEffectsForTurnEvent(`end`,y),w(e=>new Set([...e,y])),C.size+1,R.length)},B=async()=>{let e=x+1;S(e),w(new Set),b(null),await c.scene.setMetadata({[m.CURRENT_TURN]:null,[m.CURRENT_ROUND]:e})},Tt=async e=>{xe(!0);try{if(e===`clear-list`){let e=o.filter(e=>e.metadata?.[l.ON_LIST]===!0).map(e=>e.id);e.length>0&&(await c.scene.items.updateItems(e,e=>{e.forEach(e=>{e.metadata&&l.ON_LIST in e.metadata&&delete e.metadata[l.ON_LIST]})}),p(o.map(e=>{if(e.metadata?.[l.ON_LIST]!==!0)return e;let t={...e.metadata||{}};return delete t[l.ON_LIST],{...e,metadata:t}})))}if(e===`reset-initiative`){let e=o.filter(e=>e.metadata?.[l.ON_LIST]===!0).map(e=>e.id);e.length>0&&(await c.scene.items.updateItems(e,e=>{e.forEach(e=>{e.metadata[l.INITIATIVE]=0})}),p(o.map(e=>e.metadata?.[l.ON_LIST]===!0?{...e,metadata:{...e.metadata||{},[l.INITIATIVE]:0}}:e)),g(e=>e.map(e=>o.some(t=>t.id===e.id&&t.metadata?.[l.ON_LIST]===!0)?{...e,initiative:0}:e)),de({}))}let t=e===`clear-list`?null:e===`reset-initiative`?[...R].sort((e,t)=>e.name.localeCompare(t.name))[0]?.id??null:R[0]?.id??null;S(1),b(t),w(new Set),await c.scene.setMetadata({[m.CURRENT_TURN]:t,[m.CURRENT_ROUND]:1}),ye(!1)}catch(t){D.error(`Failed to reset encounter state`,{mode:e,error:t})}finally{xe(!1)}},Et=async e=>{let t=o.find(t=>t.id===e);if(t)try{await Em.CenterViewportOnImage(t)}catch(t){D.error(`Failed to center viewport on unit`,e,t)}},Dt=async(e,t)=>{try{let n=await c.viewport.getHeight(),r=n>800?700:n-100;await c.popover.open({id:u.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(t)}`,height:r,width:350,anchorElementId:e,hidePaper:!0,disableClickAway:!0})}catch(e){D.error(`Failed to open cards popover`,e)}},Ot=(e,t)=>{e.preventDefault(),e.stopPropagation(),E(null),ee(t)},kt=async e=>{if(T){if(!o.find(e=>e.id===T)){E(`Token not found in scene cache.`);return}O(!0),E(null);try{await c.scene.items.updateItems([T],t=>{let n=t[0];n.createdUserId=e}),p(o.map(t=>t.id===T?{...t,createdUserId:e}:t)),ee(null)}catch(t){D.error(`Failed to reassign token owner`,T,e,t),E(`Unable to assign token owner. Ensure you have permission to edit this token.`)}finally{O(!1)}}},At=async()=>{if(!T)return;let e=o.find(e=>e.id===T);if(!e){E(`Token not found in scene cache.`);return}let t=e.metadata?.[l.BOSS_MODE]!==!0;if(t&&o.filter(e=>e.id!==T&&e.metadata?.[l.ON_LIST]===!0&&e.metadata?.[l.BOSS_MODE]===!0).length>=2){E(`A maximum of 2 bosses can be enabled at once.`);return}se(!0),E(null);try{await c.scene.items.updateItems([T],e=>{let n={...e[0].metadata||{}};n[l.BOSS_MODE]=t,e[0].metadata=n}),p(o.map(e=>e.id===T?{...e,metadata:{...e.metadata||{},[l.BOSS_MODE]:t}}:e))}catch(e){D.error(`Failed to toggle boss mode`,T,e),E(`Unable to update boss mode for this token.`)}finally{se(!1)}},jt=async()=>{if(T){if(!o.find(e=>e.id===T)){E(`Token not found in scene cache.`);return}le(!0),E(null);try{await c.scene.items.updateItems([T],e=>{let t={...e[0].metadata||{}};l.ON_LIST in t&&delete t[l.ON_LIST],e[0].metadata=t}),p(o.map(e=>{if(e.id!==T)return e;let t={...e.metadata||{}};return delete t[l.ON_LIST],{...e,metadata:t}})),ee(null)}catch(e){D.error(`Failed to remove token from initiative list`,T,e),E(`Unable to remove token from initiative list.`)}finally{le(!1)}}},Mt=(0,j.useMemo)(()=>T&&R.find(e=>e.id===T)||null,[T,R]),Nt=(0,j.useMemo)(()=>T&&o.find(e=>e.id===T)||null,[T,o]),Pt=Nt?.metadata?.[l.BOSS_MODE]===!0,Ft=(0,j.useMemo)(()=>k&&R.find(e=>e.id===k.unitId)||null,[k,R]),It=(0,j.useMemo)(()=>k&&r.find(e=>e.attr_bid===k.bid)||null,[r,k]),Lt=(0,j.useMemo)(()=>{if(!k||!Ft)return[];let e=Ft.attributes[`${A}/${k.bid}`];return Ue(e)},[k,Ft]),Rt=(0,j.useMemo)(()=>Lt.some(e=>typeof e.inUse==`boolean`),[Lt]),zt=(0,j.useMemo)(()=>M?_.filter(e=>e.type===`initiative`||e.type===`name`?!0:e.type===`card-column`&&Ne):_,[M,_,Ne]),Bt=(0,j.useMemo)(()=>{let e=r.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),t=r.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`}),n=e?.attr_bid,i=t?.attr_bid,a=ke[m.HP_CURRENT_BID],o=ke[m.HP_MAX_BID],s=new Set(r.map(e=>e.attr_bid));return{currentHpBid:a&&s.has(a)?a:n,maxHpBid:o&&s.has(o)?o:i}},[r,ke]),Vt=(0,j.useMemo)(()=>R.filter(e=>bt(e)),[R,L]),Ht=(0,j.useMemo)(()=>{if(!Ft)return{};let e={};for(let t of r){let n=`${A}/${t.attr_bid}`,r=Ft.attributes?.[n];if(r==null||r===``)continue;let i=Number(r);Number.isFinite(i)&&(e[t.attr_bid]=i)}return e},[Ft,r]),Ut=e=>{let t=[],n=e.matchAll(/\[([^\[\]]+)\]/g);for(let e of n){let n=(e[1]||``).trim();if(!n)continue;let r=me(n,{bidValueMap:Ht,onMissingBid:`error`});!r.valid||!r.notation||t.push(r.notation)}return t};(0,j.useEffect)(()=>{Oe.current&&zt.length>0&&(D.debug(`Adjusting window width based on table size`),setTimeout(()=>{if(Oe.current){let e=Oe.current.offsetWidth+4,t=Math.min(e,800);c.action.setWidth(t),D.log(`Adjusted window width to `+t)}},100))},[M,zt.length,R.length]);let Wt=e=>{if(!e)return null;let t=fh[e.toLowerCase()];return t?(0,P.jsx)(t,{}):null},Gt=(e,t)=>{let n=window.innerWidth-t-8,r=Math.min(Math.max(e-t/2,8),Math.max(8,n));return{left:r,arrowX:e-r}},Kt=e=>{let t=e.currentTarget.getBoundingClientRect(),n=`clientX`in e?e.clientX:t.left+t.width/2,r=t.top>72?`top`:`bottom`;return{anchorX:n,y:r===`top`?t.top:t.bottom,placement:r}},qt=(e,t)=>{let n=Kt(e),r=Math.min(320,Math.max(140,t.length*7+28)),i=Gt(n.anchorX,r);Ee({text:t,...n,...i})},Jt=()=>{Ee(null)};(0,j.useLayoutEffect)(()=>{if(!Te||!De.current)return;let e=De.current.getBoundingClientRect().width,t=Gt(Te.anchorX,e);(Math.abs(t.left-Te.left)>.5||Math.abs(t.arrowX-Te.arrowX)>.5)&&Ee(e=>e&&{...e,...t})},[Te]);let Yt=e=>e.type===`initiative`?(0,P.jsx)(ld,{}):e.type===`roller`?null:e.type===`name`?`Name`:e.type===`card-column`?(0,P.jsx)(Zu,{}):e.type===`divider-column`?null:e.useIcon&&e.iconType?Wt(e.iconType):e.name||e.type,Xt=e=>e.type===`divider-column`?{fixedWidth:lh}:e.type===`initiative`?{minWidth:sh}:e.type===`name`?{minWidth:ch}:{minWidth:oh},Zt=(t,n)=>{let r=yt(n),i=xt(n),a=!L&&!Ie;if(i&&t.type!==`initiative`&&t.type!==`name`)return t.type===`divider-column`?(0,P.jsx)(Gh,{theme:e,children:(0,P.jsx)(_g,{theme:e})}):(0,P.jsx)(Ah,{theme:e,children:(0,P.jsx)(_g,{theme:e})});switch(t.type){case`initiative`:if(Me)return(0,P.jsx)(jh,{theme:e,children:(0,P.jsx)(Fh,{onClick:e=>{e.stopPropagation(),r&&(C.has(n.id)||(n.id===y?wt():z(n.id)))},children:C.has(n.id)?(0,P.jsx)(Ku,{color:e.OFFSET}):n.id===y?(0,P.jsx)(Gu,{color:e.PRIMARY}):(0,P.jsx)(qu,{color:e.BORDER})})});let i=`initiative:${n.id}`,s=pt(i);return(0,P.jsx)(jh,{theme:e,children:(0,P.jsx)(Ih,{theme:e,$isRollable:r&&!s,type:`text`,inputMode:`decimal`,value:ue[n.id]??String(n.initiative),readOnly:!r||!s,onChange:!r||!s?void 0:e=>Qe(n.id,e.target.value),onBlur:!r||!s?void 0:e=>{$e(n.id,e.target.value),ht(i)},onClick:()=>{r&&(s||vt(i)||Ze(n.id))},onContextMenu:e=>{r&&(e.preventDefault(),mt(i,e.currentTarget))},onTouchStart:e=>{r&&(s||gt(i,e.currentTarget))},onTouchEnd:()=>{_t(i)},onTouchCancel:()=>{_t(i)},onKeyDown:e=>{if(r){if(!s&&(e.key===`Enter`||e.key===` `)){e.preventDefault(),Ze(n.id);return}s&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}}})});case`name`:return(0,P.jsx)(Lh,{theme:e,title:`Right-click to assign owner`,$outlineColor:n.ownerNameOutlineColor,onDoubleClick:()=>Et(n.id),onContextMenu:r?e=>Ot(e,n.id):void 0,children:n.isBoss?`💀 ${n.name}`:n.name});case`roller`:return(0,P.jsx)(Mh,{theme:e,children:(0,P.jsx)(Nh,{theme:e,disabled:!r,onClick:e=>{e.stopPropagation(),r&&Ze(n.id)},title:`Roll initiative (1-${Je(Le)})`,children:(0,P.jsx)(Ph,{src:`/dice.svg`,alt:`Roll`})})});case`card-column`:return(0,P.jsx)(Ah,{theme:e,children:(0,P.jsx)(Vh,{id:`card-access-${n.id}`,theme:e,disabled:!r,onClick:e=>{e.stopPropagation(),r&&Dt(e.currentTarget.id,n.id)},title:`Open card for ${n.name}`,children:(0,P.jsx)(Gu,{})})});case`value-column`:return(0,P.jsx)(Ah,{theme:e,children:(0,P.jsx)(Bh,{children:t.styles?.bidList?.map((i,o)=>{let s=lt(i),c=ft(n.id,i),l=s&&pt(c),u=n.attributes[`${A}/${i}`],d=u==null||u===``?`0`:String(u),f=i===Bt.currentHpBid||i===Bt.maxHpBid,p=!!ze&&n.createdUserId===ze,m=a&&f&&!p;return(0,P.jsxs)(j.Fragment,{children:[o>0&&(0,P.jsx)(zh,{theme:e,children:t.styles?.dividers?.[o-1]||`/`}),m?(0,P.jsx)(vg,{theme:e,$small:t.styles?.bidList&&t.styles.bidList.length>2}):(0,P.jsx)(Rh,{theme:e,$isRollable:r&&s,value:d,$small:t.styles?.bidList&&t.styles.bidList.length>2,readOnly:!r||s&&!l,onChange:!r||s&&!l?void 0:e=>{let t=e.target.value;g(e=>e.map(e=>e.id===n.id?{...e,attributes:{...e.attributes,[`${A}/${i}`]:t}}:e))},onBlur:!r||s&&!l?void 0:e=>{st(n.id,i,e.target.value),s&&ht(c)},onClick:s?()=>{r&&(l||vt(c)||dt(n,i))}:void 0,onContextMenu:s?e=>{r&&(e.preventDefault(),mt(c,e.currentTarget))}:void 0,onTouchStart:s?e=>{r&&(l||gt(c,e.currentTarget))}:void 0,onTouchEnd:s?()=>{_t(c)}:void 0,onTouchCancel:s?()=>{_t(c)}:void 0,onKeyDown:e=>{if(r){if(s&&!l&&(e.key===`Enter`||e.key===` `)){e.preventDefault(),dt(n,i);return}(l||!s)&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}}})]},i)})})});case`list-column`:return(0,P.jsx)(Ah,{theme:e,children:(0,P.jsx)(Vh,{theme:e,disabled:!r,onClick:e=>{if(e.stopPropagation(),!r)return;let i=t.styles?.bidList?.[0];i&&he({unitId:n.id,bid:i})},title:`Open list reference`,children:(0,P.jsx)(Wu,{})})});case`checkbox-column`:return(0,P.jsx)(Ah,{theme:e,children:(0,P.jsx)(Bh,{children:t.styles?.bidList?.map(i=>{let a=!!n.attributes[`${A}/${i}`],s=t.styles?.inputType===`slider`,l=e=>{g(t=>t.map(t=>t.id===n.id?{...t,attributes:{...t.attributes,[`${A}/${i}`]:e}}:t)),p(o.map(t=>t.id===n.id?{...t,metadata:{...t.metadata,[`${A}/${i}`]:e}}:t)),c.scene.items.updateItems([n.id],t=>{t[0].metadata[`${A}/${i}`]=e})};return s?(0,P.jsx)(Uh,{type:`button`,theme:e,$active:a,disabled:!r,onClick:r?()=>{l(!a)}:void 0,children:(0,P.jsx)(Wh,{theme:e,$active:a})},i):(0,P.jsx)(Hh,{theme:e,type:`checkbox`,checked:a,disabled:!r,onChange:r?e=>{l(e.target.checked)}:void 0},i)})})});case`special-column`:let l=Wt(t.iconType);if(t.styles?.specialType===`elevation`){let t=fe[n.id];return(0,P.jsx)(eh,{theme:e,unit:n,canInteract:r,elevationDraftValue:t,onElevationDraftChange:rt,onCommitElevationChange:at})}else{let t=We.getEffectsForUnit(n.id).length;return(0,P.jsx)(th,{theme:e,canInteract:r,icon:l||(0,P.jsx)(od,{}),activeEffectsCount:t,onOpen:()=>We.handleOpenEffectsModal(n.id)})}case`divider-column`:return(0,P.jsx)(Gh,{theme:e,children:(0,P.jsx)(Kh,{children:t.styles?.styleDesign===`zigzag`?(0,P.jsx)(Jh,{children:(0,P.jsx)(Yh,{theme:e})}):(0,P.jsx)(qh,{theme:e,$style:t.styles?.styleDesign})})});default:return(0,P.jsx)(Ah,{theme:e,children:`-`})}};if(i)return(0,P.jsx)(ph,{children:(0,P.jsx)(mh,{theme:e,children:`Loading...`})});let Qt=M||Ce,V=M?`R: ${x}`:`Round: ${x}`;return(0,P.jsxs)(ph,{children:[(0,P.jsx)(hh,{children:(0,P.jsxs)(Ch,{ref:Oe,theme:e,$compact:M,children:[(0,P.jsx)(wh,{theme:e,children:(0,P.jsx)(Th,{children:zt.map(t=>{let n=t.description??`This has no description.`,r=Xt(t);return(0,P.jsx)(Eh,{theme:e,$minWidth:r.minWidth,$fixedWidth:r.fixedWidth,onMouseEnter:e=>qt(e,n),onMouseMove:e=>qt(e,n),onMouseLeave:Jt,onFocus:e=>qt(e,n),onBlur:Jt,children:Yt(t)},t.id)})})}),(0,P.jsx)(Oh,{children:Vt.map(t=>(0,P.jsx)(kh,{$isCurrentTurn:t.id===y,theme:e,children:zt.map(e=>(0,P.jsx)(j.Fragment,{children:Zt(e,t)},e.id))},t.id))})]})}),(0,P.jsxs)(gh,{theme:e,$compactMode:M,children:[(0,P.jsxs)(_h,{$compactMode:M,children:[M?(0,P.jsxs)(P.Fragment,{children:[L&&(0,P.jsx)(vh,{theme:e,$compact:!0,onClick:Ct,children:(0,P.jsx)(Vu,{})}),L&&(0,P.jsx)(vh,{theme:e,$compact:!0,onClick:St,children:(0,P.jsx)(Hu,{})})]}):Me?(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(vh,{theme:e,onClick:wt,disabled:!y||C.has(y),children:`End Turn`}),(0,P.jsx)(Sh,{theme:e,$compactMode:M,children:V}),(0,P.jsx)(vh,{theme:e,$compact:Qt,onClick:B,disabled:C.size<R.length,children:Qt?(0,P.jsx)(Hu,{}):`Next`})]}):(0,P.jsxs)(P.Fragment,{children:[L&&(0,P.jsx)(vh,{theme:e,$compact:!0,onClick:Ct,children:(0,P.jsx)(Vu,{})}),(0,P.jsx)(Sh,{theme:e,$compactMode:M,children:V}),L&&(0,P.jsx)(vh,{theme:e,$compact:!0,onClick:St,children:(0,P.jsx)(Hu,{})})]}),M&&(0,P.jsx)(bh,{theme:e,onClick:()=>{Ve()},title:`Switch to Fullsize list`,children:(0,P.jsx)(ed,{})})]}),!M&&(0,P.jsx)(xh,{theme:e,$hasReset:L,onClick:()=>{Ve()},title:`Switch to Compact list`,children:(0,P.jsx)(td,{})}),L&&!M&&(0,P.jsx)(yh,{theme:e,onClick:()=>ye(!0),disabled:be,title:`Reset round/turn state`,children:(0,P.jsx)(rd,{})})]}),Te&&(0,P.jsx)(Dh,{ref:De,theme:e,$left:Te.left,$y:Te.y,$placement:Te.placement,$arrowX:Te.arrowX,role:`tooltip`,children:Te.text}),(0,P.jsxs)(zp,{isOpen:!!T,title:Mt?`Unit: ${Mt.name}`:`Unit`,onClose:()=>{ie||ae||ce||(ee(null),E(null))},closeOnOverlayClick:!ie&&!ae&&!ce,maxWidth:`520px`,children:[(0,P.jsx)(Qh,{theme:e,children:`Select a player to become the owner.`}),(0,P.jsxs)(Xh,{children:[Ge.map(t=>(0,P.jsxs)(Zh,{theme:e,$isCurrent:Nt?.createdUserId===t.id,onClick:()=>kt(t.id),disabled:ie||ae||ce,children:[t.name,Nt?.createdUserId===t.id?` (current)`:``]},t.id)),(0,P.jsx)(Zh,{theme:e,onClick:()=>{jt()},disabled:ie||ae||ce,children:ce?`Removing...`:`Remove Unit from List`})]}),(0,P.jsx)(eg,{theme:e}),(0,P.jsxs)(tg,{theme:e,children:[(0,P.jsxs)(`div`,{children:[(0,P.jsx)(ng,{theme:e,children:`Boss Mode`}),(0,P.jsx)(rg,{theme:e,children:`Shows a large encounter HP bar in scene (max 2 bosses).`})]}),(0,P.jsx)(ig,{children:(0,P.jsx)(ag,{type:`button`,theme:e,$active:Pt,disabled:ie||ae||ce,"aria-label":`Toggle boss mode`,"aria-pressed":Pt,onClick:()=>{At()}})})]}),re&&(0,P.jsx)($h,{theme:e,children:re})]}),(0,P.jsx)(Xm,{manager:We}),(0,P.jsxs)(zp,{isOpen:ve,title:`Reset Encounter`,onClose:()=>{be||ye(!1)},closeOnOverlayClick:!be,maxWidth:`460px`,children:[(0,P.jsx)(Qh,{theme:e,children:`Choose how you want to reset initiative state.`}),(0,P.jsxs)(Xh,{children:[(0,P.jsx)(Zh,{theme:e,onClick:()=>{Tt(`round`)},disabled:be,children:be?`Resetting...`:`Reset Round`}),(0,P.jsx)(Zh,{theme:e,onClick:()=>{Tt(`reset-initiative`)},disabled:be,children:be?`Resetting...`:`Reset Round & Initiative`}),(0,P.jsx)(Zh,{theme:e,onClick:()=>{Tt(`clear-list`)},disabled:be,children:be?`Resetting...`:`Reset Round & Clear List`})]})]}),(0,P.jsx)(zp,{isOpen:!!k,title:Ft?`${It?.attr_name||`List`} for ${Ft.name}`:`List Reference`,onClose:()=>{he(null)},maxWidth:`620px`,children:(0,P.jsxs)(og,{children:[(0,P.jsx)(sg,{theme:e}),Lt.length===0?(0,P.jsx)(gg,{theme:e,children:`No entries.`}):(0,P.jsx)(cg,{children:Lt.map(t=>(0,P.jsxs)(lg,{theme:e,children:[(0,P.jsxs)(ug,{children:[Rt?(0,P.jsx)(dg,{type:`checkbox`,checked:!!t.inUse,readOnly:!0,tabIndex:-1}):null,(0,P.jsx)(fg,{theme:e,children:t.name||`(Unnamed)`})]}),t.description?(0,P.jsx)(pg,{theme:e,children:t.description}):null,(()=>{let n=Ut(t.description||``);return n.length===0?null:(0,P.jsx)(mg,{children:n.map((n,r)=>(0,P.jsx)(hg,{type:`button`,theme:e,onClick:()=>{let e=Ft?.createdUserId?s.find(e=>e.id===Ft.createdUserId):null;He({notation:n,actionName:t.name||It?.attr_name||`List Roll`,tokenName:Ft?.name||`Unknown`,senderId:Ft?.createdUserId||d?.id||`unknown`,senderColor:e?.color||d?.color||`#ffffff`})},title:n,children:n},`${t.id}-inline-notation-${r}`))})})()]},t.id))})]})})]})};var xg=`${u.EXTENSIONID}-partyhud`,Sg=b.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
`,Cg=b.div`
...
`,Rg=b.p`
  color: ${e=>e.theme.PRIMARY};
  margin: 0;
`,zg=e=>{switch(e){case`bottom`:return`left`;case`left`:return`top`;case`top`:return`right`;case`right`:default:return`bottom`}},Bg=e=>e===`bottom`||e===`left`||e===`top`||e===`right`,Vg=async()=>{await c.modal.open({id:xg,url:`/pages/forgeparty.html`,fullScreen:!0,hideBackdrop:!0,hidePaper:!0,disablePointerEvents:!0})};const Hg=()=>{let e=(0,j.useRef)(!1),{theme:t}=je(),{attributes:r}=wm(),i=N(e=>e.items),a=N(e=>e.sceneMetadata);N(e=>e.roomMetadata);let o=N(e=>e.playerData),s=a,u=String(o?.role||``).toUpperCase()===`GM`,d=o?.id,f=te(m.PARTY_HUD_OPEN,d),p=te(m.PARTY_HUD_ORIENTATION,d),h=(s[f]??s[m.PARTY_HUD_OPEN])===!0,g=s[p]??s[m.PARTY_HUD_ORIENTATION],_=Bg(g)?g:`bottom`,v=s[m.PARTY_HUD_ATTR_ONE]||``,y=s[m.PARTY_HUD_ATTR_TWO]||``,b=s[m.PARTY_HUD_SHOW_HP_BARS]===!0,x=s[m.PARTY_HUD_SHOW_HP_NUMBERS]===!0&&!b,S=i.filter(e=>e.metadata[l.IN_PARTY]===!0),C=(0,j.useMemo)(()=>r.filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`text`||t===`numb`||t===`bool`}),[r]),w=async(e,t)=>{await c.scene.setMetadata({[e]:t})},T=async()=>{let t=!h;if(await w(f,t),!t){await c.modal.close(xg),e.current=!1;return}await Vg(),e.current=!0},ee=async()=>{await w(p,zg(_))},ne=async(e,t)=>{let n=t.trim();await c.scene.items.updateItems([e],e=>{let t={...e[0].metadata||{}};n?t[l.PORTRAIT_URL]=n:delete t[l.PORTRAIT_URL],e[0].metadata=t})};return(0,j.useEffect)(()=>{let t=!0;return(async()=>{if(h&&!e.current){await Vg(),t&&(e.current=!0);return}!h&&e.current&&(await c.modal.close(xg),t&&(e.current=!1))})(),()=>{t=!1}},[h]),(0,P.jsx)(Bu.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,P.jsxs)(hp,{theme:t,children:[(0,P.jsx)(gp,{theme:t,children:`Party`}),(0,P.jsxs)(Cg,{theme:t,children:[(0,P.jsxs)(wg,{children:[(0,P.jsxs)(Dg,{theme:t,onClick:()=>void ee(),children:[`Display: `,_.toUpperCase()]}),(0,P.jsx)(Dg,{theme:t,onClick:()=>void T(),children:h?`Close Party HUD`:`Open Party HUD`})]}),u&&(0,P.jsxs)(P.Fragment,{children:[(0,P.jsxs)(Tg,{children:[(0,P.jsx)(Eg,{theme:t,children:`Show in HUD:`}),(0,P.jsxs)(Ag,{$disabled:!u,children:[(0,P.jsx)(jg,{theme:t,children:`Show HP Bars`}),(0,P.jsx)(X,{label:`Party HUD Show HP Bars`,isOn:b,onChange:e=>{u&&(w(m.PARTY_HUD_SHOW_HP_BARS,e),e&&w(m.PARTY_HUD_SHOW_HP_NUMBERS,!1))}})]}),(0,P.jsxs)(Ag,{$disabled:!u,children:[(0,P.jsx)(jg,{theme:t,children:`Show HP Numbers`}),(0,P.jsx)(X,{label:`Party HUD Show HP Numbers`,isOn:x,onChange:e=>{u&&(w(m.PARTY_HUD_SHOW_HP_NUMBERS,e),e&&w(m.PARTY_HUD_SHOW_HP_BARS,!1))}})]}),(0,P.jsxs)(Og,{theme:t,disabled:!u,value:v,onChange:e=>{let t=e.target.value;w(m.PARTY_HUD_ATTR_ONE,t),t&&t===y&&w(m.PARTY_HUD_ATTR_TWO,``)},children:[(0,P.jsx)(`option`,{value:``,children:`Extra Slot 1 (None)`}),C.map(e=>(0,P.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]}),(0,P.jsxs)(Og,{theme:t,disabled:!u,value:y,onChange:e=>{let t=e.target.value;w(m.PARTY_HUD_ATTR_TWO,t),t&&t===v&&w(m.PARTY_HUD_ATTR_ONE,``)},children:[(0,P.jsx)(`option`,{value:``,children:`Extra Slot 2 (None)`}),C.map(e=>(0,P.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]})]}),(0,P.jsx)(kg,{theme:t,children:(0,P.jsxs)(P.Fragment,{children:[`Configure Party HUD and portraits.`,(0,P.jsx)(`br`,{}),`LIST attributes are excluded.`]})})]})]}),S.length===0?(0,P.jsx)(Rg,{theme:t,children:`No one is in the Party.  Add a unit using the ContextMenu on the token.`}):(0,P.jsx)(Sg,{theme:t,children:S.map(e=>{let r=e.metadata?.[l.PORTRAIT_URL]||``,i=n(e)?e.image.url:void 0,a=e.metadata[l.UNIT_NAME]||e.name||`Unknown`,s=e.createdUserId===o?.id,c=u||s,d=i||`/logo.png`,f=!!r;return(0,P.jsxs)(Mg,{theme:t,children:[(0,P.jsxs)(Ng,{children:[(0,P.jsx)(Pg,{theme:t,src:d,alt:a,$full:!f}),f&&(0,P.jsx)(Pg,{theme:t,src:f?r:``,alt:`${a} override`,$overlay:!0})]}),(0,P.jsxs)(Fg,{children:[(0,P.jsx)(Ig,{theme:t,title:a,children:a}),c&&(0,P.jsx)(Lg,{theme:t,defaultValue:r,placeholder:`Portrait URL override (optional)`,onBlur:t=>{ne(e.id,t.target.value)}})]})]},e.id)})})]})})};var Ug=`${A}/hp-bar-effect`,Wg=`${A}/hp-bar-owner`,Gg=`${A}/hp-number-text`,Kg=`${A}/hp-number-owner`,qg=e=>`HPB${e.slice(3)}`,Jg=e=>`HPN${e.slice(3)}`,Yg=(e,t,n)=>Math.max(t,Math.min(n,e)),Xg=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},Zg=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||ve.CURRENT_HP,maxHpBid:n?.attr_bid||ve.MAX_HP}},Qg=(e,t)=>{let n=Zg(t),r=e[m.HP_CURRENT_BID],i=e[m.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},$g=(e,t,n)=>{let r=e.metadata?.[`${A}/${t}`],i=e.metadata?.[`${A}/${n}`],a=Xg(r),o=Xg(i);return o===null||o<=0||a===null?null:Yg(a/o*100,0,100)},e_=(e,t,n)=>{let r=e.metadata?.[`${A}/${t}`],i=e.metadata?.[`${A}/${n}`],a=Xg(r),o=Xg(i);return a===null?null:{currentHp:Math.trunc(a),maxHp:o===null?null:Math.trunc(o)}},t_=e=>{let t=String(e||`bottom`).toLowerCase();return t===`top`||t===`bottom`||t===`left`||t===`right`?t:`bottom`},n_=e=>{switch(t_(e)){case`top`:return 0;case`bottom`:return 1;case`left`:return 2;case`right`:return 3;default:return 1}},r_=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o,width:r,height:i}},i_=(e,t,n)=>{let r=r_(e,t),i=r.minX+r.width*.5,a=r.minY+r.height*.5,o;switch(n){case`top`:o={x:i,y:r.minY+r.height*.18};break;case`bottom`:o={x:i,y:r.minY+r.height*.82};break;case`left`:o={x:r.minX+r.width*.18,y:a};break;case`right`:o={x:r.minX+r.width*.82,y:a};break}let s=r.width*.25,c=r.height*.18;return{x:o.x-s,y:o.y-c}};const a_=()=>{let e=N(e=>e.cacheReady),i=N(e=>e.sceneReady),o=N(e=>e.items),s=N(e=>e.localItems),u=N(e=>e.gridDpi),d=N(e=>e.roomMetadata),f=N(e=>e.sceneMetadata);return(0,j.useEffect)(()=>{if(!e||!i)return;let d=!1;return(async()=>{let e=f,i=e[m.SHOW_HP_BARS]??!1,p=e[m.SHOW_HP_NUMBERS]??!1,h=i,g=!i&&p,_=t_(e[m.HP_BAR_ORIENTATION]),v=n_(e[m.HP_BAR_ORIENTATION]),{currentHpBid:y,maxHpBid:b}=Qg(e,f[$.CURRENT_ATTR]||[]),x=s.filter(e=>a(e)&&e.metadata?.[Ug]===!0),S=s.filter(e=>r(e)&&e.metadata?.[Gg]===!0);if(!h&&x.length>0)try{await c.scene.local.deleteItems(x.map(e=>e.id))}catch(e){D.error(`Failed to remove HP bar effects`,e)}if(!g&&S.length>0)try{await c.scene.local.deleteItems(S.map(e=>e.id))}catch(e){D.error(`Failed to remove HP number texts`,e)}if(!h&&!g)return;let C=o.filter(e=>n(e)&&e.metadata?.[l.ON_LIST]===!0),w=new Map,T=new Map;for(let e of C){if(h){let t=$g(e,y,b);t!==null&&w.set(qg(e.id),{unitId:e.id,hpPercent:t})}if(g&&n(e)){let t=e_(e,y,b);if(t){let n=t.maxHp===null?`${t.currentHp}`:`${t.currentHp}/${t.maxHp}`;T.set(Jg(e.id),{unitId:e.id,text:n,position:i_(e,u,_)})}}}if(h){let e=new Map(x.map(e=>[e.id,e])),n=Array.from(w.entries()).filter(([t])=>!e.has(t)),r=x.filter(e=>!w.has(e.id)),i=x.filter(e=>{let t=w.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`orientation`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return e.attachedTo!==t.unitId||!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-v)>.001});if(d)return;if(r.length>0)try{await c.scene.local.deleteItems(r.map(e=>e.id))}catch(e){D.error(`Failed to remove stale HP bar effects`,e)}if(n.length>0){let e=n.map(([e,n])=>t().id(e).name(`HP Bar Effect`).effectType(`ATTACHMENT`).attachedTo(n.unitId).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).uniforms([{name:`hpPercent`,value:n.hpPercent},{name:`orientation`,value:v}]).sksl(`
uniform vec2 size;
uniform float time;
...
`).metadata({[Ug]:!0,[Wg]:n.unitId}).build());try{await c.scene.local.addItems(e)}catch(e){D.error(`Failed to add HP bar effects`,e)}}if(i.length>0){let e=i.map(e=>e.id);try{await c.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=w.get(e.id);if(!t)return;e.attachedTo=t.unitId;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:v}],e.metadata={...e.metadata,[Ug]:!0,[Wg]:t.unitId}})})}catch(e){D.error(`Failed to update HP bar effects`,e)}}}if(g){let e=new Map(S.map(e=>[e.id,e])),t=Array.from(T.entries()).filter(([t])=>!e.has(t)),n=S.filter(e=>!T.has(e.id)),r=S.filter(e=>{let t=T.get(e.id);if(!t)return!1;let n=e.text?.plainText,r=Math.abs(e.position.x-t.position.x)>.01||Math.abs(e.position.y-t.position.y)>.01;return e.attachedTo!==t.unitId||n!==t.text||r});if(d)return;if(n.length>0)try{await c.scene.local.deleteItems(n.map(e=>e.id))}catch(e){D.error(`Failed to remove stale HP number texts`,e)}if(t.length>0){let e=t.map(([e,t])=>{let n=C.find(e=>e.id===t.unitId);return ne().id(e).name(`HP Number Text`).plainText(t.text).textType(`PLAIN`).fontWeight(900).fillOpacity(.95).fillColor(`white`).strokeWidth(8).strokeColor(`black`).strokeOpacity(1).fontSize(28).fontFamily(`Segoe UI`).textAlign(`CENTER`).position(t.position).metadata({[Gg]:!0,[Kg]:t.unitId}).attachedTo(t.unitId).visible(n?.visible??!0).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).layer(`TEXT`).build()});try{await c.scene.local.addItems(e)}catch(e){D.error(`Failed to add HP number texts`,e)}}if(r.length>0){let e=r.map(e=>e.id);try{await c.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=T.get(e.id);if(!t)return;e.attachedTo=t.unitId,e.position=t.position;let n=e;n.text&&(n.text.plainText=t.text),e.metadata={...e.metadata,[Gg]:!0,[Kg]:t.unitId}})})}catch(e){D.error(`Failed to update HP number texts`,e)}}}})(),()=>{d=!0}},[e,i,o,s,u,d,f]),null};var o_=`${A}/death-effect-token`,s_=`${A}/death-effect-owner`,c_=e=>`DTH${e.slice(3)}`,l_=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},u_=e=>({currentHpBid:e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`})?.attr_bid||ve.CURRENT_HP}),d_=(e,t)=>{let n=u_(t),r=e[m.HP_CURRENT_BID],i=new Set(t.map(e=>e.attr_bid));return r&&i.has(r)?r:n.currentHpBid},f_=(e,t)=>{let n=e.metadata?.[`${A}/${t}`];return l_(n)};const p_=()=>{let e=N(e=>e.cacheReady),r=N(e=>e.sceneReady),i=N(e=>e.items),o=N(e=>e.localItems),s=N(e=>e.roomMetadata),u=N(e=>e.sceneMetadata);return(0,j.useEffect)(()=>{if(!e||!r)return;let s=!1;return(async()=>{let e=u,r=e[m.SHOW_DEATH_EFFECT]??!1,d=d_(e,u[$.CURRENT_ATTR]||[]),f=o.filter(e=>a(e)&&e.metadata?.[o_]===!0);if(!r){if(f.length>0)try{await c.scene.local.deleteItems(f.map(e=>e.id))}catch(e){D.error(`Failed to remove death token effects`,e)}return}let p=i.filter(e=>n(e)&&e.metadata?.[l.ON_LIST]===!0),h=new Map;p.forEach(e=>{f_(e,d)===0&&h.set(c_(e.id),e.id)});let g=new Map(f.map(e=>[e.id,e])),_=Array.from(h.entries()).filter(([e])=>!g.has(e)),v=f.filter(e=>!h.has(e.id)),y=f.filter(e=>{let t=h.get(e.id);if(!t)return!1;let n=e;return e.attachedTo!==t||n.metadata?.[s_]!==t});if(!s){if(v.length>0)try{await c.scene.local.deleteItems(v.map(e=>e.id))}catch(e){D.error(`Failed to remove stale death token effects`,e)}if(_.length>0){let e=_.map(([e,n])=>t().id(e).name(`Death Token Effect`).effectType(`ATTACHMENT`).attachedTo(n).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(`
uniform float2 size;
uniform float time;
...
`).metadata({[o_]:!0,[s_]:n}).build());try{await c.scene.local.addItems(e)}catch(e){D.error(`Failed to add death token effects`,e)}}if(y.length>0)try{await c.scene.local.updateItems(y.map(e=>e.id),e=>{e.forEach(e=>{let t=h.get(e.id);t&&(e.attachedTo=t,e.metadata={...e.metadata,[o_]:!0,[s_]:t})})})}catch(e){D.error(`Failed to update death token effects`,e)}}})(),()=>{s=!0}},[e,r,i,o,s,u]),null};var m_=`${A}/buff-effect-token`,h_=`${A}/buff-effect-owner`,g_=`${A}/debuff-effect-token`,__=`${A}/debuff-effect-owner`,v_=`${A}/effect-preset`,y_=e=>`EFB${e.slice(3)}`,b_=e=>`EFD${e.slice(3)}`,x_=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const S_=()=>{let e=N(e=>e.cacheReady),r=N(e=>e.sceneReady),i=N(e=>e.items),o=N(e=>e.localItems),s=N(e=>e.roomMetadata),u=N(e=>e.sceneMetadata);return(0,j.useEffect)(()=>{if(!e||!r)return;let s=!1;return(async()=>{let e=u,r=e[m.BUFF_VISUAL_PRESET],d=e[m.DEBUFF_VISUAL_PRESET],f=Wp(r)?r:Bp,p=Gp(d)?d:Vp,h=Kp(f),g=qp(p),_=i.filter(e=>n(e)&&e.metadata?.[l.ON_LIST]===!0),v=new Set(_.map(e=>e.id)),y=new Map,b=(e,t)=>{let n=y.get(e)||{hasBuff:!1,hasDebuff:!1};t===`buff`?n.hasBuff=!0:n.hasDebuff=!0,y.set(e,n)};i.forEach(e=>{if(e.metadata?.[l.ON_LIST]!==!0)return;let t=x_(e.metadata?.[Dm]);t.length!==0&&t.forEach(t=>{t.effectType!==`neutral`&&(t.targets.length>0?t.targets:[e.id]).forEach(e=>{v.has(e)&&(t.effectType===`buff`||t.effectType===`debuff`)&&b(e,t.effectType)})})});let x=new Map,S=new Map;_.forEach(e=>{let t=y.get(e.id);t?.hasBuff&&x.set(y_(e.id),e.id),t?.hasDebuff&&S.set(b_(e.id),e.id)});let C=o.filter(e=>a(e)&&e.metadata?.[m_]===!0),w=o.filter(e=>a(e)&&e.metadata?.[g_]===!0),T=async e=>{let{existing:n,desiredByOverlayId:r,preset:i,shader:a,name:o,flagKey:l,ownerKey:u}=e,d=new Map(n.map(e=>[e.id,e])),f=Array.from(r.entries()).filter(([e])=>!d.has(e)),p=n.filter(e=>!r.has(e.id)),m=n.filter(e=>{let t=r.get(e.id);if(!t)return!1;let n=e.metadata?.[v_];return e.attachedTo!==t||n!==i});if(!s){if(p.length>0)try{await c.scene.local.deleteItems(p.map(e=>e.id))}catch(e){D.error(`Failed to remove stale ${o.toLowerCase()} overlays`,e)}if(f.length>0){let e=f.map(([e,n])=>t().id(e).name(o).effectType(`ATTACHMENT`).attachedTo(n).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(a).metadata({[l]:!0,[u]:n,[v_]:i}).build());try{await c.scene.local.addItems(e)}catch(e){D.error(`Failed to add ${o.toLowerCase()} overlays`,e)}}if(m.length>0)try{await c.scene.local.updateItems(m.map(e=>e.id),e=>{e.forEach(e=>{let t=r.get(e.id);if(!t)return;e.attachedTo=t;let n=e;n.sksl=a,e.metadata={...e.metadata,[l]:!0,[u]:t,[v_]:i}})})}catch(e){D.error(`Failed to update ${o.toLowerCase()} overlays`,e)}}};await T({existing:C,desiredByOverlayId:x,preset:f,shader:h,name:`Buff Token Effect`,flagKey:m_,ownerKey:h_}),await T({existing:w,desiredByOverlayId:S,preset:p,shader:g,name:`Debuff Token Effect`,flagKey:g_,ownerKey:__})})(),()=>{s=!0}},[e,r,i,o,s,u]),null};var C_=`${A}/boss-hp-effect`,w_=`${A}/boss-hp-owner`,T_=`${A}/boss-hp-slot`,E_=e=>`BOSSHP${e}`,D_=(e,t,n)=>Math.max(t,Math.min(n,e)),O_=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},k_=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||ve.CURRENT_HP,maxHpBid:n?.attr_bid||ve.MAX_HP}},A_=(e,t)=>{let n=k_(t),r=e[m.HP_CURRENT_BID],i=e[m.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},j_=(e,t,n)=>{let r=e.metadata?.[`${A}/${t}`],i=e.metadata?.[`${A}/${n}`],a=O_(r),o=O_(i);return o===null||o<=0||a===null?null:D_(a/o*100,0,100)};const M_=()=>{let e=N(e=>e.cacheReady),r=N(e=>e.sceneReady),i=N(e=>e.items),o=N(e=>e.localItems),s=N(e=>e.roomMetadata),u=N(e=>e.sceneMetadata);return(0,j.useEffect)(()=>{if(!e||!r)return;let s=!1;return(async()=>{let{currentHpBid:e,maxHpBid:r}=A_(u,u[$.CURRENT_ATTR]||[]),d=o.filter(e=>a(e)&&e.metadata?.[C_]===!0),f=i.filter(e=>n(e)&&e.metadata?.[l.ON_LIST]===!0&&e.metadata?.[l.BOSS_MODE]===!0).sort((e,t)=>{let n=Number(e.metadata?.[l.INITIATIVE]??0);return Number(t.metadata?.[l.INITIATIVE]??0)-n}).slice(0,2).map((t,n)=>{let i=j_(t,e,r);return i===null?null:{id:E_(n),unitId:t.id,slot:n,hpPercent:i}}).filter(e=>e!==null),p=new Map(f.map(e=>[e.id,e])),m=new Map(d.map(e=>[e.id,e])),h=d.filter(e=>!p.has(e.id)),g=f.filter(e=>!m.has(e.id)),_=d.filter(e=>{let t=p.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`slot`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-t.slot)>.001||e.metadata?.[w_]!==t.unitId});if(!s){if(h.length>0)try{await c.scene.local.deleteItems(h.map(e=>e.id))}catch(e){D.error(`Failed to remove stale boss HP viewport effects`,e)}if(g.length>0){let e=g.map(e=>t().id(e.id).name(`Boss HP Bar`).effectType(`VIEWPORT`).locked(!0).disableHit(!0).uniforms([{name:`hpPercent`,value:e.hpPercent},{name:`slot`,value:e.slot}]).sksl(`
uniform float2 size;
...
`).metadata({[C_]:!0,[w_]:e.unitId,[T_]:e.slot}).build());try{await c.scene.local.addItems(e)}catch(e){D.error(`Failed to add boss HP viewport effects`,e)}}if(_.length>0)try{await c.scene.local.updateItems(_.map(e=>e.id),e=>{e.forEach(e=>{let t=p.get(e.id);if(!t)return;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`slot`,value:t.slot}],e.metadata={...e.metadata,[C_]:!0,[w_]:t.unitId,[T_]:t.slot}})})}catch(e){D.error(`Failed to update boss HP viewport effects`,e)}}})(),()=>{s=!0}},[e,r,i,o,s,u]),null};var N_=`${A}/current-turn-effect`;const P_=()=>{let e=N(e=>e.cacheReady),n=N(e=>e.sceneReady),r=N(e=>e.items),i=N(e=>e.roomMetadata),a=N(e=>e.sceneMetadata);return(0,j.useEffect)(()=>{if(!e||!n)return;let i=!1;return(async()=>{let e=a[m.SHOW_TURN_EFFECT]===!0,n=a[m.CURRENT_TURN];if(!e||!n){try{await c.scene.local.deleteItems([N_])}catch{}return}if(!r.find(e=>e.id===n)){try{await c.scene.local.deleteItems([N_])}catch{}return}if(!i){try{let e=!1;if(await c.scene.local.updateItems([N_],t=>{let r=t[0];r&&(r.attachedTo=n,e=!0)}),e)return}catch{}if(!i)try{let e=t().id(N_).name(`Current Turn Effect`).effectType(`ATTACHMENT`).attachedTo(n).locked(!0).disableHit(!0).sksl(`
uniform vec2 size;
uniform float time;
...
`).build();await c.scene.local.addItems([e])}catch(e){D.error(`Failed to sync current turn effect`,e)}}})(),()=>{i=!0}},[e,n,r,i,a]),null},F_=()=>{let[e,t]=(0,j.useState)(!1),{updateThemeFromSystem:n}=je(),r=N(e=>e.sceneMetadata),i=N(e=>e.cacheReady);return(0,j.useEffect)(()=>{if(!i)return;let e=r[$.CURRENT_THEME];if(!e?.primary||!e?.offset||!e?.background||!e?.border){n(T.theme_primary,T.theme_offset,T.theme_background,T.theme_border,T.background_url);return}n(e.primary,e.offset,e.background,e.border,e.background_url)},[i,r,n]),(0,j.useEffect)(()=>{if(e)return;let a=!0,o=async()=>{if(i)try{D.log(`Starting app initialization...`),await s(),a&&(t(!0),D.log(`App initialization complete`))}catch(e){D.error(`Error during app initialization:`,e),a&&t(!0)}},s=async()=>{try{let e=r[$.CURRENT_THEME],t=r[$.CURRENT_CARD],i=r[$.CURRENT_LIST],a=r[$.CURRENT_ATTR];if(!e||!Array.isArray(t)||!Array.isArray(i)||!Array.isArray(a)){D.log(`System data not found, initializing with defaults`),await l();return}D.log(`Loading existing system theme:`,e),n(e.primary,e.offset,e.background,e.border,e.background_url)}catch(e){D.error(`Error loading system data:`,e),await l()}},l=async()=>{let e={primary:T.theme_primary,offset:T.theme_offset,background:T.theme_background,border:T.theme_border,background_url:T.background_url};await c.scene.setMetadata({[$.CURRENT_THEME]:e,[$.CURRENT_CARD]:T.card_layout,[$.CURRENT_LIST]:T.list_layout,[$.CURRENT_ATTR]:T.attributes,[$.SYSTEM_NAME]:T.name,[$.IMPORT_DATE]:null}),D.log(`Default system initialized`),n(e.primary,e.offset,e.background,e.border,e.background_url)};return o(),()=>{a=!1}},[i,e]),{isInitialized:e}};var I_=C`
...
`;function B_(){let{sceneReady:e,cacheReady:t,playerData:n,roomMetadata:r,sceneMetadata:i}=N(),{isInitialized:a}=F_(),{theme:o}=je(),[s,l]=(0,j.useState)(`ForgeMain`),[u,d]=(0,j.useState)(!1),f=String(n?.role||``).toUpperCase()===`GM`,p=i[m.SHOW_PLAYER_VIEW]||!1,h=f||p;return(0,j.useEffect)(()=>{!h&&s===`ForgeMain`&&l(`Party`)},[h,s]),(0,j.useEffect)(()=>{s!==`ForgeMain`&&c.action.setWidth(350)},[s]),(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(I_,{theme:o}),!e||!t||!a?(0,P.jsxs)(L_,{children:[(0,P.jsx)(R_,{}),(0,P.jsx)(z_,{children:e?t?a?`Loading...`:`Initializing system...`:`Loading cache...`:`Connecting to scene...`})]}):(0,P.jsxs)(np,{children:[(0,P.jsx)(a_,{}),(0,P.jsx)(p_,{}),(0,P.jsx)(S_,{}),(0,P.jsx)(M_,{}),(0,P.jsx)(P_,{}),(0,P.jsx)(rp,{theme:o,$backgroundUrl:o.BACKGROUND_URL,children:(0,P.jsx)(Yc,{mode:`wait`,children:(()=>{switch(s){case`ForgeMain`:return h?(0,P.jsx)(bg,{},`main`):(0,P.jsx)(Hg,{},`party`);case`Settings`:return f?(0,P.jsx)(Dp,{},`settings`):(0,P.jsx)(bg,{},`main`);case`Party`:return(0,P.jsx)(Hg,{},`party`);case`System`:return f?(0,P.jsx)(Cm,{},`system`):(0,P.jsx)(bg,{},`main`);case`ChatLog`:return(0,P.jsx)(Np,{},`chatlog`)}})()})}),(0,P.jsx)(mp,{isOpen:u,currentPage:s,onToggle:()=>d(!u),onNavigate:e=>{if(!h&&e===`ForgeMain`){l(`Party`),d(!1);return}if(!f&&(e===`Settings`||e===`System`)){l(`ForgeMain`),d(!1);return}l(e),d(!1)},canAccessInitiativeList:h})]})]})}var V_=B_,H_=class{static{this.ALPHANUMERICTEXTMATCH=/\s[\da-zA-Z]$/}};function U_(e){for(let t of G_)if(e.includes(t)){let n=G_[Math.floor(Math.random()*G_.length)];return e.replace(t,n)}return W_(e)}function W_(e){return`${G_[Math.floor(Math.random()*G_.length)]} ${e}`}const G_=`Grizzled.Wily.Stoic.Mellow.Pensive.Shrewd.Cautious.Hardy.Nimble.Tenacious.Gritty.Tolerant.Hardy.Adroit.Resilient.Slight.Stout.Durable.Subtle.Sober.Clever.Brave.Calm.Wise.Cunning.Alert.Swift.Agile.Loyal.Sturdy.Stable.Sneaky.Clever.Resourceful.Shady.Stalwart.Vigilant.Staunch.Fierce.Vigorous.Robust.Fearless.Dauntless.Resolute.Sagacious.Prudent.Judicious.Astute.Savvy.Sharp.Quick.Witty.Smart.Snippy.Crafty.Deft.Sly.Artful.Clever.Sneering.Tough.Rugged.Solid.Strong.Sturdy.Tough.Gritty.Rough.Hardened.Burly.Muscular.Brawny.Rowdy.Forceful.Snorting.Potent.Martial.Speckled.Mottled.Disheveled`.split(`.`);var K_=`com.battle-system.forge/view-unit`,q_=e=>e.trim().toLowerCase(),J_=e=>{let t=e.trim();return t?H_.ALPHANUMERICTEXTMATCH.test(t)?t.slice(0,-2):t:e},Y_=async e=>{let t=await c.viewport.getHeight(),n=t>800?700:t-100;await c.popover.open({id:u.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(e)}`,height:n,width:350,anchorReference:`POSITION`,anchorPosition:{left:await c.viewport.getWidth()/2,top:await c.viewport.getHeight()/2},anchorOrigin:{horizontal:`CENTER`,vertical:`CENTER`},transformOrigin:{horizontal:`CENTER`,vertical:`CENTER`},hidePaper:!0,disableClickAway:!0})},X_=async e=>{let t=Array.from(new Set(e.map(e=>e.trim()).filter(e=>e.length>0))),n=new Map;if(t.length===0)return n;try{let{data:e,error:r}=await ue.from(`bs_forge_creatures`).select(`name,metadata,is_active`).eq(`is_active`,!0).in(`name`,t).limit(250);if(!r&&Array.isArray(e)){let t=e;for(let e of t){let t=q_(String(e.name||``));if(!t||n.has(t))continue;let r=e.metadata&&typeof e.metadata==`object`&&!Array.isArray(e.metadata)?de(e.metadata):null;r&&n.set(t,r)}}}catch(e){D.log(`Supabase collection lookup failed, falling back to local collection`,e)}let r=await k(),i=new Map;for(let e of r){let t=q_(e.name);if(!t)continue;let n=i.get(t);n?n.push(e):i.set(t,[e])}for(let e of t){let t=q_(e);if(n.has(t))continue;let r=i.get(t)?.[0];!r||!r.metadata||n.set(t,de(r.metadata))}return n};function Z_({children:e}){N(e=>e.roomMetadata);let t=N(e=>e.sceneMetadata),n=N(e=>e.items),r=N(e=>e.playerData),i=t,a=i[m.HP_CURRENT_BID]!==void 0&&i[m.HP_MAX_BID]!==void 0,o=i[m.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?!0:i[m.SHOW_MODIFY_UNIT_CONTEXT_MENU]===!0;return(0,j.useEffect)(()=>{c.onReady(()=>{c.contextMenu.create({id:l.ON_LIST,icons:[{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,l.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,l.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,l.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,l.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}}],async onClick(e){if(D.info(`Add to Combat Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[l.ON_LIST]===!0))await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[l.ON_LIST],delete t.metadata[l.INITIATIVE]});else{let r=[],a=[],o=new Set(e.items.map(e=>e.id)),s=i[m.USE_DESCRIPTIVE_DUPLICATES]!==void 0,u=new Set(n.filter(e=>{if(o.has(e.id))return!1;let t=e.metadata[l.UNIT_NAME];return typeof t==`string`&&t.trim().length>0}).map(e=>q_(String(e.metadata[l.UNIT_NAME]))));for(let t of e.items){if(t.metadata[l.FABRICATED]===!0)continue;let e=J_(t.text?.plainText||t.name);r.push(e)}await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let d=await X_(r);await c.action.setBadgeText(void 0);for(let t of e.items){let e={};if(t.metadata[l.FABRICATED]!==!0){let n=J_(t.text?.plainText||t.name),r=d.get(q_(n));if(r&&Object.assign(e,r),(typeof e[l.UNIT_NAME]!=`string`||!String(e[l.UNIT_NAME]).trim())&&(e[l.UNIT_NAME]=t.name),e[l.FABRICATED]=!0,s){let r=String(e[l.UNIT_NAME]||n||t.name).trim(),i=q_(r);if(i){let e=0;for(;u.has(i)&&e<20;)r=U_(r),i=q_(r),e+=1;i&&u.add(i)}e[l.UNIT_NAME]=r}}e[l.ON_LIST]=!0,e[l.INITIATIVE]=0,a.push({id:t.id,metadata:e})}await c.scene.items.updateItems(e.items,e=>{for(let n of e){let e=a.find(e=>e.id===n.id);if(e&&(Object.assign(n.metadata,e.metadata),t[m.SHOW_NAMES]===!0)){let t=n;t.text&&(t.text.plainText=String(e.metadata[l.UNIT_NAME]||``))}}})}}}),c.contextMenu.create({id:l.IN_PARTY,icons:[{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,l.IN_PARTY],operator:`!=`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,l.IN_PARTY],operator:`!=`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,l.IN_PARTY],operator:`==`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,l.IN_PARTY],operator:`==`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){D.info(`Add to Party Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[l.IN_PARTY]===!0)?await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[l.IN_PARTY]}):await c.scene.items.updateItems(e.items,e=>{for(let t of e)t.metadata[l.IN_PARTY]=!0})}}),c.contextMenu.create({id:K_,icons:[{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){D.info(`View Unit Clicked: ${e.items[0].name}`);let r=e.items[0];if(!r)return;let a={};if(r.metadata[l.FABRICATED]!==!0){let e=J_(r.text?.plainText||r.name);await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let o=await X_([e]);await c.action.setBadgeText(void 0);let s=o.get(q_(e));s&&Object.assign(a,s),(typeof a[l.UNIT_NAME]!=`string`||!String(a[l.UNIT_NAME]).trim())&&(a[l.UNIT_NAME]=r.name),a[l.FABRICATED]=!0,i[m.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[l.UNIT_NAME]!=null&&e.id!==r.id).map(e=>e.metadata[l.UNIT_NAME]).includes(e)&&(a[l.UNIT_NAME]=U_(e)),await c.scene.items.updateItems([r],e=>{let n=e[0];if(Object.assign(n.metadata,a),t[m.SHOW_NAMES]===!0){let e=n;e.text&&(e.text.plainText=String(a[l.UNIT_NAME]||``))}})}await Y_(r.id)}}),a&&o?c.contextMenu.create({id:l.MODIFY_UNIT,icons:[{icon:`/icon.svg`,label:`Adjust HP`,filter:{some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Adjust HP`,filter:{every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e,t){D.info(`Adjust HP Clicked: ${e.items[0].name}`),await c.popover.open({id:h.CONTEXT_MENU,url:`/pages/forgecontext.html`,height:50,width:180,anchorElementId:t,hidePaper:!0})},embed:{url:`/pages/forgecontext.html?contextmenu=true`,height:70}}):c.contextMenu.remove(l.MODIFY_UNIT).catch(()=>{})})},[i,a,o]),(0,P.jsx)(P.Fragment,{children:e})}we.createRoot(document.getElementById(`root`)).render((0,P.jsx)(j.StrictMode,{children:(0,P.jsx)(re,{children:(0,P.jsx)(Oe,{children:(0,P.jsx)(Z_,{children:(0,P.jsx)(Ae,{children:(0,P.jsx)(V_,{})})})})})}));