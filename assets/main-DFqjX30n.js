...
`,A_=T.p`
  color: ${e=>e.theme.PRIMARY};
  margin: 0;
`,j_=e=>{switch(e){case`bottom`:return`left`;case`left`:return`top`;case`top`:return`right`;case`right`:default:return`bottom`}},M_=e=>e===`bottom`||e===`left`||e===`top`||e===`right`,N_=async()=>{await c.modal.open({id:p_,url:`/pages/forgeparty.html`,fullScreen:!0,hideBackdrop:!0,hidePaper:!0,disablePointerEvents:!0})};const P_=()=>{let t=(0,N.useRef)(!1),{theme:n}=We(),{attributes:r}=mm(),i=P(e=>e.items),a=P(e=>e.sceneMetadata);P(e=>e.roomMetadata);let o=P(e=>e.playerData),s=a,l=String(o?.role||``).toUpperCase()===`GM`,u=o?.id,d=ne(O.PARTY_HUD_OPEN,u),f=ne(O.PARTY_HUD_ORIENTATION,u),m=(s[d]??s[O.PARTY_HUD_OPEN])===!0,h=s[f]??s[O.PARTY_HUD_ORIENTATION],g=M_(h)?h:`bottom`,_=s[O.PARTY_HUD_ATTR_ONE]||``,v=s[O.PARTY_HUD_ATTR_TWO]||``,y=s[O.PARTY_HUD_SHOW_HP_BARS]===!0,b=s[O.PARTY_HUD_SHOW_HP_NUMBERS]===!0&&!y,x=i.filter(e=>e.metadata[p.IN_PARTY]===!0),S=(0,N.useMemo)(()=>r.filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`text`||t===`numb`||t===`bool`}),[r]),C=async(e,t)=>{await c.scene.setMetadata({[e]:t})},w=async()=>{let e=!m;if(await C(d,e),!e){await c.modal.close(p_),t.current=!1;return}await N_(),t.current=!0},T=async()=>{await C(f,j_(g))},E=async(e,t)=>{let n=t.trim();await c.scene.items.updateItems([e],e=>{let t={...e[0].metadata||{}};n?t[p.PORTRAIT_URL]=n:delete t[p.PORTRAIT_URL],e[0].metadata=t})};return(0,N.useEffect)(()=>{let e=!0;return(async()=>{if(m&&!t.current){await N_(),e&&(t.current=!0);return}!m&&t.current&&(await c.modal.close(p_),e&&(t.current=!1))})(),()=>{e=!1}},[m]),(0,F.jsx)(Zu.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,F.jsxs)(nm,{theme:n,children:[(0,F.jsx)(rm,{theme:n,children:`Party`}),(0,F.jsxs)(h_,{theme:n,children:[(0,F.jsxs)(g_,{children:[(0,F.jsxs)(y_,{theme:n,onClick:()=>void T(),children:[`Display: `,g.toUpperCase()]}),(0,F.jsx)(y_,{theme:n,onClick:()=>void w(),children:m?`Close Party HUD`:`Open Party HUD`})]}),l&&(0,F.jsxs)(F.Fragment,{children:[(0,F.jsxs)(__,{children:[(0,F.jsx)(v_,{theme:n,children:`Show in HUD:`}),(0,F.jsxs)(S_,{$disabled:!l,children:[(0,F.jsx)(C_,{theme:n,children:`Show HP Bars`}),(0,F.jsx)(X,{label:`Party HUD Show HP Bars`,isOn:y,onChange:e=>{l&&(C(O.PARTY_HUD_SHOW_HP_BARS,e),e&&C(O.PARTY_HUD_SHOW_HP_NUMBERS,!1))}})]}),(0,F.jsxs)(S_,{$disabled:!l,children:[(0,F.jsx)(C_,{theme:n,children:`Show HP Numbers`}),(0,F.jsx)(X,{label:`Party HUD Show HP Numbers`,isOn:b,onChange:e=>{l&&(C(O.PARTY_HUD_SHOW_HP_NUMBERS,e),e&&C(O.PARTY_HUD_SHOW_HP_BARS,!1))}})]}),(0,F.jsxs)(b_,{theme:n,disabled:!l,value:_,onChange:e=>{let t=e.target.value;C(O.PARTY_HUD_ATTR_ONE,t),t&&t===v&&C(O.PARTY_HUD_ATTR_TWO,``)},children:[(0,F.jsx)(`option`,{value:``,children:`Extra Slot 1 (None)`}),S.map(e=>(0,F.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]}),(0,F.jsxs)(b_,{theme:n,disabled:!l,value:v,onChange:e=>{let t=e.target.value;C(O.PARTY_HUD_ATTR_TWO,t),t&&t===_&&C(O.PARTY_HUD_ATTR_ONE,``)},children:[(0,F.jsx)(`option`,{value:``,children:`Extra Slot 2 (None)`}),S.map(e=>(0,F.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]})]}),(0,F.jsx)(x_,{theme:n,children:(0,F.jsxs)(F.Fragment,{children:[`Configure Party HUD and portraits.`,(0,F.jsx)(`br`,{}),`LIST attributes are excluded.`]})})]})]}),x.length===0?(0,F.jsx)(A_,{theme:n,children:`No one is in the Party.  Add a unit using the ContextMenu on the token.`}):(0,F.jsx)(m_,{theme:n,children:x.map(t=>{let r=t.metadata?.[p.PORTRAIT_URL]||``,i=e(t)?t.image.url:void 0,a=t.metadata[p.UNIT_NAME]||t.name||`Unknown`,s=t.createdUserId===o?.id,c=l||s,u=i||`/logo.png`,d=!!r;return(0,F.jsxs)(w_,{theme:n,children:[(0,F.jsxs)(T_,{children:[(0,F.jsx)(E_,{theme:n,src:u,alt:a,$full:!d}),d&&(0,F.jsx)(E_,{theme:n,src:d?r:``,alt:`${a} override`,$overlay:!0})]}),(0,F.jsxs)(D_,{children:[(0,F.jsx)(O_,{theme:n,title:a,children:a}),c&&(0,F.jsx)(k_,{theme:n,defaultValue:r,placeholder:`Portrait URL override (optional)`,onBlur:e=>{E(t.id,e.target.value)}})]})]},t.id)})})]})})};var F_=`${M}/hp-bar-effect`,I_=`${M}/hp-bar-owner`,L_=`${M}/hp-number-text`,R_=`${M}/hp-number-owner`,z_=e=>`HPB${e.slice(3)}`,B_=e=>`HPN${e.slice(3)}`,V_=(e,t,n)=>Math.max(t,Math.min(n,e)),H_=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},U_=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||Oe.CURRENT_HP,maxHpBid:n?.attr_bid||Oe.MAX_HP}},W_=(e,t)=>{let n=U_(t),r=e[O.HP_CURRENT_BID],i=e[O.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},G_=(e,t,n)=>{let r=e.metadata?.[`${M}/${t}`],i=e.metadata?.[`${M}/${n}`],a=H_(r),o=H_(i);return o===null||o<=0||a===null?null:V_(a/o*100,0,100)},K_=(e,t,n)=>{let r=e.metadata?.[`${M}/${t}`],i=e.metadata?.[`${M}/${n}`],a=H_(r),o=H_(i);return a===null?null:{currentHp:Math.trunc(a),maxHp:o===null?null:Math.trunc(o)}},q_=e=>{let t=String(e||`bottom`).toLowerCase();return t===`top`||t===`bottom`||t===`left`||t===`right`?t:`bottom`},J_=e=>{switch(q_(e)){case`top`:return 0;case`bottom`:return 1;case`left`:return 2;case`right`:return 3;default:return 1}},Y_=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o,width:r,height:i}},X_=(e,t,n)=>{let r=Y_(e,t),i=r.minX+r.width*.5,a=r.minY+r.height*.5,o;switch(n){case`top`:o={x:i,y:r.minY+r.height*.18};break;case`bottom`:o={x:i,y:r.minY+r.height*.82};break;case`left`:o={x:r.minX+r.width*.18,y:a};break;case`right`:o={x:r.minX+r.width*.82,y:a};break}let s=r.width*.25,c=r.height*.18;return{x:o.x-s,y:o.y-c}};const Z_=()=>{let t=P(e=>e.cacheReady),i=P(e=>e.sceneReady),a=P(e=>e.items),o=P(e=>e.localItems),s=P(e=>e.gridDpi),l=P(e=>e.roomMetadata),u=P(e=>e.sceneMetadata),d=P(e=>e.systemData);return(0,N.useEffect)(()=>{if(!t||!i)return;let l=!1;return(async()=>{let t=u,i=t[O.SHOW_HP_BARS]??!1,f=t[O.SHOW_HP_NUMBERS]??!1,m=i,h=!i&&f,g=q_(t[O.HP_BAR_ORIENTATION]),_=J_(t[O.HP_BAR_ORIENTATION]),{currentHpBid:v,maxHpBid:x}=W_(t,d?.attributes||[]),S=o.filter(e=>y(e)&&e.metadata?.[F_]===!0),C=o.filter(e=>b(e)&&e.metadata?.[L_]===!0);if(!m&&S.length>0)try{await c.scene.local.deleteItems(S.map(e=>e.id))}catch(e){k.error(`Failed to remove HP bar effects`,e)}if(!h&&C.length>0)try{await c.scene.local.deleteItems(C.map(e=>e.id))}catch(e){k.error(`Failed to remove HP number texts`,e)}if(!m&&!h)return;let w=a.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),T=new Map,E=new Map;for(let t of w){if(m){let e=G_(t,v,x);e!==null&&T.set(z_(t.id),{unitId:t.id,hpPercent:e})}if(h&&e(t)){let e=K_(t,v,x);if(e){let n=e.maxHp===null?`${e.currentHp}`:`${e.currentHp}/${e.maxHp}`;E.set(B_(t.id),{unitId:t.id,text:n,position:X_(t,s,g)})}}}if(m){let e=new Map(S.map(e=>[e.id,e])),t=Array.from(T.entries()).filter(([t])=>!e.has(t)),n=S.filter(e=>!T.has(e.id)),i=S.filter(e=>{let t=T.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`orientation`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return e.attachedTo!==t.unitId||!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-_)>.001});if(l)return;if(n.length>0)try{await c.scene.local.deleteItems(n.map(e=>e.id))}catch(e){k.error(`Failed to remove stale HP bar effects`,e)}if(t.length>0){let e=t.map(([e,t])=>r().id(e).name(`HP Bar Effect`).effectType(`ATTACHMENT`).attachedTo(t.unitId).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).uniforms([{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}]).sksl(`
uniform vec2 size;
uniform float time;
...
`).metadata({[F_]:!0,[I_]:t.unitId}).build());try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add HP bar effects`,e)}}if(i.length>0){let e=i.map(e=>e.id);try{await c.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=T.get(e.id);if(!t)return;e.attachedTo=t.unitId;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}],e.metadata={...e.metadata,[F_]:!0,[I_]:t.unitId}})})}catch(e){k.error(`Failed to update HP bar effects`,e)}}}if(h){let e=new Map(C.map(e=>[e.id,e])),t=Array.from(E.entries()).filter(([t])=>!e.has(t)),r=C.filter(e=>!E.has(e.id)),i=C.filter(e=>{let t=E.get(e.id);if(!t)return!1;let n=e.text?.plainText,r=Math.abs(e.position.x-t.position.x)>.01||Math.abs(e.position.y-t.position.y)>.01;return e.attachedTo!==t.unitId||n!==t.text||r});if(l)return;if(r.length>0)try{await c.scene.local.deleteItems(r.map(e=>e.id))}catch(e){k.error(`Failed to remove stale HP number texts`,e)}if(t.length>0){let e=t.map(([e,t])=>{let r=w.find(e=>e.id===t.unitId);return n().id(e).name(`HP Number Text`).plainText(t.text).textType(`PLAIN`).fontWeight(900).fillOpacity(.95).fillColor(`white`).strokeWidth(8).strokeColor(`black`).strokeOpacity(1).fontSize(28).fontFamily(`Segoe UI`).textAlign(`CENTER`).position(t.position).metadata({[L_]:!0,[R_]:t.unitId}).attachedTo(t.unitId).visible(r?.visible??!0).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).layer(`TEXT`).build()});try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add HP number texts`,e)}}if(i.length>0){let e=i.map(e=>e.id);try{await c.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=E.get(e.id);if(!t)return;e.attachedTo=t.unitId,e.position=t.position;let n=e;n.text&&(n.text.plainText=t.text),e.metadata={...e.metadata,[L_]:!0,[R_]:t.unitId}})})}catch(e){k.error(`Failed to update HP number texts`,e)}}}})(),()=>{l=!0}},[t,i,a,o,s,l,u,d]),null};var Q_=`${M}/death-effect-token`,$_=`${M}/death-effect-owner`,ev=e=>`DTH${e.slice(3)}`,tv=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},nv=e=>({currentHpBid:e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`})?.attr_bid||Oe.CURRENT_HP}),rv=(e,t)=>{let n=nv(t),r=e[O.HP_CURRENT_BID],i=new Set(t.map(e=>e.attr_bid));return r&&i.has(r)?r:n.currentHpBid},iv=(e,t)=>{let n=e.metadata?.[`${M}/${t}`];return tv(n)};const av=()=>{let t=P(e=>e.cacheReady),n=P(e=>e.sceneReady),i=P(e=>e.items),a=P(e=>e.localItems),o=P(e=>e.roomMetadata),s=P(e=>e.sceneMetadata),l=P(e=>e.systemData);return(0,N.useEffect)(()=>{if(!t||!n)return;let o=!1;return(async()=>{let t=s,n=t[O.SHOW_DEATH_EFFECT]??!1,u=rv(t,l?.attributes||[]),d=a.filter(e=>y(e)&&e.metadata?.[Q_]===!0);if(!n){if(d.length>0)try{await c.scene.local.deleteItems(d.map(e=>e.id))}catch(e){k.error(`Failed to remove death token effects`,e)}return}let f=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),m=new Map;f.forEach(e=>{iv(e,u)===0&&m.set(ev(e.id),e.id)});let h=new Map(d.map(e=>[e.id,e])),g=Array.from(m.entries()).filter(([e])=>!h.has(e)),_=d.filter(e=>!m.has(e.id)),v=d.filter(e=>{let t=m.get(e.id);if(!t)return!1;let n=e;return e.attachedTo!==t||n.metadata?.[$_]!==t});if(!o){if(_.length>0)try{await c.scene.local.deleteItems(_.map(e=>e.id))}catch(e){k.error(`Failed to remove stale death token effects`,e)}if(g.length>0){let e=g.map(([e,t])=>r().id(e).name(`Death Token Effect`).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(`
uniform float2 size;
uniform float time;
...
`).metadata({[Q_]:!0,[$_]:t}).build());try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add death token effects`,e)}}if(v.length>0)try{await c.scene.local.updateItems(v.map(e=>e.id),e=>{e.forEach(e=>{let t=m.get(e.id);t&&(e.attachedTo=t,e.metadata={...e.metadata,[Q_]:!0,[$_]:t})})})}catch(e){k.error(`Failed to update death token effects`,e)}}})(),()=>{o=!0}},[t,n,i,a,o,s,l]),null};var ov=`${M}/buff-effect-token`,sv=`${M}/buff-effect-owner`,cv=`${M}/debuff-effect-token`,lv=`${M}/debuff-effect-owner`,uv=`${M}/effect-preset`,dv=e=>`EFB${e.slice(3)}`,fv=e=>`EFD${e.slice(3)}`,pv=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const mv=()=>{let t=P(e=>e.cacheReady),n=P(e=>e.sceneReady),i=P(e=>e.items),a=P(e=>e.localItems),o=P(e=>e.roomMetadata),s=P(e=>e.sceneMetadata);return(0,N.useEffect)(()=>{if(!t||!n)return;let o=!1;return(async()=>{let t=s,n=t[O.BUFF_VISUAL_PRESET],l=t[O.DEBUFF_VISUAL_PRESET],u=Im(n)?n:Mm,d=Lm(l)?l:Nm,f=Rm(u),m=zm(d),h=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),g=new Set(h.map(e=>e.id)),_=new Map,v=(e,t)=>{let n=_.get(e)||{hasBuff:!1,hasDebuff:!1};t===`buff`?n.hasBuff=!0:n.hasDebuff=!0,_.set(e,n)};i.forEach(e=>{if(e.metadata?.[p.ON_LIST]!==!0)return;let t=pv(e.metadata?.[yh]);t.length!==0&&t.forEach(t=>{t.effectType!==`neutral`&&(t.targets.length>0?t.targets:[e.id]).forEach(e=>{g.has(e)&&(t.effectType===`buff`||t.effectType===`debuff`)&&v(e,t.effectType)})})});let b=new Map,x=new Map;h.forEach(e=>{let t=_.get(e.id);t?.hasBuff&&b.set(dv(e.id),e.id),t?.hasDebuff&&x.set(fv(e.id),e.id)});let S=a.filter(e=>y(e)&&e.metadata?.[ov]===!0),C=a.filter(e=>y(e)&&e.metadata?.[cv]===!0),w=async e=>{let{existing:t,desiredByOverlayId:n,preset:i,shader:a,name:s,flagKey:l,ownerKey:u}=e,d=new Map(t.map(e=>[e.id,e])),f=Array.from(n.entries()).filter(([e])=>!d.has(e)),p=t.filter(e=>!n.has(e.id)),m=t.filter(e=>{let t=n.get(e.id);if(!t)return!1;let r=e.metadata?.[uv];return e.attachedTo!==t||r!==i});if(!o){if(p.length>0)try{await c.scene.local.deleteItems(p.map(e=>e.id))}catch(e){k.error(`Failed to remove stale ${s.toLowerCase()} overlays`,e)}if(f.length>0){let e=f.map(([e,t])=>r().id(e).name(s).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(a).metadata({[l]:!0,[u]:t,[uv]:i}).build());try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add ${s.toLowerCase()} overlays`,e)}}if(m.length>0)try{await c.scene.local.updateItems(m.map(e=>e.id),e=>{e.forEach(e=>{let t=n.get(e.id);if(!t)return;e.attachedTo=t;let r=e;r.sksl=a,e.metadata={...e.metadata,[l]:!0,[u]:t,[uv]:i}})})}catch(e){k.error(`Failed to update ${s.toLowerCase()} overlays`,e)}}};await w({existing:S,desiredByOverlayId:b,preset:u,shader:f,name:`Buff Token Effect`,flagKey:ov,ownerKey:sv}),await w({existing:C,desiredByOverlayId:x,preset:d,shader:m,name:`Debuff Token Effect`,flagKey:cv,ownerKey:lv})})(),()=>{o=!0}},[t,n,i,a,o,s]),null};var hv=`${M}/boss-hp-effect`,gv=`${M}/boss-hp-owner`,_v=`${M}/boss-hp-slot`,vv=e=>`BOSSHP${e}`,yv=(e,t,n)=>Math.max(t,Math.min(n,e)),bv=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},xv=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||Oe.CURRENT_HP,maxHpBid:n?.attr_bid||Oe.MAX_HP}},Sv=(e,t)=>{let n=xv(t),r=e[O.HP_CURRENT_BID],i=e[O.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},Cv=(e,t,n)=>{let r=e.metadata?.[`${M}/${t}`],i=e.metadata?.[`${M}/${n}`],a=bv(r),o=bv(i);return o===null||o<=0||a===null?null:yv(a/o*100,0,100)};const wv=()=>{let t=P(e=>e.cacheReady),n=P(e=>e.sceneReady),i=P(e=>e.items),a=P(e=>e.localItems),o=P(e=>e.roomMetadata),s=P(e=>e.sceneMetadata),l=P(e=>e.systemData);return(0,N.useEffect)(()=>{if(!t||!n)return;let o=!1;return(async()=>{let{currentHpBid:t,maxHpBid:n}=Sv(s,l?.attributes||[]),u=a.filter(e=>y(e)&&e.metadata?.[hv]===!0),d=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0&&t.metadata?.[p.BOSS_MODE]===!0).sort((e,t)=>{let n=Number(e.metadata?.[p.INITIATIVE]??0);return Number(t.metadata?.[p.INITIATIVE]??0)-n}).slice(0,2).map((e,r)=>{let i=Cv(e,t,n);return i===null?null:{id:vv(r),unitId:e.id,slot:r,hpPercent:i}}).filter(e=>e!==null),f=new Map(d.map(e=>[e.id,e])),m=new Map(u.map(e=>[e.id,e])),h=u.filter(e=>!f.has(e.id)),g=d.filter(e=>!m.has(e.id)),_=u.filter(e=>{let t=f.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`slot`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-t.slot)>.001||e.metadata?.[gv]!==t.unitId});if(!o){if(h.length>0)try{await c.scene.local.deleteItems(h.map(e=>e.id))}catch(e){k.error(`Failed to remove stale boss HP viewport effects`,e)}if(g.length>0){let e=g.map(e=>r().id(e.id).name(`Boss HP Bar`).effectType(`VIEWPORT`).locked(!0).disableHit(!0).uniforms([{name:`hpPercent`,value:e.hpPercent},{name:`slot`,value:e.slot}]).sksl(`
uniform float2 size;
...
`).metadata({[hv]:!0,[gv]:e.unitId,[_v]:e.slot}).build());try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add boss HP viewport effects`,e)}}if(_.length>0)try{await c.scene.local.updateItems(_.map(e=>e.id),e=>{e.forEach(e=>{let t=f.get(e.id);if(!t)return;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`slot`,value:t.slot}],e.metadata={...e.metadata,[hv]:!0,[gv]:t.unitId,[_v]:t.slot}})})}catch(e){k.error(`Failed to update boss HP viewport effects`,e)}}})(),()=>{o=!0}},[t,n,i,a,o,s,l]),null};var Tv=`${M}/current-turn-effect`;const Ev=()=>{let e=P(e=>e.cacheReady),t=P(e=>e.sceneReady),n=P(e=>e.items),i=P(e=>e.roomMetadata),a=P(e=>e.sceneMetadata);return(0,N.useEffect)(()=>{if(!e||!t)return;let i=!1;return(async()=>{let e=a[O.SHOW_TURN_EFFECT]===!0,t=a[O.CURRENT_TURN];if(!e||!t){try{await c.scene.local.deleteItems([Tv])}catch{}return}if(!n.find(e=>e.id===t)){try{await c.scene.local.deleteItems([Tv])}catch{}return}if(!i){try{let e=!1;if(await c.scene.local.updateItems([Tv],n=>{let r=n[0];r&&(r.attachedTo=t,e=!0)}),e)return}catch{}if(!i)try{let e=r().id(Tv).name(`Current Turn Effect`).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).sksl(`
uniform vec2 size;
uniform float time;
...
`;function Mv(){let{sceneReady:e,cacheReady:t,playerData:n,roomMetadata:r,sceneMetadata:i}=P(),{isInitialized:a}=Dv(),{theme:o}=We(),[s,l]=(0,N.useState)(`ForgeMain`),[u,d]=(0,N.useState)(!1),f=String(n?.role||``).toUpperCase()===`GM`,p=i[O.SHOW_PLAYER_VIEW]||!1,m=f||p,h=e&&t&&a;return(0,N.useEffect)(()=>{h&&pe()},[h]),(0,N.useEffect)(()=>{h&&!m&&s===`ForgeMain`&&l(`Party`)},[h,m,s]),(0,N.useEffect)(()=>{s!==`ForgeMain`&&c.action.setWidth(350)},[s]),(0,F.jsxs)(F.Fragment,{children:[(0,F.jsx)(Ov,{theme:o}),!e||!t||!a?(0,F.jsxs)(kv,{children:[(0,F.jsx)(Av,{}),(0,F.jsx)(jv,{children:e?t?a?`Loading...`:`Initializing system...`:`Loading cache...`:`Connecting to scene...`})]}):(0,F.jsxs)(Up,{children:[(0,F.jsx)(Z_,{}),(0,F.jsx)(av,{}),(0,F.jsx)(mv,{}),(0,F.jsx)(wv,{}),(0,F.jsx)(Ev,{}),(0,F.jsx)(Wp,{theme:o,$backgroundUrl:o.BACKGROUND_URL,children:(0,F.jsx)(ol,{mode:`wait`,children:(()=>{switch(s){case`ForgeMain`:return m?(0,F.jsx)(f_,{},`main`):(0,F.jsx)(P_,{},`party`);case`Settings`:return f?(0,F.jsx)(Tm,{},`settings`):(0,F.jsx)(f_,{},`main`);case`Party`:return(0,F.jsx)(P_,{},`party`);case`System`:return f?(0,F.jsx)(gh,{},`system`):(0,F.jsx)(f_,{},`main`);case`ChatLog`:return(0,F.jsx)(jm,{},`chatlog`)}})()})}),(0,F.jsx)(tm,{isOpen:u,currentPage:s,onToggle:()=>d(!u),onNavigate:e=>{if(!m&&e===`ForgeMain`){l(`Party`),d(!1);return}if(!f&&(e===`Settings`||e===`System`)){l(`ForgeMain`),d(!1);return}l(e),d(!1)},canAccessInitiativeList:m})]})]})}var Nv=Mv,Pv=class{static{this.ALPHANUMERICTEXTMATCH=/\s[\da-zA-Z]$/}};function Fv(e){for(let t of Lv)if(e.includes(t)){let n=Lv[Math.floor(Math.random()*Lv.length)];return e.replace(t,n)}return Iv(e)}function Iv(e){return`${Lv[Math.floor(Math.random()*Lv.length)]} ${e}`}const Lv=`Grizzled.Wily.Stoic.Mellow.Pensive.Shrewd.Cautious.Hardy.Nimble.Tenacious.Gritty.Tolerant.Hardy.Adroit.Resilient.Slight.Stout.Durable.Subtle.Sober.Clever.Brave.Calm.Wise.Cunning.Alert.Swift.Agile.Loyal.Sturdy.Stable.Sneaky.Clever.Resourceful.Shady.Stalwart.Vigilant.Staunch.Fierce.Vigorous.Robust.Fearless.Dauntless.Resolute.Sagacious.Prudent.Judicious.Astute.Savvy.Sharp.Quick.Witty.Smart.Snippy.Crafty.Deft.Sly.Artful.Clever.Sneering.Tough.Rugged.Solid.Strong.Sturdy.Tough.Gritty.Rough.Hardened.Burly.Muscular.Brawny.Rowdy.Forceful.Snorting.Potent.Martial.Speckled.Mottled.Disheveled`.split(`.`);var Rv=`com.battle-system.forge/view-unit`,zv=e=>e.trim().toLowerCase(),Bv=e=>{let t=e.trim();return t?Pv.ALPHANUMERICTEXTMATCH.test(t)?t.slice(0,-2):t:e},Vv=async e=>{let n=await c.viewport.getHeight(),r=n>800?700:n-100;await c.popover.open({id:t.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(e)}`,height:r,width:350,anchorReference:`POSITION`,anchorPosition:{left:await c.viewport.getWidth()/2,top:await c.viewport.getHeight()/2},anchorOrigin:{horizontal:`CENTER`,vertical:`CENTER`},transformOrigin:{horizontal:`CENTER`,vertical:`CENTER`},hidePaper:!0,disableClickAway:!0})},Hv=async e=>{let t=Array.from(new Set(e.map(e=>e.trim()).filter(e=>e.length>0))),n=new Map;if(t.length===0)return n;let r=await de(),i=new Map;for(let e of r){let t=zv(e.name);if(!t)continue;let n=i.get(t);n?n.push(e):i.set(t,[e])}for(let e of t){let t=zv(e),r=i.get(t)?.[0];!r||!r.metadata||n.set(t,De(r.metadata))}try{let e=await be(t);for(let t of e){let e=zv(t.name);!e||n.has(e)||!t.metadata||n.set(e,De(t.metadata))}let r=await Se(t);for(let e of r){let t=zv(e.name);!t||n.has(t)||!e.metadata||n.set(t,De(e.metadata))}}catch(e){k.log(`Remote collection lookup failed, using local collection only`,e)}return n};function Uv({children:e}){P(e=>e.roomMetadata);let t=P(e=>e.sceneMetadata),n=P(e=>e.items),r=P(e=>e.playerData),i=t,a=i[O.HP_CURRENT_BID]!==void 0&&i[O.HP_MAX_BID]!==void 0,o=i[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?!0:i[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===!0;return(0,N.useEffect)(()=>{c.onReady(()=>{c.contextMenu.create({id:p.ON_LIST,icons:[{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}}],async onClick(e){if(k.info(`Add to Combat Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[p.ON_LIST]===!0))await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[p.ON_LIST],delete t.metadata[p.INITIATIVE]});else{let r=[],a=[],o=new Set(e.items.map(e=>e.id)),s=i[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0,l=new Set(n.filter(e=>{if(o.has(e.id))return!1;let t=e.metadata[p.UNIT_NAME];return typeof t==`string`&&t.trim().length>0}).map(e=>zv(String(e.metadata[p.UNIT_NAME]))));for(let t of e.items){if(t.metadata[p.FABRICATED]===!0)continue;let e=Bv(t.text?.plainText||t.name);r.push(e)}await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let u=await Hv(r);await c.action.setBadgeText(void 0);for(let t of e.items){let e={};if(t.metadata[p.FABRICATED]!==!0){let n=Bv(t.text?.plainText||t.name),r=u.get(zv(n));if(r&&Object.assign(e,r),(typeof e[p.UNIT_NAME]!=`string`||!String(e[p.UNIT_NAME]).trim())&&(e[p.UNIT_NAME]=t.name),e[p.FABRICATED]=!0,s){let r=String(e[p.UNIT_NAME]||n||t.name).trim(),i=zv(r);if(i){let e=0;for(;l.has(i)&&e<20;)r=Fv(r),i=zv(r),e+=1;i&&l.add(i)}e[p.UNIT_NAME]=r}}e[p.ON_LIST]=!0,e[p.INITIATIVE]=0,a.push({id:t.id,metadata:e})}await c.scene.items.updateItems(e.items,e=>{for(let n of e){let e=a.find(e=>e.id===n.id);if(e&&(Object.assign(n.metadata,e.metadata),t[O.SHOW_NAMES]===!0)){let t=n;t.text&&(t.text.plainText=String(e.metadata[p.UNIT_NAME]||``))}}})}}}),c.contextMenu.create({id:p.IN_PARTY,icons:[{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`!=`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`!=`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`==`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`==`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){k.info(`Add to Party Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[p.IN_PARTY]===!0)?await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[p.IN_PARTY]}):await c.scene.items.updateItems(e.items,e=>{for(let t of e)t.metadata[p.IN_PARTY]=!0})}}),c.contextMenu.create({id:Rv,icons:[{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){k.info(`View Unit Clicked: ${e.items[0].name}`);let r=e.items[0];if(!r)return;let a={};if(r.metadata[p.FABRICATED]!==!0){let e=Bv(r.text?.plainText||r.name);await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let o=await Hv([e]);await c.action.setBadgeText(void 0);let s=o.get(zv(e));s&&Object.assign(a,s),(typeof a[p.UNIT_NAME]!=`string`||!String(a[p.UNIT_NAME]).trim())&&(a[p.UNIT_NAME]=r.name),a[p.FABRICATED]=!0,i[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[p.UNIT_NAME]!=null&&e.id!==r.id).map(e=>e.metadata[p.UNIT_NAME]).includes(e)&&(a[p.UNIT_NAME]=Fv(e)),await c.scene.items.updateItems([r],e=>{let n=e[0];if(Object.assign(n.metadata,a),t[O.SHOW_NAMES]===!0){let e=n;e.text&&(e.text.plainText=String(a[p.UNIT_NAME]||``))}})}await Vv(r.id)}}),a&&o?c.contextMenu.create({id:p.MODIFY_UNIT,icons:[{icon:`/icon.svg`,label:`Adjust HP`,filter:{some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Adjust HP`,filter:{every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e,t){k.info(`Adjust HP Clicked: ${e.items[0].name}`),await c.popover.open({id:D.CONTEXT_MENU,url:`/pages/forgecontext.html`,height:50,width:180,anchorElementId:t,hidePaper:!0})},embed:{url:`/pages/forgecontext.html?contextmenu=true`,height:70}}):c.contextMenu.remove(p.MODIFY_UNIT).catch(()=>{})})},[i,a,o]),(0,F.jsx)(F.Fragment,{children:e})}Fe.createRoot(document.getElementById(`root`)).render((0,F.jsx)(N.StrictMode,{children:(0,F.jsx)(te,{children:(0,F.jsx)(Ve,{children:(0,F.jsx)(Uv,{children:(0,F.jsx)(Ue,{children:(0,F.jsx)(Nv,{})})})})})}));