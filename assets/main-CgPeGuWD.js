...
`;const X=({label:e,isOn:t,onChange:n})=>{let{theme:r}=Pt();return(0,z.jsx)(um,{theme:r,$isOn:t,onClick:()=>{let r=!t;k.log(`${e}: ${r}`),n(r)},role:`switch`,"aria-checked":t,"aria-label":e})};var dm=T.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Dm=T.p`
  ...
  margin: 0;
  line-height: 1.5;
`;const Om=()=>{let{theme:e}=Pt(),{attributes:t}=_m(),n=R(e=>e.roomMetadata);R(e=>e.sceneMetadata);let r=R(e=>e.items),i=R(e=>e.cacheReady),[a,o]=(0,L.useState)(!1),[s,l]=(0,L.useState)(!1),[u,d]=(0,L.useState)(`D20`),[f,m]=(0,L.useState)(!1),[h,g]=(0,L.useState)(``),[_,v]=(0,L.useState)(`@STAT`),[y,b]=(0,L.useState)(!1),[x,S]=(0,L.useState)(!1),[C,w]=(0,L.useState)(!0),[T,E]=(0,L.useState)(!1),[ee,te]=(0,L.useState)(!0),[D,ne]=(0,L.useState)(!0),[re,ie]=(0,L.useState)(!1),[ae,oe]=(0,L.useState)(`bottom`),[se,ce]=(0,L.useState)(!1),[le,ue]=(0,L.useState)(!1),[de,fe]=(0,L.useState)(!1),[pe,me]=(0,L.useState)(!1),[he,ge]=(0,L.useState)(!1),[_e,ve]=(0,L.useState)(!1),[ye,j]=(0,L.useState)(!1),[xe,Se]=(0,L.useState)(!1),[we,Te]=(0,L.useState)(!1),[Ee,De]=(0,L.useState)(!1),[Oe,ke]=(0,L.useState)(!1),[Ae,je]=(0,L.useState)(!1),[Me,Ne]=(0,L.useState)(``),[Pe,Ie]=(0,L.useState)(!1),M=(0,L.useRef)(null),[Re,ze]=(0,L.useState)(()=>Ge()),[Be,He]=(0,L.useState)(()=>Ve()),[We,Ke]=(0,L.useState)(()=>Ue()),[qe,Je]=(0,L.useState)(!1),[Ye,Xe]=(0,L.useState)(!1);(0,L.useEffect)(()=>{let e=!0;return(async()=>{let t=await ut();e&&(ze(t&&Ge()),He(Ve()),Ke(Ue()))})(),()=>{e=!1}},[]);let N=n;(0,L.useEffect)(()=>{if(i){if(N[O.POPCORN_INITIATIVE]!==void 0&&o(N[O.POPCORN_INITIATIVE]),N[O.REVERSE_INITIATIVE]!==void 0&&l(N[O.REVERSE_INITIATIVE]),N[O.DICE_RANGE]!==void 0&&d(N[O.DICE_RANGE]),N[O.INITIATIVE_MODIFIER_BID]===void 0?g(``):g(N[O.INITIATIVE_MODIFIER_BID]||``),N[O.INITIATIVE_MODIFIER_EXPR]!==void 0){let e=(N[O.INITIATIVE_MODIFIER_EXPR]||`@STAT`).replace(/\bx\b/gi,`@STAT`).trim();v(e.length>0?e:`@STAT`)}else v(`@STAT`);if(N[O.SHOW_CARD_ACCESS]!==void 0&&m(N[O.SHOW_CARD_ACCESS]),N[O.SHOW_PLAYER_VIEW]!==void 0&&b(N[O.SHOW_PLAYER_VIEW]),N[O.SHOW_OWNER_ONLY_EDIT]!==void 0&&E(N[O.SHOW_OWNER_ONLY_EDIT]),N[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?te(!0):te(N[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]),N[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===void 0?ne(!0):ne(N[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]),N[O.SHOW_NON_PARTY_UNITS]!==void 0&&S(N[O.SHOW_NON_PARTY_UNITS]),N[O.SHOW_LIST_HP_NUMBERS]===void 0?w(!0):w(N[O.SHOW_LIST_HP_NUMBERS]),N[O.SHOW_HP_BARS]!==void 0&&ie(N[O.SHOW_HP_BARS]),N[O.HP_BAR_ORIENTATION]!==void 0&&oe(N[O.HP_BAR_ORIENTATION]),N[O.SHOW_HP_NUMBERS]!==void 0&&ce(N[O.SHOW_HP_NUMBERS]),N[O.SHOW_DEATH_EFFECT]!==void 0&&ue(N[O.SHOW_DEATH_EFFECT]),N[O.SHOW_NAMES]!==void 0&&fe(N[O.SHOW_NAMES]),N[O.SHOW_TURN_EFFECT]!==void 0&&me(N[O.SHOW_TURN_EFFECT]),N[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&ge(N[O.USE_DESCRIPTIVE_DUPLICATES]),N[O.ENABLE_RUMBLE]!==void 0&&ve(N[O.ENABLE_RUMBLE]),N[O.ENABLE_BONES]!==void 0&&j(N[O.ENABLE_BONES]),N[O.ENABLE_DICE_PLUS]!==void 0&&Se(N[O.ENABLE_DICE_PLUS]),N[O.ENABLE_TEXT_BASED_ROLLS]!==void 0&&Te(N[O.ENABLE_TEXT_BASED_ROLLS]),N[O.ENABLE_OBR_NOTIFICATION]!==void 0&&De(N[O.ENABLE_OBR_NOTIFICATION]),N[O.SHOW_NOTIFICATION_TO_ALL]!==void 0&&ke(N[O.SHOW_NOTIFICATION_TO_ALL]),N[O.ENABLE_DISCORD_LOGGING]!==void 0&&je(N[O.ENABLE_DISCORD_LOGGING]),N[O.DISCORD_URL]!==void 0&&Ne(N[O.DISCORD_URL]),N[O.ENABLE_CONSOLE_LOG]!==void 0){let e=N[O.ENABLE_CONSOLE_LOG];Ie(e),k.setEnabled(e)}else Ie(!1)}},[i,N]);let P=async(e,t)=>{await c.room.setMetadata({[e]:t})},Qe=e=>{let t=(e||``).trim().match(/(\d+)/),n=t?parseInt(t[1],10):NaN;return Number.isFinite(n)&&n>0?n:20},$e=t.filter(e=>e.attr_type===`numb`).sort((e,t)=>(e.attr_name||``).localeCompare(t.attr_name||``)),F=(e,t)=>{let n=e.trim();return n?t?/@STAT/i.test(n)?/\d\s*d\s*\d|\bd\s*\d/i.test(n)?{valid:!1,error:`Dice notation is not allowed in initiative modifiers.`}:Le(n.replace(/@STAT/gi,`@${t}`))?{valid:!0}:{valid:!1,error:`Invalid expression syntax.`}:{valid:!1,error:`Expression must include @STAT (the selected attribute value).`}:{valid:!1,error:`Select a numeric attribute first.`}:{valid:!1,error:`Expression is required.`}},et=async(e,t)=>{await P(O.INITIATIVE_MODIFIER_BID,e),await P(O.INITIATIVE_MODIFIER_EXPR,t)},tt=async e=>{if(g(e),!e){await et(``,_);return}let t=F(_,e);t.valid||await c.notification.show(t.error||`Invalid initiative modifier settings.`,`WARNING`),await et(e,_)},nt=async()=>{let e=_.trim(),t=(e.length>0?e:`@STAT`).replace(/\bx\b/gi,`@STAT`);if(v(t),!h){await et(``,t);return}let n=F(t,h);if(!n.valid){await c.notification.show(n.error||`Invalid initiative modifier expression.`,`WARNING`);return}await et(h,t)},rt=async()=>{if(!h){await c.notification.show(`Select an Initiative Modifier attribute before testing.`,`WARNING`);return}let e=_.replace(/\bx\b/gi,`@STAT`),t=F(e,h);if(!t.valid){await c.notification.show(t.error||`Invalid initiative modifier expression.`,`WARNING`);return}let n=Qe(u),r=Math.floor(Math.random()*n)+1,i=at(e.replace(/@STAT/gi,`@${h}`),{bidValueMap:{[h]:14},onMissingBid:`useZero`});if(!i.valid||!i.notation){await c.notification.show(`Could not resolve initiative modifier expression.`,`ERROR`);return}let a=Number(i.notation),o=Number.isFinite(a)?Math.trunc(a):0,s=r+o,l=e.replace(/@STAT/gi,`14`);await c.notification.show(`Mock Initiative: 1d${n}(${r}) + ${l}(${o}) = ${s}`,`SUCCESS`)},it=async()=>{try{let e=await Ce(),t=JSON.stringify(e,null,2),n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`forge-collection-${new Date().toISOString().slice(0,10)}.txt`,i.click(),URL.revokeObjectURL(r),await c.notification.show(`Collection export complete. ${e.length} record(s) written.`,`SUCCESS`)}catch(e){k.log(`Collection export failed`,e),await c.notification.show(`Collection export failed. See console log for details.`,`ERROR`)}},ot=()=>{Xe(!0)},st=()=>{Xe(!1),M.current?.click()},ct=async e=>{let t=e.target.files?.[0];if(t)try{let e=await t.text(),n=JSON.parse(e);if(!Array.isArray(n)){await c.notification.show(`Import file must contain a JSON array of collection records.`,`ERROR`);return}let r=await Fe(n);await c.notification.show(`Collection import complete. Created: ${r.created}, Updated: ${r.updated}, Skipped: ${r.skipped}.`,`SUCCESS`)}catch(e){k.log(`Collection import failed`,e),await c.notification.show(`Collection import failed. Ensure the file is valid JSON and try again.`,`ERROR`)}finally{e.target.value=``}},lt=async()=>{Je(!0);try{await Ze(),ze(Ge()),He(Ve()),Ke(Ue()),await c.notification.show(`Connected to Battle-System account.`,`SUCCESS`)}catch(e){k.error(`Battle-System auth connection failed`,e),await c.notification.show(`Unable to connect to Battle-System account. Please try again.`,`ERROR`),ze(Ge()),He(Ve()),Ke(Ue())}finally{Je(!1)}};return(0,z.jsxs)(Gd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},children:[(0,z.jsxs)(am,{theme:e,children:[(0,z.jsx)(om,{theme:e,children:`Settings`}),(0,z.jsxs)(sm,{theme:e,children:[(0,z.jsx)(vm,{theme:e,children:`Battle-System Account`}),(0,z.jsx)(Tm,{children:(0,z.jsx)(cm,{theme:e,onClick:()=>{lt()},disabled:qe,children:qe?`Connecting...`:Re?`Reconnect to Battle-System`:`Connect to Battle-System`})}),(0,z.jsx)(Em,{theme:e,$connected:Re,children:Re?`Status: Connected (${Be} tier)`:`Status: Disconnected`})]}),(0,z.jsxs)(sm,{theme:e,children:[(0,z.jsx)(vm,{theme:e,children:`Collection Management`}),(0,z.jsxs)(Tm,{children:[(0,z.jsx)(cm,{theme:e,onClick:it,children:`Export`}),(0,z.jsx)(cm,{theme:e,onClick:ot,children:`Import`})]}),(0,z.jsx)(`input`,{ref:M,type:`file`,accept:`.txt,.json,text/plain,application/json`,onChange:ct,style:{display:`none`}})]}),(0,z.jsxs)(sm,{theme:e,children:[(0,z.jsx)(vm,{theme:e,children:`List Controls`}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.reverseInitiative,children:`Reverse Initiative`})}),(0,z.jsx)(X,{label:`Reverse Initiative`,isOn:s,onChange:async e=>{l(e),await P(O.REVERSE_INITIATIVE,e),e&&a&&(o(!1),await P(O.POPCORN_INITIATIVE,!1))}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.popcornInitiative,children:`Popcorn Initiative`})}),(0,z.jsx)(X,{label:`Popcorn Initiative`,isOn:a,onChange:async e=>{o(e),await P(O.POPCORN_INITIATIVE,e),e&&s&&(l(!1),await P(O.REVERSE_INITIATIVE,!1))}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.initiativeDie,children:`Initiative Die:`})}),(0,z.jsx)(Sm,{theme:e,type:`text`,value:u,onChange:async e=>{let t=e.target.value;d(t),await P(O.DICE_RANGE,t),k.log(`Dice Range:`,t)},placeholder:`D20`,maxLength:3})]}),(0,z.jsxs)(ym,{theme:e,children:[(0,z.jsx)(bm,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.initiativeModifierAttr,children:`Initiative Modifier:`})}),(0,z.jsxs)(Cm,{theme:e,value:h,onChange:async e=>{await tt(e.target.value)},children:[(0,z.jsx)(`option`,{value:``,children:`None`}),$e.map(e=>(0,z.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,z.jsxs)(ym,{theme:e,children:[(0,z.jsx)(bm,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.initiativeModifierMath,children:`Math:`})}),(0,z.jsx)(Sm,{theme:e,type:`text`,value:_,onChange:e=>{v(e.target.value)},onBlur:async()=>{await nt()},placeholder:`floor((@STAT-10)/2)`,maxLength:120,disabled:!h}),(0,z.jsx)(wm,{theme:e,type:`button`,onClick:()=>{rt()},disabled:!h,children:`Test`})]}),(0,z.jsx)(xm,{theme:e,children:`Use @STAT as the selected attribute value. Example: floor((@STAT-10)/2)`}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showCardColumn,children:`Show Card Column`})}),(0,z.jsx)(X,{label:`Show Stat Block Access`,isOn:f,onChange:async e=>{m(e),await P(O.SHOW_CARD_ACCESS,e)}})]})]}),(0,z.jsxs)(sm,{theme:e,children:[(0,z.jsx)(vm,{theme:e,children:`Player Controls`}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showPlayerView,children:`Show Player View`})}),(0,z.jsx)(X,{label:`Show Player View`,isOn:y,onChange:async e=>{b(e),await P(O.SHOW_PLAYER_VIEW,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showNonPartyUnits,children:`Show Non-Party Units`})}),(0,z.jsx)(X,{label:`Show Non-Party Units`,isOn:x,onChange:async e=>{S(e),await P(O.SHOW_NON_PARTY_UNITS,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showHpNumbersOnList,children:`Show HP Numbers on List`})}),(0,z.jsx)(X,{label:`Show HP Numbers on List`,isOn:C,onChange:async e=>{w(e),await P(O.SHOW_LIST_HP_NUMBERS,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.ownerOnlyEdit,children:`GM/Owner Only Edit`})}),(0,z.jsx)(X,{label:`Owner Only Edit`,isOn:T,onChange:async e=>{E(e),await P(O.SHOW_OWNER_ONLY_EDIT,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showAdjustHpContextMenu,children:`Show Adjust HP Context Menu`})}),(0,z.jsx)(X,{label:`Show Adjust HP Context Menu`,isOn:ee,onChange:async e=>{te(e),await P(O.SHOW_MODIFY_UNIT_CONTEXT_MENU,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showViewUnitContextMenuForPlayers,children:`Show View Unit Context Menu for Players`})}),(0,z.jsx)(X,{label:`Show View Unit Context Menu for Players`,isOn:D,onChange:async e=>{ne(e),await P(O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS,e)}})]})]}),(0,z.jsxs)(sm,{theme:e,children:[(0,z.jsx)(vm,{theme:e,children:`Game Controls`}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showHpBarsOnTokens,children:`Show HP Bars on tokens`})}),(0,z.jsx)(X,{label:`Show HP Bars on tokens`,isOn:re,onChange:async e=>{ie(e),await P(O.SHOW_HP_BARS,e),e&&se&&(ce(!1),await P(O.SHOW_HP_NUMBERS,!1)),e&&N[O.HP_BAR_ORIENTATION]===void 0&&(oe(`bottom`),await P(O.HP_BAR_ORIENTATION,`bottom`))}})]}),(re||se)&&(0,z.jsxs)(ym,{theme:e,children:[(0,z.jsx)(bm,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.hpOrientation,children:`Orientation:`})}),(0,z.jsxs)(Cm,{theme:e,value:ae,onChange:async e=>{let t=e.target.value;oe(t),await P(O.HP_BAR_ORIENTATION,t)},children:[(0,z.jsx)(`option`,{value:`top`,children:`Top`}),(0,z.jsx)(`option`,{value:`bottom`,children:`Bottom`}),(0,z.jsx)(`option`,{value:`left`,children:`Left`}),(0,z.jsx)(`option`,{value:`right`,children:`Right`})]})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showHpNumbersOnTokens,children:`Show HP Numbers on tokens`})}),(0,z.jsx)(X,{label:`Show HP Numbers on tokens`,isOn:se,onChange:async e=>{ce(e),await P(O.SHOW_HP_NUMBERS,e),e&&re&&(ie(!1),await P(O.SHOW_HP_BARS,!1)),e&&N[O.HP_BAR_ORIENTATION]===void 0&&(oe(`bottom`),await P(O.HP_BAR_ORIENTATION,`bottom`))}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showDeathEffect,children:`Show Death Effect`})}),(0,z.jsx)(X,{label:`Show Death Effect`,isOn:le,onChange:async e=>{ue(e),await P(O.SHOW_DEATH_EFFECT,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showNamesOnTokens,children:`Show Names on Tokens`})}),(0,z.jsx)(X,{label:`Show names on tokens`,isOn:de,onChange:async e=>{fe(e),await P(O.SHOW_NAMES,e);let t=r.filter(e=>e.metadata[p.ON_LIST]===!0);e?(k.log(`Showing names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t.metadata[p.UNIT_NAME],n=t;e&&n.text&&(n.text.plainText=String(e))}})):(k.log(`Hiding names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t;e.text&&(e.text.plainText=``)}}))}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showTurnEffect,children:`Show Turn Effect`})}),(0,z.jsx)(X,{label:`Show Turn Effect`,isOn:pe,onChange:async e=>{me(e),await P(O.SHOW_TURN_EFFECT,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.useDescriptiveNames,children:`Use Descriptive Names`})}),(0,z.jsx)(X,{label:`Use Descriptive Duplicates Names`,isOn:he,onChange:async e=>{ge(e),await P(O.USE_DESCRIPTIVE_DUPLICATES,e)}})]})]}),(0,z.jsxs)(sm,{theme:e,children:[(0,z.jsx)(vm,{theme:e,children:`Dice Controls`}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.enableTextBasedRolls,children:`Enable Text-Based Rolls`})}),(0,z.jsx)(X,{label:`Enable Text-Based Rolls`,isOn:we,onChange:async e=>{Te(e),await P(O.ENABLE_TEXT_BASED_ROLLS,e),e&&(De(!0),ve(!1),j(!1),Se(!1),await P(O.ENABLE_OBR_NOTIFICATION,!0),await P(O.ENABLE_RUMBLE,!1),await P(O.ENABLE_BONES,!1),await P(O.ENABLE_DICE_PLUS,!1))}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.enableRumble,children:`Enable Rumble! Integration`})}),(0,z.jsx)(X,{label:`Enable Rumble! Integration`,isOn:_e,onChange:async e=>{ve(e),await P(O.ENABLE_RUMBLE,e),e&&(j(!1),Se(!1),Te(!1),await P(O.ENABLE_BONES,!1),await P(O.ENABLE_DICE_PLUS,!1),await P(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.enableBones,children:`Enable Bones! Integration`})}),(0,z.jsx)(X,{label:`Enable Bones! Integration`,isOn:ye,onChange:async e=>{j(e),await P(O.ENABLE_BONES,e),e&&(ve(!1),Se(!1),Te(!1),await P(O.ENABLE_RUMBLE,!1),await P(O.ENABLE_DICE_PLUS,!1),await P(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.enableDicePlus,children:`Enable Dice+ Integration`})}),(0,z.jsx)(X,{label:`Enable Dice+ Integration`,isOn:xe,onChange:async e=>{Se(e),await P(O.ENABLE_DICE_PLUS,e),e&&(ve(!1),j(!1),Te(!1),await P(O.ENABLE_RUMBLE,!1),await P(O.ENABLE_BONES,!1),await P(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.enableObrNotification,children:`Enable OBR Notification`})}),(0,z.jsx)(X,{label:`Enable OBR Notification`,isOn:Ee,onChange:async e=>{De(e),await P(O.ENABLE_OBR_NOTIFICATION,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.showResultsToAll,children:`Show Results to All`})}),(0,z.jsx)(X,{label:`Show Results to All`,isOn:Oe,onChange:async e=>{ke(e),await P(O.SHOW_NOTIFICATION_TO_ALL,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.enableDiscordLogging,children:`Enable Discord Logging`})}),(0,z.jsx)(X,{label:`Enable Discord Logging`,isOn:Ae,onChange:async e=>{if(e&&!be(Me.trim())){await c.notification.show(`Please enter a valid Discord webhook URL before enabling Discord logging.`,`WARNING`),je(!1),await P(O.ENABLE_DISCORD_LOGGING,!1);return}je(e),await P(O.ENABLE_DISCORD_LOGGING,e)}})]}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)(bm,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.discordUrl,children:`Discord Url:`})}),(0,z.jsx)(Sm,{theme:e,type:`text`,value:Me,onChange:async e=>{let t=e.target.value,n=t.trim();Ne(t),await P(O.DISCORD_URL,n),k.log(`Discord URL:`,n)},placeholder:`https://discord.com/api/webhooks/...`,maxLength:200})]})]}),(0,z.jsxs)(sm,{theme:e,children:[(0,z.jsx)(vm,{theme:e,children:`Other`}),(0,z.jsxs)(Q,{theme:e,children:[(0,z.jsx)($,{theme:e,children:(0,z.jsx)(A,{theme:e,text:Z.enableConsoleLog,children:`Enable Console Log`})}),(0,z.jsx)(X,{label:`Enable Console Log`,isOn:Pe,onChange:async e=>{Ie(e),k.setEnabled(e),await P(O.ENABLE_CONSOLE_LOG,e)}})]})]})]}),(0,z.jsx)(gm,{isOpen:Ye,title:`Confirm Import`,onClose:()=>Xe(!1),actions:(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(cm,{theme:e,variant:`secondary`,onClick:()=>Xe(!1),children:`Cancel`}),(0,z.jsx)(cm,{theme:e,onClick:st,children:`Continue`})]}),children:(0,z.jsx)(Dm,{theme:e,children:`Import will overwrite duplicate records that share the same Name and Author. Continue?`})})]})};var km=T.div`
...
`,vh={initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20}};const yh=()=>{let{theme:e,updateThemeFromSystem:t}=Pt(),n=R(e=>e.sceneMetadata),r=R(e=>e.roomMetadata),i=r,a=R(e=>e.systemData),o=R(e=>e.setSystemData),[s,l]=(0,L.useState)(()=>Re().premiumAuthorized),[u,d]=(0,L.useState)(``),[p,m]=(0,L.useState)(!1),[h,g]=(0,L.useState)(null),[_,v]=(0,L.useState)(null),[y,b]=(0,L.useState)(``),[x,S]=(0,L.useState)(null),[w,T]=(0,L.useState)(null),[ee,te]=(0,L.useState)([]),[D,ne]=(0,L.useState)(``),[re,ie]=(0,L.useState)(``),[ae,oe]=(0,L.useState)(Fm),[se,ce]=(0,L.useState)(Im),[A,le]=(0,L.useState)(!1),[ue,de]=(0,L.useState)(!1),[fe,pe]=(0,L.useState)(null),[me,he]=(0,L.useState)(null),[ge,ve]=(0,L.useState)([]),[be,j]=(0,L.useState)(!1),[xe,Se]=(0,L.useState)(null),[Ce,we]=(0,L.useState)(``);(0,L.useEffect)(()=>{let e=!0,t=async()=>{await ut(),e&&l(Re().premiumAuthorized)},n=Me(t=>{e&&l(t.premiumAuthorized)});return t(),()=>{e=!1,n()}},[]),(0,L.useEffect)(()=>{Te(),ke()},[n,r,a,s]);let Te=()=>{try{if(!s){let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url},t=i[O.BUFF_VISUAL_PRESET],n=i[O.DEBUFF_VISUAL_PRESET],r=zm(t)?t:Fm,a=Bm(n)?n:Im;b(E.name),S(null),T(e),te(E.attributes),ne(Km.currentHpBid),ie(Km.maxHpBid),oe(r),ce(a);return}if(a){let e=i[O.HP_CURRENT_BID],t=i[O.HP_MAX_BID],n=i[O.BUFF_VISUAL_PRESET],r=i[O.DEBUFF_VISUAL_PRESET],o=zm(n)?n:null,s=Bm(r)?r:null;b(a.systemName),S(a.importDate),T(a.theme),te(a.attributes),ne(e||``),ie(t||``),fe&&o===fe&&pe(null),me&&s===me&&he(null),!A&&!fe&&oe(e=>o||e),!ue&&!me&&ce(e=>s||e);return}let e=r[Gm.SYSTEM_NAME],t=r[Gm.IMPORT_DATE],n=i[O.HP_CURRENT_BID],o=i[O.HP_MAX_BID],c=i[O.BUFF_VISUAL_PRESET],l=i[O.DEBUFF_VISUAL_PRESET],u=zm(c)?c:null,d=Bm(l)?l:null;b(e||E.name),S(t||null),T({primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url}),te(E.attributes),ne(n||``),ie(o||``),fe&&u===fe&&pe(null),me&&d===me&&he(null),!A&&!fe&&oe(e=>u||e),!ue&&!me&&ce(e=>d||e)}catch(e){k.error(`Error loading system from cache:`,e)}},Ee=async(e,t)=>{await c.room.setMetadata({[e]:t})},De=(e,t)=>{if(Array.isArray(e))return e;if(typeof e==`string`){let n;try{n=JSON.parse(e)}catch{throw Error(`Imported ${t} is not valid JSON`)}if(!Array.isArray(n))throw Error(`Imported ${t} is not a JSON array`);return n}throw Error(`Imported ${t} has invalid type`)},Oe=ee.filter(e=>e.attr_type===`numb`),ke=()=>{try{let e=[];for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);if(n&&n.startsWith(`${Wm}.`)&&n.endsWith(`.backup`)){let t=localStorage.getItem(n);if(t){let n=JSON.parse(t);e.push(n)}}}e.sort((e,t)=>new Date(t.backupDate).getTime()-new Date(e.backupDate).getTime()),ve(e)}catch(e){k.error(`Error loading backups:`,e)}},Ae=async e=>{try{if(!a){k.warn(`Cannot create backup: runtime system data is unavailable`);return}let e=a.systemName||E.name,t={name:e,backupDate:new Date().toISOString(),theme_primary:a.theme.primary,theme_offset:a.theme.offset,theme_background:a.theme.background,theme_border:a.theme.border,background_url:a.theme.background_url,card_layout:a.cardLayout,list_layout:a.listLayout,attributes:a.attributes},n=`${Wm}.${e}.backup`;localStorage.setItem(n,JSON.stringify(t)),k.log(`Backup created for ${e}`),ke()}catch(e){throw k.error(`Error creating backup:`,e),e}},je=e=>{try{let t=`${Wm}.${e}.backup`;localStorage.removeItem(t),k.log(`Backup deleted for ${e}`),ke(),v(`Backup for "${e}" deleted successfully`)}catch(e){k.error(`Error deleting backup:`,e),g(`Failed to delete backup`)}},Ne=(e,t)=>{we(e),Se(()=>t),j(!0)},Pe=async()=>{j(!1),xe&&(await xe(),Se(null))},Fe=()=>{j(!1),Se(null),we(``)},Ie=async()=>{if(!u.trim()){g(`Please enter a share_id`);return}Ne(`This will overwrite your current system data. A backup of your current system will be saved to local storage. Do you want to continue?`,async()=>{await Le()})},Le=async()=>{if(!Ue()){g(`Premium account required. Connect and use a premium Battle-System account before importing systems.`);return}m(!0),g(null),v(null);try{await ct();let{data:e,error:n}=await ht(async()=>C.rpc(`bs_forge_import_system_snapshot`,{p_source_share_id:u.trim()}));if(n)throw n;if(!e){g(`No system found with that share_id`),m(!1);return}let r=Array.isArray(e)?e[0]:e;if(!r||typeof r.snapshot_public_id!=`string`)throw Error(`Snapshot import did not return a valid record`);let i=De(r.card_layout,`card_layout`),a=De(r.list_layout,`list_layout`),s=De(r.attributes,`attributes`);if(!Array.isArray(s))throw Error(`Imported attributes are not a valid array`);await Ae(y);let l={primary:r.theme_primary,offset:r.theme_offset,background:r.theme_background,border:r.theme_border,background_url:r.background_url},f=new Date().toISOString();await c.room.setMetadata({[Gm.SNAPSHOT_PUBLIC_ID]:r.snapshot_public_id,[Gm.SYSTEM_NAME]:r.system_name,[Gm.IMPORT_DATE]:f}),o({theme:l,cardLayout:i,listLayout:a,attributes:s,systemName:r.system_name,importDate:f,snapshotPublicId:r.snapshot_public_id}),b(r.system_name),S(f),T(l),t(l.primary,l.offset,l.background,l.border,l.background_url),v(`System "${r.system_name}" loaded successfully! Backup created.`),d(``),k.log(`System snapshot imported and loaded:`,{systemName:r.system_name,snapshotPublicId:r.snapshot_public_id})}catch(e){k.error(`Error fetching system:`,e),g(qm(e,`An error occurred while fetching the system`))}finally{m(!1)}},M=async e=>{Ne(`This will restore the system "${e.name}" from backup. A backup of your current system will be created. Do you want to continue?`,async()=>{await ze(e)})},ze=async e=>{m(!0),g(null),v(null);try{if(!Ue()){g(`Premium account required. Connect and use a premium Battle-System account before restoring backups for room sharing.`);return}await ct(),await Ae(y);let n={primary:e.theme_primary,offset:e.theme_offset,background:e.theme_background,border:e.theme_border,background_url:e.background_url};if(!Array.isArray(e.card_layout)||!Array.isArray(e.list_layout)||!Array.isArray(e.attributes))throw Error(`Backup data is invalid`);let r=new Date().toISOString(),i=`forge-backup:${e.name.trim().toLowerCase()}`,{data:a,error:s}=await ht(async()=>C.rpc(`bs_forge_upsert_user_snapshot_payload`,{p_source_share_id:i,p_system_name:e.name,p_background_url:e.background_url,p_theme_primary:e.theme_primary,p_theme_offset:e.theme_offset,p_theme_background:e.theme_background,p_theme_border:e.theme_border,p_card_layout:e.card_layout,p_list_layout:e.list_layout,p_attributes:e.attributes}));if(s)throw s;let l=Array.isArray(a)?a[0]:a;if(!l||typeof l.snapshot_public_id!=`string`)throw Error(`Backup restore snapshot publish failed`);o({theme:n,cardLayout:e.card_layout,listLayout:e.list_layout,attributes:e.attributes,systemName:e.name,importDate:r,snapshotPublicId:l.snapshot_public_id}),await c.room.setMetadata({[Gm.SNAPSHOT_PUBLIC_ID]:l.snapshot_public_id,[Gm.SYSTEM_NAME]:e.name,[Gm.IMPORT_DATE]:r}),b(e.name),S(r),T(n),t(n.primary,n.offset,n.background,n.border,n.background_url),v(`System "${e.name}" restored from backup successfully!`),k.log(`System restored from backup:`,e.name)}catch(e){k.error(`Error restoring backup:`,e),g(`Failed to restore system from backup`)}finally{m(!1)}},Be=async()=>{m(!0),g(null),v(null);try{let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url};o({theme:e,cardLayout:E.card_layout,listLayout:E.list_layout,attributes:E.attributes,systemName:E.name,importDate:null,snapshotPublicId:null}),await c.room.setMetadata({[Gm.SNAPSHOT_PUBLIC_ID]:null,[Gm.SYSTEM_NAME]:E.name,[Gm.IMPORT_DATE]:null}),b(E.name),S(null),T(e),t(e.primary,e.offset,e.background,e.border,e.background_url),v(`Reset to default system successfully!`)}catch(e){g(`Failed to reset to default system`),k.error(`Error resetting to default:`,e)}finally{m(!1)}},Ve=e=>e?new Date(e).toLocaleDateString(`en-US`,{year:`numeric`,month:`long`,day:`numeric`,hour:`2-digit`,minute:`2-digit`}):null,He=!s,We=!s;return(0,z.jsxs)(Gd.div,{variants:vh,initial:`initial`,animate:`animate`,exit:`exit`,children:[(0,z.jsxs)(am,{theme:e,children:[(0,z.jsx)(om,{theme:e,children:`System Configuration`}),(0,z.jsx)(Xm,{theme:e,children:y}),x?(0,z.jsxs)(Zm,{theme:e,children:[`Imported: `,Ve(x)]}):(0,z.jsx)(Zm,{theme:e,children:`Using Default System`}),w&&(0,z.jsxs)(z.Fragment,{children:[(0,z.jsxs)(Qm,{children:[(0,z.jsxs)(`div`,{children:[(0,z.jsx)($m,{color:w.primary,theme:e,children:w.primary}),(0,z.jsx)(eh,{theme:e,children:`PRIMARY`})]}),(0,z.jsxs)(`div`,{children:[(0,z.jsx)($m,{color:w.offset,theme:e,children:w.offset}),(0,z.jsx)(eh,{theme:e,children:`OFFSET`})]}),(0,z.jsxs)(`div`,{children:[(0,z.jsx)($m,{color:w.background,theme:e,children:w.background}),(0,z.jsx)(eh,{theme:e,children:`BG`})]}),(0,z.jsxs)(`div`,{children:[(0,z.jsx)($m,{color:w.border,theme:e,children:w.border}),(0,z.jsx)(eh,{theme:e,children:`BORDER`})]})]}),(0,z.jsxs)(th,{theme:e,children:[(0,z.jsx)(nh,{theme:e,children:`System Settings`}),(0,z.jsxs)(rh,{children:[(0,z.jsx)(ih,{theme:e,children:`Current HP`}),(0,z.jsxs)(ah,{theme:e,value:D,disabled:We,onChange:async e=>{if(We)return;let t=e.target.value;ne(t),await Ee(O.HP_CURRENT_BID,t)},children:[(0,z.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),Oe.map(e=>(0,z.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,z.jsxs)(rh,{children:[(0,z.jsx)(ih,{theme:e,children:`Max HP`}),(0,z.jsxs)(ah,{theme:e,value:re,disabled:We,onChange:async e=>{if(We)return;let t=e.target.value;ie(t),await Ee(O.HP_MAX_BID,t)},children:[(0,z.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),Oe.map(e=>(0,z.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),We&&(0,z.jsx)(Zm,{theme:e,children:`Premium account required to edit HP mapping.`}),(0,z.jsxs)(rh,{children:[(0,z.jsx)(ih,{theme:e,children:`Buff Visual`}),(0,z.jsx)(ah,{theme:e,value:ae,onChange:async e=>{let t=e.target.value;if(zm(t)){oe(t),pe(t),le(!0);try{await Ee(O.BUFF_VISUAL_PRESET,t)}finally{le(!1)}}},children:Lm.map(e=>(0,z.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,z.jsxs)(rh,{children:[(0,z.jsx)(ih,{theme:e,children:`Debuff Visual`}),(0,z.jsx)(ah,{theme:e,value:se,onChange:async e=>{let t=e.target.value;if(Bm(t)){ce(t),he(t),de(!0);try{await Ee(O.DEBUFF_VISUAL_PRESET,t)}finally{de(!1)}}},children:Rm.map(e=>(0,z.jsx)(`option`,{value:e.value,children:e.label},e.value))})]})]})]}),(0,z.jsxs)(Ym,{theme:e,children:[(0,z.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0},children:`Import New System`}),(0,z.jsx)(`p`,{style:{color:f(e.PRIMARY,.8),fontSize:`14px`},children:He?`Premium account required to import new/custom systems.`:`Enter a share_id to download and activate a new game system configuration.`}),(0,z.jsx)(Jm,{children:(0,z.jsx)(lm,{theme:e,type:`text`,value:u,onChange:e=>d(e.target.value),placeholder:He?``:`Enter Share Id...`,disabled:p||He,onKeyPress:e=>e.key===`Enter`&&Ie()})}),(0,z.jsxs)(ch,{children:[(0,z.jsx)(cm,{theme:e,onClick:Ie,disabled:p||He||!u.trim(),children:p?`....!`:`Import System`}),(0,z.jsx)(cm,{theme:e,variant:`secondary`,onClick:Be,disabled:p,children:`Use Default`})]})]}),h&&(0,z.jsxs)(oh,{theme:e,children:[(0,z.jsx)(`strong`,{children:`Error:`}),` `,h]}),_&&(0,z.jsxs)(sh,{theme:e,children:[(0,z.jsx)(`strong`,{children:`Success:`}),` `,_]}),ge.length>0&&(0,z.jsx)(uh,{children:(0,z.jsxs)(sm,{theme:e,children:[(0,z.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0,marginBottom:`15px`},children:`System Backups`}),(0,z.jsx)(dh,{children:ge.map(t=>(0,z.jsxs)(fh,{theme:e,children:[(0,z.jsxs)(ph,{children:[(0,z.jsx)(mh,{theme:e,children:t.name}),(0,z.jsxs)(hh,{theme:e,children:[`Backed up: `,Ve(t.backupDate)]})]}),(0,z.jsxs)(gh,{children:[(0,z.jsx)(_h,{theme:e,onClick:()=>M(t),disabled:p,title:`Import this backup`,children:(0,z.jsx)(_e,{size:18})}),(0,z.jsx)(_h,{theme:e,$variant:`danger`,onClick:()=>je(t.name),disabled:p,title:`Delete this backup`,children:(0,z.jsx)(ye,{size:18})})]})]},`${t.name}-${t.backupDate}`))})]})})]}),(0,z.jsx)(gm,{isOpen:be,title:`Confirm Action`,onClose:Fe,actions:(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(cm,{theme:e,variant:`secondary`,onClick:Fe,children:`Cancel`}),(0,z.jsx)(cm,{theme:e,onClick:Pe,children:`Confirm`})]}),children:(0,z.jsx)(lh,{theme:e,children:Ce})})]},`system`)};function bh(e,t){let n=e.replace(`#`,``);n.length===3&&(n=n.split(``).map(e=>e+e).join(``));let r=parseInt(n,16);return`rgba(${r>>16&255}, ${r>>8&255}, ${r&255}, ${t})`}var xh=class{static async CenterViewportOnImage(e){let t=await c.scene.grid.getDpi(),n=await c.viewport.getScale(),r=await c.viewport.getWidth(),i=await c.viewport.getHeight(),a={x:r/2,y:i/2},o={x:a.x/n,y:a.y/n},s=await this.GetImageCenter(e,t),l={x:s.x-o.x,y:s.y-o.y},u={x:l.x*n*-1,y:l.y*n*-1};await c.viewport.animateTo({position:u,scale:n})}static async GetImageCenter(t,n){if(e(t)){let e=n/t.grid.dpi,r=t.image.width*e,i=t.image.height*e,a=t.grid.offset.x/t.image.width*r,o=t.grid.offset.y/t.image.height*i;return{x:t.position.x-a+r/2,y:t.position.y-o+i/2}}else if(o(t)&&t.points.length>0)return{x:t.points[0].x,y:t.points[0].y};else return{x:t.position.x,y:t.position.y}}};const Sh=`${I}/effects`;var Ch=`${I}/effects-expired`,wh=T.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,Th=T.div`
...
`,H_=T.span`
  ...
  text-align: center;
  margin-top: 4px;
`,U_=e=>{switch(e){case`bottom`:return`left`;case`left`:return`top`;case`top`:return`right`;case`right`:default:return`bottom`}},W_=e=>e===`bottom`||e===`left`||e===`top`||e===`right`,G_=e=>e===`default`||e===`plate`||e===`tech`||e===`deco`,K_=e=>e===`deco`?`plate`:e===`tech`?`tech`:e===`plate`?`plate`:`default`;const q_=()=>{let t=(0,L.useRef)(!1),[n,r]=(0,L.useState)(null),{theme:i}=Pt(),{attributes:a}=_m(),o=R(e=>e.items);R(e=>e.sceneMetadata);let s=R(e=>e.roomMetadata),l=R(e=>e.playerData),u=s,d=String(l?.role||``).toUpperCase()===`GM`,f=l?.id,m=ne(O.PARTY_HUD_OPEN,f),h=ne(O.PARTY_HUD_ORIENTATION,f),g=(u[m]??u[O.PARTY_HUD_OPEN])===!0,_=u[h]??u[O.PARTY_HUD_ORIENTATION],v=W_(_)?_:`bottom`,y=u[O.PARTY_HUD_ATTR_ONE]||``,b=u[O.PARTY_HUD_ATTR_TWO]||``,x=u[O.PARTY_HUD_SHOW_HP_BARS]===!0,S=u[O.PARTY_HUD_SHOW_HP_NUMBERS]===!0&&!x,C=u[O.PARTY_HUD_BORDER_STYLE],w=G_(C)?K_(C):`default`,T=o.filter(e=>e.metadata[p.IN_PARTY]===!0);(0,L.useEffect)(()=>{try{let e=localStorage.getItem(w_);e&&r(JSON.parse(e).savedAt??null)}catch{}},[]);let E=()=>{let e={savedAt:new Date().toISOString(),items:T};localStorage.setItem(w_,JSON.stringify(e)),r(e.savedAt)},ee=async()=>{let e=localStorage.getItem(w_);if(e)try{let t=JSON.parse(e);if(!t.items.length)return;let n=new Set(t.items.map(e=>e.id)),r=o.filter(e=>n.has(e.id)).map(e=>e.id);r.length>0&&await c.scene.items.deleteItems(r);let[i,a]=await Promise.all([c.viewport.getWidth(),c.viewport.getHeight()]),s={x:i*.75,y:a*.6},l=await c.viewport.inverseTransformPoint(s),u={x:s.x-75,y:s.y-75},d=await c.viewport.inverseTransformPoint(u),f=d.x-l.x,p=d.y-l.y,m=t.items.map((e,t)=>({...e,position:{x:l.x+f*t,y:l.y+p*t}}));await c.scene.items.addItems(m)}catch{}},te=(0,L.useMemo)(()=>a.filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`text`||t===`numb`||t===`bool`}),[a]),D=async(e,t)=>{await c.room.setMetadata({[e]:t})},re=async e=>{await c.room.setMetadata(e)},ie=async()=>{let e=!g;if(await D(m,e),!e){await C_(),t.current=!1;return}await S_(),t.current=!0},ae=async()=>{await D(h,U_(v))},oe=async(e,t)=>{let n=t.trim();await c.scene.items.updateItems([e],e=>{let t={...e[0].metadata||{}};n?t[p.PORTRAIT_URL]=n:delete t[p.PORTRAIT_URL],e[0].metadata=t})};return(0,z.jsx)(Gd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,z.jsxs)(am,{theme:i,children:[(0,z.jsx)(om,{theme:i,children:`Party`}),(0,z.jsxs)(E_,{theme:i,children:[(0,z.jsxs)(D_,{children:[(0,z.jsxs)(A_,{theme:i,onClick:()=>void ae(),children:[`Display: `,v.toUpperCase()]}),(0,z.jsx)(A_,{theme:i,onClick:()=>void ie(),children:g?`Close Party HUD`:`Open Party HUD`})]}),d&&(0,z.jsxs)(z.Fragment,{children:[(0,z.jsxs)(O_,{children:[(0,z.jsx)(k_,{theme:i,children:`Show in HUD:`}),(0,z.jsxs)(N_,{$disabled:!d,children:[(0,z.jsx)(P_,{theme:i,children:`Show HP Bars`}),(0,z.jsx)(X,{label:`Party HUD Show HP Bars`,isOn:x,onChange:e=>{if(d){if(e){re({[O.PARTY_HUD_SHOW_HP_BARS]:!0,[O.PARTY_HUD_SHOW_HP_NUMBERS]:!1});return}D(O.PARTY_HUD_SHOW_HP_BARS,!1)}}})]}),(0,z.jsxs)(N_,{$disabled:!d,children:[(0,z.jsx)(P_,{theme:i,children:`Show HP Numbers`}),(0,z.jsx)(X,{label:`Party HUD Show HP Numbers`,isOn:S,onChange:e=>{if(d){if(e){re({[O.PARTY_HUD_SHOW_HP_NUMBERS]:!0,[O.PARTY_HUD_SHOW_HP_BARS]:!1});return}D(O.PARTY_HUD_SHOW_HP_NUMBERS,!1)}}})]}),(0,z.jsxs)(j_,{theme:i,disabled:!d,value:y,onChange:e=>{let t=e.target.value;D(O.PARTY_HUD_ATTR_ONE,t),t&&t===b&&D(O.PARTY_HUD_ATTR_TWO,``)},children:[(0,z.jsx)(`option`,{value:``,children:`Extra Slot 1 (None)`}),te.map(e=>(0,z.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]}),(0,z.jsxs)(j_,{theme:i,disabled:!d,value:b,onChange:e=>{let t=e.target.value;D(O.PARTY_HUD_ATTR_TWO,t),t&&t===y&&D(O.PARTY_HUD_ATTR_ONE,``)},children:[(0,z.jsx)(`option`,{value:``,children:`Extra Slot 2 (None)`}),te.map(e=>(0,z.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]}),(0,z.jsxs)(j_,{theme:i,disabled:!d,value:w,onChange:e=>{let t=e.target.value;G_(t)&&D(O.PARTY_HUD_BORDER_STYLE,t)},children:[(0,z.jsx)(`option`,{value:`default`,children:`Portrait Border: Default`}),(0,z.jsx)(`option`,{value:`plate`,children:`Portrait Border: Plate`}),(0,z.jsx)(`option`,{value:`tech`,children:`Portrait Border: Tech`})]})]}),(0,z.jsx)(M_,{theme:i,children:(0,z.jsxs)(z.Fragment,{children:[`Configure Party HUD and portraits.`,(0,z.jsx)(`br`,{}),`LIST attributes are excluded.`]})})]})]}),d&&(0,z.jsxs)(E_,{theme:i,children:[(0,z.jsxs)(O_,{children:[(0,z.jsx)(A_,{theme:i,onClick:E,disabled:T.length===0,children:`Save Party`}),(0,z.jsx)(A_,{theme:i,onClick:()=>void ee(),disabled:n===null,children:`Load Party`})]}),(0,z.jsx)(H_,{theme:i,children:n?`Last saved: ${new Date(n).toLocaleString()}`:`No save available.`})]}),T.length===0?(0,z.jsx)(V_,{theme:i,children:`No one is in the Party.  Add a unit using the ContextMenu on the token.`}):(0,z.jsx)(T_,{theme:i,children:T.map(t=>{let n=t.metadata?.[p.PORTRAIT_URL]||``,r=e(t)?t.image.url:void 0,a=t.metadata[p.UNIT_NAME]||t.name||`Unknown`,o=t.createdUserId===l?.id,s=d||o,c=r||`/logo.png`,u=!!n;return(0,z.jsxs)(F_,{theme:i,children:[(0,z.jsxs)(I_,{children:[(0,z.jsx)(L_,{theme:i,src:c,alt:a,$full:!u}),u&&(0,z.jsx)(L_,{theme:i,src:u?n:``,alt:`${a} override`,$overlay:!0})]}),(0,z.jsxs)(R_,{children:[(0,z.jsx)(z_,{theme:i,title:a,children:a}),s&&(0,z.jsx)(B_,{theme:i,defaultValue:n,placeholder:`Portrait URL override (optional)`,onBlur:e=>{oe(t.id,e.target.value)}})]})]},t.id)})})]})})};var J_=`${I}/hp-bar-effect`,Y_=`${I}/hp-bar-owner`,X_=`${I}/hp-number-text`,Z_=`${I}/hp-number-owner`,Q_=e=>`HPB${e.slice(3)}`,$_=e=>`HPN${e.slice(3)}`,ev=(e,t,n)=>Math.max(t,Math.min(n,e)),tv=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},nv=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||vt.CURRENT_HP,maxHpBid:n?.attr_bid||vt.MAX_HP}},rv=(e,t)=>{let n=nv(t),r=e[O.HP_CURRENT_BID],i=e[O.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},iv=(e,t,n)=>{let r=e.metadata?.[`${I}/${t}`],i=e.metadata?.[`${I}/${n}`],a=tv(r),o=tv(i);return o===null||o<=0||a===null?null:ev(a/o*100,0,100)},av=(e,t,n)=>{let r=e.metadata?.[`${I}/${t}`],i=e.metadata?.[`${I}/${n}`],a=tv(r),o=tv(i);return a===null?null:{currentHp:Math.trunc(a),maxHp:o===null?null:Math.trunc(o)}},ov=e=>{let t=String(e||`bottom`).toLowerCase();return t===`top`||t===`bottom`||t===`left`||t===`right`?t:`bottom`},sv=e=>{switch(ov(e)){case`top`:return 0;case`bottom`:return 1;case`left`:return 2;case`right`:return 3;default:return 1}},cv=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o,width:r,height:i}},lv=(e,t,n)=>{let r=cv(e,t),i=r.minX+r.width*.5,a=r.minY+r.height*.5,o;switch(n){case`top`:o={x:i,y:r.minY+r.height*.18};break;case`bottom`:o={x:i,y:r.minY+r.height*.82};break;case`left`:o={x:r.minX+r.width*.18,y:a};break;case`right`:o={x:r.minX+r.width*.82,y:a};break}let s=r.width*.25,c=r.height*.18;return{x:o.x-s,y:o.y-c}};const uv=()=>{let t=R(e=>e.cacheReady),i=R(e=>e.sceneReady),a=R(e=>e.items),o=R(e=>e.localItems),s=R(e=>e.gridDpi),l=R(e=>e.roomMetadata),u=R(e=>e.sceneMetadata),d=R(e=>e.systemData);return(0,L.useEffect)(()=>{if(!t||!i)return;let u=!1;return(async()=>{let t=l,i=t[O.SHOW_HP_BARS]??!1,f=t[O.SHOW_HP_NUMBERS]??!1,m=i,h=!i&&f,g=ov(t[O.HP_BAR_ORIENTATION]),_=sv(t[O.HP_BAR_ORIENTATION]),{currentHpBid:v,maxHpBid:x}=rv(t,d?.attributes||[]),S=o.filter(e=>y(e)&&e.metadata?.[J_]===!0),C=o.filter(e=>b(e)&&e.metadata?.[X_]===!0);if(!m&&S.length>0)try{await c.scene.local.deleteItems(S.map(e=>e.id))}catch(e){k.error(`Failed to remove HP bar effects`,e)}if(!h&&C.length>0)try{await c.scene.local.deleteItems(C.map(e=>e.id))}catch(e){k.error(`Failed to remove HP number texts`,e)}if(!m&&!h)return;let w=a.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),T=new Map,E=new Map;for(let t of w){if(m){let e=iv(t,v,x);e!==null&&T.set(Q_(t.id),{unitId:t.id,hpPercent:e})}if(h&&e(t)){let e=av(t,v,x);if(e){let n=e.maxHp===null?`${e.currentHp}`:`${e.currentHp}/${e.maxHp}`;E.set($_(t.id),{unitId:t.id,text:n,position:lv(t,s,g)})}}}if(m){let e=new Map(S.map(e=>[e.id,e])),t=Array.from(T.entries()).filter(([t])=>!e.has(t)),n=S.filter(e=>!T.has(e.id)),i=S.filter(e=>{let t=T.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`orientation`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return e.attachedTo!==t.unitId||!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-_)>.001});if(u)return;if(n.length>0)try{await c.scene.local.deleteItems(n.map(e=>e.id))}catch(e){k.error(`Failed to remove stale HP bar effects`,e)}if(t.length>0){let e=t.map(([e,t])=>r().id(e).name(`HP Bar Effect`).effectType(`ATTACHMENT`).attachedTo(t.unitId).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).uniforms([{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}]).sksl(`
uniform vec2 size;
uniform float time;
...
`).metadata({[J_]:!0,[Y_]:t.unitId}).build());try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add HP bar effects`,e)}}if(i.length>0){let e=i.map(e=>e.id);try{await c.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=T.get(e.id);if(!t)return;e.attachedTo=t.unitId;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}],e.metadata={...e.metadata,[J_]:!0,[Y_]:t.unitId}})})}catch(e){k.error(`Failed to update HP bar effects`,e)}}}if(h){let e=new Map(C.map(e=>[e.id,e])),t=Array.from(E.entries()).filter(([t])=>!e.has(t)),r=C.filter(e=>!E.has(e.id)),i=C.filter(e=>{let t=E.get(e.id);if(!t)return!1;let n=e.text?.plainText,r=Math.abs(e.position.x-t.position.x)>.01||Math.abs(e.position.y-t.position.y)>.01;return e.attachedTo!==t.unitId||n!==t.text||r});if(u)return;if(r.length>0)try{await c.scene.local.deleteItems(r.map(e=>e.id))}catch(e){k.error(`Failed to remove stale HP number texts`,e)}if(t.length>0){let e=t.map(([e,t])=>{let r=w.find(e=>e.id===t.unitId);return n().id(e).name(`HP Number Text`).plainText(t.text).textType(`PLAIN`).fontWeight(900).fillOpacity(.95).fillColor(`white`).strokeWidth(8).strokeColor(`black`).strokeOpacity(1).fontSize(28).fontFamily(`Segoe UI`).textAlign(`CENTER`).position(t.position).metadata({[X_]:!0,[Z_]:t.unitId}).attachedTo(t.unitId).visible(r?.visible??!0).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).layer(`TEXT`).build()});try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add HP number texts`,e)}}if(i.length>0){let e=i.map(e=>e.id);try{await c.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=E.get(e.id);if(!t)return;e.attachedTo=t.unitId,e.position=t.position;let n=e;n.text&&(n.text.plainText=t.text),e.metadata={...e.metadata,[X_]:!0,[Z_]:t.unitId}})})}catch(e){k.error(`Failed to update HP number texts`,e)}}}})(),()=>{u=!0}},[t,i,a,o,s,l,u,d]),null};var dv=`${I}/death-effect-token`,fv=`${I}/death-effect-owner`,pv=e=>`DTH${e.slice(3)}`,mv=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},hv=e=>({currentHpBid:e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`})?.attr_bid||vt.CURRENT_HP}),gv=(e,t)=>{let n=hv(t),r=e[O.HP_CURRENT_BID],i=new Set(t.map(e=>e.attr_bid));return r&&i.has(r)?r:n.currentHpBid},_v=(e,t)=>{let n=e.metadata?.[`${I}/${t}`];return mv(n)};const vv=()=>{let t=R(e=>e.cacheReady),n=R(e=>e.sceneReady),i=R(e=>e.items),a=R(e=>e.localItems),o=R(e=>e.roomMetadata),s=R(e=>e.sceneMetadata),l=R(e=>e.systemData);return(0,L.useEffect)(()=>{if(!t||!n)return;let s=!1;return(async()=>{let t=o,n=t[O.SHOW_DEATH_EFFECT]??!1,u=gv(t,l?.attributes||[]),d=a.filter(e=>y(e)&&e.metadata?.[dv]===!0);if(!n){if(d.length>0)try{await c.scene.local.deleteItems(d.map(e=>e.id))}catch(e){k.error(`Failed to remove death token effects`,e)}return}let f=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),m=new Map;f.forEach(e=>{_v(e,u)===0&&m.set(pv(e.id),e.id)});let h=new Map(d.map(e=>[e.id,e])),g=Array.from(m.entries()).filter(([e])=>!h.has(e)),_=d.filter(e=>!m.has(e.id)),v=d.filter(e=>{let t=m.get(e.id);if(!t)return!1;let n=e;return e.attachedTo!==t||n.metadata?.[fv]!==t});if(!s){if(_.length>0)try{await c.scene.local.deleteItems(_.map(e=>e.id))}catch(e){k.error(`Failed to remove stale death token effects`,e)}if(g.length>0){let e=g.map(([e,t])=>r().id(e).name(`Death Token Effect`).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(`
uniform float2 size;
uniform float time;
...
`).metadata({[dv]:!0,[fv]:t}).build());try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add death token effects`,e)}}if(v.length>0)try{await c.scene.local.updateItems(v.map(e=>e.id),e=>{e.forEach(e=>{let t=m.get(e.id);t&&(e.attachedTo=t,e.metadata={...e.metadata,[dv]:!0,[fv]:t})})})}catch(e){k.error(`Failed to update death token effects`,e)}}})(),()=>{s=!0}},[t,n,i,a,o,s,l]),null};var yv=`${I}/buff-effect-token`,bv=`${I}/buff-effect-owner`,xv=`${I}/debuff-effect-token`,Sv=`${I}/debuff-effect-owner`,Cv=`${I}/effect-preset`,wv=e=>`EFB${e.slice(3)}`,Tv=e=>`EFD${e.slice(3)}`,Ev=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const Dv=()=>{let t=R(e=>e.cacheReady),n=R(e=>e.sceneReady),i=R(e=>e.items),a=R(e=>e.localItems),o=R(e=>e.roomMetadata),s=R(e=>e.sceneMetadata);return(0,L.useEffect)(()=>{if(!t||!n)return;let s=!1;return(async()=>{let t=o,n=t[O.BUFF_VISUAL_PRESET],l=t[O.DEBUFF_VISUAL_PRESET],u=zm(n)?n:Fm,d=Bm(l)?l:Im,f=Vm(u),m=Hm(d),h=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),g=new Set(h.map(e=>e.id)),_=new Map,v=(e,t)=>{let n=_.get(e)||{hasBuff:!1,hasDebuff:!1};t===`buff`?n.hasBuff=!0:n.hasDebuff=!0,_.set(e,n)};i.forEach(e=>{if(e.metadata?.[p.ON_LIST]!==!0)return;let t=Ev(e.metadata?.[Sh]);t.length!==0&&t.forEach(t=>{t.effectType!==`neutral`&&(t.targets.length>0?t.targets:[e.id]).forEach(e=>{g.has(e)&&(t.effectType===`buff`||t.effectType===`debuff`)&&v(e,t.effectType)})})});let b=new Map,x=new Map;h.forEach(e=>{let t=_.get(e.id);t?.hasBuff&&b.set(wv(e.id),e.id),t?.hasDebuff&&x.set(Tv(e.id),e.id)});let S=a.filter(e=>y(e)&&e.metadata?.[yv]===!0),C=a.filter(e=>y(e)&&e.metadata?.[xv]===!0),w=async e=>{let{existing:t,desiredByOverlayId:n,preset:i,shader:a,name:o,flagKey:l,ownerKey:u}=e,d=new Map(t.map(e=>[e.id,e])),f=Array.from(n.entries()).filter(([e])=>!d.has(e)),p=t.filter(e=>!n.has(e.id)),m=t.filter(e=>{let t=n.get(e.id);if(!t)return!1;let r=e.metadata?.[Cv];return e.attachedTo!==t||r!==i});if(!s){if(p.length>0)try{await c.scene.local.deleteItems(p.map(e=>e.id))}catch(e){k.error(`Failed to remove stale ${o.toLowerCase()} overlays`,e)}if(f.length>0){let e=f.map(([e,t])=>r().id(e).name(o).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(a).metadata({[l]:!0,[u]:t,[Cv]:i}).build());try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add ${o.toLowerCase()} overlays`,e)}}if(m.length>0)try{await c.scene.local.updateItems(m.map(e=>e.id),e=>{e.forEach(e=>{let t=n.get(e.id);if(!t)return;e.attachedTo=t;let r=e;r.sksl=a,e.metadata={...e.metadata,[l]:!0,[u]:t,[Cv]:i}})})}catch(e){k.error(`Failed to update ${o.toLowerCase()} overlays`,e)}}};await w({existing:S,desiredByOverlayId:b,preset:u,shader:f,name:`Buff Token Effect`,flagKey:yv,ownerKey:bv}),await w({existing:C,desiredByOverlayId:x,preset:d,shader:m,name:`Debuff Token Effect`,flagKey:xv,ownerKey:Sv})})(),()=>{s=!0}},[t,n,i,a,o,s]),null};var Ov=`${I}/boss-hp-effect`,kv=`${I}/boss-hp-owner`,Av=`${I}/boss-hp-slot`,jv=e=>`BOSSHP${e}`,Mv=(e,t,n)=>Math.max(t,Math.min(n,e)),Nv=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},Pv=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||vt.CURRENT_HP,maxHpBid:n?.attr_bid||vt.MAX_HP}},Fv=(e,t)=>{let n=Pv(t),r=e[O.HP_CURRENT_BID],i=e[O.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},Iv=(e,t,n)=>{let r=e.metadata?.[`${I}/${t}`],i=e.metadata?.[`${I}/${n}`],a=Nv(r),o=Nv(i);return o===null||o<=0||a===null?null:Mv(a/o*100,0,100)};const Lv=()=>{let t=R(e=>e.cacheReady),n=R(e=>e.sceneReady),i=R(e=>e.items),a=R(e=>e.localItems),o=R(e=>e.roomMetadata),s=R(e=>e.sceneMetadata),l=R(e=>e.systemData);return(0,L.useEffect)(()=>{if(!t||!n)return;let s=!1;return(async()=>{let{currentHpBid:t,maxHpBid:n}=Fv(o,l?.attributes||[]),u=a.filter(e=>y(e)&&e.metadata?.[Ov]===!0),d=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0&&t.metadata?.[p.BOSS_MODE]===!0).sort((e,t)=>{let n=Number(e.metadata?.[p.INITIATIVE]??0);return Number(t.metadata?.[p.INITIATIVE]??0)-n}).slice(0,2).map((e,r)=>{let i=Iv(e,t,n);return i===null?null:{id:jv(r),unitId:e.id,slot:r,hpPercent:i}}).filter(e=>e!==null),f=new Map(d.map(e=>[e.id,e])),m=new Map(u.map(e=>[e.id,e])),h=u.filter(e=>!f.has(e.id)),g=d.filter(e=>!m.has(e.id)),_=u.filter(e=>{let t=f.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`slot`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-t.slot)>.001||e.metadata?.[kv]!==t.unitId});if(!s){if(h.length>0)try{await c.scene.local.deleteItems(h.map(e=>e.id))}catch(e){k.error(`Failed to remove stale boss HP viewport effects`,e)}if(g.length>0){let e=g.map(e=>r().id(e.id).name(`Boss HP Bar`).effectType(`VIEWPORT`).locked(!0).disableHit(!0).uniforms([{name:`hpPercent`,value:e.hpPercent},{name:`slot`,value:e.slot}]).sksl(`
uniform float2 size;
...
`).metadata({[Ov]:!0,[kv]:e.unitId,[Av]:e.slot}).build());try{await c.scene.local.addItems(e)}catch(e){k.error(`Failed to add boss HP viewport effects`,e)}}if(_.length>0)try{await c.scene.local.updateItems(_.map(e=>e.id),e=>{e.forEach(e=>{let t=f.get(e.id);if(!t)return;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`slot`,value:t.slot}],e.metadata={...e.metadata,[Ov]:!0,[kv]:t.unitId,[Av]:t.slot}})})}catch(e){k.error(`Failed to update boss HP viewport effects`,e)}}})(),()=>{s=!0}},[t,n,i,a,o,s,l]),null};var Rv=`${I}/current-turn-effect`;const zv=()=>{let e=R(e=>e.cacheReady),t=R(e=>e.sceneReady),n=R(e=>e.items),i=R(e=>e.roomMetadata),a=R(e=>e.sceneMetadata);return(0,L.useEffect)(()=>{if(!e||!t)return;let o=!1;return(async()=>{let e=i[O.SHOW_TURN_EFFECT]===!0,t=a[O.CURRENT_TURN];if(!e||!t){try{await c.scene.local.deleteItems([Rv])}catch{}return}if(!n.find(e=>e.id===t)){try{await c.scene.local.deleteItems([Rv])}catch{}return}if(!o){try{let e=!1;if(await c.scene.local.updateItems([Rv],n=>{let r=n[0];r&&(r.attachedTo=t,e=!0)}),e)return}catch{}if(!o)try{let e=r().id(Rv).name(`Current Turn Effect`).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).sksl(`
uniform vec2 size;
uniform float time;
...
`).build();await c.scene.local.addItems([e])}catch(e){k.error(`Failed to sync current turn effect`,e)}}})(),()=>{o=!0}},[e,t,n,i,a]),null},Bv=()=>{let[e,t]=(0,L.useState)(!1),{updateThemeFromSystem:n}=Pt(),r=R(e=>e.roomMetadata),i=R(e=>e.cacheReady),a=R(e=>e.systemData),o=R(e=>e.setSystemData),s=()=>({theme:{primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url},cardLayout:E.card_layout,listLayout:E.list_layout,attributes:E.attributes,systemName:E.name,importDate:null,snapshotPublicId:null});return(0,L.useEffect)(()=>{!i&&e&&(t(!1),o(null))},[i,e,o]),(0,L.useEffect)(()=>{!i||!a||n(a.theme.primary,a.theme.offset,a.theme.background,a.theme.border,a.theme.background_url)},[i,a,n]),(0,L.useEffect)(()=>{if(e)return;let n=!0,a=async()=>{if(i)try{k.log(`Starting app initialization...`),await c(),n&&(t(!0),k.log(`App initialization complete`))}catch(e){k.error(`Error during app initialization:`,e),n&&t(!0)}},c=async()=>{let e=(e,t)=>{if(Array.isArray(e))return e;if(typeof e==`string`){let n;try{n=JSON.parse(e)}catch{throw Error(`Snapshot ${t} is not valid JSON`)}if(!Array.isArray(n))throw Error(`Snapshot ${t} is not a JSON array`);return n}throw Error(`Snapshot ${t} has invalid type`)},t=async t=>{let{data:n,error:r}=await C.rpc(`bs_forge_get_snapshot_for_room`,{p_snapshot_public_id:t});if(r)return k.error(`Failed to load room snapshot:`,r),!1;let i=Array.isArray(n)?n[0]:n;if(!i||typeof i.snapshot_public_id!=`string`)return k.warn(`Room snapshot reference was set, but no snapshot record was returned`),!1;let a=e(i.card_layout,`card_layout`),s=e(i.list_layout,`list_layout`),c=e(i.attributes,`attributes`);return o({theme:{primary:i.theme_primary,offset:i.theme_offset,background:i.theme_background,border:i.theme_border,background_url:i.background_url},cardLayout:a,listLayout:s,attributes:c,systemName:i.system_name,importDate:i.imported_at,snapshotPublicId:i.snapshot_public_id}),k.log(`System data hydrated from room snapshot`,{snapshotPublicId:i.snapshot_public_id,systemName:i.system_name}),!0};try{let e=r[Gm.SNAPSHOT_PUBLIC_ID];if(typeof e==`string`&&e.trim().length>0&&await t(e))return;k.log(`Room snapshot reference missing or unavailable, initializing defaults`),await l()}catch(e){k.error(`Error loading system data:`,e),await l()}},l=async()=>{o(s()),k.log(`Default system initialized`)};return a(),()=>{n=!1}},[i,e,r,o,n]),(0,L.useEffect)(()=>{if(!i||!e)return;let t=e=>{if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);return Array.isArray(t)?t:null}catch{return null}return null},n=r[Gm.SNAPSHOT_PUBLIC_ID],c=typeof n==`string`&&n.trim().length>0?n.trim():null;if(c===(a?.snapshotPublicId??null))return;let l=!1;return(async()=>{if(!c){l||(o(s()),k.log(`Room snapshot reference cleared, reverted runtime system to defaults`));return}let{data:e,error:n}=await C.rpc(`bs_forge_get_snapshot_for_room`,{p_snapshot_public_id:c});if(n){k.error(`Failed to refresh system from room snapshot change:`,n);return}let r=Array.isArray(e)?e[0]:e;if(!r||typeof r.snapshot_public_id!=`string`){k.warn(`Room snapshot reference changed, but snapshot record was not found`);return}let i=t(r.card_layout),a=t(r.list_layout),u=t(r.attributes);if(!i||!a||!u){k.warn(`Room snapshot refresh returned invalid payload arrays`);return}l||(o({theme:{primary:r.theme_primary,offset:r.theme_offset,background:r.theme_background,border:r.theme_border,background_url:r.background_url},cardLayout:i,listLayout:a,attributes:u,systemName:r.system_name,importDate:r.imported_at,snapshotPublicId:r.snapshot_public_id}),k.log(`Runtime system refreshed from room snapshot change`,{snapshotPublicId:r.snapshot_public_id,systemName:r.system_name}))})(),()=>{l=!0}},[i,e,r,a,o]),{isInitialized:e}};var Vv=m`
...
`;function Gv(){let{sceneReady:e,cacheReady:t,playerData:n,roomMetadata:r,sceneMetadata:i}=R(),{isInitialized:a}=Bv(),{theme:o}=Pt(),[s,l]=(0,L.useState)(`ForgeMain`),[u,d]=(0,L.useState)(!1),f=(0,L.useRef)(!1),p=String(n?.role||``).toUpperCase()===`GM`,m=r,h=n?.id,g=(m[ne(O.PARTY_HUD_OPEN,h)]??m[O.PARTY_HUD_OPEN])===!0,_=m[O.SHOW_PLAYER_VIEW]||!1,v=p||_,y=e&&t&&a;return(0,L.useEffect)(()=>{y&&P()},[y]),(0,L.useEffect)(()=>{if(!y)return;let e=!0;return(async()=>{if(g&&!f.current){await S_(),e&&(f.current=!0);return}!g&&f.current&&(await C_(),e&&(f.current=!1))})(),()=>{e=!1}},[y,g]),(0,L.useEffect)(()=>{y&&!v&&s===`ForgeMain`&&l(`Party`)},[y,v,s]),(0,L.useEffect)(()=>{s!==`ForgeMain`&&c.action.setWidth(350)},[s]),(0,z.jsxs)(z.Fragment,{children:[(0,z.jsx)(Vv,{theme:o}),!e||!t||!a?(0,z.jsxs)(Hv,{children:[(0,z.jsx)(Uv,{}),(0,z.jsx)(Wv,{children:e?t?a?`Loading...`:`Initializing system...`:`Loading cache...`:`Connecting to scene...`})]}):(0,z.jsxs)(qp,{children:[(0,z.jsx)(uv,{}),(0,z.jsx)(vv,{}),(0,z.jsx)(Dv,{}),(0,z.jsx)(Lv,{}),(0,z.jsx)(zv,{}),(0,z.jsx)(Jp,{theme:o,$backgroundUrl:o.BACKGROUND_URL,children:(0,z.jsx)(eu,{mode:`wait`,children:(()=>{switch(s){case`ForgeMain`:return v?(0,z.jsx)(b_,{},`main`):(0,z.jsx)(q_,{},`party`);case`Settings`:return p?(0,z.jsx)(Om,{},`settings`):(0,z.jsx)(b_,{},`main`);case`Party`:return(0,z.jsx)(q_,{},`party`);case`System`:return p?(0,z.jsx)(yh,{},`system`):(0,z.jsx)(b_,{},`main`);case`ChatLog`:return(0,z.jsx)(Pm,{},`chatlog`)}})()})}),(0,z.jsx)(im,{isOpen:u,currentPage:s,onToggle:()=>d(!u),onNavigate:e=>{if(!v&&e===`ForgeMain`){l(`Party`),d(!1);return}if(!p&&(e===`Settings`||e===`System`)){l(`ForgeMain`),d(!1);return}l(e),d(!1)},canAccessInitiativeList:v})]})]})}var Kv=Gv,qv=class{static{this.ALPHANUMERICTEXTMATCH=/\s[\da-zA-Z]$/}};function Jv(e){for(let t of Xv)if(e.includes(t)){let n=Xv[Math.floor(Math.random()*Xv.length)];return e.replace(t,n)}return Yv(e)}function Yv(e){return`${Xv[Math.floor(Math.random()*Xv.length)]} ${e}`}const Xv=`Grizzled.Wily.Stoic.Mellow.Pensive.Shrewd.Cautious.Hardy.Nimble.Tenacious.Gritty.Tolerant.Hardy.Adroit.Resilient.Slight.Stout.Durable.Subtle.Sober.Clever.Brave.Calm.Wise.Cunning.Alert.Swift.Agile.Loyal.Sturdy.Stable.Sneaky.Clever.Resourceful.Shady.Stalwart.Vigilant.Staunch.Fierce.Vigorous.Robust.Fearless.Dauntless.Resolute.Sagacious.Prudent.Judicious.Astute.Savvy.Sharp.Quick.Witty.Smart.Snippy.Crafty.Deft.Sly.Artful.Clever.Sneering.Tough.Rugged.Solid.Strong.Sturdy.Tough.Gritty.Rough.Hardened.Burly.Muscular.Brawny.Rowdy.Forceful.Snorting.Potent.Martial.Speckled.Mottled.Disheveled`.split(`.`);var Zv=`com.battle-system.forge/view-unit`,Qv=`com.battle-system.forge/view-unit-player`,$v=e=>e.trim().toLowerCase(),ey=e=>{if(typeof e!=`string`)return null;let t=e.trim();return t.length>0?t:null},ty=e=>{let t=e.trim();return t?qv.ALPHANUMERICTEXTMATCH.test(t)?t.slice(0,-2):t:e},ny=e=>{let t=typeof e.text?.plainText==`string`?e.text.plainText.trim():``;if(t.length>0)return t;let n=e.metadata?.[p.UNIT_NAME],r=typeof n==`string`?n.trim():``;if(r.length>0)return r;let i=typeof e.name==`string`?e.name.trim():``;return i.length>0?i:typeof e.name==`string`?e.name:``},ry=async e=>{let n=await c.viewport.getHeight(),r=n>800?700:n-100;await c.popover.open({id:t.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(e)}`,height:r,width:350,anchorReference:`POSITION`,anchorPosition:{left:await c.viewport.getWidth()/2,top:await c.viewport.getHeight()/2},anchorOrigin:{horizontal:`CENTER`,vertical:`CENTER`},transformOrigin:{horizontal:`CENTER`,vertical:`CENTER`},hidePaper:!0,disableClickAway:!0})},iy=async e=>{let t=Array.from(new Set(e.map(e=>e.trim()).filter(e=>e.length>0))),n=new Map;if(t.length===0)return n;let r=await ft(),i=new Map;for(let e of r){let t=$v(e.name);if(!t)continue;let n=i.get(t);n?n.push(e):i.set(t,[e])}for(let e of t){let t=$v(e),r=i.get(t)?.[0];!r||!r.metadata||n.set(t,oe(r.metadata))}try{let e=await $e(t);for(let t of e){let e=$v(t.name);!e||n.has(e)||!t.metadata||n.set(e,oe(t.metadata))}let r=await rt(t);for(let e of r){let t=$v(e.name);!t||n.has(t)||!e.metadata||n.set(t,oe(e.metadata))}}catch(e){k.log(`Remote collection lookup failed, using local collection only`,e)}return n};function ay({children:e}){let t=R(e=>e.roomMetadata);R(e=>e.sceneMetadata);let n=R(e=>e.items),r=R(e=>e.playerData),i=R(e=>e.systemData),a=t,o=i?.attributes??[],s=new Set(o.map(e=>e.attr_bid)),l=o.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`})?.attr_bid,u=o.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`})?.attr_bid,d=ey(a[O.HP_CURRENT_BID]),f=ey(a[O.HP_MAX_BID]),m=d&&(s.size===0||s.has(d))?d:l||(s.size===0?vt.CURRENT_HP:``),h=f&&(s.size===0||s.has(f))?f:u||(s.size===0?vt.MAX_HP:``),g=!!(m&&h),_=a[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?!0:a[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===!0,v=a[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===void 0?!0:a[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===!0;return(0,L.useEffect)(()=>{c.onReady(()=>{c.contextMenu.create({id:p.ON_LIST,icons:[{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}}],async onClick(e){if(k.info(`Add to Combat Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[p.ON_LIST]===!0))await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[p.ON_LIST],delete t.metadata[p.INITIATIVE]});else{let t=[],r=[],i=new Set(e.items.map(e=>e.id)),o=a[O.USE_DESCRIPTIVE_DUPLICATES]===!0,s=new Set(n.filter(e=>{if(i.has(e.id))return!1;let t=e.metadata[p.UNIT_NAME];return typeof t==`string`&&t.trim().length>0}).map(e=>$v(String(e.metadata[p.UNIT_NAME]))));for(let n of e.items){if(n.metadata[p.FABRICATED]===!0)continue;let e=ty(n.text?.plainText||n.name);t.push(e)}await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let l=await iy(t);await c.action.setBadgeText(void 0);for(let t of e.items){let e={},n=t,i=ny(n);if(t.metadata[p.FABRICATED]!==!0){let r=ty(n.text?.plainText||t.name),a=l.get($v(r));a&&Object.assign(e,a),(typeof e[p.UNIT_NAME]!=`string`||!String(e[p.UNIT_NAME]).trim())&&(e[p.UNIT_NAME]=i),e[p.FABRICATED]=!0}if(o){let r=typeof t.metadata[p.UNIT_NAME]==`string`?String(t.metadata[p.UNIT_NAME]).trim():``,a=ty(n.text?.plainText||t.name).trim(),o=String(e[p.UNIT_NAME]||r||i||a||t.name).trim(),c=$v(o);if(c){let e=0;for(;s.has(c)&&e<20;)o=Jv(o),c=$v(o),e+=1;c&&s.add(c)}e[p.UNIT_NAME]=o}(typeof e[p.UNIT_NAME]!=`string`||!String(e[p.UNIT_NAME]).trim())&&(e[p.UNIT_NAME]=i),e[p.ON_LIST]=!0,e[p.INITIATIVE]=0,r.push({id:t.id,metadata:e})}await c.scene.items.updateItems(e.items,e=>{for(let t of e){let e=r.find(e=>e.id===t.id);if(e&&(Object.assign(t.metadata,e.metadata),a[O.SHOW_NAMES]===!0)){let n=t,r=typeof e.metadata[p.UNIT_NAME]==`string`&&String(e.metadata[p.UNIT_NAME]).trim().length>0?String(e.metadata[p.UNIT_NAME]).trim():ny(n);n.text&&(n.text.plainText=r)}}})}}}),c.contextMenu.create({id:p.IN_PARTY,icons:[{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`!=`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`!=`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`==`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`==`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){k.info(`Add to Party Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[p.IN_PARTY]===!0)?await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[p.IN_PARTY]}):await c.scene.items.updateItems(e.items,e=>{for(let t of e)t.metadata[p.IN_PARTY]=!0})}}),c.contextMenu.create({id:Zv,icons:[{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}}],async onClick(e){k.info(`View Unit Clicked: ${e.items[0].name}`);let t=e.items[0];if(!t)return;let r={};if(t.metadata[p.FABRICATED]!==!0){let e=t,i=ny(e),o=ty(e.text?.plainText||t.name);await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let s=await iy([o]);await c.action.setBadgeText(void 0);let l=s.get($v(o));l&&Object.assign(r,l),(typeof r[p.UNIT_NAME]!=`string`||!String(r[p.UNIT_NAME]).trim())&&(r[p.UNIT_NAME]=i),r[p.FABRICATED]=!0,a[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[p.UNIT_NAME]!=null&&e.id!==t.id).map(e=>e.metadata[p.UNIT_NAME]).includes(o)&&(r[p.UNIT_NAME]=Jv(o)),await c.scene.items.updateItems([t],e=>{let t=e[0];if(Object.assign(t.metadata,r),a[O.SHOW_NAMES]===!0){let e=t,n=typeof r[p.UNIT_NAME]==`string`&&String(r[p.UNIT_NAME]).trim().length>0?String(r[p.UNIT_NAME]).trim():ny(e);e.text&&(e.text.plainText=n)}})}await ry(t.id)}}),v?c.contextMenu.create({id:Qv,icons:[{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){k.info(`View Unit Clicked: ${e.items[0].name}`);let t=e.items[0];if(!t)return;let r={};if(t.metadata[p.FABRICATED]!==!0){let e=t,i=ny(e),o=ty(e.text?.plainText||t.name);await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let s=await iy([o]);await c.action.setBadgeText(void 0);let l=s.get($v(o));l&&Object.assign(r,l),(typeof r[p.UNIT_NAME]!=`string`||!String(r[p.UNIT_NAME]).trim())&&(r[p.UNIT_NAME]=i),r[p.FABRICATED]=!0,a[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[p.UNIT_NAME]!=null&&e.id!==t.id).map(e=>e.metadata[p.UNIT_NAME]).includes(o)&&(r[p.UNIT_NAME]=Jv(o)),await c.scene.items.updateItems([t],e=>{let t=e[0];if(Object.assign(t.metadata,r),a[O.SHOW_NAMES]===!0){let e=t,n=typeof r[p.UNIT_NAME]==`string`&&String(r[p.UNIT_NAME]).trim().length>0?String(r[p.UNIT_NAME]).trim():ny(e);e.text&&(e.text.plainText=n)}})}await ry(t.id)}}):c.contextMenu.remove(Qv).catch(()=>{}),g&&_?c.contextMenu.create({id:p.MODIFY_UNIT,icons:[{icon:`/icon.svg`,label:`Adjust HP`,filter:{some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Adjust HP`,filter:{every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e,t){k.info(`Adjust HP Clicked: ${e.items[0].name}`),await c.popover.open({id:te.CONTEXT_MENU,url:`/pages/forgecontext.html`,height:50,width:180,anchorElementId:t,hidePaper:!0})},embed:{url:`/pages/forgecontext.html?contextmenu=true`,height:70}}):c.contextMenu.remove(p.MODIFY_UNIT).catch(()=>{})})},[a,g,_,v]),(0,z.jsx)(z.Fragment,{children:e})}Tt.createRoot(document.getElementById(`root`)).render((0,z.jsx)(L.StrictMode,{children:(0,z.jsx)(D,{children:(0,z.jsx)(jt,{children:(0,z.jsx)(ay,{children:(0,z.jsx)(Nt,{children:(0,z.jsx)(Kv,{})})})})})}));