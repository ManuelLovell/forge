import{A as e,D as t,P as n,S as r,T as i,_ as a,b as o,g as s,j as c,m as l,n as u,t as d,v as f,x as p,y as m}from"./defaultgamesystem-CNO7r0LB.js";import{n as h,t as g}from"./MockData-DTzuSraw.js";/* empty css               */var _=n(e(),1),v=c(),y=r(),b={CURRENT_THEME:`${o.EXTENSIONID}/CurrentTheme`,CURRENT_ATTR:`${o.EXTENSIONID}/CurrentAttr`},ee={primary:d.theme_primary,offset:d.theme_offset,background:d.theme_background,border:d.theme_border,background_url:d.background_url},x=50,te=75,ne=120,S=8,C=190,w=90,T=120,E=150,re=1024,ie=6,D=u.div`
  position: fixed;
  inset: 0;
  width: 100vw;
  height: 100vh;
...
`,P=u.div`
  ...
  color: ${e=>e.$theme.primary};
  font-size: 14px;
`,F=(e,t,n)=>Math.max(t,Math.min(n,e)),I=e=>{if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);return Array.isArray(t)?t:null}catch{return null}return null},L=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},R=e=>e.sceneMetadata,z=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||h.CURRENT_HP,maxHpBid:n?.attr_bid||h.MAX_HP}},B=e=>e===`bottom`||e===`left`||e===`top`||e===`right`,me=(e,t)=>t.toLowerCase()===`bool`?e===!0?`Yes`:e===!1?`No`:`-`:e==null||e===``?`-`:String(e),V=()=>{let[e,n]=(0,v.useState)({sceneMetadata:{},roomMetadata:{},items:[]}),[r,o]=(0,v.useState)(!1),[c,l]=(0,v.useState)(()=>({width:typeof window<`u`?window.innerWidth:1920,height:typeof window<`u`?window.innerHeight:1080})),[u,p]=(0,v.useState)(``),[m,h]=(0,v.useState)(0),_=e=>e.filter(e=>e.metadata?.[a.BOSS_MODE]===!0).length;(0,v.useEffect)(()=>{let e=!0;(async()=>{let[t,r,a,s]=await Promise.all([i.scene.getMetadata(),i.room.getMetadata(),i.scene.items.getItems(),i.player.getId()]);e&&(n({sceneMetadata:t,roomMetadata:r,items:a}),p(s),h(_(a)),o(!0))})();let t=i.scene.onMetadataChange(t=>{e&&n(e=>({...e,sceneMetadata:t}))}),r=i.room.onMetadataChange(t=>{e&&n(e=>({...e,roomMetadata:t}))}),a=i.scene.items.onChange(t=>{e&&(n(e=>({...e,items:t})),h(_(t)))}),s=i.player.onChange(t=>{e&&p(t.id||``)});return()=>{e=!1,t(),r(),a(),s()}},[]),(0,v.useEffect)(()=>{let e=()=>{l({width:window.innerWidth,height:window.innerHeight})};return e(),window.addEventListener(`resize`,e),()=>window.removeEventListener(`resize`,e)},[]);let V=(0,v.useMemo)(()=>{let t=e.sceneMetadata[b.CURRENT_THEME];return!t?.primary||!t?.offset||!t?.background||!t?.border?ee:t},[e.sceneMetadata]),U=(0,v.useMemo)(()=>I(e.sceneMetadata[b.CURRENT_ATTR])||d.attributes,[e.sceneMetadata]),W=(0,v.useMemo)(()=>R(e),[e]),G=(0,v.useMemo)(()=>{let e=W[f(s.PARTY_HUD_ORIENTATION,u)]??W[s.PARTY_HUD_ORIENTATION];return B(e)?e:`bottom`},[W,u]),K=W[s.PARTY_HUD_ATTR_ONE]||``,q=W[s.PARTY_HUD_ATTR_TWO]||``,he=W[s.PARTY_HUD_SHOW_HP_BARS]!==void 0,ge=W[s.PARTY_HUD_SHOW_HP_NUMBERS]!==void 0,J=W[s.PARTY_HUD_SHOW_HP_BARS]===!0,_e=W[s.PARTY_HUD_SHOW_HP_NUMBERS]===!0&&!J,Y=!he&&!ge,ve=Y?!0:J,ye=Y?!1:_e,X=(0,v.useMemo)(()=>[K,q].filter((e,t,n)=>e&&n.indexOf(e)===t).map(e=>U.find(t=>t.attr_bid===e)||null).filter(e=>e!==null).filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`text`||t===`numb`||t===`bool`}),[U,K,q]),{currentHpBid:be,maxHpBid:xe}=(0,v.useMemo)(()=>{let e=z(U),t=W[s.HP_CURRENT_BID],n=W[s.HP_MAX_BID],r=new Set(U.map(e=>e.attr_bid));return{currentHpBid:t&&r.has(t)?t:e.currentHpBid,maxHpBid:n&&r.has(n)?n:e.maxHpBid}},[U,W]),Z=(0,v.useMemo)(()=>e.items.filter(e=>e.metadata?.[a.IN_PARTY]===!0).sort((e,t)=>{let n=String(H(e)),r=String(H(t));return n.localeCompare(r)}),[e.items]),Se=(0,v.useMemo)(()=>{let t=e.sceneMetadata[s.CURRENT_TURN];return typeof t==`string`&&t.trim().length>0?t:null},[e.sceneMetadata]),Q=(0,v.useMemo)(()=>G===`top`?m>=2?ne:m===1?te:x:x,[m,G]),$=(0,v.useMemo)(()=>{let e=Math.max(1,Z.length),t=G===`left`||G===`right`,n=t?T:C,r=t?E:w,i=t?n:e*n+(e-1)*S,a=t?e*r+(e-1)*S:r,o=Math.max(1,c.width-Q*2),s=Math.max(1,c.height-Q*2),l=c.width>=re&&Z.length>=ie,u=o/i,d=s/a,f=l?Math.min(1,u,d):1;return{contentWidth:i,contentHeight:a,scale:f,scaledWidth:Math.max(1,Math.floor(i*f)),scaledHeight:Math.max(1,Math.floor(a*f))}},[G,Z.length,c.height,c.width,Q]);return r?(0,y.jsx)(D,{$theme:V,children:(0,y.jsx)(O,{$orientation:G,$inset:Q,children:Z.length===0?(0,y.jsx)(P,{$theme:V,children:`No party units found.`}):(0,y.jsx)(ae,{$scaledWidth:$.scaledWidth,$scaledHeight:$.scaledHeight,children:(0,y.jsx)(k,{$contentWidth:$.contentWidth,$contentHeight:$.contentHeight,$scale:$.scale,children:(0,y.jsx)(oe,{$orientation:G,children:Z.map(e=>{let n=H(e),r=e.metadata?.[a.PORTRAIT_URL]||``,i=(t(e)?e.image.url:void 0)||`/logo.png`,o=r||i,s=e.metadata?.[`${g}/${be}`],c=e.metadata?.[`${g}/${xe}`],l=L(s),u=L(c),d=l!==null&&u!==null&&u>0?F(l/u*100,0,100):0,f=e.id===Se;return(0,y.jsxs)(se,{$theme:V,$orientation:G,children:[(0,y.jsx)(le,{$orientation:G,children:(0,y.jsx)(ue,{src:o,alt:n,$theme:V,$orientation:G})}),f&&(0,y.jsx)(ce,{$theme:V}),(0,y.jsxs)(de,{$theme:V,$orientation:G,children:[(0,y.jsx)(fe,{$theme:V,title:n,children:n}),ve&&(0,y.jsx)(pe,{$theme:V,children:(0,y.jsx)(A,{$percent:d})}),ye&&(0,y.jsxs)(j,{$theme:V,children:[`HP: `,l===null?`-`:Math.trunc(l),` / `,u===null?`-`:Math.trunc(u)]}),X.length>0&&(0,y.jsx)(M,{children:X.map(t=>{let n=(t.attr_abbr||t.attr_name||t.attr_bid).trim(),r=e.metadata?.[`com.battle-system.forge/${t.attr_bid}`];return(0,y.jsxs)(N,{$theme:V,children:[n,`: `,me(r,String(t.attr_type||``))]},`${e.id}-${t.attr_bid}`)})})]})]},e.id)})})})})})}):(0,y.jsx)(D,{$theme:V})},H=e=>{let t=e.metadata?.[a.UNIT_NAME];return typeof t==`string`&&t.trim()?t.trim():typeof e.name==`string`&&e.name.trim()?e.name.trim():`Unknown`},U=V;_.createRoot(document.getElementById(`root`)).render((0,y.jsx)(v.StrictMode,{children:(0,y.jsx)(p,{children:(0,y.jsx)(U,{})})}));