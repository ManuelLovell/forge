...
export function SetupContextMenu({ children }: { children: React.ReactNode }) {
    ...
    const resolvedHpBidKeys = getConfiguredHpBidKeys(storageContainer, systemAttributes);
    const resolvedCurrentHpBid = configuredCurrentHpBid || resolvedHpBidKeys.currentHpBid;
    const resolvedMaxHpBid = configuredMaxHpBid || resolvedHpBidKeys.maxHpBid;
