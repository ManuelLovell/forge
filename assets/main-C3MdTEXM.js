...
`,ep=_(zu.div)`
  ...
  background-color: ${e=>g(e.theme.BACKGROUND,.5)};
...
`,rp=_.p`
  ...
  color: ${e=>g(e.theme.PRIMARY,.7)};
`,ip=Zf.div({flex:`1 1 0%`}),ap=_.nav`
...
`,sp=Zf.div({position:`fixed`,bottom:`0`,left:`0`,right:`0`,top:`0`,zIndex:`999`,backgroundColor:`rgba(0, 0, 0, 0.6)`}),cp=Zf.div({position:`fixed`,bottom:`2px`,left:`2px`,zIndex:`1000`,display:`flex`,height:`3rem`,width:`3rem`,alignItems:`center`,justifyContent:`center`,borderRadius:`9999px`,"--tw-backdrop-blur":`blur(8px)`,WebkitBackdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`,backdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`}),lp=_.button`
  ...
  background-color: ${e=>g(e.theme.BACKGROUND,.75)};
  border: 2px solid ${e=>e.theme.BORDER};
  color: ${e=>e.theme.PRIMARY};
`,up=({isOpen:e,currentPage:t,onToggle:n,onNavigate:r})=>{let{theme:i}=Me(),a=M(e=>e.playerData),o=String(a?.role||``).toUpperCase()===`GM`;return(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(Jc,{children:e&&(0,A.jsxs)(ep,{theme:i,initial:{x:-300},animate:{x:0},exit:{x:-300},transition:{type:`tween`,duration:.3},style:{boxShadow:`4px 0 12px rgba(0, 0, 0, 0.15)`},children:[(0,A.jsxs)(tp,{theme:i,children:[(0,A.jsx)(np,{theme:i,children:`Forge!`}),(0,A.jsx)(rp,{theme:i,children:`Alpha Testing!`})]}),(0,A.jsx)(ip,{}),(0,A.jsxs)(ap,{theme:i,children:[(0,A.jsx)(op,{theme:i,$isActive:t===`ForgeMain`,onClick:()=>r(`ForgeMain`),children:`Main`}),(0,A.jsx)(op,{theme:i,$isActive:t===`Party`,onClick:()=>r(`Party`),children:`Party`}),(0,A.jsx)(op,{theme:i,$isActive:t===`ChatLog`,onClick:()=>r(`ChatLog`),children:`System Log`}),o&&(0,A.jsx)(op,{theme:i,$isActive:t===`System`,onClick:()=>r(`System`),children:`System`}),o&&(0,A.jsx)(op,{theme:i,$isActive:t===`Settings`,onClick:()=>r(`Settings`),children:`Settings`})]})]})}),e&&(0,A.jsx)(sp,{onClick:n}),(0,A.jsx)(cp,{children:(0,A.jsx)(lp,{theme:i,onClick:n,children:(0,A.jsx)(me,{size:24})})})]})},dp=_.div`
  padding: 20px;
  color: ${e=>e.theme.PRIMARY};
  min-height: 100vh;
`,fp=_.h1`
...
`,pp=_.div`
  background-color: ${e=>g(e.theme.BACKGROUND,.3)};
  border: 2px solid ${e=>e.theme.BORDER};
  border-radius: 6px;
  padding: 20px;
  margin: 15px 0;
...
`;_.div`
  ...
  font-size: 18px;
`;const mp=_.button`
  background-color: ${e=>g(e.theme.OFFSET,e.variant===`secondary`?.5:.75)};
  color: ${e=>e.theme.PRIMARY};
  border: 2px solid ${e=>e.theme.BORDER};
  border-radius: 6px;
  padding: 8px 8px;
  ...
  &:hover {
    background-color: ${e=>g(e.theme.OFFSET,.9)};
...
`,_.p`
  ...
  margin: 10px 0;
`,_.span`
  background-color: ${e=>g(e.theme.OFFSET,.75)};
  color: ${e=>e.theme.PRIMARY};
...
`,_.li`
  ...
  &:hover {
    background-color: ${e=>g(e.theme.OFFSET,.2)};
  }
`;var gp=_.button`
  ...
  background-color: ${e=>e.$isOn?g(e.theme.OFFSET,.8):g(e.theme.BORDER,.3)};
  border: 2px solid ${e=>e.theme.BORDER};
  
  &:focus {
    outline: none;
    box-shadow: 0 0 0 3px ${e=>g(e.theme.OFFSET,.3)};
  }
...
`;const X=({label:e,isOn:t,onChange:n})=>{let{theme:r}=Me();return(0,A.jsx)(gp,{theme:r,$isOn:t,onClick:()=>{let r=!t;E.log(`${e}: ${r}`),n(r)},role:`switch`,"aria-checked":t,"aria-label":e})};var _p=_.h2`
...
`,Sp=Zf.div({marginTop:`0.5rem`,display:`flex`,justifyContent:`center`,gap:`0.75rem`});const Cp=()=>{let{theme:e}=Me();M(e=>e.roomMetadata);let t=M(e=>e.sceneMetadata),n=M(e=>e.items),r=M(e=>e.cacheReady),[i,o]=(0,k.useState)(!1),[s,c]=(0,k.useState)(!1),[l,u]=(0,k.useState)(`D20`),[d,m]=(0,k.useState)(!1),[h,g]=(0,k.useState)(!1),[_,v]=(0,k.useState)(!1),[y,b]=(0,k.useState)(!1),[x,S]=(0,k.useState)(!1),[C,w]=(0,k.useState)(`bottom`),[T,ee]=(0,k.useState)(!1),[te,D]=(0,k.useState)(!1),[re,ie]=(0,k.useState)(!1),[ae,oe]=(0,k.useState)(!1),[se,ce]=(0,k.useState)(!1),[le,ue]=(0,k.useState)(!1),[fe,pe]=(0,k.useState)(!1),[me,ge]=(0,k.useState)(!1),[_e,O]=(0,k.useState)(!1),[ve,ye]=(0,k.useState)(!1),[be,xe]=(0,k.useState)(``),[Se,Ce]=(0,k.useState)(!1),we=(0,k.useRef)(null),j=t;(0,k.useEffect)(()=>{if(r)if(j[p.POPCORN_INITIATIVE]!==void 0&&o(j[p.POPCORN_INITIATIVE]),j[p.REVERSE_INITIATIVE]!==void 0&&c(j[p.REVERSE_INITIATIVE]),j[p.DICE_RANGE]!==void 0&&u(j[p.DICE_RANGE]),j[p.SHOW_CARD_ACCESS]!==void 0&&m(j[p.SHOW_CARD_ACCESS]),j[p.SHOW_PLAYER_VIEW]!==void 0&&g(j[p.SHOW_PLAYER_VIEW]),j[p.SHOW_OWNER_ONLY_EDIT]!==void 0&&b(j[p.SHOW_OWNER_ONLY_EDIT]),j[p.SHOW_NON_PARTY_UNITS]!==void 0&&v(j[p.SHOW_NON_PARTY_UNITS]),j[p.SHOW_HP_BARS]!==void 0&&S(j[p.SHOW_HP_BARS]),j[p.HP_BAR_ORIENTATION]!==void 0&&w(j[p.HP_BAR_ORIENTATION]),j[p.SHOW_HP_NUMBERS]!==void 0&&ee(j[p.SHOW_HP_NUMBERS]),j[p.SHOW_NAMES]!==void 0&&D(j[p.SHOW_NAMES]),j[p.SHOW_TURN_EFFECT]!==void 0&&ie(j[p.SHOW_TURN_EFFECT]),j[p.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&oe(j[p.USE_DESCRIPTIVE_DUPLICATES]),j[p.ENABLE_RUMBLE]!==void 0&&ce(j[p.ENABLE_RUMBLE]),j[p.ENABLE_BONES]!==void 0&&ue(j[p.ENABLE_BONES]),j[p.ENABLE_DICE_PLUS]!==void 0&&pe(j[p.ENABLE_DICE_PLUS]),j[p.ENABLE_OBR_NOTIFICATION]!==void 0&&ge(j[p.ENABLE_OBR_NOTIFICATION]),j[p.SHOW_NOTIFICATION_TO_ALL]!==void 0&&O(j[p.SHOW_NOTIFICATION_TO_ALL]),j[p.ENABLE_DISCORD_LOGGING]!==void 0&&ye(j[p.ENABLE_DISCORD_LOGGING]),j[p.DISCORD_URL]!==void 0&&xe(j[p.DISCORD_URL]),j[p.ENABLE_CONSOLE_LOG]!==void 0){let e=j[p.ENABLE_CONSOLE_LOG];Ce(e),E.setEnabled(e)}else Ce(!1)},[r,j]);let N=async(e,t)=>{await a.scene.setMetadata({[e]:t})};return(0,A.jsx)(zu.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},children:(0,A.jsxs)(dp,{theme:e,children:[(0,A.jsx)(fp,{theme:e,children:`Settings`}),(0,A.jsxs)(pp,{theme:e,children:[(0,A.jsx)(_p,{theme:e,children:`Collection Management`}),(0,A.jsxs)(Sp,{children:[(0,A.jsx)(mp,{theme:e,onClick:async()=>{try{let e=await ne(),t=JSON.stringify(e,null,2),n=new Blob([t],{type:`text/plain;charset=utf-8`}),r=URL.createObjectURL(n),i=document.createElement(`a`);i.href=r,i.download=`forge-collection-${new Date().toISOString().slice(0,10)}.txt`,i.click(),URL.revokeObjectURL(r),alert(`Collection export complete. ${e.length} record(s) written.`)}catch(e){E.log(`Collection export failed`,e),alert(`Collection export failed. See console log for details.`)}},children:`Export`}),(0,A.jsx)(mp,{theme:e,onClick:()=>{window.confirm(`Import will overwrite duplicate records that share the same Name and Author. Continue?`)&&we.current?.click()},children:`Import`})]}),(0,A.jsx)(`input`,{ref:we,type:`file`,accept:`.txt,.json,text/plain,application/json`,onChange:async e=>{let t=e.target.files?.[0];if(t)try{let e=await t.text(),n=JSON.parse(e);if(!Array.isArray(n)){alert(`Import file must contain a JSON array of collection records.`);return}let r=await de(n);alert(`Collection import complete. Created: ${r.created}, Updated: ${r.updated}, Skipped: ${r.skipped}.`)}catch(e){E.log(`Collection import failed`,e),alert(`Collection import failed. Ensure the file is valid JSON and try again.`)}finally{e.target.value=``}},style:{display:`none`}})]}),(0,A.jsxs)(pp,{theme:e,children:[(0,A.jsx)(_p,{theme:e,children:`List Controls`}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Reverse Initiative`}),(0,A.jsx)(X,{label:`Reverse Initiative`,isOn:s,onChange:async e=>{c(e),await N(p.REVERSE_INITIATIVE,e),e&&i&&(o(!1),await N(p.POPCORN_INITIATIVE,!1))}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Popcorn Initiative`}),(0,A.jsx)(X,{label:`Popcorn Initiative`,isOn:i,onChange:async e=>{o(e),await N(p.POPCORN_INITIATIVE,e),e&&s&&(c(!1),await N(p.REVERSE_INITIATIVE,!1))}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Initiative Die: `}),(0,A.jsx)(bp,{theme:e,type:`text`,value:l,onChange:async e=>{let t=e.target.value;u(t),await N(p.DICE_RANGE,t),E.log(`Dice Range:`,t)},placeholder:`D20`,maxLength:3})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Show Card Column`}),(0,A.jsx)(X,{label:`Show Stat Block Access`,isOn:d,onChange:async e=>{m(e),await N(p.SHOW_CARD_ACCESS,e)}})]})]}),(0,A.jsxs)(pp,{theme:e,children:[(0,A.jsx)(_p,{theme:e,children:`Player Controls`}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Show Player View`}),(0,A.jsx)(X,{label:`Show Player View`,isOn:h,onChange:async e=>{g(e),await N(p.SHOW_PLAYER_VIEW,e)}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Show Non-Party Units`}),(0,A.jsx)(X,{label:`Show Non-Party Units`,isOn:_,onChange:async e=>{v(e),await N(p.SHOW_NON_PARTY_UNITS,e)}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`GM/Owner Only Edit`}),(0,A.jsx)(X,{label:`Owner Only Edit`,isOn:y,onChange:async e=>{b(e),await N(p.SHOW_OWNER_ONLY_EDIT,e)}})]})]}),(0,A.jsxs)(pp,{theme:e,children:[(0,A.jsx)(_p,{theme:e,children:`Game Controls`}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Show HP Bars on tokens`}),(0,A.jsx)(X,{label:`Show HP Bars on tokens`,isOn:x,onChange:async e=>{S(e),await N(p.SHOW_HP_BARS,e),e&&T&&(ee(!1),await N(p.SHOW_HP_NUMBERS,!1)),e&&j[p.HP_BAR_ORIENTATION]===void 0&&(w(`bottom`),await N(p.HP_BAR_ORIENTATION,`bottom`))}})]}),(x||T)&&(0,A.jsxs)(vp,{theme:e,children:[(0,A.jsx)(yp,{theme:e,children:`Orientation: `}),(0,A.jsxs)(xp,{theme:e,value:C,onChange:async e=>{let t=e.target.value;w(t),await N(p.HP_BAR_ORIENTATION,t)},children:[(0,A.jsx)(`option`,{value:`top`,children:`Top`}),(0,A.jsx)(`option`,{value:`bottom`,children:`Bottom`}),(0,A.jsx)(`option`,{value:`left`,children:`Left`}),(0,A.jsx)(`option`,{value:`right`,children:`Right`})]})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Show HP Numbers on tokens`}),(0,A.jsx)(X,{label:`Show HP Numbers on tokens`,isOn:T,onChange:async e=>{ee(e),await N(p.SHOW_HP_NUMBERS,e),e&&x&&(S(!1),await N(p.SHOW_HP_BARS,!1)),e&&j[p.HP_BAR_ORIENTATION]===void 0&&(w(`bottom`),await N(p.HP_BAR_ORIENTATION,`bottom`))}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Show Names on Tokens`}),(0,A.jsx)(X,{label:`Show names on tokens`,isOn:te,onChange:async e=>{D(e),await N(p.SHOW_NAMES,e);let t=n.filter(e=>e.metadata[f.ON_LIST]===!0);e?(E.log(`Showing names on tokens`),await a.scene.items.updateItems(t,e=>{for(let t of e){let e=t.metadata[f.UNIT_NAME],n=t;e&&n.text&&(n.text.plainText=String(e))}})):(E.log(`Hiding names on tokens`),await a.scene.items.updateItems(t,e=>{for(let t of e){let e=t;e.text&&(e.text.plainText=``)}}))}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Show Turn Effect`}),(0,A.jsx)(X,{label:`Show Turn Effect`,isOn:re,onChange:async e=>{ie(e),await N(p.SHOW_TURN_EFFECT,e)}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Use Descriptive Names`}),(0,A.jsx)(X,{label:`Use Descriptive Duplicates Names`,isOn:ae,onChange:async e=>{oe(e),await N(p.USE_DESCRIPTIVE_DUPLICATES,e)}})]})]}),(0,A.jsxs)(pp,{theme:e,children:[(0,A.jsx)(_p,{theme:e,children:`Dice Controls`}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Enable Rumble! Integration`}),(0,A.jsx)(X,{label:`Enable Rumble! Integration`,isOn:se,onChange:async e=>{ce(e),await N(p.ENABLE_RUMBLE,e),e&&(ue(!1),pe(!1),await N(p.ENABLE_BONES,!1),await N(p.ENABLE_DICE_PLUS,!1))}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Enable Bones! Integration`}),(0,A.jsx)(X,{label:`Enable Bones! Integration`,isOn:le,onChange:async e=>{ue(e),await N(p.ENABLE_BONES,e),e&&(ce(!1),pe(!1),await N(p.ENABLE_RUMBLE,!1),await N(p.ENABLE_DICE_PLUS,!1))}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Enable Dice+ Integration`}),(0,A.jsx)(X,{label:`Enable Dice+ Integration`,isOn:fe,onChange:async e=>{pe(e),await N(p.ENABLE_DICE_PLUS,e),e&&(ce(!1),ue(!1),await N(p.ENABLE_RUMBLE,!1),await N(p.ENABLE_BONES,!1))}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Enable OBR Notification`}),(0,A.jsx)(X,{label:`Enable OBR Notification`,isOn:me,onChange:async e=>{ge(e),await N(p.ENABLE_OBR_NOTIFICATION,e)}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Show Results to All`}),(0,A.jsx)(X,{label:`Show Results to All`,isOn:_e,onChange:async e=>{O(e),await N(p.SHOW_NOTIFICATION_TO_ALL,e)}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Enable Discord Logging`}),(0,A.jsx)(X,{label:`Enable Discord Logging`,isOn:ve,onChange:async e=>{if(e&&!he(be.trim())){alert(`Please enter a valid Discord webhook URL before enabling Discord logging.`),ye(!1),await N(p.ENABLE_DISCORD_LOGGING,!1);return}ye(e),await N(p.ENABLE_DISCORD_LOGGING,e)}})]}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(yp,{theme:e,children:`Discord Url: `}),(0,A.jsx)(bp,{theme:e,type:`text`,value:be,onChange:async e=>{let t=e.target.value,n=t.trim();xe(t),await N(p.DISCORD_URL,n),E.log(`Discord URL:`,n)},placeholder:`https://discord.com/api/webhooks/...`,maxLength:200})]})]}),(0,A.jsxs)(pp,{theme:e,children:[(0,A.jsx)(_p,{theme:e,children:`Other`}),(0,A.jsxs)(Z,{theme:e,children:[(0,A.jsx)(Q,{theme:e,children:`Enable Console Log`}),(0,A.jsx)(X,{label:`Enable Console Log`,isOn:Se,onChange:async e=>{Ce(e),E.setEnabled(e),await N(p.ENABLE_CONSOLE_LOG,e)}})]})]})]})})};var wp=_.div`
...
`;const kp=()=>{let e=Te(e=>e.messages),t=(0,k.useRef)(null),{theme:n}=Me();return(0,k.useEffect)(()=>{t.current?.scrollIntoView({behavior:`smooth`})},[e]),(0,A.jsx)(zu.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,A.jsxs)(wp,{children:[(0,A.jsx)(fp,{theme:n,children:`System Log`}),(0,A.jsxs)(Tp,{children:[e.map(e=>(0,A.jsxs)(Ep,{children:[(0,A.jsx)(Dp,{children:e.timestamp}),(0,A.jsx)(Op,{children:e.text})]},e.id)),(0,A.jsx)(`div`,{ref:t})]})]})})};var Ap=_.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`;const Fp=({isOpen:e,title:t,onClose:n,children:r,actions:i,closeOnOverlayClick:a=!0,minWidth:o,maxWidth:s})=>{let{theme:c}=Me();return e?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(Ap,{onClick:a?n:void 0}),(0,A.jsxs)(jp,{theme:c,$minWidth:o,$maxWidth:s,onClick:e=>e.stopPropagation(),children:[t&&(0,A.jsx)(Mp,{theme:c,children:t}),(0,A.jsx)(Np,{children:r}),i&&(0,A.jsx)(Pp,{children:i})]})]}):null},Ip=`buff_effect_one`,Lp=`debuff_effect_one`,Rp=[{value:`buff_effect_one`,label:`Buff Effect One`},{value:`buff_effect_two`,label:`Buff Effect Two`}],zp=[{value:`debuff_effect_one`,label:`Debuff Effect One`},{value:`debuff_effect_two`,label:`Debuff Effect Two`}],Bp=e=>Rp.some(t=>t.value===e),Vp=e=>zp.some(t=>t.value===e),Hp=e=>{switch(e){case`buff_effect_two`:return`
uniform float2 size;
uniform float time;
...
`}};var Wp=w.EXTENSIONID,Gp=`com.battle-system.forge`;const $={CURRENT_THEME:`${Wp}/CurrentTheme`,CURRENT_CARD:`${Wp}/CurrentCard`,CURRENT_LIST:`${Wp}/CurrentList`,CURRENT_ATTR:`${Wp}/CurrentAttr`,SYSTEM_NAME:`${Wp}/SystemName`,IMPORT_DATE:`${Wp}/ImportDate`};var Kp=(e,t)=>e instanceof Error&&e.message?e.message:t,qp=(e,t)=>{if(Array.isArray(e))return e;if(typeof e==`string`){let n;try{n=JSON.parse(e)}catch{throw Error(`Imported ${t} is not valid JSON`)}if(!Array.isArray(n))throw Error(`Imported ${t} is not a JSON array`);return n}throw Error(`Imported ${t} has invalid type`)},Jp=_.div`
  display: flex;
  gap: 10px;
  margin-bottom: 20px;
`,Yp=_.div`
...
`,gm=_.div`
  ...
  gap: 8px;
`,_m=_.button`
  background-color: ${e=>e.$variant===`danger`?g(`#FF0000`,.2):g(e.theme.OFFSET,.5)};
  ...
  &:hover {
    background-color: ${e=>e.$variant===`danger`?g(`#FF0000`,.3):e.theme.OFFSET};
  }
...
`,vm={initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20}};const ym=()=>{let{theme:e,updateThemeFromSystem:t}=Me(),n=M(e=>e.sceneMetadata),[r,i]=(0,k.useState)(``),[o,s]=(0,k.useState)(!1),[c,l]=(0,k.useState)(null),[u,d]=(0,k.useState)(null),[f,m]=(0,k.useState)(``),[h,_]=(0,k.useState)(null),[v,y]=(0,k.useState)(null),[b,x]=(0,k.useState)([]),[C,w]=(0,k.useState)(``),[T,ee]=(0,k.useState)(``),[te,ne]=(0,k.useState)(Ip),[D,re]=(0,k.useState)(Lp),[ie,ae]=(0,k.useState)([]),[se,le]=(0,k.useState)(!1),[ue,de]=(0,k.useState)(null),[fe,pe]=(0,k.useState)(``);(0,k.useEffect)(()=>{me(),_e()},[n]),(0,k.useEffect)(()=>{me(),_e()},[n]);let me=()=>{try{let e=n[$.CURRENT_THEME],t=n[$.CURRENT_ATTR],r=n[$.SYSTEM_NAME]||S.name,i=n[$.IMPORT_DATE]||null,a=n[p.HP_CURRENT_BID],o=n[p.HP_MAX_BID],s=n[p.BUFF_VISUAL_PRESET],c=n[p.DEBUFF_VISUAL_PRESET],l=Array.isArray(t)?t:[];m(r),_(i),y(e||null),x(l),w(a||``),ee(o||``),ne(Bp(s)?s:Ip),re(Vp(c)?c:Lp)}catch(e){E.error(`Error loading system from cache:`,e)}},he=async(e,t)=>{await a.scene.setMetadata({[e]:t})},ge=b.filter(e=>e.attr_type===`numb`),_e=()=>{try{let e=[];for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);if(n&&n.startsWith(`${Gp}.`)&&n.endsWith(`.backup`)){let t=localStorage.getItem(n);if(t){let n=JSON.parse(t);e.push(n)}}}e.sort((e,t)=>new Date(t.backupDate).getTime()-new Date(e.backupDate).getTime()),ae(e)}catch(e){E.error(`Error loading backups:`,e)}},O=async e=>{try{let e=n[$.CURRENT_THEME],t=n[$.CURRENT_CARD],r=n[$.CURRENT_LIST],i=n[$.CURRENT_ATTR],a=n[$.SYSTEM_NAME]||S.name;if(!e||!Array.isArray(t)||!Array.isArray(r)||!Array.isArray(i)){E.warn(`Cannot create backup: system data incomplete`);return}let o={name:a,backupDate:new Date().toISOString(),theme_primary:e.primary,theme_offset:e.offset,theme_background:e.background,theme_border:e.border,background_url:e.background_url,card_layout:t,list_layout:r,attributes:i},s=`${Gp}.${a}.backup`;localStorage.setItem(s,JSON.stringify(o)),E.log(`Backup created for ${a}`),_e()}catch(e){throw E.error(`Error creating backup:`,e),e}},ve=e=>{try{let t=`${Gp}.${e}.backup`;localStorage.removeItem(t),E.log(`Backup deleted for ${e}`),_e(),d(`Backup for "${e}" deleted successfully`)}catch(e){E.error(`Error deleting backup:`,e),l(`Failed to delete backup`)}},ye=(e,t)=>{pe(e),de(()=>t),le(!0)},be=async()=>{le(!1),ue&&(await ue(),de(null))},xe=()=>{le(!1),de(null),pe(``)},Se=async()=>{if(!r.trim()){l(`Please enter a share_id`);return}ye(`This will overwrite your current system data. A backup of your current system will be saved to local storage. Do you want to continue?`,async()=>{await Ce()})},Ce=async()=>{s(!0),l(null),d(null);try{let{data:e,error:n}=await ce.from(`v_bs_system_with_attributes`).select(`*`).eq(`share_id`,r).maybeSingle();if(n)throw n;if(!e){l(`No system found with that share_id`),s(!1);return}let o=e,c=qp(o.card_layout,`card_layout`),u=qp(o.list_layout,`list_layout`),p=o.attributes;if(!Array.isArray(p))throw Error(`Imported attributes are not a valid array`);await O(f);let h={primary:o.theme_primary,offset:o.theme_offset,background:o.theme_background,border:o.theme_border,background_url:o.background_url};await a.scene.setMetadata({[$.CURRENT_THEME]:h,[$.CURRENT_CARD]:c,[$.CURRENT_LIST]:u,[$.CURRENT_ATTR]:p,[$.SYSTEM_NAME]:o.name,[$.IMPORT_DATE]:new Date().toISOString()}),m(o.name),_(new Date().toISOString()),y(h),t(h.primary,h.offset,h.background,h.border,h.background_url),d(`System "${o.name}" loaded successfully! Backup created.`),i(``),E.log(`System loaded:`,o.name)}catch(e){E.error(`Error fetching system:`,e),l(Kp(e,`An error occurred while fetching the system`))}finally{s(!1)}},we=async e=>{ye(`This will restore the system "${e.name}" from backup. A backup of your current system will be created. Do you want to continue?`,async()=>{await j(e)})},j=async e=>{s(!0),l(null),d(null);try{await O(f);let n={primary:e.theme_primary,offset:e.theme_offset,background:e.theme_background,border:e.theme_border,background_url:e.background_url};if(!Array.isArray(e.card_layout)||!Array.isArray(e.list_layout)||!Array.isArray(e.attributes))throw Error(`Backup data is invalid`);await a.scene.setMetadata({[$.CURRENT_THEME]:n,[$.CURRENT_CARD]:e.card_layout,[$.CURRENT_LIST]:e.list_layout,[$.CURRENT_ATTR]:e.attributes,[$.SYSTEM_NAME]:e.name,[$.IMPORT_DATE]:new Date().toISOString()}),m(e.name),_(new Date().toISOString()),y(n),t(n.primary,n.offset,n.background,n.border,n.background_url),d(`System "${e.name}" restored from backup successfully!`),E.log(`System restored from backup:`,e.name)}catch(e){E.error(`Error restoring backup:`,e),l(`Failed to restore system from backup`)}finally{s(!1)}},N=async()=>{s(!0),l(null),d(null);try{let e={primary:S.theme_primary,offset:S.theme_offset,background:S.theme_background,border:S.theme_border,background_url:S.background_url};await a.scene.setMetadata({[$.CURRENT_THEME]:e,[$.CURRENT_CARD]:S.card_layout,[$.CURRENT_LIST]:S.list_layout,[$.CURRENT_ATTR]:S.attributes,[$.SYSTEM_NAME]:S.name,[$.IMPORT_DATE]:null}),m(S.name),_(null),y(e),t(e.primary,e.offset,e.background,e.border,e.background_url),d(`Reset to default system successfully!`)}catch(e){l(`Failed to reset to default system`),E.error(`Error resetting to default:`,e)}finally{s(!1)}},Te=e=>e?new Date(e).toLocaleDateString(`en-US`,{year:`numeric`,month:`long`,day:`numeric`,hour:`2-digit`,minute:`2-digit`}):null;return(0,A.jsxs)(zu.div,{variants:vm,initial:`initial`,animate:`animate`,exit:`exit`,children:[(0,A.jsxs)(dp,{theme:e,children:[(0,A.jsx)(fp,{theme:e,children:`System Configuration`}),(0,A.jsx)(Xp,{theme:e,children:f}),h?(0,A.jsxs)(Zp,{theme:e,children:[`Imported: `,Te(h)]}):(0,A.jsx)(Zp,{theme:e,children:`Using Default System`}),v&&(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(Qp,{children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)($p,{color:v.primary,theme:e,children:v.primary}),(0,A.jsx)(em,{theme:e,children:`PRIMARY`})]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)($p,{color:v.offset,theme:e,children:v.offset}),(0,A.jsx)(em,{theme:e,children:`OFFSET`})]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)($p,{color:v.background,theme:e,children:v.background}),(0,A.jsx)(em,{theme:e,children:`BG`})]}),(0,A.jsxs)(`div`,{children:[(0,A.jsx)($p,{color:v.border,theme:e,children:v.border}),(0,A.jsx)(em,{theme:e,children:`BORDER`})]})]}),(0,A.jsxs)(tm,{theme:e,children:[(0,A.jsx)(nm,{theme:e,children:`System Settings`}),(0,A.jsxs)(rm,{children:[(0,A.jsx)(im,{theme:e,children:`Current HP`}),(0,A.jsxs)(am,{theme:e,value:C,onChange:async e=>{let t=e.target.value;w(t),await he(p.HP_CURRENT_BID,t)},children:[(0,A.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),ge.map(e=>(0,A.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,A.jsxs)(rm,{children:[(0,A.jsx)(im,{theme:e,children:`Max HP`}),(0,A.jsxs)(am,{theme:e,value:T,onChange:async e=>{let t=e.target.value;ee(t),await he(p.HP_MAX_BID,t)},children:[(0,A.jsx)(`option`,{value:``,children:`-- Select Attribute --`}),ge.map(e=>(0,A.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,A.jsxs)(rm,{children:[(0,A.jsx)(im,{theme:e,children:`Buff Visual`}),(0,A.jsx)(am,{theme:e,value:te,onChange:async e=>{let t=e.target.value;Bp(t)&&(ne(t),await he(p.BUFF_VISUAL_PRESET,t))},children:Rp.map(e=>(0,A.jsx)(`option`,{value:e.value,children:e.label},e.value))})]}),(0,A.jsxs)(rm,{children:[(0,A.jsx)(im,{theme:e,children:`Debuff Visual`}),(0,A.jsx)(am,{theme:e,value:D,onChange:async e=>{let t=e.target.value;Vp(t)&&(re(t),await he(p.DEBUFF_VISUAL_PRESET,t))},children:zp.map(e=>(0,A.jsx)(`option`,{value:e.value,children:e.label},e.value))})]})]})]}),(0,A.jsxs)(Yp,{theme:e,children:[(0,A.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0},children:`Import New System`}),(0,A.jsx)(`p`,{style:{color:g(e.PRIMARY,.8),fontSize:`14px`},children:`Enter a share_id to download and activate a new game system configuration.`}),(0,A.jsx)(Jp,{children:(0,A.jsx)(hp,{theme:e,type:`text`,value:r,onChange:e=>i(e.target.value),placeholder:`Enter Share Id...`,disabled:o,onKeyPress:e=>e.key===`Enter`&&Se()})}),(0,A.jsxs)(cm,{children:[(0,A.jsx)(mp,{theme:e,onClick:Se,disabled:o||!r.trim(),children:o?`....!`:`Import System`}),(0,A.jsx)(mp,{theme:e,variant:`secondary`,onClick:N,disabled:o,children:`Use Default`})]})]}),c&&(0,A.jsxs)(om,{theme:e,children:[(0,A.jsx)(`strong`,{children:`Error:`}),` `,c]}),u&&(0,A.jsxs)(sm,{theme:e,children:[(0,A.jsx)(`strong`,{children:`Success:`}),` `,u]}),ie.length>0&&(0,A.jsx)(um,{children:(0,A.jsxs)(pp,{theme:e,children:[(0,A.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0,marginBottom:`15px`},children:`System Backups`}),(0,A.jsx)(dm,{children:ie.map(t=>(0,A.jsxs)(fm,{theme:e,children:[(0,A.jsxs)(pm,{children:[(0,A.jsx)(mm,{theme:e,children:t.name}),(0,A.jsxs)(hm,{theme:e,children:[`Backed up: `,Te(t.backupDate)]})]}),(0,A.jsxs)(gm,{children:[(0,A.jsx)(_m,{theme:e,onClick:()=>we(t),disabled:o,title:`Import this backup`,children:(0,A.jsx)(ad,{size:18})}),(0,A.jsx)(_m,{theme:e,$variant:`danger`,onClick:()=>ve(t.name),disabled:o,title:`Delete this backup`,children:(0,A.jsx)(oe,{size:18})})]})]},`${t.name}-${t.backupDate}`))})]})})]}),(0,A.jsx)(Fp,{isOpen:se,title:`Confirm Action`,onClose:xe,actions:(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(mp,{theme:e,variant:`secondary`,onClick:xe,children:`Cancel`}),(0,A.jsx)(mp,{theme:e,onClick:be,children:`Confirm`})]}),children:(0,A.jsx)(lm,{theme:e,children:fe})})]},`system`)},bm=()=>{let[e,t]=(0,k.useState)({theme:null,cardLayout:[],listLayout:[],attributes:[],systemName:S.name,importDate:null,isLoading:!0}),n=M(e=>e.sceneMetadata);return(0,k.useEffect)(()=>{let e=!0;(async()=>{try{let r=n[$.CURRENT_THEME],i=n[$.CURRENT_CARD],a=n[$.CURRENT_LIST],o=n[$.CURRENT_ATTR];if(!r||!Array.isArray(i)||!Array.isArray(a)||!Array.isArray(o)){E.log(`System data missing, using defaults`),e&&t({theme:{primary:S.theme_primary,offset:S.theme_offset,background:S.theme_background,border:S.theme_border,background_url:S.background_url},cardLayout:S.card_layout,listLayout:S.list_layout,attributes:S.attributes,systemName:S.name,importDate:null,isLoading:!1});return}let s=n[$.SYSTEM_NAME]||S.name,c=n[$.IMPORT_DATE]||null;e&&t({theme:r,cardLayout:i,listLayout:a,attributes:o,systemName:s,importDate:c,isLoading:!1})}catch(n){E.error(`Error loading system data:`,n),e&&t({theme:{primary:S.theme_primary,offset:S.theme_offset,background:S.theme_background,border:S.theme_border,background_url:S.background_url},cardLayout:S.card_layout,listLayout:S.list_layout,attributes:S.attributes,systemName:S.name,importDate:null,isLoading:!1})}})();let r=a.scene.onMetadataChange(n=>{let r=n[$.CURRENT_THEME],i=n[$.CURRENT_CARD],a=n[$.CURRENT_LIST],o=n[$.CURRENT_ATTR],s=n[$.SYSTEM_NAME]||S.name,c=n[$.IMPORT_DATE]||null;r&&Array.isArray(i)&&Array.isArray(a)&&Array.isArray(o)&&e&&t({theme:r,cardLayout:i,listLayout:a,attributes:o,systemName:s,importDate:c,isLoading:!1})});return()=>{e=!1,r()}},[]),e};function xm(e,t){let n=e.replace(`#`,``);n.length===3&&(n=n.split(``).map(e=>e+e).join(``));let r=parseInt(n,16);return`rgba(${r>>16&255}, ${r>>8&255}, ${r&255}, ${t})`}var Sm=class{static async CenterViewportOnImage(e){let t=await a.scene.grid.getDpi(),n=await a.viewport.getScale(),r=await a.viewport.getWidth(),i=await a.viewport.getHeight(),o={x:r/2,y:i/2},s={x:o.x/n,y:o.y/n},c=await this.GetImageCenter(e,t),l={x:c.x-s.x,y:c.y-s.y},u={x:l.x*n*-1,y:l.y*n*-1};await a.viewport.animateTo({position:u,scale:n})}static async GetImageCenter(e,t){if(T(e)){let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{x:e.position.x-a+r/2,y:e.position.y-o+i/2}}else if(r(e)&&e.points.length>0)return{x:e.points[0].x,y:e.points[0].y};else return{x:e.position.x,y:e.position.y}}};const Cm=`${O}/effects`;var wm=`${O}/effects-expired`,Tm=_.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,Em=_.div`
...
`,Pm=_.button`
  ...
  &:hover {
    background: ${e=>g(e.theme.OFFSET,.5)};
  }
`,Fm=_.div`
  display: flex;
  flex-direction: column;
...
`,Im=_.div`
  ...
  align-items: center;
  gap: 8px;
  background: ${e=>g(e.theme.BACKGROUND,.35)};
  border: 1px solid ${e=>e.theme.BORDER};
  border-radius: 6px;
  padding: 8px;
`,Lm=_.div`
...
`,Vm=_.div`
  ...
  display: inline-flex;
`,Hm=_.button`
  background: ${e=>e.$active?g(e.theme.OFFSET,.65):`rgba(0, 0, 0, 0.3)`};
  border: 1px solid ${e=>e.theme.BORDER};
  border-radius: 4px;
...
`,Um=_.span`
  ...
  font-weight: 700;
  padding: 0 3px;
`,Wm=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const Gm=({items:e,units:t,setItems:n,playerData:r})=>{let[i,o]=(0,k.useState)(null),[s,c]=(0,k.useState)(``),[l,u]=(0,k.useState)(`1`),[d,p]=(0,k.useState)(`rounds`),[m,h]=(0,k.useState)(`start`),[g,_]=(0,k.useState)(`neutral`),[v,y]=(0,k.useState)([]),[b,x]=(0,k.useState)(null),S=(0,k.useMemo)(()=>{let t=new Map;return e.forEach(e=>{e.metadata?.[f.ON_LIST]===!0&&t.set(e.id,Wm(e.metadata?.[Cm]))}),t},[e]),C=e=>S.get(e)||[],w=async(t,r)=>{let i=r.filter(e=>e.remaining>0);n(e.map(e=>{if(e.id!==t)return e;let n={...e.metadata||{}};return i.length>0?n[Cm]=i:delete n[Cm],{...e,metadata:n}})),await a.scene.items.updateItems([t],e=>{let t={...e[0].metadata||{}};i.length>0?t[Cm]=i:delete t[Cm],e[0].metadata=t})},T=async e=>{try{await a.broadcast.sendMessage(wm,{message:e},{destination:`ALL`})}catch(t){E.error(`Failed to broadcast expired effect message`,t),await a.notification.show(e,`WARNING`)}},ee=async(t,n)=>{if(String(r?.role||``).toUpperCase()!==`GM`)return;let i=[],a=[];e.forEach(e=>{if(e.metadata?.[f.ON_LIST]!==!0)return;let r=Wm(e.metadata?.[Cm]);if(r.length===0)return;let o=!1,s=[];r.forEach(r=>{if(!(r.endTiming===t&&(r.durationType===`turns`||e.id===n))){s.push(r);return}let i=r.remaining-1;if(o=!0,i<=0){a.push(`${e.name||`Unit`}: ${r.name} expired`);return}s.push({...r,remaining:i})}),o&&i.push({unitId:e.id,effects:s})});for(let e of i)await w(e.unitId,e.effects);if(a.length>0)for(let e of a)await T(e)},te=(0,k.useMemo)(()=>i&&t.find(e=>e.id===i)||null,[i,t]),ne=(0,k.useMemo)(()=>i?C(i):[],[i,S]);return(0,k.useEffect)(()=>{let e=a.broadcast.onMessage(wm,async e=>{let t=e.data?.message;typeof t!=`string`||!t.trim()||await a.notification.show(t,`WARNING`)});return()=>{e()}},[]),{effectsModalUnitId:i,selectedEffectsUnit:te,activeEffectsForSelectedUnit:ne,effectNameInput:s,setEffectNameInput:c,effectDurationInput:l,setEffectDurationInput:u,effectDurationType:d,setEffectDurationType:p,effectEndTiming:m,setEffectEndTiming:h,effectType:g,setEffectType:_,effectTargetIds:v,setEffectTargetIds:e=>{y(Array.from(new Set(e)))},effectsModalError:b,units:t,getEffectsForUnit:C,handleOpenEffectsModal:e=>{x(null),c(``),u(`1`),p(`rounds`),h(`start`),_(`neutral`),y([e]),o(e)},handleCloseEffectsModal:()=>{o(null),x(null)},handleAddEffect:async()=>{if(!i)return;let n=s.trim(),r=parseInt(l,10);if(!n){x(`Enter an effect name.`);return}if(!Number.isFinite(r)||r<=0){x(`Duration must be a positive number.`);return}let a=Array.from(new Set(v.filter(e=>t.some(t=>t.id===e))));if(a.length===0){x(`Select at least one target.`);return}let o=C(i),f=te?.name||e.find(e=>e.id===i)?.name||`Unknown`,p={id:crypto.randomUUID(),name:n,remaining:r,durationType:d,endTiming:m,effectType:g,targets:a,createdByName:f,createdById:i};await w(i,[...o,p]),x(null),c(``),u(`1`),_(`neutral`),y([i])},handleDeleteEffect:async e=>{i&&await w(i,C(i).filter(t=>t.id!==e))},processEffectsForTurnEvent:ee}},Km=({manager:e})=>{let{theme:t}=Me(),n=(0,k.useMemo)(()=>{let t=new Map;return e.units.forEach(e=>{t.set(e.id,e.name)}),t},[e.units]),r=e=>e===`buff`?`Buff`:e===`debuff`?`Debuff`:`Neutral`,i=e=>{if(e.length===0)return`No targets`;let t=e.map(e=>n.get(e)).filter(e=>typeof e==`string`&&e.length>0);return t.length===0?`${e.length} target${e.length===1?``:`s`}`:t.length<=2?t.join(`, `):`${t.slice(0,2).join(`, `)} +${t.length-2}`};return(0,A.jsx)(Fp,{isOpen:!!e.effectsModalUnitId,title:e.selectedEffectsUnit?`Effects: ${e.selectedEffectsUnit.name}`:`Effects`,onClose:e.handleCloseEffectsModal,minWidth:`520px`,maxWidth:`600px`,children:(0,A.jsxs)(Tm,{children:[(0,A.jsxs)(Em,{children:[(0,A.jsxs)(Dm,{children:[(0,A.jsxs)(Om,{style:{flex:`0 0 120px`},children:[(0,A.jsx)(Am,{theme:t,children:`Effect`}),(0,A.jsx)(jm,{theme:t,type:`text`,placeholder:`Name`,value:e.effectNameInput,onChange:t=>e.setEffectNameInput(t.target.value)})]}),(0,A.jsxs)(Om,{style:{flex:`0 0 140px`},children:[(0,A.jsx)(Am,{theme:t,children:`Duration`}),(0,A.jsx)(jm,{theme:t,type:`number`,min:1,value:e.effectDurationInput,onChange:t=>e.setEffectDurationInput(t.target.value)})]}),(0,A.jsxs)(Om,{style:{flex:`0 0 120px`},children:[(0,A.jsx)(Am,{theme:t,children:`By`}),(0,A.jsxs)(Mm,{theme:t,value:e.effectDurationType,onChange:t=>e.setEffectDurationType(t.target.value),children:[(0,A.jsx)(`option`,{value:`turns`,children:`Turns`}),(0,A.jsx)(`option`,{value:`rounds`,children:`Rounds`})]})]})]}),(0,A.jsxs)(Dm,{children:[(0,A.jsxs)(Om,{style:{flex:`0 0 120px`},children:[(0,A.jsx)(Am,{theme:t,children:`Type`}),(0,A.jsxs)(Mm,{theme:t,value:e.effectType,onChange:t=>e.setEffectType(t.target.value),children:[(0,A.jsx)(`option`,{value:`neutral`,children:`Neutral`}),(0,A.jsx)(`option`,{value:`buff`,children:`Buff`}),(0,A.jsx)(`option`,{value:`debuff`,children:`Debuff`})]})]}),(0,A.jsxs)(Om,{style:{flex:`0 0 140px`},children:[(0,A.jsx)(Am,{theme:t,children:`Ends at`}),(0,A.jsxs)(Mm,{theme:t,value:e.effectEndTiming,onChange:t=>e.setEffectEndTiming(t.target.value),children:[(0,A.jsx)(`option`,{value:`start`,children:`Start of turn`}),(0,A.jsx)(`option`,{value:`end`,children:`End of turn`})]})]}),(0,A.jsx)(km,{children:(0,A.jsx)(Pm,{theme:t,onClick:e.handleAddEffect,style:{width:`100%`},children:`Add`})})]})]}),(0,A.jsxs)(Om,{children:[(0,A.jsx)(Am,{theme:t,children:`Targets`}),(0,A.jsx)(Nm,{theme:t,multiple:!0,value:e.effectTargetIds,onChange:t=>{let n=Array.from(t.target.selectedOptions).map(e=>e.value);e.setEffectTargetIds(n)},children:e.units.map(e=>(0,A.jsx)(`option`,{value:e.id,children:e.name},e.id))})]}),e.effectsModalError&&(0,A.jsx)(Bm,{theme:t,children:e.effectsModalError}),e.activeEffectsForSelectedUnit.length===0?(0,A.jsx)(zm,{theme:t,children:`No active effects.`}):(0,A.jsx)(Fm,{children:e.activeEffectsForSelectedUnit.map(n=>(0,A.jsxs)(Im,{theme:t,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(Rm,{theme:t,children:n.name}),(0,A.jsxs)(Lm,{theme:t,children:[r(n.effectType),` • `,n.remaining,` `,n.durationType,` • ends at `,n.endTiming===`start`?`start of turn`:`end of turn`,` • by `,n.createdByName]}),(0,A.jsxs)(Lm,{theme:t,children:[`Targets: `,i(n.targets)]})]}),(0,A.jsx)(Pm,{theme:t,onClick:()=>{e.handleDeleteEffect(n.id)},children:`Delete`})]},n.id))})]})})},qm=({activeEffectsCount:e,canInteract:t,onOpen:n,icon:r})=>{let{theme:i}=Me();return(0,A.jsxs)(Vm,{children:[(0,A.jsx)(Hm,{theme:i,$active:e>0,disabled:!t,onClick:()=>{t&&n()},children:r||(0,A.jsx)(rd,{})}),e>0&&(0,A.jsx)(Um,{theme:i,children:e>99?`99+`:e})]})};var Jm=_.td`
  color: ${e=>e.theme.PRIMARY};
  padding: 2px 6px;
  text-align: center;
  font-size: 14px;
...
`;const Xm=({theme:e,unit:t,canInteract:n,elevationDraftValue:r,onElevationDraftChange:i,onCommitElevationChange:a})=>(0,A.jsx)(Jm,{theme:e,children:(0,A.jsx)(Ym,{theme:e,type:`text`,inputMode:`decimal`,min:-999,max:999,step:1,value:r??String(t.elevation??0),readOnly:!n,onChange:n?e=>i(t.id,e.target.value):void 0,onBlur:n?e=>a(t.id,e.target.value):void 0,onKeyDown:e=>{n&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}})}),Zm=({theme:e,canInteract:t,icon:n,activeEffectsCount:r,onOpen:i})=>(0,A.jsx)(Jm,{theme:e,children:(0,A.jsx)(qm,{activeEffectsCount:r,canInteract:t,icon:n||(0,A.jsx)(rd,{}),onOpen:i})});var Qm=`${O}/elevation-badge`,$m=`${O}/elevation-badge-owner`,eh=`${O}/elevation`,th=(e,t)=>{if(!e)return;if(e.startsWith(`#`))return xm(e,t);let n=e.match(/^rgba\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([\d.]+)\)$/i);if(n){let[,e,r,i]=n;return`rgba(${e}, ${r}, ${i}, ${t})`}let r=e.match(/^rgb\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\)$/i);if(r){let[,e,n,i]=r;return`rgba(${e}, ${n}, ${i}, ${t})`}return e},nh={heart:Zu,shield:td,sun:rd,award:Hu,target:id,users:od,star:nd,zap:sd,clock:qu,eye:Ju,layers:Qu,music:$u,feather:Yu,book:Uu},rh=_.div`
  padding: 2px;
  width: 100%;
`,ih=_.h1`
  color: ${e=>e.theme.PRIMARY};
...
`,sh=_.div`
  ...
  gap: 16px;
`,ch=_.button`
  background: ${e=>e.disabled?g(e.theme.BORDER,.3):g(e.theme.OFFSET,.5)};
  border: 2px solid ${e=>e.theme.BORDER};
  border-radius: 6px;
  color: ${e=>e.theme.PRIMARY};
  padding: 4px 4px;
  ...
  &:hover {
    background: ${e=>e.disabled?g(e.theme.BORDER,.3):e.theme.OFFSET};
  }
...
`,dh=_.table`
  ...
  overflow: hidden;
`,fh=_.thead`
  background-color: ${e=>g(e.theme.BACKGROUND,.35)};
`,ph=_.tr``,mh=_.th`
...
`,hh=_.tbody``,gh=_.tr`
  ${e=>e.$isCurrentTurn&&e.theme&&`
    background: linear-gradient(to left, ${g(e.theme.OFFSET,.4)} 0%, transparent 100%);
  `}
  cursor: context-menu;
...
`,Ch=_.input`
  background: ${e=>e.$isRollable?g(e.theme.OFFSET,.3):`rgba(0, 0, 0, 0.3)`};
  border: 1px solid ${e=>e.$isRollable?g(e.theme.OFFSET,.8):e.theme.BORDER};
  border-radius: 4px;
  color: ${e=>e.theme.PRIMARY};
  padding: 2px 4px;
  font-size: 18px;
...
`,wh=_(_h)`
  ...
  text-shadow: ${e=>e.$outlineColor?`
      ...
      `:`none`};
`,Th=_.input`
  background: ${e=>e.$isRollable?g(e.theme.OFFSET,.3):`rgba(0, 0, 0, 0.4)`};
  border: 1px solid ${e=>e.$isRollable?g(e.theme.OFFSET,.8):e.theme.BORDER};
  border-radius: 4px;
  color: ${e=>e.theme.PRIMARY};
  padding: 2px 4px;
...
`,Ah=_(_h)`
  ...
  &::before {
    ...
    width: 2px;
    background: ${e=>{switch(e.$style){case`dashed`:return`repeating-linear-gradient(to bottom, ${e.theme.BORDER} 0, ${e.theme.BORDER} 5px, transparent 5px, transparent 10px)`;case`shadow`:return`none`;case`zigzag`:return`none`;case`ridge`:return`none`;case`pulse`:return e.theme.OFFSET;default:return e.theme.BORDER}}};
    ${e=>e.$style===`shadow`&&`box-shadow: 0 0 10px ${e.theme.OFFSET};`}
    ${e=>e.$style===`pulse`&&`animation: pulse 2s ease-in-out infinite;`}
  }
...
`,Mh=_.button`
  width: 100%;
  text-align: left;
  background: ${e=>e.$isCurrent?g(e.theme.OFFSET,.45):g(e.theme.BACKGROUND,.35)};
  border: 1px solid ${e=>e.theme.BORDER};
  border-radius: 6px;
  color: ${e=>e.theme.PRIMARY};
  padding: 8px 10px;
  ...
  &:hover {
    background: ${e=>g(e.theme.OFFSET,.55)};
  }
`,Nh=_.p`
  color: ${e=>g(e.theme.PRIMARY,.8)};
  margin: 0 0 12px 0;
...
`,Fh=_.div`
  height: 1px;
  margin: 12px 0;
  background: ${e=>g(e.theme.BORDER,.7)};
`,Ih=_.div`
  display: flex;
  align-items: center;
  justify-content: space-between;
...
`,zh=_.button`
  ...
  border-radius: 6px;
  color: ${e=>e.theme.PRIMARY};
  background: ${e=>e.$active?g(e.theme.OFFSET,.55):g(e.theme.BACKGROUND,.45)};
  cursor: pointer;
  font-size: 12px;
  font-weight: 700;

  &:hover {
    background: ${e=>e.$active?g(e.theme.OFFSET,.7):g(e.theme.OFFSET,.45)};
  }
...
`,Jh=_.div`
  ...
  margin-top: 6px;
`,Yh=_.button`
  border: 1px solid ${e=>g(e.theme.OFFSET,.7)};
  border-radius: 999px;
  background: ${e=>g(e.theme.OFFSET,.35)};
  color: ${e=>e.theme.PRIMARY};
  font-size: 11px;
  padding: 2px 8px;
  cursor: pointer;
...
`,Xh=_.p`
  ...
  margin: 0;
  font-size: 13px;
`,Zh=(e,t,n)=>{let r=[{id:crypto.randomUUID(),type:`initiative`},...t?[{id:`roller-column`,type:`roller`}]:[],{id:crypto.randomUUID(),type:`name`}],i=n?[{id:`card-column`,type:`card-column`}]:[];if(!e||e.length===0)return[...r,...i];let a=[...e].sort((e,t)=>e.col-t.col).map(e=>({id:e.id,type:e.type,name:e.styles?.labelName,useIcon:e.styles?.labelMode===`icon`,iconType:e.styles?.labelIcon,description:e.styles?.description,styles:e.styles}));return[...r,...a,...i]};const Qh=()=>{let{theme:e}=Me(),{listLayout:t,attributes:n,isLoading:r}=bm();M(e=>e.roomMetadata);let i=M(e=>e.sceneMetadata),o=M(e=>e.items),s=M(e=>e.partyData),c=M(e=>e.playerData),l=M(e=>e.gridDpi),u=M(e=>e.setItems),[d,m]=(0,k.useState)([]),[h,g]=(0,k.useState)([]),[_,v]=(0,k.useState)(null),[y,b]=(0,k.useState)(1),[x,S]=(0,k.useState)(new Set),[C,te]=(0,k.useState)(null),[ne,D]=(0,k.useState)(null),[re,ae]=(0,k.useState)(!1),[oe,se]=(0,k.useState)(!1),[ce,le]=(0,k.useState)({}),[ue,de]=(0,k.useState)({}),[fe,me]=(0,k.useState)(null),[he,ge]=(0,k.useState)({}),[_e,ve]=(0,k.useState)(!1),[ye,be]=(0,k.useState)(!1),[xe,Se]=(0,k.useState)(()=>window.innerWidth<400),Ce=(0,k.useRef)({}),we=(0,k.useRef)({}),j=(0,k.useRef)(null);(0,k.useEffect)(()=>{let e=()=>{Se(window.innerWidth<400)};return window.addEventListener(`resize`,e),()=>{window.removeEventListener(`resize`,e)}},[]);let N=i,Te=N[p.REVERSE_INITIATIVE]||!1,Ee=N[p.POPCORN_INITIATIVE]||!1,De=N[p.SHOW_ROLLER_COLUMN]||!1,Oe=N[p.SHOW_CARD_ACCESS]||!1,ke=N[p.DICE_RANGE]||``,Ae=N[p.SHOW_OWNER_ONLY_EDIT]||!1,je=String(c?.role||``).toUpperCase()===`GM`,Ne=async({notation:e,actionName:t,tokenName:n,senderId:r,senderColor:i})=>{try{await ie({notation:e,actionName:t,senderName:n,senderId:r,senderColor:i},N)}catch(t){E.error(`Failed to send dice roll from InitiativeList`,e,t),E.log(e)}},Pe=e=>{let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return[]}return Array.isArray(t)?t.map((e,t)=>{let n=e&&typeof e==`object`?e:{},r=n.inUse,i=typeof r==`boolean`?r:typeof r==`string`?[`true`,`1`,`yes`].includes(r.trim().toLowerCase()):typeof r==`number`?r===1:void 0;return{id:typeof n.id==`string`&&n.id?n.id:`entry-${t}`,name:typeof n.name==`string`?n.name:``,description:typeof n.description==`string`?n.description:``,...i===void 0?{}:{inUse:i}}}):[]};(0,k.useEffect)(()=>{m(o.filter(e=>e.metadata?.[f.ON_LIST]===!0).map(e=>{let t=e.metadata?.[f.INITIATIVE]||0,n=e.metadata[f.UNIT_NAME]||e.name||`Unknown`,r=e.metadata?.[eh]||0,i=s.find(t=>t.id===e.createdUserId)||(c?.id===e.createdUserId?c:void 0),a=String(i?.role||``).toUpperCase()===`GM`,o=i?.color||(c?.id===e.createdUserId?c?.color:void 0),l=a?void 0:th(o,1),u={};return Object.keys(e.metadata||{}).forEach(t=>{t.startsWith(`com.battle-system.forge`)&&(u[t]=e.metadata?.[t])}),{id:e.id,initiative:t,name:n,elevation:r,attributes:u,createdUserId:e.createdUserId,ownerNameOutlineColor:l}}))},[o,s,c]);let P=(0,k.useMemo)(()=>Ee?[...d].sort((e,t)=>e.name.localeCompare(t.name)):[...d].sort((e,t)=>e.initiative===t.initiative?e.name.localeCompare(t.name):Te?e.initiative-t.initiative:t.initiative-e.initiative),[d,Te,Ee]),Fe=Gm({items:o,units:P,setItems:u,playerData:c}),Ie=(0,k.useMemo)(()=>{let e=new Map;return s.forEach(t=>{e.set(t.id,t)}),c&&!e.has(c.id)&&e.set(c.id,c),Array.from(e.values()).sort((e,t)=>e.name.localeCompare(t.name))},[s,c]),Le=(e,t)=>{let n=parseInt(t)||0;m(t=>t.map(t=>t.id===e?{...t,initiative:n}:t))},Re=(e,t)=>{u(o.map(n=>n.id===e?{...n,metadata:{...n.metadata,[f.INITIATIVE]:t}}:n)),a.scene.items.updateItems([e],e=>{e[0].metadata[f.INITIATIVE]=t})},ze=e=>{let t=(e||``).trim().match(/(\d+)/),n=t?parseInt(t[1],10):NaN;return Number.isFinite(n)&&n>0?n:20},Be=(e,t,n)=>(typeof t==`number`&&(e=Math.max(t,e)),typeof n==`number`&&(e=Math.min(n,e)),e),Ve=(e,t,n)=>{let r=e.trim(),{min:i,max:a}=n||{};if(r.length===0)return Be(0,i,a);let o=r.match(/^([+\-*/])\s*(-?\d+(?:\.\d+)?)$/),s=r.match(/^(-?\d+(?:\.\d+)?)\s*([+\-*/])\s*(-?\d+(?:\.\d+)?)$/),c=null;if(o){let e=o[1],n=parseFloat(o[2]);switch(e){case`+`:c=t+n;break;case`-`:c=t-n;break;case`*`:c=t*n;break;case`/`:c=n===0?t:t/n;break}}else if(s){let e=parseFloat(s[1]),t=s[2],n=parseFloat(s[3]);switch(t){case`+`:c=e+n;break;case`-`:c=e-n;break;case`*`:c=e*n;break;case`/`:c=n===0?e:e/n;break}}else{let e=parseFloat(r);Number.isNaN(e)||(c=e)}return Be(c===null||!Number.isFinite(c)?t:Math.trunc(c),i,a)},He=e=>{let t=ze(ke),n=Math.floor(Math.random()*t)+1;Le(e,String(n)),Re(e,n)},Ue=(e,t)=>{le(n=>({...n,[e]:t}))},We=(e,t)=>{let n=Ve(t,d.find(t=>t.id===e)?.initiative??0);le(t=>{let{[e]:n,...r}=t;return r}),m(t=>t.map(t=>t.id===e?{...t,initiative:n}:t)),Re(e,n)},Ge=e=>`ELE${e.slice(3)}`,Ke=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o}},qe=async(e,t)=>{let n=Ge(e);try{await a.scene.items.deleteItems([n])}catch{}if(t===0)return;let r=o.find(t=>t.id===e);if(!r||!T(r))return;let i=Ke(r,l),s=`${t>0?`🡹`:`🡻`}${Math.abs(t)}`,c=ee().id(n).name(`Elevation Badge`).plainText(s).textType(`PLAIN`).fontWeight(900).fillOpacity(.95).fillColor(`white`).strokeWidth(8).strokeColor(`black`).strokeOpacity(1).fontSize(36).fontFamily(`Segoe UI`).textAlign(`CENTER`).position({x:i.minX-40,y:i.minY}).metadata({[Qm]:!0,[$m]:e}).attachedTo(e).visible(r.visible).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).layer(`TEXT`).build();try{await a.scene.items.addItems([c])}catch(t){E.error(`Failed to add elevation badge`,e,t)}},Je=(e,t)=>{de(n=>({...n,[e]:t}))},Ye=(e,t,n)=>{let r=e.trim(),{min:i,max:a}=n||{};if(!r)return Be(0,i,a);let o=parseFloat(r);return Be(Number.isFinite(o)?Math.trunc(o):t,i,a)},Xe=(e,t)=>{let n=Ye(t,d.find(t=>t.id===e)?.elevation??0,{min:-999,max:999});de(t=>{let{[e]:n,...r}=t;return r}),m(t=>t.map(t=>t.id===e?{...t,elevation:n}:t)),u(o.map(t=>t.id===e?{...t,metadata:{...t.metadata,[eh]:n}}:t)),a.scene.items.updateItems([e],e=>{e[0].metadata[eh]=n}),qe(e,n)},Ze=(e,t)=>{let n=e.trim();if(!n)return e;let r=/^([+\-*/])\s*-?\d+(?:\.\d+)?$/.test(n),i=/^-?\d+(?:\.\d+)?\s*[+\-*/]\s*-?\d+(?:\.\d+)?$/.test(n),a=/^-?\d+(?:\.\d+)?$/.test(n);if(!r&&!i&&!a)return e;let o=typeof t==`number`?t:parseFloat(String(t)),s=Number.isFinite(o)?o:0;return String(Ve(n,s))},Qe=(e,t,n)=>{let r=`${O}/${t}`,i=d.find(t=>t.id===e)?.attributes?.[r],s=Ze(n,i);m(t=>t.map(t=>t.id===e?{...t,attributes:{...t.attributes,[r]:s}}:t)),u(o.map(t=>t.id===e?{...t,metadata:{...t.metadata,[r]:s}}:t)),a.scene.items.updateItems([e],e=>{e[0].metadata[r]=s})},$e=e=>n.find(t=>t.attr_bid===e)||null,et=e=>{let t=$e(e);return typeof t?.attr_func==`string`&&t.attr_func.trim().length>0},tt=e=>{let t={};for(let r of n){let n=`${O}/${r.attr_bid}`,i=e.attributes?.[n];if(i==null||i===``)continue;let a=Number(i);Number.isFinite(a)&&(t[r.attr_bid]=a)}return t},nt=async(e,t)=>{let n=$e(t)?.attr_func;if(typeof n!=`string`||n.trim().length===0)return;let r=pe(n,{bidValueMap:tt(e),onMissingBid:`error`});if(!r.valid||!r.notation){E.warn(`Could not resolve notation for initiative list value-column`,{unitId:e.id,bid:t,error:r.error});return}let i=$e(t)?.attr_name||t,a=s.find(t=>t.id===e.createdUserId);await Ne({notation:r.notation,actionName:i,tokenName:e.name,senderId:e.createdUserId||c?.id||`unknown`,senderColor:a?.color||c?.color||`#ffffff`})};(0,k.useEffect)(()=>()=>{Object.values(Ce.current).forEach(e=>{window.clearTimeout(e)})},[]);let rt=(e,t)=>`value-column:${e}:${t}`,it=e=>!!he[e],at=(e,t)=>{ge(t=>({...t,[e]:!0})),window.setTimeout(()=>{t?.focus(),t?.select()},0)},ot=e=>{ge(t=>{let{[e]:n,...r}=t;return r})},st=(e,t)=>{let n=Ce.current[e];n&&window.clearTimeout(n),Ce.current[e]=window.setTimeout(()=>{we.current[e]=!0,at(e,t),delete Ce.current[e]},500)},ct=e=>{let t=Ce.current[e];t&&(window.clearTimeout(t),delete Ce.current[e])},lt=e=>we.current[e]?(delete we.current[e],!0):!1,ut=e=>{if(!Ae||je)return!0;let t=c?.id;return t?e.createdUserId===t:!1};(0,k.useEffect)(()=>{r||g(Zh(t,De,Oe))},[t,r,De,Oe]),(0,k.useEffect)(()=>{let e=i[p.CURRENT_TURN],t=i[p.CURRENT_ROUND];e?v(e):P.length>0&&v(P[0].id),t&&b(t)},[i,P]);let dt=async()=>{if(P.length===0)return;_&&await Fe.processEffectsForTurnEvent(`end`,_);let e=P.findIndex(e=>e.id===_)+1;if(e>=P.length){let e=y+1;b(e),v(P[0].id),await a.scene.setMetadata({[p.CURRENT_TURN]:P[0].id,[p.CURRENT_ROUND]:e}),await Fe.processEffectsForTurnEvent(`start`,P[0].id)}else v(P[e].id),await a.scene.setMetadata({[p.CURRENT_TURN]:P[e].id}),await Fe.processEffectsForTurnEvent(`start`,P[e].id)},ft=async()=>{if(P.length===0)return;let e=P.findIndex(e=>e.id===_)-1;if(e<0){let e=Math.max(1,y-1);b(e),v(P[P.length-1].id),await a.scene.setMetadata({[p.CURRENT_TURN]:P[P.length-1].id,[p.CURRENT_ROUND]:e})}else v(P[e].id),await a.scene.setMetadata({[p.CURRENT_TURN]:P[e].id})},pt=async e=>{Ee&&(x.has(e)||(v(e),await a.scene.setMetadata({[p.CURRENT_TURN]:e}),await Fe.processEffectsForTurnEvent(`start`,e)))},mt=async()=>{_&&(await Fe.processEffectsForTurnEvent(`end`,_),S(e=>new Set([...e,_])),x.size+1,P.length)},ht=async()=>{let e=y+1;b(e),S(new Set),v(null),await a.scene.setMetadata({[p.CURRENT_TURN]:null,[p.CURRENT_ROUND]:e})},gt=async e=>{be(!0);try{if(e){let e=o.filter(e=>e.metadata?.[f.ON_LIST]===!0).map(e=>e.id);e.length>0&&(await a.scene.items.updateItems(e,e=>{e.forEach(e=>{e.metadata&&f.ON_LIST in e.metadata&&delete e.metadata[f.ON_LIST]})}),u(o.map(e=>{if(e.metadata?.[f.ON_LIST]!==!0)return e;let t={...e.metadata||{}};return delete t[f.ON_LIST],{...e,metadata:t}})))}let t=e?null:P[0]?.id??null;b(1),v(t),S(new Set),await a.scene.setMetadata({[p.CURRENT_TURN]:t,[p.CURRENT_ROUND]:1}),ve(!1)}catch(t){E.error(`Failed to reset encounter state`,{clearList:e,error:t})}finally{be(!1)}},_t=async e=>{let t=o.find(t=>t.id===e);if(t)try{await Sm.CenterViewportOnImage(t)}catch(t){E.error(`Failed to center viewport on unit`,e,t)}},vt=async(e,t)=>{try{let n=await a.viewport.getHeight(),r=n>800?700:n-100;await a.popover.open({id:w.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(t)}`,height:r,width:350,anchorElementId:e,hidePaper:!0,disableClickAway:!0})}catch(e){E.error(`Failed to open cards popover`,e)}},yt=(e,t)=>{e.preventDefault(),e.stopPropagation(),D(null),te(t)},bt=async e=>{if(C){if(!o.find(e=>e.id===C)){D(`Token not found in scene cache.`);return}ae(!0),D(null);try{await a.scene.items.updateItems([C],t=>{let n=t[0];n.createdUserId=e}),u(o.map(t=>t.id===C?{...t,createdUserId:e}:t)),te(null)}catch(t){E.error(`Failed to reassign token owner`,C,e,t),D(`Unable to assign token owner. Ensure you have permission to edit this token.`)}finally{ae(!1)}}},xt=async()=>{if(!C)return;let e=o.find(e=>e.id===C);if(!e){D(`Token not found in scene cache.`);return}let t=e.metadata?.[f.BOSS_MODE]!==!0;if(t&&o.filter(e=>e.id!==C&&e.metadata?.[f.ON_LIST]===!0&&e.metadata?.[f.BOSS_MODE]===!0).length>=2){D(`A maximum of 2 bosses can be enabled at once.`);return}se(!0),D(null);try{await a.scene.items.updateItems([C],e=>{let n={...e[0].metadata||{}};n[f.BOSS_MODE]=t,e[0].metadata=n}),u(o.map(e=>e.id===C?{...e,metadata:{...e.metadata||{},[f.BOSS_MODE]:t}}:e))}catch(e){E.error(`Failed to toggle boss mode`,C,e),D(`Unable to update boss mode for this token.`)}finally{se(!1)}},St=(0,k.useMemo)(()=>C&&P.find(e=>e.id===C)||null,[C,P]),Ct=(0,k.useMemo)(()=>C&&o.find(e=>e.id===C)||null,[C,o]),wt=Ct?.metadata?.[f.BOSS_MODE]===!0,Tt=(0,k.useMemo)(()=>fe&&P.find(e=>e.id===fe.unitId)||null,[fe,P]),F=(0,k.useMemo)(()=>fe&&n.find(e=>e.attr_bid===fe.bid)||null,[n,fe]),Et=(0,k.useMemo)(()=>{if(!fe||!Tt)return[];let e=Tt.attributes[`${O}/${fe.bid}`];return Pe(e)},[fe,Tt]),I=(0,k.useMemo)(()=>Et.some(e=>typeof e.inUse==`boolean`),[Et]),Dt=(0,k.useMemo)(()=>{if(!Tt)return{};let e={};for(let t of n){let n=`${O}/${t.attr_bid}`,r=Tt.attributes?.[n];if(r==null||r===``)continue;let i=Number(r);Number.isFinite(i)&&(e[t.attr_bid]=i)}return e},[Tt,n]),Ot=e=>{let t=[],n=e.matchAll(/\[([^\[\]]+)\]/g);for(let e of n){let n=(e[1]||``).trim();if(!n)continue;let r=pe(n,{bidValueMap:Dt,onMissingBid:`error`});!r.valid||!r.notation||t.push(r.notation)}return t};(0,k.useEffect)(()=>{j.current&&h.length>0&&(E.debug(`Adjusting window width based on table size`),setTimeout(()=>{if(j.current){let e=j.current.offsetWidth+4,t=Math.min(e,800);a.action.setWidth(t),E.log(`Adjusted window width to `+t)}},100))},[j.current?.offsetWidth]);let kt=e=>{if(!e)return null;let t=nh[e.toLowerCase()];return t?(0,A.jsx)(t,{}):null},L=e=>e.type===`initiative`?(0,A.jsx)(od,{}):e.type===`roller`?null:e.type===`name`?`Name`:e.type===`card-column`?(0,A.jsx)(Xu,{}):e.type===`divider-column`?null:e.useIcon&&e.iconType?kt(e.iconType):e.name||e.type,At=(t,n)=>{let r=ut(n);switch(t.type){case`initiative`:if(Ee)return(0,A.jsx)(vh,{theme:e,children:(0,A.jsx)(Sh,{onClick:e=>{e.stopPropagation(),r&&(x.has(n.id)||(n.id===_?mt():pt(n.id)))},children:x.has(n.id)?(0,A.jsx)(Gu,{color:e.OFFSET}):n.id===_?(0,A.jsx)(Wu,{color:e.PRIMARY}):(0,A.jsx)(Ku,{color:e.BORDER})})});let i=`initiative:${n.id}`,s=it(i);return(0,A.jsx)(vh,{theme:e,children:(0,A.jsx)(Ch,{theme:e,$isRollable:r&&!s,type:`text`,inputMode:`decimal`,value:ce[n.id]??String(n.initiative),readOnly:!r||!s,onChange:!r||!s?void 0:e=>Ue(n.id,e.target.value),onBlur:!r||!s?void 0:e=>{We(n.id,e.target.value),ot(i)},onClick:()=>{r&&(s||lt(i)||He(n.id))},onContextMenu:e=>{r&&(e.preventDefault(),at(i,e.currentTarget))},onTouchStart:e=>{r&&(s||st(i,e.currentTarget))},onTouchEnd:()=>{ct(i)},onTouchCancel:()=>{ct(i)},onKeyDown:e=>{if(r){if(!s&&(e.key===`Enter`||e.key===` `)){e.preventDefault(),He(n.id);return}s&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}}})});case`name`:return(0,A.jsx)(wh,{theme:e,title:`Right-click to assign owner`,$outlineColor:n.ownerNameOutlineColor,onDoubleClick:()=>_t(n.id),onContextMenu:r?e=>yt(e,n.id):void 0,children:n.name});case`roller`:return(0,A.jsx)(yh,{theme:e,children:(0,A.jsx)(bh,{theme:e,disabled:!r,onClick:e=>{e.stopPropagation(),r&&He(n.id)},title:`Roll initiative (1-${ze(ke)})`,children:(0,A.jsx)(xh,{src:`/dice.svg`,alt:`Roll`})})});case`card-column`:return(0,A.jsx)(_h,{theme:e,children:(0,A.jsx)(Oh,{id:`card-access-${n.id}`,theme:e,disabled:!r,onClick:e=>{e.stopPropagation(),r&&vt(e.currentTarget.id,n.id)},title:`Open card for ${n.name}`,children:(0,A.jsx)(Wu,{})})});case`value-column`:return(0,A.jsx)(_h,{theme:e,children:(0,A.jsx)(Dh,{children:t.styles?.bidList?.map((i,a)=>{let o=et(i),s=rt(n.id,i),c=o&&it(s),l=n.attributes[`${O}/${i}`],u=l==null||l===``?`0`:String(l);return(0,A.jsxs)(k.Fragment,{children:[a>0&&(0,A.jsx)(Eh,{theme:e,children:t.styles?.dividers?.[a-1]||`/`}),(0,A.jsx)(Th,{theme:e,$isRollable:r&&o,value:u,$small:t.styles?.bidList&&t.styles.bidList.length>2,readOnly:!r||o&&!c,onChange:!r||o&&!c?void 0:e=>{let t=e.target.value;m(e=>e.map(e=>e.id===n.id?{...e,attributes:{...e.attributes,[`${O}/${i}`]:t}}:e))},onBlur:!r||o&&!c?void 0:e=>{Qe(n.id,i,e.target.value),o&&ot(s)},onClick:o?()=>{r&&(c||lt(s)||nt(n,i))}:void 0,onContextMenu:o?e=>{r&&(e.preventDefault(),at(s,e.currentTarget))}:void 0,onTouchStart:o?e=>{r&&(c||st(s,e.currentTarget))}:void 0,onTouchEnd:o?()=>{ct(s)}:void 0,onTouchCancel:o?()=>{ct(s)}:void 0,onKeyDown:e=>{if(r){if(o&&!c&&(e.key===`Enter`||e.key===` `)){e.preventDefault(),nt(n,i);return}(c||!o)&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}}})]},i)})})});case`list-column`:return(0,A.jsx)(_h,{theme:e,children:(0,A.jsx)(Oh,{theme:e,disabled:!r,onClick:e=>{if(e.stopPropagation(),!r)return;let i=t.styles?.bidList?.[0];i&&me({unitId:n.id,bid:i})},title:`Open list reference`,children:(0,A.jsx)(Uu,{})})});case`checkbox-column`:return(0,A.jsx)(_h,{theme:e,children:(0,A.jsx)(Dh,{children:t.styles?.bidList?.map(e=>(0,A.jsx)(kh,{type:`checkbox`,checked:!!n.attributes[`${O}/${e}`],disabled:!r,onChange:r?t=>{let r=t.target.checked;m(t=>t.map(t=>t.id===n.id?{...t,attributes:{...t.attributes,[`${O}/${e}`]:r}}:t)),u(o.map(t=>t.id===n.id?{...t,metadata:{...t.metadata,[`${O}/${e}`]:r}}:t)),a.scene.items.updateItems([n.id],t=>{t[0].metadata[`${O}/${e}`]=r})}:void 0},e))})});case`special-column`:let c=kt(t.iconType);if(t.styles?.specialType===`elevation`){let t=ue[n.id];return(0,A.jsx)(Xm,{theme:e,unit:n,canInteract:r,elevationDraftValue:t,onElevationDraftChange:Je,onCommitElevationChange:Xe})}else{let t=Fe.getEffectsForUnit(n.id).length;return(0,A.jsx)(Zm,{theme:e,canInteract:r,icon:c||(0,A.jsx)(rd,{}),activeEffectsCount:t,onOpen:()=>Fe.handleOpenEffectsModal(n.id)})}case`divider-column`:return(0,A.jsx)(Ah,{theme:e,$style:t.styles?.styleDesign});default:return(0,A.jsx)(_h,{theme:e,children:`-`})}};return r?(0,A.jsx)(rh,{children:(0,A.jsx)(ih,{theme:e,children:`Loading...`})}):(0,A.jsxs)(rh,{children:[(0,A.jsx)(ah,{children:(0,A.jsxs)(dh,{ref:j,theme:e,children:[(0,A.jsx)(fh,{theme:e,children:(0,A.jsx)(ph,{children:h.map(t=>(0,A.jsx)(mh,{theme:e,children:L(t)},t.id))})}),(0,A.jsx)(hh,{children:P.map(t=>(0,A.jsx)(gh,{$isCurrentTurn:t.id===_,theme:e,children:h.map(e=>(0,A.jsx)(k.Fragment,{children:At(e,t)},e.id))},t.id))})]})}),(0,A.jsxs)(oh,{theme:e,children:[(0,A.jsx)(sh,{children:Ee?(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(ch,{theme:e,onClick:mt,disabled:!_||x.has(_),children:`End Turn`}),(0,A.jsxs)(uh,{theme:e,children:[`Round: `,y]}),(0,A.jsx)(ch,{theme:e,onClick:ht,disabled:x.size<P.length,children:`Next`})]}):(0,A.jsxs)(A.Fragment,{children:[je&&(0,A.jsx)(ch,{theme:e,$compact:xe,onClick:ft,children:xe?(0,A.jsx)(Bu,{}):`Previous`}),(0,A.jsxs)(uh,{theme:e,children:[`Round: `,y]}),je&&(0,A.jsx)(ch,{theme:e,$compact:xe,onClick:dt,children:xe?(0,A.jsx)(Vu,{}):`Next`})]})}),je&&(0,A.jsx)(lh,{theme:e,onClick:()=>ve(!0),disabled:ye,title:`Reset round/turn state`,children:(0,A.jsx)(ed,{})})]}),(0,A.jsxs)(Fp,{isOpen:!!C,title:St?`Unit: ${St.name}`:`Unit`,onClose:()=>{re||oe||(te(null),D(null))},closeOnOverlayClick:!re&&!oe,maxWidth:`520px`,children:[(0,A.jsx)(Nh,{theme:e,children:`Select a player to become the owner.`}),(0,A.jsx)(jh,{children:Ie.map(t=>(0,A.jsxs)(Mh,{theme:e,$isCurrent:Ct?.createdUserId===t.id,onClick:()=>bt(t.id),disabled:re||oe,children:[t.name,Ct?.createdUserId===t.id?` (current)`:``]},t.id))}),(0,A.jsx)(Fh,{theme:e}),(0,A.jsxs)(Ih,{theme:e,children:[(0,A.jsxs)(`div`,{children:[(0,A.jsx)(Lh,{theme:e,children:`Boss Mode`}),(0,A.jsx)(Rh,{theme:e,children:`Shows a large encounter HP bar in scene (max 2 bosses).`})]}),(0,A.jsx)(zh,{theme:e,$active:wt,disabled:re||oe,onClick:()=>{xt()},children:oe?`Updating...`:wt?`Enabled`:`Disabled`})]}),ne&&(0,A.jsx)(Ph,{theme:e,children:ne})]}),(0,A.jsx)(Km,{manager:Fe}),(0,A.jsxs)(Fp,{isOpen:_e,title:`Reset Encounter`,onClose:()=>{ye||ve(!1)},closeOnOverlayClick:!ye,maxWidth:`460px`,children:[(0,A.jsx)(Nh,{theme:e,children:`Choose how you want to reset initiative state.`}),(0,A.jsxs)(jh,{children:[(0,A.jsx)(Mh,{theme:e,onClick:()=>{gt(!1)},disabled:ye,children:ye?`Resetting...`:`Reset Round`}),(0,A.jsx)(Mh,{theme:e,onClick:()=>{gt(!0)},disabled:ye,children:ye?`Resetting...`:`Reset Round and Clear Initiative List`})]})]}),(0,A.jsx)(Fp,{isOpen:!!fe,title:Tt?`${F?.attr_name||`List`} for ${Tt.name}`:`List Reference`,onClose:()=>{me(null)},maxWidth:`620px`,children:(0,A.jsxs)(Bh,{children:[(0,A.jsx)(Vh,{theme:e}),Et.length===0?(0,A.jsx)(Xh,{theme:e,children:`No entries.`}):(0,A.jsx)(Hh,{children:Et.map(t=>(0,A.jsxs)(Uh,{theme:e,children:[(0,A.jsxs)(Wh,{children:[I?(0,A.jsx)(Gh,{type:`checkbox`,checked:!!t.inUse,readOnly:!0,tabIndex:-1}):null,(0,A.jsx)(Kh,{theme:e,children:t.name||`(Unnamed)`})]}),t.description?(0,A.jsx)(qh,{theme:e,children:t.description}):null,(()=>{let n=Ot(t.description||``);return n.length===0?null:(0,A.jsx)(Jh,{children:n.map((n,r)=>(0,A.jsx)(Yh,{type:`button`,theme:e,onClick:()=>{let e=Tt?.createdUserId?s.find(e=>e.id===Tt.createdUserId):null;Ne({notation:n,actionName:t.name||F?.attr_name||`List Roll`,tokenName:Tt?.name||`Unknown`,senderId:Tt?.createdUserId||c?.id||`unknown`,senderColor:e?.color||c?.color||`#ffffff`})},title:n,children:n},`${t.id}-inline-notation-${r}`))})})()]},t.id))})]})})]})};var $h=`${w.EXTENSIONID}-partyhud`,eg=_.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
`,tg=_.div`
...
`,ag=_.button`
  border: 1px solid ${e=>e.theme.BORDER};
  border-radius: 6px;
  background: ${e=>g(e.theme.OFFSET,.45)};
  color: ${e=>e.theme.PRIMARY};
  padding: 8px 10px;
  cursor: pointer;
  font-size: 12px;
...
`,og=_.select`
  border: 1px solid ${e=>e.theme.BORDER};
  border-radius: 6px;
  background: ${e=>g(e.theme.BACKGROUND,.55)};
  color: ${e=>e.theme.PRIMARY};
  padding: 8px;
  min-width: 160px;
`,sg=_.p`
...
`,fg=_.img`
  ...
  border-radius: 6px;
  border: 2px solid ${e=>e.theme.BORDER};
  background-color: ${e=>g(e.theme.BACKGROUND,.6)};
`,pg=_.div`
  display: flex;
  flex-direction: column;
  gap: 6px;
...
`,gg=_.p`
  color: ${e=>e.theme.PRIMARY};
  margin: 0;
`,_g=e=>{switch(e){case`bottom`:return`left`;case`left`:return`top`;case`top`:return`right`;case`right`:default:return`bottom`}},vg=e=>e===`bottom`||e===`left`||e===`top`||e===`right`,yg=async()=>{await a.modal.open({id:$h,url:`/pages/forgeparty.html`,fullScreen:!0,hideBackdrop:!0,hidePaper:!0,disablePointerEvents:!0})};const bg=()=>{let e=(0,k.useRef)(!1),{theme:t}=Me(),{attributes:n}=bm(),r=M(e=>e.items),i=M(e=>e.sceneMetadata);M(e=>e.roomMetadata);let o=M(e=>e.playerData),s=i,c=String(o?.role||``).toUpperCase()===`GM`,l=s[p.PARTY_HUD_OPEN]===!0,u=s[p.PARTY_HUD_ORIENTATION],d=vg(u)?u:`bottom`,m=s[p.PARTY_HUD_ATTR_ONE]||``,h=s[p.PARTY_HUD_ATTR_TWO]||``,g=s[p.PARTY_HUD_SHOW_HP_BARS]===!0,_=s[p.PARTY_HUD_SHOW_HP_NUMBERS]===!0&&!g,v=r.filter(e=>e.metadata[f.IN_PARTY]===!0),y=(0,k.useMemo)(()=>n.filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`text`||t===`numb`||t===`bool`}),[n]),b=async(e,t)=>{await a.scene.setMetadata({[e]:t})},x=async()=>{let t=!l;if(await b(p.PARTY_HUD_OPEN,t),!t){await a.modal.close($h),e.current=!1;return}await yg(),e.current=!0},S=async()=>{let e=_g(d);await b(p.PARTY_HUD_ORIENTATION,e)},C=async(e,t)=>{let n=t.trim();await a.scene.items.updateItems([e],e=>{let t={...e[0].metadata||{}};n?t[f.PORTRAIT_URL]=n:delete t[f.PORTRAIT_URL],e[0].metadata=t})};return(0,k.useEffect)(()=>{let t=!0;return(async()=>{if(l&&!e.current){await yg(),t&&(e.current=!0);return}!l&&e.current&&(await a.modal.close($h),t&&(e.current=!1))})(),()=>{t=!1}},[l]),(0,A.jsx)(zu.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,A.jsxs)(dp,{theme:t,children:[(0,A.jsx)(fp,{theme:t,children:`Party`}),(0,A.jsxs)(tg,{theme:t,children:[(0,A.jsxs)(ng,{children:[(0,A.jsxs)(ag,{theme:t,onClick:()=>void S(),children:[`Display: `,d.toUpperCase()]}),(0,A.jsx)(ag,{theme:t,onClick:()=>void x(),children:l?`Close Party HUD`:`Open Party HUD`})]}),c&&(0,A.jsxs)(A.Fragment,{children:[(0,A.jsxs)(rg,{children:[(0,A.jsx)(ig,{theme:t,children:`Show in HUD:`}),(0,A.jsxs)(cg,{$disabled:!c,children:[(0,A.jsx)(lg,{theme:t,children:`Show HP Bars`}),(0,A.jsx)(X,{label:`Party HUD Show HP Bars`,isOn:g,onChange:e=>{c&&(b(p.PARTY_HUD_SHOW_HP_BARS,e),e&&b(p.PARTY_HUD_SHOW_HP_NUMBERS,!1))}})]}),(0,A.jsxs)(cg,{$disabled:!c,children:[(0,A.jsx)(lg,{theme:t,children:`Show HP Numbers`}),(0,A.jsx)(X,{label:`Party HUD Show HP Numbers`,isOn:_,onChange:e=>{c&&(b(p.PARTY_HUD_SHOW_HP_NUMBERS,e),e&&b(p.PARTY_HUD_SHOW_HP_BARS,!1))}})]}),(0,A.jsxs)(og,{theme:t,disabled:!c,value:m,onChange:e=>{let t=e.target.value;b(p.PARTY_HUD_ATTR_ONE,t),t&&t===h&&b(p.PARTY_HUD_ATTR_TWO,``)},children:[(0,A.jsx)(`option`,{value:``,children:`Extra Slot 1 (None)`}),y.map(e=>(0,A.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]}),(0,A.jsxs)(og,{theme:t,disabled:!c,value:h,onChange:e=>{let t=e.target.value;b(p.PARTY_HUD_ATTR_TWO,t),t&&t===m&&b(p.PARTY_HUD_ATTR_ONE,``)},children:[(0,A.jsx)(`option`,{value:``,children:`Extra Slot 2 (None)`}),y.map(e=>(0,A.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]})]}),(0,A.jsx)(sg,{theme:t,children:(0,A.jsxs)(A.Fragment,{children:[`Configure Party HUD and portraits.`,(0,A.jsx)(`br`,{}),`LIST attributes are excluded.`]})})]})]}),v.length===0?(0,A.jsx)(gg,{theme:t,children:`No one is in the Party.  Add a unit using the ContextMenu on the token.`}):(0,A.jsx)(eg,{theme:t,children:v.map(e=>{let n=e.metadata?.[f.PORTRAIT_URL]||``,r=T(e)?e.image.url:void 0,i=e.metadata[f.UNIT_NAME]||e.name||`Unknown`,a=e.createdUserId===o?.id,s=c||a,l=r||`/logo.png`,u=!!n;return(0,A.jsxs)(ug,{theme:t,children:[(0,A.jsxs)(dg,{children:[(0,A.jsx)(fg,{theme:t,src:l,alt:i,$full:!u}),u&&(0,A.jsx)(fg,{theme:t,src:u?n:``,alt:`${i} override`,$overlay:!0})]}),(0,A.jsxs)(pg,{children:[(0,A.jsx)(mg,{theme:t,title:i,children:i}),s&&(0,A.jsx)(hg,{theme:t,defaultValue:n,placeholder:`Portrait URL override (optional)`,onBlur:t=>{C(e.id,t.target.value)}})]})]},e.id)})})]})})};var xg=`${O}/hp-bar-effect`,Sg=`${O}/hp-bar-owner`,Cg=`${O}/hp-number-text`,wg=`${O}/hp-number-owner`,Tg=e=>`HPB${e.slice(3)}`,Eg=e=>`HPN${e.slice(3)}`,Dg=(e,t,n)=>Math.max(t,Math.min(n,e)),Og=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},kg=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||_e.CURRENT_HP,maxHpBid:n?.attr_bid||_e.MAX_HP}},Ag=(e,t)=>{let n=kg(t),r=e[p.HP_CURRENT_BID],i=e[p.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},jg=(e,t,n)=>{let r=e.metadata?.[`${O}/${t}`],i=e.metadata?.[`${O}/${n}`],a=Og(r),o=Og(i);return o===null||o<=0||a===null?null:Dg(a/o*100,0,100)},Mg=(e,t,n)=>{let r=e.metadata?.[`${O}/${t}`],i=e.metadata?.[`${O}/${n}`],a=Og(r),o=Og(i);return a===null?null:{currentHp:Math.trunc(a),maxHp:o===null?null:Math.trunc(o)}},Ng=e=>{let t=String(e||`bottom`).toLowerCase();return t===`top`||t===`bottom`||t===`left`||t===`right`?t:`bottom`},Pg=e=>{switch(Ng(e)){case`top`:return 0;case`bottom`:return 1;case`left`:return 2;case`right`:return 3;default:return 1}},Fg=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o,width:r,height:i}},Ig=(e,t,n)=>{let r=Fg(e,t),i=r.minX+r.width*.5,a=r.minY+r.height*.5,o;switch(n){case`top`:o={x:i,y:r.minY+r.height*.18};break;case`bottom`:o={x:i,y:r.minY+r.height*.82};break;case`left`:o={x:r.minX+r.width*.18,y:a};break;case`right`:o={x:r.minX+r.width*.82,y:a};break}let s=r.width*.25,c=r.height*.18;return{x:o.x-s,y:o.y-c}};const Lg=()=>{let e=M(e=>e.cacheReady),n=M(e=>e.sceneReady),r=M(e=>e.items),i=M(e=>e.localItems),s=M(e=>e.gridDpi),l=M(e=>e.roomMetadata),u=M(e=>e.sceneMetadata);return(0,k.useEffect)(()=>{if(!e||!n)return;let l=!1;return(async()=>{let e=u,n=e[p.SHOW_HP_BARS]??!1,d=e[p.SHOW_HP_NUMBERS]??!1,m=n,h=!n&&d,g=Ng(e[p.HP_BAR_ORIENTATION]),_=Pg(e[p.HP_BAR_ORIENTATION]),{currentHpBid:v,maxHpBid:y}=Ag(e,u[$.CURRENT_ATTR]||[]),b=i.filter(e=>o(e)&&e.metadata?.[xg]===!0),x=i.filter(e=>t(e)&&e.metadata?.[Cg]===!0);if(!m&&b.length>0)try{await a.scene.local.deleteItems(b.map(e=>e.id))}catch(e){E.error(`Failed to remove HP bar effects`,e)}if(!h&&x.length>0)try{await a.scene.local.deleteItems(x.map(e=>e.id))}catch(e){E.error(`Failed to remove HP number texts`,e)}if(!m&&!h)return;let S=r.filter(e=>T(e)&&e.metadata?.[f.ON_LIST]===!0),C=new Map,w=new Map;for(let e of S){if(m){let t=jg(e,v,y);t!==null&&C.set(Tg(e.id),{unitId:e.id,hpPercent:t})}if(h&&T(e)){let t=Mg(e,v,y);if(t){let n=t.maxHp===null?`${t.currentHp}`:`${t.currentHp}/${t.maxHp}`;w.set(Eg(e.id),{unitId:e.id,text:n,position:Ig(e,s,g)})}}}if(m){let e=new Map(b.map(e=>[e.id,e])),t=Array.from(C.entries()).filter(([t])=>!e.has(t)),n=b.filter(e=>!C.has(e.id)),r=b.filter(e=>{let t=C.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`orientation`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return e.attachedTo!==t.unitId||!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-_)>.001});if(l)return;if(n.length>0)try{await a.scene.local.deleteItems(n.map(e=>e.id))}catch(e){E.error(`Failed to remove stale HP bar effects`,e)}if(t.length>0){let e=t.map(([e,t])=>c().id(e).name(`HP Bar Effect`).effectType(`ATTACHMENT`).attachedTo(t.unitId).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).uniforms([{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}]).sksl(`
uniform vec2 size;
uniform float time;
...
`).metadata({[xg]:!0,[Sg]:t.unitId}).build());try{await a.scene.local.addItems(e)}catch(e){E.error(`Failed to add HP bar effects`,e)}}if(r.length>0){let e=r.map(e=>e.id);try{await a.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=C.get(e.id);if(!t)return;e.attachedTo=t.unitId;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}],e.metadata={...e.metadata,[xg]:!0,[Sg]:t.unitId}})})}catch(e){E.error(`Failed to update HP bar effects`,e)}}}if(h){let e=new Map(x.map(e=>[e.id,e])),t=Array.from(w.entries()).filter(([t])=>!e.has(t)),n=x.filter(e=>!w.has(e.id)),r=x.filter(e=>{let t=w.get(e.id);if(!t)return!1;let n=e.text?.plainText,r=Math.abs(e.position.x-t.position.x)>.01||Math.abs(e.position.y-t.position.y)>.01;return e.attachedTo!==t.unitId||n!==t.text||r});if(l)return;if(n.length>0)try{await a.scene.local.deleteItems(n.map(e=>e.id))}catch(e){E.error(`Failed to remove stale HP number texts`,e)}if(t.length>0){let e=t.map(([e,t])=>{let n=S.find(e=>e.id===t.unitId);return ee().id(e).name(`HP Number Text`).plainText(t.text).textType(`PLAIN`).fontWeight(900).fillOpacity(.95).fillColor(`white`).strokeWidth(8).strokeColor(`black`).strokeOpacity(1).fontSize(28).fontFamily(`Segoe UI`).textAlign(`CENTER`).position(t.position).metadata({[Cg]:!0,[wg]:t.unitId}).attachedTo(t.unitId).visible(n?.visible??!0).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).layer(`TEXT`).build()});try{await a.scene.local.addItems(e)}catch(e){E.error(`Failed to add HP number texts`,e)}}if(r.length>0){let e=r.map(e=>e.id);try{await a.scene.local.updateItems(e,e=>{e.forEach(e=>{let t=w.get(e.id);if(!t)return;e.attachedTo=t.unitId,e.position=t.position;let n=e;n.text&&(n.text.plainText=t.text),e.metadata={...e.metadata,[Cg]:!0,[wg]:t.unitId}})})}catch(e){E.error(`Failed to update HP number texts`,e)}}}})(),()=>{l=!0}},[e,n,r,i,s,l,u]),null};var Rg=`${O}/buff-effect-token`,zg=`${O}/buff-effect-owner`,Bg=`${O}/debuff-effect-token`,Vg=`${O}/debuff-effect-owner`,Hg=`${O}/effect-preset`,Ug=e=>`EFB${e.slice(3)}`,Wg=e=>`EFD${e.slice(3)}`,Gg=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const Kg=()=>{let e=M(e=>e.cacheReady),t=M(e=>e.sceneReady),n=M(e=>e.items),r=M(e=>e.localItems),i=M(e=>e.roomMetadata),s=M(e=>e.sceneMetadata);return(0,k.useEffect)(()=>{if(!e||!t)return;let i=!1;return(async()=>{let e=s,t=e[p.BUFF_VISUAL_PRESET],l=e[p.DEBUFF_VISUAL_PRESET],u=Bp(t)?t:Ip,d=Vp(l)?l:Lp,m=Hp(u),h=Up(d),g=n.filter(e=>T(e)&&e.metadata?.[f.ON_LIST]===!0),_=new Set(g.map(e=>e.id)),v=new Map,y=(e,t)=>{let n=v.get(e)||{hasBuff:!1,hasDebuff:!1};t===`buff`?n.hasBuff=!0:n.hasDebuff=!0,v.set(e,n)};n.forEach(e=>{if(e.metadata?.[f.ON_LIST]!==!0)return;let t=Gg(e.metadata?.[Cm]);t.length!==0&&t.forEach(t=>{t.effectType!==`neutral`&&(t.targets.length>0?t.targets:[e.id]).forEach(e=>{_.has(e)&&(t.effectType===`buff`||t.effectType===`debuff`)&&y(e,t.effectType)})})});let b=new Map,x=new Map;g.forEach(e=>{let t=v.get(e.id);t?.hasBuff&&b.set(Ug(e.id),e.id),t?.hasDebuff&&x.set(Wg(e.id),e.id)});let S=r.filter(e=>o(e)&&e.metadata?.[Rg]===!0),C=r.filter(e=>o(e)&&e.metadata?.[Bg]===!0),w=async e=>{let{existing:t,desiredByOverlayId:n,preset:r,shader:o,name:s,flagKey:l,ownerKey:u}=e,d=new Map(t.map(e=>[e.id,e])),f=Array.from(n.entries()).filter(([e])=>!d.has(e)),p=t.filter(e=>!n.has(e.id)),m=t.filter(e=>{let t=n.get(e.id);if(!t)return!1;let i=e.metadata?.[Hg];return e.attachedTo!==t||i!==r});if(!i){if(p.length>0)try{await a.scene.local.deleteItems(p.map(e=>e.id))}catch(e){E.error(`Failed to remove stale ${s.toLowerCase()} overlays`,e)}if(f.length>0){let e=f.map(([e,t])=>c().id(e).name(s).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(o).metadata({[l]:!0,[u]:t,[Hg]:r}).build());try{await a.scene.local.addItems(e)}catch(e){E.error(`Failed to add ${s.toLowerCase()} overlays`,e)}}if(m.length>0)try{await a.scene.local.updateItems(m.map(e=>e.id),e=>{e.forEach(e=>{let t=n.get(e.id);if(!t)return;e.attachedTo=t;let i=e;i.sksl=o,e.metadata={...e.metadata,[l]:!0,[u]:t,[Hg]:r}})})}catch(e){E.error(`Failed to update ${s.toLowerCase()} overlays`,e)}}};await w({existing:S,desiredByOverlayId:b,preset:u,shader:m,name:`Buff Token Effect`,flagKey:Rg,ownerKey:zg}),await w({existing:C,desiredByOverlayId:x,preset:d,shader:h,name:`Debuff Token Effect`,flagKey:Bg,ownerKey:Vg})})(),()=>{i=!0}},[e,t,n,r,i,s]),null};var qg=`${O}/boss-hp-effect`,Jg=`${O}/boss-hp-owner`,Yg=`${O}/boss-hp-slot`,Xg=e=>`BOSSHP${e}`,Zg=(e,t,n)=>Math.max(t,Math.min(n,e)),Qg=e=>{if(typeof e==`number`&&Number.isFinite(e))return e;if(typeof e==`string`){let t=parseFloat(e);return Number.isFinite(t)?t:null}return null},$g=e=>{let t=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`HP`||n===`hit points`}),n=e.find(e=>{let t=(e.attr_abbr||``).toUpperCase(),n=(e.attr_name||``).toLowerCase();return t===`MHP`||n===`max hit points`});return{currentHpBid:t?.attr_bid||_e.CURRENT_HP,maxHpBid:n?.attr_bid||_e.MAX_HP}},e_=(e,t)=>{let n=$g(t),r=e[p.HP_CURRENT_BID],i=e[p.HP_MAX_BID],a=new Set(t.map(e=>e.attr_bid));return{currentHpBid:r&&a.has(r)?r:n.currentHpBid,maxHpBid:i&&a.has(i)?i:n.maxHpBid}},t_=(e,t,n)=>{let r=e.metadata?.[`${O}/${t}`],i=e.metadata?.[`${O}/${n}`],a=Qg(r),o=Qg(i);return o===null||o<=0||a===null?null:Zg(a/o*100,0,100)};const n_=()=>{let e=M(e=>e.cacheReady),t=M(e=>e.sceneReady),n=M(e=>e.items),r=M(e=>e.localItems),i=M(e=>e.roomMetadata),s=M(e=>e.sceneMetadata);return(0,k.useEffect)(()=>{if(!e||!t)return;let i=!1;return(async()=>{let{currentHpBid:e,maxHpBid:t}=e_(s,s[$.CURRENT_ATTR]||[]),l=r.filter(e=>o(e)&&e.metadata?.[qg]===!0),u=n.filter(e=>T(e)&&e.metadata?.[f.ON_LIST]===!0&&e.metadata?.[f.BOSS_MODE]===!0).sort((e,t)=>{let n=Number(e.metadata?.[f.INITIATIVE]??0);return Number(t.metadata?.[f.INITIATIVE]??0)-n}).slice(0,2).map((n,r)=>{let i=t_(n,e,t);return i===null?null:{id:Xg(r),unitId:n.id,slot:r,hpPercent:i}}).filter(e=>e!==null),d=new Map(u.map(e=>[e.id,e])),p=new Map(l.map(e=>[e.id,e])),m=l.filter(e=>!d.has(e.id)),h=u.filter(e=>!p.has(e.id)),g=l.filter(e=>{let t=d.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`slot`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-t.slot)>.001||e.metadata?.[Jg]!==t.unitId});if(!i){if(m.length>0)try{await a.scene.local.deleteItems(m.map(e=>e.id))}catch(e){E.error(`Failed to remove stale boss HP viewport effects`,e)}if(h.length>0){let e=h.map(e=>c().id(e.id).name(`Boss HP Bar`).effectType(`VIEWPORT`).locked(!0).disableHit(!0).uniforms([{name:`hpPercent`,value:e.hpPercent},{name:`slot`,value:e.slot}]).sksl(`
uniform float2 size;
...
`).metadata({[qg]:!0,[Jg]:e.unitId,[Yg]:e.slot}).build());try{await a.scene.local.addItems(e)}catch(e){E.error(`Failed to add boss HP viewport effects`,e)}}if(g.length>0)try{await a.scene.local.updateItems(g.map(e=>e.id),e=>{e.forEach(e=>{let t=d.get(e.id);if(!t)return;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`slot`,value:t.slot}],e.metadata={...e.metadata,[qg]:!0,[Jg]:t.unitId,[Yg]:t.slot}})})}catch(e){E.error(`Failed to update boss HP viewport effects`,e)}}})(),()=>{i=!0}},[e,t,n,r,i,s]),null};var r_=`${O}/current-turn-effect`;const i_=()=>{let e=M(e=>e.cacheReady),t=M(e=>e.sceneReady),n=M(e=>e.items),r=M(e=>e.roomMetadata),i=M(e=>e.sceneMetadata);return(0,k.useEffect)(()=>{if(!e||!t)return;let r=!1;return(async()=>{let e=i[p.SHOW_TURN_EFFECT]===!0,t=i[p.CURRENT_TURN];if(!e||!t){try{await a.scene.local.deleteItems([r_])}catch{}return}if(!n.find(e=>e.id===t)){try{await a.scene.local.deleteItems([r_])}catch{}return}if(!r){try{let e=!1;if(await a.scene.local.updateItems([r_],n=>{let r=n[0];r&&(r.attachedTo=t,e=!0)}),e)return}catch{}if(!r)try{let e=c().id(r_).name(`Current Turn Effect`).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).sksl(`
uniform vec2 size;
uniform float time;
...
`).build();await a.scene.local.addItems([e])}catch(e){E.error(`Failed to sync current turn effect`,e)}}})(),()=>{r=!0}},[e,t,n,r,i]),null},a_=()=>{let[e,t]=(0,k.useState)(!1),{updateThemeFromSystem:n}=Me(),r=M(e=>e.sceneMetadata),i=M(e=>e.cacheReady);return(0,k.useEffect)(()=>{if(e)return;let o=!0,s=async()=>{if(i)try{E.log(`Starting app initialization...`),await c(),o&&(t(!0),E.log(`App initialization complete`))}catch(e){E.error(`Error during app initialization:`,e),o&&t(!0)}},c=async()=>{try{let e=r[$.CURRENT_THEME],t=r[$.CURRENT_CARD],i=r[$.CURRENT_LIST],a=r[$.CURRENT_ATTR];if(!e||!Array.isArray(t)||!Array.isArray(i)||!Array.isArray(a)){E.log(`System data not found, initializing with defaults`),await l();return}E.log(`Loading existing system theme:`,e),n(e.primary,e.offset,e.background,e.border,e.background_url)}catch(e){E.error(`Error loading system data:`,e),await l()}},l=async()=>{let e={primary:S.theme_primary,offset:S.theme_offset,background:S.theme_background,border:S.theme_border,background_url:S.background_url};await a.scene.setMetadata({[$.CURRENT_THEME]:e,[$.CURRENT_CARD]:S.card_layout,[$.CURRENT_LIST]:S.list_layout,[$.CURRENT_ATTR]:S.attributes,[$.SYSTEM_NAME]:S.name,[$.IMPORT_DATE]:null}),E.log(`Default system initialized`),n(e.primary,e.offset,e.background,e.border,e.background_url)};return s(),()=>{o=!1}},[i,e]),{isInitialized:e}};var o_=b`
  ...
  body {
    background-color: ${e=>g(e.theme.BACKGROUND,.1)};
    color: ${e=>e.theme.PRIMARY};
  ...
  ::-webkit-scrollbar-track {
    background: ${e=>g(e.theme.BACKGROUND,.3)};
  }
  ...
  ::-webkit-scrollbar-thumb {
    ...
    &:hover {
      background: ${e=>g(e.theme.OFFSET,.7)};
    }
  }
...
`;function u_(){let{sceneReady:e,cacheReady:t,playerData:n}=M(),{isInitialized:r}=a_(),{theme:i}=Me(),[o,s]=(0,k.useState)(`ForgeMain`),[c,l]=(0,k.useState)(!1),u=String(n?.role||``).toUpperCase()===`GM`;return(0,k.useEffect)(()=>{o!==`ForgeMain`&&a.action.setWidth(350)},[o]),(0,A.jsxs)(A.Fragment,{children:[(0,A.jsx)(o_,{theme:i}),!e||!t||!r?(0,A.jsxs)(s_,{children:[(0,A.jsx)(c_,{}),(0,A.jsx)(l_,{children:e?t?r?`Loading...`:`Initializing system...`:`Loading cache...`:`Connecting to scene...`})]}):(0,A.jsxs)(Qf,{children:[(0,A.jsx)(Lg,{}),(0,A.jsx)(Kg,{}),(0,A.jsx)(n_,{}),(0,A.jsx)(i_,{}),(0,A.jsx)($f,{theme:i,$backgroundUrl:i.BACKGROUND_URL,children:(0,A.jsx)(Jc,{mode:`wait`,children:(()=>{switch(o){case`ForgeMain`:return(0,A.jsx)(Qh,{},`main`);case`Settings`:return u?(0,A.jsx)(Cp,{},`settings`):(0,A.jsx)(Qh,{},`main`);case`Party`:return(0,A.jsx)(bg,{},`party`);case`System`:return u?(0,A.jsx)(ym,{},`system`):(0,A.jsx)(Qh,{},`main`);case`ChatLog`:return(0,A.jsx)(kp,{},`chatlog`)}})()})}),(0,A.jsx)(up,{isOpen:c,currentPage:o,onToggle:()=>l(!c),onNavigate:e=>{if(!u&&(e===`Settings`||e===`System`)){s(`ForgeMain`),l(!1);return}s(e),l(!1)}})]})]})}var d_=u_,f_=class{static{this.ALPHANUMERICTEXTMATCH=/\s[\da-zA-Z]$/}};function p_(e){for(let t of h_)if(e.includes(t)){let n=h_[Math.floor(Math.random()*h_.length)];return e.replace(t,n)}return m_(e)}function m_(e){return`${h_[Math.floor(Math.random()*h_.length)]} ${e}`}const h_=`Grizzled.Wily.Stoic.Mellow.Pensive.Shrewd.Cautious.Hardy.Nimble.Tenacious.Gritty.Tolerant.Hardy.Adroit.Resilient.Slight.Stout.Durable.Subtle.Sober.Clever.Brave.Calm.Wise.Cunning.Alert.Swift.Agile.Loyal.Sturdy.Stable.Sneaky.Clever.Resourceful.Shady.Stalwart.Vigilant.Staunch.Fierce.Vigorous.Robust.Fearless.Dauntless.Resolute.Sagacious.Prudent.Judicious.Astute.Savvy.Sharp.Quick.Witty.Smart.Snippy.Crafty.Deft.Sly.Artful.Clever.Sneering.Tough.Rugged.Solid.Strong.Sturdy.Tough.Gritty.Rough.Hardened.Burly.Muscular.Brawny.Rowdy.Forceful.Snorting.Potent.Martial.Speckled.Mottled.Disheveled`.split(`.`);var g_=`com.battle-system.forge/view-unit`,__=e=>e.trim().toLowerCase(),v_=e=>{let t=e.trim();return t?f_.ALPHANUMERICTEXTMATCH.test(t)?t.slice(0,-2):t:e},y_=async e=>{let t=await a.viewport.getHeight(),n=t>800?700:t-100;await a.popover.open({id:w.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(e)}`,height:n,width:350,anchorReference:`POSITION`,anchorPosition:{left:await a.viewport.getWidth()/2,top:await a.viewport.getHeight()/2},anchorOrigin:{horizontal:`CENTER`,vertical:`CENTER`},transformOrigin:{horizontal:`CENTER`,vertical:`CENTER`},hidePaper:!0,disableClickAway:!0})},b_=async e=>{let t=Array.from(new Set(e.map(e=>e.trim()).filter(e=>e.length>0))),n=new Map;if(t.length===0)return n;try{let{data:e,error:r}=await ce.from(`bs_forge_creatures`).select(`name,metadata,is_active`).eq(`is_active`,!0).in(`name`,t).limit(250);if(!r&&Array.isArray(e)){let t=e;for(let e of t){let t=__(String(e.name||``));if(!t||n.has(t))continue;let r=e.metadata&&typeof e.metadata==`object`&&!Array.isArray(e.metadata)?le(e.metadata):null;r&&n.set(t,r)}}}catch(e){E.log(`Supabase collection lookup failed, falling back to local collection`,e)}let r=await fe(),i=new Map;for(let e of r){let t=__(e.name);if(!t)continue;let n=i.get(t);n?n.push(e):i.set(t,[e])}for(let e of t){let t=__(e);if(n.has(t))continue;let r=i.get(t)?.[0];!r||!r.metadata||n.set(t,le(r.metadata))}return n};function x_({children:e}){M(e=>e.roomMetadata);let t=M(e=>e.sceneMetadata),n=M(e=>e.items),r=M(e=>e.playerData),i=t;return(0,k.useEffect)(()=>{a.onReady(()=>{a.contextMenu.create({id:f.ON_LIST,icons:[{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,f.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,f.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,f.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,f.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}}],async onClick(e){if(E.info(`Add to Combat Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[f.ON_LIST]===!0))await a.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[f.ON_LIST],delete t.metadata[f.INITIATIVE]});else{let r=[],o=[];for(let t of e.items){if(t.metadata[f.FABRICATED]===!0)continue;let e=v_(t.text?.plainText||t.name);r.push(e)}await a.action.setBadgeText(`Retrieving Data.. ⏱️`);let s=await b_(r);await a.action.setBadgeText(void 0);for(let t of e.items){let e={};if(t.metadata[f.FABRICATED]!==!0){let r=v_(t.text?.plainText||t.name),a=s.get(__(r));a&&Object.assign(e,a),(typeof e[f.UNIT_NAME]!=`string`||!String(e[f.UNIT_NAME]).trim())&&(e[f.UNIT_NAME]=t.name),e[f.FABRICATED]=!0,i[p.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[f.UNIT_NAME]!=null&&e.id!==t.id).map(e=>e.metadata[f.UNIT_NAME]).includes(r)&&(e[f.UNIT_NAME]=p_(r))}e[f.ON_LIST]=!0,e[f.INITIATIVE]=0,o.push({id:t.id,metadata:e})}await a.scene.items.updateItems(e.items,e=>{for(let n of e){let e=o.find(e=>e.id===n.id);if(e&&(Object.assign(n.metadata,e.metadata),t[p.SHOW_NAMES]===!0)){let t=n;t.text&&(t.text.plainText=String(e.metadata[f.UNIT_NAME]||``))}}})}}}),a.contextMenu.create({id:f.IN_PARTY,icons:[{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,f.IN_PARTY],operator:`!=`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,f.IN_PARTY],operator:`!=`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,f.IN_PARTY],operator:`==`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,f.IN_PARTY],operator:`==`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){E.info(`Add to Party Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[f.IN_PARTY]===!0)?await a.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[f.IN_PARTY]}):await a.scene.items.updateItems(e.items,e=>{for(let t of e)t.metadata[f.IN_PARTY]=!0})}}),a.contextMenu.create({id:g_,icons:[{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){E.info(`View Unit Clicked: ${e.items[0].name}`);let r=e.items[0];if(!r)return;let o={};if(r.metadata[f.FABRICATED]!==!0){let e=v_(r.text?.plainText||r.name);await a.action.setBadgeText(`Retrieving Data.. ⏱️`);let s=await b_([e]);await a.action.setBadgeText(void 0);let c=s.get(__(e));c&&Object.assign(o,c),(typeof o[f.UNIT_NAME]!=`string`||!String(o[f.UNIT_NAME]).trim())&&(o[f.UNIT_NAME]=r.name),o[f.FABRICATED]=!0,i[p.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[f.UNIT_NAME]!=null&&e.id!==r.id).map(e=>e.metadata[f.UNIT_NAME]).includes(e)&&(o[f.UNIT_NAME]=p_(e)),await a.scene.items.updateItems([r],e=>{let n=e[0];if(Object.assign(n.metadata,o),t[p.SHOW_NAMES]===!0){let e=n;e.text&&(e.text.plainText=String(o[f.UNIT_NAME]||``))}})}await y_(r.id)}})})},[i]),(0,A.jsx)(A.Fragment,{children:e})}ve.createRoot(document.getElementById(`root`)).render((0,A.jsx)(k.StrictMode,{children:(0,A.jsx)(ye,{children:(0,A.jsx)(ke,{children:(0,A.jsx)(x_,{children:(0,A.jsx)(je,{children:(0,A.jsx)(d_,{})})})})})}));