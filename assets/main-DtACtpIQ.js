...
`,hm=em.div({position:`fixed`,bottom:`0`,left:`0`,right:`0`,top:`0`,zIndex:`999`,backgroundColor:`rgba(0, 0, 0, 0.6)`}),gm=em.div({position:`fixed`,bottom:`2px`,left:`2px`,zIndex:`1000`,display:`flex`,height:`3rem`,width:`3rem`,alignItems:`center`,justifyContent:`center`,borderRadius:`9999px`,"--tw-backdrop-blur":`blur(8px)`,WebkitBackdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`,backdropFilter:`var(--tw-backdrop-blur) var(--tw-backdrop-brightness) var(--tw-backdrop-contrast) var(--tw-backdrop-grayscale) var(--tw-backdrop-hue-rotate) var(--tw-backdrop-invert) var(--tw-backdrop-opacity) var(--tw-backdrop-saturate) var(--tw-backdrop-sepia)`}),_m=T.button`
  ...
  border: 2px solid ${e=>e.theme.BORDER};
  color: ${e=>e.theme.PRIMARY};
`,vm=({isOpen:e,currentPage:t,onToggle:n,onNavigate:r,canAccessInitiativeList:i=!0})=>{let{theme:a}=Lt(),{t:o,locale:s,setLocale:c,availableLocales:l}=vt(),u=V(e=>e.playerData),d=String(u?.role||``).toUpperCase()===`GM`,[f,p]=(0,B.useState)(!1),m=(0,B.useRef)(null),h=(0,B.useMemo)(()=>({en:o(`common.locale.en`),es:o(`common.locale.es`),fr:o(`common.locale.fr`),de:o(`common.locale.de`)}),[o]);(0,B.useEffect)(()=>{e||p(!1)},[e]),(0,B.useEffect)(()=>{if(!f)return;let e=e=>{m.current&&!m.current.contains(e.target)&&p(!1)};return window.addEventListener(`mousedown`,e),()=>{window.removeEventListener(`mousedown`,e)}},[f]);let g=e=>{c(e),p(!1)};return(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(iu,{children:e&&(0,H.jsxs)(rm,{theme:a,initial:{x:-300},animate:{x:0},exit:{x:-300},transition:{type:`tween`,duration:.3},style:{boxShadow:`4px 0 12px rgba(0, 0, 0, 0.15)`},children:[(0,H.jsxs)(im,{theme:a,children:[(0,H.jsx)(om,{theme:a,children:o(`nav.title`)}),(0,H.jsxs)(sm,{ref:m,children:[(0,H.jsxs)(cm,{theme:a,$open:f,type:`button`,"aria-haspopup":`listbox`,"aria-expanded":f,"aria-label":o(`nav.languageSwitcher`),onClick:()=>p(e=>!e),children:[(0,H.jsxs)(lm,{children:[(0,H.jsx)(of,{size:16}),(0,H.jsx)(um,{children:h[s]})]}),(0,H.jsx)(ef,{size:8})]}),f?(0,H.jsx)(dm,{theme:a,role:`listbox`,"aria-label":o(`nav.languageOptions`),children:l.map(e=>(0,H.jsxs)(fm,{theme:a,$active:e===s,type:`button`,role:`option`,"aria-selected":e===s,onClick:()=>g(e),children:[(0,H.jsx)(`span`,{children:h[e]}),e===s?(0,H.jsx)($d,{size:14}):null]},e))}):null]})]}),(0,H.jsxs)(am,{theme:a,children:[o(`nav.featureRequest`),(0,H.jsx)(`br`,{}),(0,H.jsx)(`br`,{}),o(`nav.featureSubmit`),` `,(0,H.jsx)(`a`,{href:`mailto:manuel@battle-system.com`,children:o(`nav.featureEmail`)}),` `,o(`nav.featureOr`),` `,(0,H.jsx)(`a`,{href:`https://discord.gg/Kh9hbHAZnX`,target:`_blank`,rel:`noreferrer`,children:o(`nav.battleSystemDiscord`)}),`.`]}),(0,H.jsxs)(pm,{theme:a,children:[i&&(0,H.jsx)(mm,{theme:a,$isActive:t===`ForgeMain`,onClick:()=>r(`ForgeMain`),children:o(`nav.main`)}),(0,H.jsx)(mm,{theme:a,$isActive:t===`Party`,onClick:()=>r(`Party`),children:o(`nav.party`)}),(0,H.jsx)(mm,{theme:a,$isActive:t===`ChatLog`,onClick:()=>r(`ChatLog`),children:o(`nav.systemLog`)}),d&&(0,H.jsx)(mm,{theme:a,$isActive:t===`System`,onClick:()=>r(`System`),children:o(`nav.system`)}),d&&(0,H.jsx)(mm,{theme:a,$isActive:t===`Settings`,onClick:()=>r(`Settings`),children:o(`nav.settings`)})]})]})}),e&&(0,H.jsx)(hm,{onClick:n}),(0,H.jsx)(gm,{children:(0,H.jsx)(_m,{theme:a,onClick:n,children:(0,H.jsx)(ke,{size:24})})})]})},ym=T.div`
  padding: 20px;
  color: ${e=>e.theme.PRIMARY};
  min-height: 100vh;
`,bm=T.h1`
...
`;const Z=({label:e,isOn:t,onChange:n})=>{let{theme:r}=Lt();return(0,H.jsx)(wm,{theme:r,$isOn:t,onClick:()=>{let r=!t;A.log(`${e}: ${r}`),n(r)},role:`switch`,"aria-checked":t,"aria-label":e})};var Tm=T.div`
  position: fixed;
  top: 0;
  left: 0;
  right: 0;
...
`,Bm=em.div({marginTop:`0.5rem`,display:`flex`,justifyContent:`center`,gap:`0.75rem`}),Vm=T.p`
  margin: 8px 0 0;
  font-size: 13px;
...
`,Hm=T.p`
  ...
  margin: 0;
  line-height: 1.5;
`;const Um=()=>{let{theme:e}=Lt(),{t:n}=vt(),{attributes:r}=Mm(),i=V(e=>e.roomMetadata);V(e=>e.sceneMetadata);let a=V(e=>e.items),o=V(e=>e.cacheReady),[s,l]=(0,B.useState)(!1),[u,d]=(0,B.useState)(!1),[f,m]=(0,B.useState)(`D20`),[h,g]=(0,B.useState)(!1),[_,v]=(0,B.useState)(``),[y,b]=(0,B.useState)(`@STAT`),[x,S]=(0,B.useState)(!1),[C,w]=(0,B.useState)(!1),[T,E]=(0,B.useState)(!0),[D,ee]=(0,B.useState)(!1),[te,ne]=(0,B.useState)(!0),[re,k]=(0,B.useState)(!0),[ie,oe]=(0,B.useState)(!1),[se,ce]=(0,B.useState)(`bottom`),[le,ue]=(0,B.useState)(!1),[de,fe]=(0,B.useState)(!1),[pe,me]=(0,B.useState)(!1),[he,ge]=(0,B.useState)(!1),[_e,ve]=(0,B.useState)(!1),[ye,j]=(0,B.useState)(!1),[be,xe]=(0,B.useState)(!1),[Se,M]=(0,B.useState)(!1),[Ce,N]=(0,B.useState)(!1),[Te,Ee]=(0,B.useState)(!1),[De,Oe]=(0,B.useState)(!1),[ke,Ae]=(0,B.useState)(!1),[je,Me]=(0,B.useState)(``),[Ne,Pe]=(0,B.useState)(!1),Fe=(0,B.useRef)(null),[Ie,Re]=(0,B.useState)(()=>ut()),[Be,Ve]=(0,B.useState)(()=>Ge()),[He,Ue]=(0,B.useState)(()=>ht()),[We,Ke]=(0,B.useState)(!1),[qe,Je]=(0,B.useState)(!1),F=jm(n);(0,B.useEffect)(()=>{let e=!0;return(async()=>{let t=await pt();e&&(Re(t&&ut()),Ve(Ge()),Ue(ht()))})(),()=>{e=!1}},[]);let I=i;(0,B.useEffect)(()=>{if(o){if(I[O.POPCORN_INITIATIVE]!==void 0&&l(I[O.POPCORN_INITIATIVE]),I[O.REVERSE_INITIATIVE]!==void 0&&d(I[O.REVERSE_INITIATIVE]),I[O.DICE_RANGE]!==void 0&&m(I[O.DICE_RANGE]),I[O.INITIATIVE_MODIFIER_BID]===void 0?v(``):v(I[O.INITIATIVE_MODIFIER_BID]||``),I[O.INITIATIVE_MODIFIER_EXPR]!==void 0){let e=(I[O.INITIATIVE_MODIFIER_EXPR]||`@STAT`).replace(/\bx\b/gi,`@STAT`).trim();b(e.length>0?e:`@STAT`)}else b(`@STAT`);if(I[O.SHOW_CARD_ACCESS]!==void 0&&g(I[O.SHOW_CARD_ACCESS]),I[O.SHOW_PLAYER_VIEW]!==void 0&&S(I[O.SHOW_PLAYER_VIEW]),I[O.SHOW_OWNER_ONLY_EDIT]!==void 0&&ee(I[O.SHOW_OWNER_ONLY_EDIT]),I[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?ne(!0):ne(I[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]),I[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===void 0?k(!0):k(I[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]),I[O.SHOW_NON_PARTY_UNITS]!==void 0&&w(I[O.SHOW_NON_PARTY_UNITS]),I[O.SHOW_LIST_HP_NUMBERS]===void 0?E(!0):E(I[O.SHOW_LIST_HP_NUMBERS]),I[O.SHOW_HP_BARS]!==void 0&&oe(I[O.SHOW_HP_BARS]),I[O.HP_BAR_ORIENTATION]!==void 0&&ce(I[O.HP_BAR_ORIENTATION]),I[O.SHOW_HP_NUMBERS]!==void 0&&ue(I[O.SHOW_HP_NUMBERS]),I[O.SHOW_DEATH_EFFECT]!==void 0&&fe(I[O.SHOW_DEATH_EFFECT]),I[O.SHOW_NAMES]!==void 0&&me(I[O.SHOW_NAMES]),I[O.SHOW_TURN_EFFECT]!==void 0&&ge(I[O.SHOW_TURN_EFFECT]),I[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&ve(I[O.USE_DESCRIPTIVE_DUPLICATES]),I[O.ENABLE_RUMBLE]!==void 0&&j(I[O.ENABLE_RUMBLE]),I[O.ENABLE_BONES]!==void 0&&xe(I[O.ENABLE_BONES]),I[O.ENABLE_DICE_PLUS]!==void 0&&M(I[O.ENABLE_DICE_PLUS]),I[O.ENABLE_TEXT_BASED_ROLLS]!==void 0&&N(I[O.ENABLE_TEXT_BASED_ROLLS]),I[O.ENABLE_OBR_NOTIFICATION]!==void 0&&Ee(I[O.ENABLE_OBR_NOTIFICATION]),I[O.SHOW_NOTIFICATION_TO_ALL]!==void 0&&Oe(I[O.SHOW_NOTIFICATION_TO_ALL]),I[O.ENABLE_DISCORD_LOGGING]!==void 0&&Ae(I[O.ENABLE_DISCORD_LOGGING]),I[O.DISCORD_URL]!==void 0&&Me(I[O.DISCORD_URL]),I[O.ENABLE_CONSOLE_LOG]!==void 0){let e=I[O.ENABLE_CONSOLE_LOG];Pe(e),A.setEnabled(e)}else Pe(!1)}},[o,I]);let L=async(e,t)=>{await c.room.setMetadata({[e]:t})},Qe=e=>{let t=(e||``).trim().match(/(\d+)/),n=t?parseInt(t[1],10):NaN;return Number.isFinite(n)&&n>0?n:20},R=r.filter(e=>e.attr_type===`numb`).sort((e,t)=>(e.attr_name||``).localeCompare(t.attr_name||``)),$e=(e,t)=>{let r=e.trim();return r?t?/@STAT/i.test(r)?/\d\s*d\s*\d|\bd\s*\d/i.test(r)?{valid:!1,error:n(`settings.diceNotAllowedError`)}:Xe(r.replace(/@STAT/gi,`@${t}`))?{valid:!0}:{valid:!1,error:n(`settings.invalidSyntaxError`)}:{valid:!1,error:n(`settings.exprMustIncludeStatError`)}:{valid:!1,error:n(`settings.selectNumericAttributeError`)}:{valid:!1,error:n(`settings.exprRequiredError`)}},et=async(e,t)=>{await L(O.INITIATIVE_MODIFIER_BID,e),await L(O.INITIATIVE_MODIFIER_EXPR,t)},tt=async e=>{if(v(e),!e){await et(``,y);return}let t=$e(y,e);t.valid||await c.notification.show(t.error||n(`settings.invalidModifierSettingsError`),`WARNING`),await et(e,y)},nt=async()=>{let e=y.trim(),t=(e.length>0?e:`@STAT`).replace(/\bx\b/gi,`@STAT`);if(b(t),!_){await et(``,t);return}let r=$e(t,_);if(!r.valid){await c.notification.show(r.error||n(`settings.invalidModifierExpressionError`),`WARNING`);return}await et(_,t)},rt=async()=>{if(!_){await c.notification.show(n(`settings.selectAttributeBeforeTestingError`),`WARNING`);return}let e=y.replace(/\bx\b/gi,`@STAT`),t=$e(e,_);if(!t.valid){await c.notification.show(t.error||n(`settings.invalidModifierExpressionError`),`WARNING`);return}let r=Qe(f),i=Math.floor(Math.random()*r)+1,a=Le(e.replace(/@STAT/gi,`@${_}`),{bidValueMap:{[_]:14},onMissingBid:`useZero`});if(!a.valid||!a.notation){await c.notification.show(n(`settings.couldNotResolveModifierError`),`ERROR`);return}let o=Number(a.notation),s=Number.isFinite(o)?Math.trunc(o):0,l=i+s,u=e.replace(/@STAT/gi,`14`);await c.notification.show(n(`settings.mockInitiativeResult`,{sides:r,baseRoll:i,expression:u,modifier:s,total:l}),`SUCCESS`)},it=async()=>{try{let e=await we(),t=JSON.stringify(e,null,2),r=new Blob([t],{type:`text/plain;charset=utf-8`}),i=URL.createObjectURL(r),a=document.createElement(`a`);a.href=i,a.download=`forge-collection-${new Date().toISOString().slice(0,10)}.txt`,a.click(),URL.revokeObjectURL(i),await c.notification.show(n(`settings.collectionExportComplete`,{count:e.length}),`SUCCESS`)}catch(e){A.log(`Collection export failed`,e),await c.notification.show(n(`settings.collectionExportFailed`),`ERROR`)}},at=()=>{Je(!0)},ot=()=>{Je(!1),Fe.current?.click()},st=async e=>{let t=e.target.files?.[0];if(t)try{let e=await t.text(),r=JSON.parse(e);if(!Array.isArray(r)){await c.notification.show(n(`settings.collectionImportArrayError`),`ERROR`);return}let i=await ae(r);await c.notification.show(n(`settings.collectionImportCompleteSummary`,{created:i.created,updated:i.updated,skipped:i.skipped}),`SUCCESS`)}catch(e){A.log(`Collection import failed`,e),await c.notification.show(n(`settings.collectionImportFailed`),`ERROR`)}finally{e.target.value=``}},ct=async()=>{Ke(!0);try{await ze(),await c.broadcast.sendMessage(t.AUTHSYNCCHANNEL,{type:`BS_AUTH_STATE`,source:t.EXTENSIONID,snapshot:Ze()},{destination:`LOCAL`}),Re(ut()),Ve(Ge()),Ue(ht()),await c.notification.show(n(`settings.connectedAccount`),`SUCCESS`)}catch(e){A.error(`Battle-System auth connection failed`,e),await c.notification.show(n(`settings.unableToConnectAccount`),`ERROR`),Re(ut()),Ve(Ge()),Ue(ht())}finally{Ke(!1)}};return(0,H.jsxs)(Yd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},children:[(0,H.jsxs)(ym,{theme:e,children:[(0,H.jsx)(bm,{theme:e,children:n(`settings.pageTitle`)}),(0,H.jsxs)(xm,{theme:e,children:[(0,H.jsx)(Nm,{theme:e,children:n(`settings.accountSectionTitle`)}),(0,H.jsx)(Bm,{children:(0,H.jsx)(Sm,{theme:e,onClick:()=>{ct()},disabled:We,children:n(We?`settings.connecting`:Ie?`settings.reconnectAccount`:`settings.connectAccount`)})}),(0,H.jsx)(Vm,{theme:e,$connected:Ie,children:Ie?n(`settings.statusConnected`,{tier:Be}):n(`settings.statusDisconnected`)})]}),(0,H.jsxs)(xm,{theme:e,children:[(0,H.jsx)(Nm,{theme:e,children:n(`settings.collectionSectionTitle`)}),(0,H.jsxs)(Bm,{children:[(0,H.jsx)(Sm,{theme:e,onClick:it,children:n(`settings.export`)}),(0,H.jsx)(Sm,{theme:e,onClick:at,children:n(`settings.import`)})]}),(0,H.jsx)(`input`,{ref:Fe,type:`file`,accept:`.txt,.json,text/plain,application/json`,onChange:st,style:{display:`none`}})]}),(0,H.jsxs)(xm,{theme:e,children:[(0,H.jsx)(Nm,{theme:e,children:n(`settings.listControlsSectionTitle`)}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.reverseInitiative,children:n(`settings.reverseInitiative`)})}),(0,H.jsx)(Z,{label:n(`settings.reverseInitiative`),isOn:u,onChange:async e=>{d(e),await L(O.REVERSE_INITIATIVE,e),e&&s&&(l(!1),await L(O.POPCORN_INITIATIVE,!1))}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.popcornInitiative,children:n(`settings.popcornInitiative`)})}),(0,H.jsx)(Z,{label:n(`settings.popcornInitiative`),isOn:s,onChange:async e=>{l(e),await L(O.POPCORN_INITIATIVE,e),e&&u&&(d(!1),await L(O.REVERSE_INITIATIVE,!1))}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.initiativeDie,children:n(`settings.initiativeDie`)})}),(0,H.jsx)(Lm,{theme:e,type:`text`,value:f,onChange:async e=>{let t=e.target.value;m(t),await L(O.DICE_RANGE,t),A.log(`Dice Range:`,t)},placeholder:`D20`,maxLength:3})]}),(0,H.jsxs)(Pm,{theme:e,children:[(0,H.jsx)(Fm,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.initiativeModifierAttr,children:n(`settings.initiativeModifier`)})}),(0,H.jsxs)(Rm,{theme:e,value:_,onChange:async e=>{await tt(e.target.value)},children:[(0,H.jsx)(`option`,{value:``,children:n(`settings.none`)}),R.map(e=>(0,H.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name]},e.attr_bid))]})]}),(0,H.jsxs)(Pm,{theme:e,children:[(0,H.jsx)(Fm,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.initiativeModifierMath,children:n(`settings.math`)})}),(0,H.jsx)(Lm,{theme:e,type:`text`,value:y,onChange:e=>{b(e.target.value)},onBlur:async()=>{await nt()},placeholder:`floor((@STAT-10)/2)`,maxLength:120,disabled:!_}),(0,H.jsx)(zm,{theme:e,type:`button`,onClick:()=>{rt()},disabled:!_,children:n(`settings.test`)})]}),(0,H.jsx)(Im,{theme:e,children:n(`settings.initiativeModifierHint`)}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showCardColumn,children:n(`settings.showCardColumn`)})}),(0,H.jsx)(Z,{label:n(`settings.showCardColumn`),isOn:h,onChange:async e=>{g(e),await L(O.SHOW_CARD_ACCESS,e)}})]})]}),(0,H.jsxs)(xm,{theme:e,children:[(0,H.jsx)(Nm,{theme:e,children:n(`settings.playerControlsSectionTitle`)}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showPlayerView,children:n(`settings.showPlayerView`)})}),(0,H.jsx)(Z,{label:n(`settings.showPlayerView`),isOn:x,onChange:async e=>{S(e),await L(O.SHOW_PLAYER_VIEW,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showNonPartyUnits,children:n(`settings.showNonPartyUnits`)})}),(0,H.jsx)(Z,{label:n(`settings.showNonPartyUnits`),isOn:C,onChange:async e=>{w(e),await L(O.SHOW_NON_PARTY_UNITS,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showHpNumbersOnList,children:n(`settings.showHpNumbersOnList`)})}),(0,H.jsx)(Z,{label:n(`settings.showHpNumbersOnList`),isOn:T,onChange:async e=>{E(e),await L(O.SHOW_LIST_HP_NUMBERS,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.ownerOnlyEdit,children:n(`settings.ownerOnlyEdit`)})}),(0,H.jsx)(Z,{label:n(`settings.ownerOnlyEdit`),isOn:D,onChange:async e=>{ee(e),await L(O.SHOW_OWNER_ONLY_EDIT,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showAdjustHpContextMenu,children:n(`settings.showAdjustHpContextMenu`)})}),(0,H.jsx)(Z,{label:n(`settings.showAdjustHpContextMenu`),isOn:te,onChange:async e=>{ne(e),await L(O.SHOW_MODIFY_UNIT_CONTEXT_MENU,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showViewUnitContextMenuForPlayers,children:n(`settings.showViewUnitContextMenuForPlayers`)})}),(0,H.jsx)(Z,{label:n(`settings.showViewUnitContextMenuForPlayers`),isOn:re,onChange:async e=>{k(e),await L(O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS,e)}})]})]}),(0,H.jsxs)(xm,{theme:e,children:[(0,H.jsx)(Nm,{theme:e,children:n(`settings.gameControlsSectionTitle`)}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showHpBarsOnTokens,children:n(`settings.showHpBarsOnTokens`)})}),(0,H.jsx)(Z,{label:n(`settings.showHpBarsOnTokens`),isOn:ie,onChange:async e=>{oe(e),await L(O.SHOW_HP_BARS,e),e&&le&&(ue(!1),await L(O.SHOW_HP_NUMBERS,!1)),e&&I[O.HP_BAR_ORIENTATION]===void 0&&(ce(`bottom`),await L(O.HP_BAR_ORIENTATION,`bottom`))}})]}),(ie||le)&&(0,H.jsxs)(Pm,{theme:e,children:[(0,H.jsx)(Fm,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.hpOrientation,children:n(`settings.orientation`)})}),(0,H.jsxs)(Rm,{theme:e,value:se,onChange:async e=>{let t=e.target.value;ce(t),await L(O.HP_BAR_ORIENTATION,t)},children:[(0,H.jsx)(`option`,{value:`top`,children:n(`common.orientation.top`)}),(0,H.jsx)(`option`,{value:`bottom`,children:n(`common.orientation.bottom`)}),(0,H.jsx)(`option`,{value:`left`,children:n(`common.orientation.left`)}),(0,H.jsx)(`option`,{value:`right`,children:n(`common.orientation.right`)})]})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showHpNumbersOnTokens,children:n(`settings.showHpNumbersOnTokens`)})}),(0,H.jsx)(Z,{label:n(`settings.showHpNumbersOnTokens`),isOn:le,onChange:async e=>{ue(e),await L(O.SHOW_HP_NUMBERS,e),e&&ie&&(oe(!1),await L(O.SHOW_HP_BARS,!1)),e&&I[O.HP_BAR_ORIENTATION]===void 0&&(ce(`bottom`),await L(O.HP_BAR_ORIENTATION,`bottom`))}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showDeathEffect,children:n(`settings.showDeathEffect`)})}),(0,H.jsx)(Z,{label:n(`settings.showDeathEffect`),isOn:de,onChange:async e=>{fe(e),await L(O.SHOW_DEATH_EFFECT,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showNamesOnTokens,children:n(`settings.showNamesOnTokens`)})}),(0,H.jsx)(Z,{label:n(`settings.showNamesOnTokens`),isOn:pe,onChange:async e=>{me(e),await L(O.SHOW_NAMES,e);let t=a.filter(e=>e.metadata[p.ON_LIST]===!0);e?(A.log(`Showing names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t.metadata[p.UNIT_NAME],n=t;e&&n.text&&(n.text.plainText=String(e))}})):(A.log(`Hiding names on tokens`),await c.scene.items.updateItems(t,e=>{for(let t of e){let e=t;e.text&&(e.text.plainText=``)}}))}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showTurnEffect,children:n(`settings.showTurnEffect`)})}),(0,H.jsx)(Z,{label:n(`settings.showTurnEffect`),isOn:he,onChange:async e=>{ge(e),await L(O.SHOW_TURN_EFFECT,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.useDescriptiveNames,children:n(`settings.useDescriptiveNames`)})}),(0,H.jsx)(Z,{label:n(`settings.useDescriptiveNames`),isOn:_e,onChange:async e=>{ve(e),await L(O.USE_DESCRIPTIVE_DUPLICATES,e)}})]})]}),(0,H.jsxs)(xm,{theme:e,children:[(0,H.jsx)(Nm,{theme:e,children:n(`settings.diceControlsSectionTitle`)}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.enableTextBasedRolls,children:n(`settings.enableTextBasedRolls`)})}),(0,H.jsx)(Z,{label:n(`settings.enableTextBasedRolls`),isOn:Ce,onChange:async e=>{N(e),await L(O.ENABLE_TEXT_BASED_ROLLS,e),e&&(Ee(!0),j(!1),xe(!1),M(!1),await L(O.ENABLE_OBR_NOTIFICATION,!0),await L(O.ENABLE_RUMBLE,!1),await L(O.ENABLE_BONES,!1),await L(O.ENABLE_DICE_PLUS,!1))}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.enableRumble,children:n(`settings.enableRumble`)})}),(0,H.jsx)(Z,{label:n(`settings.enableRumble`),isOn:ye,onChange:async e=>{j(e),await L(O.ENABLE_RUMBLE,e),e&&(xe(!1),M(!1),N(!1),await L(O.ENABLE_BONES,!1),await L(O.ENABLE_DICE_PLUS,!1),await L(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.enableBones,children:n(`settings.enableBones`)})}),(0,H.jsx)(Z,{label:n(`settings.enableBones`),isOn:be,onChange:async e=>{xe(e),await L(O.ENABLE_BONES,e),e&&(j(!1),M(!1),N(!1),await L(O.ENABLE_RUMBLE,!1),await L(O.ENABLE_DICE_PLUS,!1),await L(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.enableDicePlus,children:n(`settings.enableDicePlus`)})}),(0,H.jsx)(Z,{label:n(`settings.enableDicePlus`),isOn:Se,onChange:async e=>{M(e),await L(O.ENABLE_DICE_PLUS,e),e&&(j(!1),xe(!1),N(!1),await L(O.ENABLE_RUMBLE,!1),await L(O.ENABLE_BONES,!1),await L(O.ENABLE_TEXT_BASED_ROLLS,!1))}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.enableObrNotification,children:n(`settings.enableObrNotification`)})}),(0,H.jsx)(Z,{label:n(`settings.enableObrNotification`),isOn:Te,onChange:async e=>{Ee(e),await L(O.ENABLE_OBR_NOTIFICATION,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.showResultsToAll,children:n(`settings.showResultsToAll`)})}),(0,H.jsx)(Z,{label:n(`settings.showResultsToAll`),isOn:De,onChange:async e=>{Oe(e),await L(O.SHOW_NOTIFICATION_TO_ALL,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.enableDiscordLogging,children:n(`settings.enableDiscordLogging`)})}),(0,H.jsx)(Z,{label:n(`settings.enableDiscordLogging`),isOn:ke,onChange:async e=>{if(e&&!Ye(je.trim())){await c.notification.show(n(`settings.invalidDiscordWebhookWarning`),`WARNING`),Ae(!1),await L(O.ENABLE_DISCORD_LOGGING,!1);return}Ae(e),await L(O.ENABLE_DISCORD_LOGGING,e)}})]}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)(Fm,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.discordUrl,children:n(`settings.discordUrl`)})}),(0,H.jsx)(Lm,{theme:e,type:`text`,value:je,onChange:async e=>{let t=e.target.value,n=t.trim();Me(t),await L(O.DISCORD_URL,n),A.log(`Discord URL:`,n)},placeholder:`https://discord.com/api/webhooks/...`,maxLength:200})]})]}),(0,H.jsxs)(xm,{theme:e,children:[(0,H.jsx)(Nm,{theme:e,children:n(`settings.otherSectionTitle`)}),(0,H.jsxs)(Q,{theme:e,children:[(0,H.jsx)($,{theme:e,children:(0,H.jsx)(P,{theme:e,text:F.enableConsoleLog,children:n(`settings.enableConsoleLog`)})}),(0,H.jsx)(Z,{label:n(`settings.enableConsoleLog`),isOn:Ne,onChange:async e=>{Pe(e),A.setEnabled(e),await L(O.ENABLE_CONSOLE_LOG,e)}})]})]})]}),(0,H.jsx)(Am,{isOpen:qe,title:n(`settings.confirmImportTitle`),onClose:()=>Je(!1),actions:(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(Sm,{theme:e,variant:`secondary`,onClick:()=>Je(!1),children:n(`settings.cancel`)}),(0,H.jsx)(Sm,{theme:e,onClick:ot,children:n(`settings.continue`)})]}),children:(0,H.jsx)(Hm,{theme:e,children:n(`settings.importConfirmMessage`)})})]})};var Wm=T.div`
...
`;const Ym=()=>{let e=At(e=>e.messages),t=(0,B.useRef)(null),{theme:n}=Lt(),{t:r}=vt();return(0,B.useEffect)(()=>{t.current?.scrollIntoView({behavior:`smooth`})},[e]),(0,H.jsx)(Yd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,H.jsxs)(Wm,{children:[(0,H.jsx)(bm,{theme:n,children:r(`nav.systemLog`)}),(0,H.jsxs)(Gm,{children:[e.map(e=>(0,H.jsxs)(Km,{children:[(0,H.jsx)(qm,{children:e.timestamp}),(0,H.jsx)(Jm,{children:e.text})]},e.id)),(0,H.jsx)(`div`,{ref:t})]})]})})},Xm=`buff_effect_one`,Zm=`debuff_effect_one`,Qm=[{value:`buff_effect_one`,label:`Buff Effect One`},{value:`buff_effect_two`,label:`Buff Effect Two`}],$m=[{value:`debuff_effect_one`,label:`Debuff Effect One`},{value:`debuff_effect_two`,label:`Debuff Effect Two`}],eh=e=>Qm.some(t=>t.value===e),th=e=>$m.some(t=>t.value===e),nh=e=>{switch(e){case`buff_effect_two`:return`
uniform float2 size;
uniform float time;
...
`}},rh=e=>{switch(e){case`debuff_effect_two`:return`
uniform float2 size;
uniform float time;
...
`}};var ih=t.EXTENSIONID,ah=`com.battle-system.forge`;const oh={SYSTEM_NAME:`${ih}/SystemName`,IMPORT_DATE:`${ih}/ImportDate`,SNAPSHOT_PUBLIC_ID:`${ih}/SnapshotPublicId`};var sh=yt(E.attributes),ch=(e,t)=>e instanceof Error&&e.message?e.message:t,lh=T.div`
  display: flex;
  gap: 10px;
  margin-bottom: 20px;
`,uh=T.div`
...
`,Nh={initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20}};const Ph=()=>{let{theme:e,updateThemeFromSystem:t}=Lt(),{t:n,locale:r}=vt(),i=V(e=>e.sceneMetadata),a=V(e=>e.roomMetadata),o=a,s=V(e=>e.systemData),l=V(e=>e.setSystemData),[u,d]=(0,B.useState)(()=>et().premiumAuthorized),[p,m]=(0,B.useState)(``),[h,g]=(0,B.useState)(!1),[_,v]=(0,B.useState)(null),[y,b]=(0,B.useState)(null),[x,S]=(0,B.useState)(``),[w,T]=(0,B.useState)(null),[D,ee]=(0,B.useState)(null),[te,ne]=(0,B.useState)([]),[re,k]=(0,B.useState)(``),[ie,ae]=(0,B.useState)(``),[oe,se]=(0,B.useState)(Xm),[ce,le]=(0,B.useState)(Zm),[ue,fe]=(0,B.useState)(!1),[pe,me]=(0,B.useState)(!1),[he,ge]=(0,B.useState)(null),[_e,ve]=(0,B.useState)(null),[ye,j]=(0,B.useState)([]),[be,xe]=(0,B.useState)(!1),[Se,M]=(0,B.useState)(null),[N,we]=(0,B.useState)(``),Te={buff_effect_one:n(`system.buffVisualPreset.buff_effect_one`),buff_effect_two:n(`system.buffVisualPreset.buff_effect_two`)},Ee={debuff_effect_one:n(`system.debuffVisualPreset.debuff_effect_one`),debuff_effect_two:n(`system.debuffVisualPreset.debuff_effect_two`)};(0,B.useEffect)(()=>{let e=!0,t=async()=>{await pt(),e&&d(et().premiumAuthorized)},n=Fe(t=>{e&&d(t.premiumAuthorized)});return t(),()=>{e=!1,n()}},[]),(0,B.useEffect)(()=>{De(),je()},[i,a,s,u]);let De=()=>{try{if(!u){let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url},t=o[O.BUFF_VISUAL_PRESET],n=o[O.DEBUFF_VISUAL_PRESET],r=eh(t)?t:Xm,i=th(n)?n:Zm;S(E.name),T(null),ee(e),ne(E.attributes),k(sh.currentHpBid),ae(sh.maxHpBid),se(r),le(i);return}if(s){let e=o[O.HP_CURRENT_BID],t=o[O.HP_MAX_BID],n=o[O.BUFF_VISUAL_PRESET],r=o[O.DEBUFF_VISUAL_PRESET],i=eh(n)?n:null,a=th(r)?r:null;S(s.systemName),T(s.importDate),ee(s.theme),ne(s.attributes),k(e||``),ae(t||``),he&&i===he&&ge(null),_e&&a===_e&&ve(null),!ue&&!he&&se(e=>i||e),!pe&&!_e&&le(e=>a||e);return}let e=a[oh.SYSTEM_NAME],t=a[oh.IMPORT_DATE],n=o[O.HP_CURRENT_BID],r=o[O.HP_MAX_BID],i=o[O.BUFF_VISUAL_PRESET],c=o[O.DEBUFF_VISUAL_PRESET],l=eh(i)?i:null,d=th(c)?c:null;S(e||E.name),T(t||null),ee({primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url}),ne(E.attributes),k(n||``),ae(r||``),he&&l===he&&ge(null),_e&&d===_e&&ve(null),!ue&&!he&&se(e=>l||e),!pe&&!_e&&le(e=>d||e)}catch(e){A.error(`Error loading system from cache:`,e)}},Oe=async(e,t)=>{await c.room.setMetadata({[e]:t})},ke=(e,t)=>{if(Array.isArray(e))return e;if(typeof e==`string`){let r;try{r=JSON.parse(e)}catch{throw Error(n(`system.error.invalidJsonField`,{field:t}))}if(!Array.isArray(r))throw Error(n(`system.error.invalidArrayField`,{field:t}));return r}throw Error(n(`system.error.invalidFieldType`,{field:t}))},Ae=te.filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`numb`||t===`resource`}),je=()=>{try{let e=[];for(let t=0;t<localStorage.length;t++){let n=localStorage.key(t);if(n&&n.startsWith(`${ah}.`)&&n.endsWith(`.backup`)){let t=localStorage.getItem(n);if(t){let n=JSON.parse(t);e.push(n)}}}e.sort((e,t)=>new Date(t.backupDate).getTime()-new Date(e.backupDate).getTime()),j(e)}catch(e){A.error(`Error loading backups:`,e)}},Me=async e=>{try{if(!s){A.warn(`Cannot create backup: runtime system data is unavailable`);return}let e=s.systemName||E.name,t={name:e,backupDate:new Date().toISOString(),theme_primary:s.theme.primary,theme_offset:s.theme.offset,theme_background:s.theme.background,theme_border:s.theme.border,background_url:s.theme.background_url,card_layout:s.cardLayout,list_layout:s.listLayout,attributes:s.attributes},n=`${ah}.${e}.backup`;localStorage.setItem(n,JSON.stringify(t)),A.log(`Backup created for ${e}`),je()}catch(e){throw A.error(`Error creating backup:`,e),e}},Ne=e=>{try{let t=`${ah}.${e}.backup`;localStorage.removeItem(t),A.log(`Backup deleted for ${e}`),je(),b(n(`system.success.backupDeleted`,{name:e}))}catch(e){A.error(`Error deleting backup:`,e),v(n(`system.error.deleteBackup`))}},Pe=(e,t)=>{we(e),M(()=>t),xe(!0)},Ie=async()=>{xe(!1),Se&&(await Se(),M(null))},Le=()=>{xe(!1),M(null),we(``)},Re=async()=>{if(!p.trim()){v(n(`system.error.enterShareId`));return}Pe(n(`system.confirm.importSystem`),async()=>{await ze()})},ze=async()=>{if(!ht()){v(n(`system.error.premiumImport`));return}g(!0),v(null),b(null);try{await He();let{data:e,error:r}=await Ce(async()=>C.rpc(`bs_forge_import_system_snapshot`,{p_source_share_id:p.trim()}));if(r)throw r;if(!e){v(n(`system.error.noSystemFound`)),g(!1);return}let i=Array.isArray(e)?e[0]:e;if(!i||typeof i.snapshot_public_id!=`string`)throw Error(n(`system.error.snapshotInvalid`));let a=ke(i.card_layout,`card_layout`),o=ke(i.list_layout,`list_layout`),s=ke(i.attributes,`attributes`);if(!Array.isArray(s))throw Error(n(`system.error.attributesInvalid`));await Me(x);let u={primary:i.theme_primary,offset:i.theme_offset,background:i.theme_background,border:i.theme_border,background_url:i.background_url},d=new Date().toISOString();await c.room.setMetadata({[oh.SNAPSHOT_PUBLIC_ID]:i.snapshot_public_id,[oh.SYSTEM_NAME]:i.system_name,[oh.IMPORT_DATE]:d}),l({theme:u,cardLayout:a,listLayout:o,attributes:s,systemName:i.system_name,importDate:d,snapshotPublicId:i.snapshot_public_id}),S(i.system_name),T(d),ee(u),t(u.primary,u.offset,u.background,u.border,u.background_url),b(n(`system.success.systemImported`,{name:i.system_name})),m(``),A.log(`System snapshot imported and loaded:`,{systemName:i.system_name,snapshotPublicId:i.snapshot_public_id})}catch(e){A.error(`Error fetching system:`,e),v(ch(e,n(`system.error.fetchSystem`)))}finally{g(!1)}},Be=async e=>{Pe(n(`system.confirm.restoreBackup`,{name:e.name}),async()=>{await Ve(e)})},Ve=async e=>{g(!0),v(null),b(null);try{if(!ht()){v(n(`system.error.premiumRestore`));return}await He(),await Me(x);let r={primary:e.theme_primary,offset:e.theme_offset,background:e.theme_background,border:e.theme_border,background_url:e.background_url};if(!Array.isArray(e.card_layout)||!Array.isArray(e.list_layout)||!Array.isArray(e.attributes))throw Error(n(`system.error.backupInvalid`));let i=new Date().toISOString(),a=`forge-backup:${e.name.trim().toLowerCase()}`,{data:o,error:s}=await Ce(async()=>C.rpc(`bs_forge_upsert_user_snapshot_payload`,{p_source_share_id:a,p_system_name:e.name,p_background_url:e.background_url,p_theme_primary:e.theme_primary,p_theme_offset:e.theme_offset,p_theme_background:e.theme_background,p_theme_border:e.theme_border,p_card_layout:e.card_layout,p_list_layout:e.list_layout,p_attributes:e.attributes}));if(s)throw s;let u=Array.isArray(o)?o[0]:o;if(!u||typeof u.snapshot_public_id!=`string`)throw Error(n(`system.error.backupPublishFailed`));l({theme:r,cardLayout:e.card_layout,listLayout:e.list_layout,attributes:e.attributes,systemName:e.name,importDate:i,snapshotPublicId:u.snapshot_public_id}),await c.room.setMetadata({[oh.SNAPSHOT_PUBLIC_ID]:u.snapshot_public_id,[oh.SYSTEM_NAME]:e.name,[oh.IMPORT_DATE]:i}),S(e.name),T(i),ee(r),t(r.primary,r.offset,r.background,r.border,r.background_url),b(n(`system.success.backupRestored`,{name:e.name})),A.log(`System restored from backup:`,e.name)}catch(e){A.error(`Error restoring backup:`,e),v(n(`system.error.restoreBackup`))}finally{g(!1)}},Ue=async()=>{g(!0),v(null),b(null);try{let e={primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url};l({theme:e,cardLayout:E.card_layout,listLayout:E.list_layout,attributes:E.attributes,systemName:E.name,importDate:null,snapshotPublicId:null}),await c.room.setMetadata({[oh.SNAPSHOT_PUBLIC_ID]:null,[oh.SYSTEM_NAME]:E.name,[oh.IMPORT_DATE]:null}),S(E.name),T(null),ee(e),t(e.primary,e.offset,e.background,e.border,e.background_url),b(n(`system.success.resetDefault`))}catch(e){v(n(`system.error.resetDefault`)),A.error(`Error resetting to default:`,e)}finally{g(!1)}},We=e=>e?new Date(e).toLocaleDateString(r,{year:`numeric`,month:`long`,day:`numeric`,hour:`2-digit`,minute:`2-digit`}):null,Ge=!u,Ke=!u;return(0,H.jsxs)(Yd.div,{variants:Nh,initial:`initial`,animate:`animate`,exit:`exit`,children:[(0,H.jsxs)(ym,{theme:e,children:[(0,H.jsx)(bm,{theme:e,children:n(`system.pageTitle`)}),(0,H.jsx)(dh,{theme:e,children:x}),w?(0,H.jsx)(fh,{theme:e,children:n(`system.importedOn`,{value:We(w)})}):(0,H.jsx)(fh,{theme:e,children:n(`system.usingDefaultSystem`)}),D&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsxs)(ph,{children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(mh,{color:D.primary,theme:e,children:D.primary}),(0,H.jsx)(hh,{theme:e,children:n(`system.swatch.primary`)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(mh,{color:D.offset,theme:e,children:D.offset}),(0,H.jsx)(hh,{theme:e,children:n(`system.swatch.offset`)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(mh,{color:D.background,theme:e,children:D.background}),(0,H.jsx)(hh,{theme:e,children:n(`system.swatch.background`)})]}),(0,H.jsxs)(`div`,{children:[(0,H.jsx)(mh,{color:D.border,theme:e,children:D.border}),(0,H.jsx)(hh,{theme:e,children:n(`system.swatch.border`)})]})]}),(0,H.jsxs)(gh,{theme:e,children:[(0,H.jsx)(_h,{theme:e,children:n(`system.settingsSectionTitle`)}),(0,H.jsxs)(vh,{children:[(0,H.jsx)(yh,{theme:e,children:n(`system.currentHp`)}),(0,H.jsxs)(bh,{theme:e,value:re,disabled:Ke,onChange:async e=>{if(Ke)return;let t=e.target.value;k(t),await Oe(O.HP_CURRENT_BID,t)},children:[(0,H.jsx)(`option`,{value:``,children:n(`system.selectAttribute`)}),Ae.map(e=>(0,H.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name,String(e.attr_type||``).toLowerCase()===`resource`?n(`system.resourceOptionSuffix`):``]},e.attr_bid))]})]}),(0,H.jsxs)(vh,{children:[(0,H.jsx)(yh,{theme:e,children:n(`system.maxHp`)}),(0,H.jsxs)(bh,{theme:e,value:ie,disabled:Ke,onChange:async e=>{if(Ke)return;let t=e.target.value;ae(t),await Oe(O.HP_MAX_BID,t)},children:[(0,H.jsx)(`option`,{value:``,children:n(`system.selectAttribute`)}),Ae.map(e=>(0,H.jsxs)(`option`,{value:e.attr_bid,children:[e.attr_abbr,` — `,e.attr_name,String(e.attr_type||``).toLowerCase()===`resource`?n(`system.resourceOptionSuffix`):``]},e.attr_bid))]})]}),Ke&&(0,H.jsx)(fh,{theme:e,children:n(`system.premiumHpMappingLocked`)}),(0,H.jsxs)(vh,{children:[(0,H.jsx)(yh,{theme:e,children:n(`system.buffVisual`)}),(0,H.jsx)(bh,{theme:e,value:oe,onChange:async e=>{let t=e.target.value;if(eh(t)){se(t),ge(t),fe(!0);try{await Oe(O.BUFF_VISUAL_PRESET,t)}finally{fe(!1)}}},children:Qm.map(e=>(0,H.jsx)(`option`,{value:e.value,children:Te[e.value]},e.value))})]}),(0,H.jsxs)(vh,{children:[(0,H.jsx)(yh,{theme:e,children:n(`system.debuffVisual`)}),(0,H.jsx)(bh,{theme:e,value:ce,onChange:async e=>{let t=e.target.value;if(th(t)){le(t),ve(t),me(!0);try{await Oe(O.DEBUFF_VISUAL_PRESET,t)}finally{me(!1)}}},children:$m.map(e=>(0,H.jsx)(`option`,{value:e.value,children:Ee[e.value]},e.value))})]})]})]}),(0,H.jsxs)(uh,{theme:e,children:[(0,H.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0},children:n(`system.importSectionTitle`)}),(0,H.jsx)(`p`,{style:{color:f(e.PRIMARY,.8),fontSize:`14px`},children:n(Ge?`system.importLockedDescription`:`system.importDescription`)}),(0,H.jsx)(lh,{children:(0,H.jsx)(Cm,{theme:e,type:`text`,value:p,onChange:e=>m(e.target.value),placeholder:Ge?``:n(`system.shareIdPlaceholder`),disabled:h||Ge,onKeyPress:e=>e.key===`Enter`&&Re()})}),(0,H.jsxs)(Ch,{children:[(0,H.jsx)(Sm,{theme:e,onClick:Re,disabled:h||Ge||!p.trim(),children:n(h?`system.importButtonLoading`:`system.importButton`)}),(0,H.jsx)(Sm,{theme:e,variant:`secondary`,onClick:Ue,disabled:h,children:n(`system.useDefaultButton`)})]})]}),_&&(0,H.jsxs)(xh,{theme:e,children:[(0,H.jsx)(`strong`,{children:n(`system.errorPrefix`)}),` `,_]}),y&&(0,H.jsxs)(Sh,{theme:e,children:[(0,H.jsx)(`strong`,{children:n(`system.successPrefix`)}),` `,y]}),ye.length>0&&(0,H.jsx)(Th,{children:(0,H.jsxs)(xm,{theme:e,children:[(0,H.jsx)(`h3`,{style:{color:e.PRIMARY,marginTop:0,marginBottom:`15px`},children:n(`system.backupsSectionTitle`)}),(0,H.jsx)(Eh,{children:ye.map(t=>(0,H.jsxs)(Dh,{theme:e,children:[(0,H.jsxs)(Oh,{children:[(0,H.jsx)(kh,{theme:e,children:t.name}),(0,H.jsx)(Ah,{theme:e,children:n(`system.backedUpOn`,{value:We(t.backupDate)})})]}),(0,H.jsxs)(jh,{children:[(0,H.jsx)(Mh,{theme:e,onClick:()=>Be(t),disabled:h,title:n(`system.importBackupTitle`),children:(0,H.jsx)(de,{size:18})}),(0,H.jsx)(Mh,{theme:e,$variant:`danger`,onClick:()=>Ne(t.name),disabled:h,title:n(`system.deleteBackupTitle`),children:(0,H.jsx)(Je,{size:18})})]})]},`${t.name}-${t.backupDate}`))})]})})]}),(0,H.jsx)(Am,{isOpen:be,title:n(`system.confirmActionTitle`),onClose:Le,actions:(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(Sm,{theme:e,variant:`secondary`,onClick:Le,children:n(`system.cancel`)}),(0,H.jsx)(Sm,{theme:e,onClick:Ie,children:n(`system.confirm`)})]}),children:(0,H.jsx)(wh,{theme:e,children:N})})]},`system`)};function Fh(e,t){let n=e.replace(`#`,``);n.length===3&&(n=n.split(``).map(e=>e+e).join(``));let r=parseInt(n,16);return`rgba(${r>>16&255}, ${r>>8&255}, ${r&255}, ${t})`}var Ih=class{static async CenterViewportOnImage(e){let t=await c.scene.grid.getDpi(),n=await c.viewport.getScale(),r=await c.viewport.getWidth(),i=await c.viewport.getHeight(),a={x:r/2,y:i/2},o={x:a.x/n,y:a.y/n},s=await this.GetImageCenter(e,t),l={x:s.x-o.x,y:s.y-o.y},u={x:l.x*n*-1,y:l.y*n*-1};await c.viewport.animateTo({position:u,scale:n})}static async GetImageCenter(t,n){if(e(t)){let e=n/t.grid.dpi,r=t.image.width*e,i=t.image.height*e,a=t.grid.offset.x/t.image.width*r,o=t.grid.offset.y/t.image.height*i;return{x:t.position.x-a+r/2,y:t.position.y-o+i/2}}else if(o(t)&&t.points.length>0)return{x:t.points[0].x,y:t.points[0].y};else return{x:t.position.x,y:t.position.y}}};const Lh=`${z}/effects`;var Rh=`${z}/effects-expired`,zh=T.div`
  display: flex;
  flex-direction: column;
  gap: 10px;
`,Bh=T.div`
...
`,rg=T.span`
  ...
  font-weight: 700;
  padding: 0 3px;
`,ig=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const ag=({items:e,units:n,setItems:r,playerData:i})=>{let[a,o]=(0,B.useState)(null),[s,l]=(0,B.useState)(``),[u,d]=(0,B.useState)(`1`),[f,m]=(0,B.useState)(`rounds`),[h,g]=(0,B.useState)(`start`),[_,v]=(0,B.useState)(`neutral`),[y,b]=(0,B.useState)([]),[x,S]=(0,B.useState)(null),C=(0,B.useMemo)(()=>{let t=new Map;return e.forEach(e=>{e.metadata?.[p.ON_LIST]===!0&&t.set(e.id,ig(e.metadata?.[Lh]))}),t},[e]),w=e=>C.get(e)||[],T=async(t,n)=>{let i=n.filter(e=>e.remaining>0);r(e.map(e=>{if(e.id!==t)return e;let n={...e.metadata||{}};return i.length>0?n[Lh]=i:delete n[Lh],{...e,metadata:n}})),await c.scene.items.updateItems([t],e=>{let t={...e[0].metadata||{}};i.length>0?t[Lh]=i:delete t[Lh],e[0].metadata=t})},E=async e=>{try{await c.broadcast.sendMessage(Rh,{message:e},{destination:`ALL`})}catch(t){A.error(`Failed to broadcast expired effect message`,t),await c.notification.show(e,`WARNING`)}},D=async e=>{if(e.length!==0)try{await c.broadcast.sendMessage(t.MARKCONNECT,e,{destination:`LOCAL`})}catch(e){A.error(`Failed to broadcast marked effect update`,e)}},ee=async(t,n)=>{if(String(i?.role||``).toUpperCase()!==`GM`)return;let r=[],a=[],o=[];e.forEach(e=>{if(e.metadata?.[p.ON_LIST]!==!0)return;let i=ig(e.metadata?.[Lh]);if(i.length===0)return;let s=!1,c=[];i.forEach(r=>{if(!(r.endTiming===t&&(r.durationType===`turns`||e.id===n))){c.push(r);return}let i=r.remaining-1;if(s=!0,i<=0){a.push(`${e.name||`Unit`}: ${r.name} expired`),o.push({LabelName:r.name,TokenId:e.id,Show:!1});return}c.push({...r,remaining:i})}),s&&r.push({unitId:e.id,effects:c})});for(let e of r)await T(e.unitId,e.effects);if(await D(o),a.length>0)for(let e of a)await E(e)},te=(0,B.useMemo)(()=>a&&n.find(e=>e.id===a)||null,[a,n]),ne=(0,B.useMemo)(()=>a?w(a):[],[a,C]);return(0,B.useEffect)(()=>{let e=c.broadcast.onMessage(Rh,async e=>{let t=e.data?.message;typeof t!=`string`||!t.trim()||await c.notification.show(t,`WARNING`)});return()=>{e()}},[]),{effectsModalUnitId:a,selectedEffectsUnit:te,activeEffectsForSelectedUnit:ne,effectNameInput:s,setEffectNameInput:l,effectDurationInput:u,setEffectDurationInput:d,effectDurationType:f,setEffectDurationType:m,effectEndTiming:h,setEffectEndTiming:g,effectType:_,setEffectType:v,effectTargetIds:y,setEffectTargetIds:e=>{b(Array.from(new Set(e)))},effectsModalError:x,units:n,getEffectsForUnit:w,handleOpenEffectsModal:e=>{S(null),l(``),d(`1`),m(`rounds`),g(`start`),v(`neutral`),b([e]),o(e)},handleCloseEffectsModal:()=>{o(null),S(null)},handleAddEffect:async()=>{if(!a)return;let t=s.trim(),r=parseInt(u,10);if(!t){S(`Enter an effect name.`);return}if(!Number.isFinite(r)||r<=0){S(`Duration must be a positive number.`);return}let i=Array.from(new Set(y.filter(e=>n.some(t=>t.id===e))));if(i.length===0){S(`Select at least one target.`);return}let o=w(a),c=te?.name||e.find(e=>e.id===a)?.name||`Unknown`,p={id:crypto.randomUUID(),name:t,remaining:r,durationType:f,endTiming:h,effectType:_,targets:i,createdByName:c,createdById:a};await T(a,[...o,p]),await D([{LabelName:p.name,TokenId:a,Show:!0}]),S(null),l(``),d(`1`),v(`neutral`),b([a])},handleDeleteEffect:async e=>{if(!a)return;let t=w(a),n=t.find(t=>t.id===e);await T(a,t.filter(t=>t.id!==e)),n&&await D([{LabelName:n.name,TokenId:a,Show:!1}])},processEffectsForTurnEvent:ee}},og=({manager:e})=>{let{theme:t}=Lt(),n=(0,B.useMemo)(()=>{let t=new Map;return e.units.forEach(e=>{t.set(e.id,e.name)}),t},[e.units]),r=e=>e===`buff`?`Buff`:e===`debuff`?`Debuff`:`Neutral`,i=e=>{if(e.length===0)return`No targets`;let t=e.map(e=>n.get(e)).filter(e=>typeof e==`string`&&e.length>0);return t.length===0?`${e.length} target${e.length===1?``:`s`}`:t.length<=2?t.join(`, `):`${t.slice(0,2).join(`, `)} +${t.length-2}`};return(0,H.jsx)(Am,{isOpen:!!e.effectsModalUnitId,title:e.selectedEffectsUnit?`Effects: ${e.selectedEffectsUnit.name}`:`Effects`,onClose:e.handleCloseEffectsModal,minWidth:`520px`,maxWidth:`600px`,children:(0,H.jsxs)(zh,{children:[(0,H.jsxs)(Bh,{children:[(0,H.jsxs)(Vh,{children:[(0,H.jsxs)(Hh,{style:{flex:`0 0 120px`},children:[(0,H.jsx)(Wh,{theme:t,children:`Effect`}),(0,H.jsx)(Gh,{theme:t,type:`text`,placeholder:`Name`,value:e.effectNameInput,onChange:t=>e.setEffectNameInput(t.target.value)})]}),(0,H.jsxs)(Hh,{style:{flex:`0 0 140px`},children:[(0,H.jsx)(Wh,{theme:t,children:`Duration`}),(0,H.jsx)(Gh,{theme:t,type:`number`,min:1,value:e.effectDurationInput,onChange:t=>e.setEffectDurationInput(t.target.value)})]}),(0,H.jsxs)(Hh,{style:{flex:`0 0 120px`},children:[(0,H.jsx)(Wh,{theme:t,children:`By`}),(0,H.jsxs)(Kh,{theme:t,value:e.effectDurationType,onChange:t=>e.setEffectDurationType(t.target.value),children:[(0,H.jsx)(`option`,{value:`turns`,children:`Turns`}),(0,H.jsx)(`option`,{value:`rounds`,children:`Rounds`})]})]})]}),(0,H.jsxs)(Vh,{children:[(0,H.jsxs)(Hh,{style:{flex:`0 0 120px`},children:[(0,H.jsx)(Wh,{theme:t,children:`Type`}),(0,H.jsxs)(Kh,{theme:t,value:e.effectType,onChange:t=>e.setEffectType(t.target.value),children:[(0,H.jsx)(`option`,{value:`neutral`,children:`Neutral`}),(0,H.jsx)(`option`,{value:`buff`,children:`Buff`}),(0,H.jsx)(`option`,{value:`debuff`,children:`Debuff`})]})]}),(0,H.jsxs)(Hh,{style:{flex:`0 0 140px`},children:[(0,H.jsx)(Wh,{theme:t,children:`Ends at`}),(0,H.jsxs)(Kh,{theme:t,value:e.effectEndTiming,onChange:t=>e.setEffectEndTiming(t.target.value),children:[(0,H.jsx)(`option`,{value:`start`,children:`Start of turn`}),(0,H.jsx)(`option`,{value:`end`,children:`End of turn`})]})]}),(0,H.jsx)(Uh,{children:(0,H.jsx)(Jh,{theme:t,onClick:e.handleAddEffect,style:{width:`100%`},children:`Add`})})]})]}),(0,H.jsxs)(Hh,{children:[(0,H.jsx)(Wh,{theme:t,children:`Targets`}),(0,H.jsx)(qh,{theme:t,multiple:!0,value:e.effectTargetIds,onChange:t=>{let n=Array.from(t.target.selectedOptions).map(e=>e.value);e.setEffectTargetIds(n)},children:e.units.map(e=>(0,H.jsx)(`option`,{value:e.id,children:e.name},e.id))})]}),e.effectsModalError&&(0,H.jsx)(eg,{theme:t,children:e.effectsModalError}),e.activeEffectsForSelectedUnit.length===0?(0,H.jsx)($h,{theme:t,children:`No active effects.`}):(0,H.jsx)(Yh,{children:e.activeEffectsForSelectedUnit.map(n=>(0,H.jsxs)(Xh,{theme:t,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(Qh,{theme:t,children:n.name}),(0,H.jsxs)(Zh,{theme:t,children:[r(n.effectType),` • `,n.remaining,` `,n.durationType,` • ends at `,n.endTiming===`start`?`start of turn`:`end of turn`,` • by `,n.createdByName]}),(0,H.jsxs)(Zh,{theme:t,children:[`Targets: `,i(n.targets)]})]}),(0,H.jsx)(Jh,{theme:t,onClick:()=>{e.handleDeleteEffect(n.id)},children:`Delete`})]},n.id))})]})})},sg=({activeEffectsCount:e,canInteract:t,onOpen:n,icon:r})=>{let{theme:i}=Lt();return(0,H.jsxs)(tg,{children:[(0,H.jsx)(ng,{theme:i,$active:e>0,disabled:!t,onClick:()=>{t&&n()},children:r||(0,H.jsx)(ie,{})}),e>0&&(0,H.jsx)(rg,{theme:i,children:e>99?`99+`:e})]})};var cg=T.td`
  color: ${e=>e.theme.PRIMARY};
  padding: 2px 6px;
  text-align: center;
  font-size: 14px;
...
`;const ug=({theme:e,unit:t,canInteract:n,elevationDraftValue:r,onElevationDraftChange:i,onCommitElevationChange:a})=>(0,H.jsx)(cg,{theme:e,children:(0,H.jsx)(lg,{theme:e,type:`text`,inputMode:`decimal`,min:-999,max:999,step:1,value:r??String(t.elevation??0),readOnly:!n,onChange:n?e=>i(t.id,e.target.value):void 0,onBlur:n?e=>a(t.id,e.target.value):void 0,onKeyDown:e=>{n&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}})}),dg=({theme:e,canInteract:t,icon:n,activeEffectsCount:r,onOpen:i})=>(0,H.jsx)(cg,{theme:e,children:(0,H.jsx)(sg,{activeEffectsCount:r,canInteract:t,icon:n||(0,H.jsx)(ie,{}),onOpen:i})});var fg=`${z}/elevation-badge`,pg=`${z}/elevation-badge-owner`,mg=`${z}/elevation`,hg=200,gg=40,_g=60,vg=120,yg=24,bg=(e,t)=>{if(!e)return;if(e.startsWith(`#`))return Fh(e,t);let n=e.match(/^rgba\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([\d.]+)\)$/i);if(n){let[,e,r,i]=n;return`rgba(${e}, ${r}, ${i}, ${t})`}let r=e.match(/^rgb\((\d+)\s*,\s*(\d+)\s*,\s*(\d+)\)$/i);if(r){let[,e,n,i]=r;return`rgba(${e}, ${n}, ${i}, ${t})`}return e},xg=e=>`
    0 1px 1px ${f(e.BACKGROUND,.95)},
    0 0 2px ${f(e.BACKGROUND,.85)}
  `,Sg=/(\d+)d(\d+)([kd][hl]\d+|!)?/gi,Cg={anchor:mt,aperture:Ie,award:gt,batterycharging:Ne,book:Ke,calendar:tt,clock:lt,cloudlightning:I,drama:qe,carrot:Ue,bone:We,compass:ot,dollarsign:Pe,feather:st,eye:it,heart:je,moon:Ae,music:he,shield:fe,star:De,sun:ie,target:_e,users:xe,wind:ve,zap:k,sword:_t,swords:M,axe:dt,bowarrow:L,coins:Re,wand:j,flower:Ve,skull:Oe,castle:Be,cross:$e,testtubediagonal:me,squirrel:pe,snowflake:Ee,shell:ge,pickaxe:nt,heartplus:Se,heartcrack:re,fan:R},wg=T.div`
  padding: 2px;
  width: 100%;
`,Tg=T.h1`
  color: ${e=>e.theme.PRIMARY};
...
`,Pg=T.table`
  ...
  min-width: ${e=>e.$compact?`${hg}px`:`100%`};
...
`,qg=T.input`
  ...
  border-radius: 4px;
  color: ${e=>e.theme.PRIMARY};
  text-shadow: ${e=>e.$isRollable?xg(e.theme):`none`};
...
`,N_=T.div`
  ...
  border: 1px solid ${e=>f(e.theme.BORDER,.8)};
  background: ${e=>f(e.theme.BACKGROUND,.55)};
`,P_=(e,t,n)=>{let r=[{id:crypto.randomUUID(),type:`initiative`,description:n(`initiative.defaultInitiativeDescription`)},{id:crypto.randomUUID(),type:`name`,description:n(`initiative.defaultNameDescription`)}],i=t?[{id:`card-column`,type:`card-column`}]:[];if(!e||e.length===0)return[...r,...i];let a=[...e].sort((e,t)=>e.col-t.col).map(e=>({id:e.id,type:e.type,name:e.styles?.labelName,useIcon:e.styles?.labelMode===`icon`,iconType:e.styles?.labelIcon,description:e.styles?.description,styles:e.styles}));return[...r,...a,...i]};const F_=()=>{let{t:r}=vt(),{theme:i}=Lt(),{listLayout:a,attributes:o,isLoading:s}=Mm(),l=V(e=>e.roomMetadata),u=V(e=>e.sceneMetadata),d=V(e=>e.items),f=V(e=>e.partyData),m=V(e=>e.playerData),h=V(e=>e.gridDpi),g=V(e=>e.setItems),[_,v]=(0,B.useState)([]),[y,b]=(0,B.useState)([]),[x,S]=(0,B.useState)(null),[C,w]=(0,B.useState)(1),[T,E]=(0,B.useState)(new Set),[D,ee]=(0,B.useState)(null),[te,re]=(0,B.useState)(null),[k,ae]=(0,B.useState)(!1),[oe,se]=(0,B.useState)(!1),[ce,le]=(0,B.useState)(!1),[ue,de]=(0,B.useState)({}),[fe,pe]=(0,B.useState)({}),[me,he]=(0,B.useState)({}),[ge,_e]=(0,B.useState)(null),[ve,ye]=(0,B.useState)({}),[j,Se]=(0,B.useState)(null),[M,Ce]=(0,B.useState)(null),[N,we]=(0,B.useState)(!1),[Te,Ee]=(0,B.useState)(!1),[De,Oe]=(0,B.useState)(!1),[ke,Ae]=(0,B.useState)(()=>window.innerWidth<400),[je,Me]=(0,B.useState)(null),Ne=(0,B.useRef)(null),Pe=(0,B.useRef)({}),Fe=(0,B.useRef)({}),Ie=(0,B.useRef)(null);(0,B.useEffect)(()=>{let e=()=>{Ae(window.innerWidth<400)};return window.addEventListener(`resize`,e),()=>{window.removeEventListener(`resize`,e)}},[]);let Re=(0,B.useMemo)(()=>{let e=Array.isArray(m?.selection)?m.selection:[];return new Set(e)},[m?.selection]),ze=l,Be=ze[O.REVERSE_INITIATIVE]||!1,Ve=ze[O.POPCORN_INITIATIVE]||!1,He=ze[O.SHOW_CARD_ACCESS]||!1,Ue=ze[O.SHOW_NON_PARTY_UNITS]||!1,We=ze[O.SHOW_LIST_HP_NUMBERS],Ge=typeof We==`boolean`?We:!0,Ke=ze[O.DICE_RANGE]||``,qe=ze[O.INITIATIVE_MODIFIER_BID]||``,Je=ze[O.INITIATIVE_MODIFIER_EXPR]||`@STAT`,Ye=Je.trim().length>0?Je:`@STAT`,P=ze[O.SHOW_OWNER_ONLY_EDIT]||!1,F=String(m?.role||``).toUpperCase()===`GM`,Xe=m?.id||``,I=ne(O.INITIATIVE_LIST_COMPACT,Xe);(0,B.useEffect)(()=>{let e=ze[I],t=ze[O.INITIATIVE_LIST_COMPACT];Oe(typeof e==`boolean`?e:typeof t==`boolean`?t:!1)},[ze,I]);let Ze=async()=>{let e=!De;Oe(e);try{await c.room.setMetadata({[I]:e})}catch(t){A.error(`Failed to persist initiative list compact mode`,t),Oe(!e)}},L=async({notation:e,actionName:t,tokenName:n,senderId:r,senderColor:i})=>{try{await be({notation:e,actionName:t,senderName:n,senderId:r,senderColor:i},ze)}catch(t){A.error(`Failed to send dice roll from InitiativeList`,e,t),A.log(e)}},Qe=e=>{let t=e;if(typeof t==`string`)try{t=JSON.parse(t)}catch{return[]}return Array.isArray(t)?t.map((e,t)=>{let n=e&&typeof e==`object`?e:{},r=n.inUse,i=typeof r==`boolean`?r:typeof r==`string`?[`true`,`1`,`yes`].includes(r.trim().toLowerCase()):typeof r==`number`?r===1:void 0;return{id:typeof n.id==`string`&&n.id?n.id:`entry-${t}`,name:typeof n.name==`string`?n.name:``,description:typeof n.description==`string`?n.description:``,...i===void 0?{}:{inUse:i}}}):[]};(0,B.useEffect)(()=>{v(d.filter(e=>e.metadata?.[p.ON_LIST]===!0).map(e=>{let t=e.metadata?.[p.INITIATIVE]||0,n=e.metadata[p.UNIT_NAME]||e.name||`Unknown`,r=e.metadata?.[p.BOSS_MODE]===!0,i=e.metadata?.[mg]||0,a=f.find(t=>t.id===e.createdUserId)||(m?.id===e.createdUserId?m:void 0),o=String(a?.role||``).toUpperCase()===`GM`,s=a?.color||(m?.id===e.createdUserId?m?.color:void 0),c=o?void 0:bg(s,1),l={};return Object.keys(e.metadata||{}).forEach(t=>{t.startsWith(`com.battle-system.forge`)&&(l[t]=e.metadata?.[t])}),{id:e.id,initiative:t,name:n,isBoss:r,elevation:i,attributes:l,createdUserId:e.createdUserId,ownerNameOutlineColor:c,isInParty:e.metadata?.[p.IN_PARTY]===!0,isVisible:e.visible!==!1}}))},[d,f,m]);let R=(0,B.useMemo)(()=>Ve?[..._].sort((e,t)=>e.name.localeCompare(t.name)):[..._].sort((e,t)=>e.initiative===t.initiative?e.name.localeCompare(t.name):Be?e.initiative-t.initiative:t.initiative-e.initiative),[_,Be,Ve]),$e=ag({items:d,units:R,setItems:g,playerData:m}),et=(0,B.useMemo)(()=>{let e=new Map;return f.forEach(t=>{e.set(t.id,t)}),m&&!e.has(m.id)&&e.set(m.id,m),Array.from(e.values()).sort((e,t)=>e.name.localeCompare(t.name))},[f,m]),tt=(e,t)=>{let n=parseInt(t)||0;v(t=>t.map(t=>t.id===e?{...t,initiative:n}:t))},nt=(e,t)=>{g(d.map(n=>n.id===e?{...n,metadata:{...n.metadata,[p.INITIATIVE]:t}}:n)),c.scene.items.updateItems([e],e=>{e[0].metadata[p.INITIATIVE]=t})},rt=e=>{let t=(e||``).trim().match(/(\d+)/),n=t?parseInt(t[1],10):NaN;return Number.isFinite(n)&&n>0?n:20},it=(e,t,n)=>(typeof t==`number`&&(e=Math.max(t,e)),typeof n==`number`&&(e=Math.min(n,e)),e),ot=(e,t,n)=>{let r=e.trim(),{min:i,max:a}=n||{};if(r.length===0)return it(0,i,a);let o=r.match(/^([+\-*/])\s*(-?\d+(?:\.\d+)?)$/),s=r.match(/^(-?\d+(?:\.\d+)?)\s*([+\-*/])\s*(-?\d+(?:\.\d+)?)$/),c=null;if(o){let e=o[1],n=parseFloat(o[2]);switch(e){case`+`:c=t+n;break;case`-`:c=t-n;break;case`*`:c=t*n;break;case`/`:c=n===0?t:t/n;break}}else if(s){let e=parseFloat(s[1]),t=s[2],n=parseFloat(s[3]);switch(t){case`+`:c=e+n;break;case`-`:c=e-n;break;case`*`:c=e*n;break;case`/`:c=n===0?e:e/n;break}}else{let e=parseFloat(r);Number.isNaN(e)||(c=e)}return it(c===null||!Number.isFinite(c)?t:Math.trunc(c),i,a)},st=e=>{let t=0;if(qe){let n=_.find(t=>t.id===e);if(n){let e=n.attributes?.[`${z}/${qe}`],r=Number(e),i=Number.isFinite(r)?r:0,a=Le(Ye.replace(/@STAT/gi,`@${qe}`).replace(/\bx\b/gi,`@${qe}`),{bidValueMap:{[qe]:i},onMissingBid:`useZero`});if(a.valid&&a.notation){let e=Number(a.notation);Number.isFinite(e)&&(t=Math.trunc(e))}}}return t},ct=(e,t=`normal`)=>{let n=rt(Ke),r=Math.floor(Math.random()*n)+1,i=t===`normal`?null:Math.floor(Math.random()*n)+1,a=(i===null?r:t===`advantage`?Math.max(r,i):Math.min(r,i))+st(e);tt(e,String(a)),nt(e,a)},lt=(e,t)=>{de(n=>({...n,[e]:t}))},ut=(e,t)=>{let n=ot(t,_.find(t=>t.id===e)?.initiative??0);de(t=>{let{[e]:n,...r}=t;return r}),v(t=>t.map(t=>t.id===e?{...t,initiative:n}:t)),nt(e,n)},dt=e=>`ELE${e.slice(3)}`,ft=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o}},pt=async(t,r)=>{let i=dt(t);try{await c.scene.items.deleteItems([i])}catch{}if(r===0)return;let a=d.find(e=>e.id===t);if(!a||!e(a))return;let o=ft(a,h),s=`${r>0?`🡹`:`🡻`}${Math.abs(r)}`,l=n().id(i).name(`Elevation Badge`).plainText(s).textType(`PLAIN`).fontWeight(900).fillOpacity(.95).fillColor(`white`).strokeWidth(8).strokeColor(`black`).strokeOpacity(1).fontSize(36).fontFamily(`Segoe UI`).textAlign(`CENTER`).position({x:o.minX-40,y:o.minY}).metadata({[fg]:!0,[pg]:t}).attachedTo(t).visible(a.visible).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).layer(`TEXT`).build();try{await c.scene.items.addItems([l])}catch(e){A.error(`Failed to add elevation badge`,t,e)}},mt=(e,t)=>{pe(n=>({...n,[e]:t}))},ht=(e,t,n)=>{let r=e.trim(),{min:i,max:a}=n||{};if(!r)return it(0,i,a);let o=parseFloat(r);return it(Number.isFinite(o)?Math.trunc(o):t,i,a)},gt=(e,t)=>{let n=ht(t,_.find(t=>t.id===e)?.elevation??0,{min:-999,max:999});pe(t=>{let{[e]:n,...r}=t;return r}),v(t=>t.map(t=>t.id===e?{...t,elevation:n}:t)),g(d.map(t=>t.id===e?{...t,metadata:{...t.metadata,[mg]:n}}:t)),c.scene.items.updateItems([e],e=>{e[0].metadata[mg]=n}),pt(e,n)},_t=(e,t)=>{let n=e.trim();if(!n)return e;let r=/^([+\-*/])\s*-?\d+(?:\.\d+)?$/.test(n),i=/^-?\d+(?:\.\d+)?\s*[+\-*/]\s*-?\d+(?:\.\d+)?$/.test(n),a=/^-?\d+(?:\.\d+)?$/.test(n);if(!r&&!i&&!a)return e;let o=typeof t==`number`?t:parseFloat(String(t)),s=Number.isFinite(o)?o:0;return String(ot(n,s))},yt=(e,t,n)=>{let r=`${z}/${t}`,i=d.find(t=>t.id===e)?.metadata?.[r],a=_t(n,i);v(t=>t.map(t=>t.id===e?{...t,attributes:{...t.attributes,[r]:a}}:t)),g(d.map(t=>t.id===e?{...t,metadata:{...t.metadata,[r]:a}}:t)),c.scene.items.updateItems([e],e=>{e[0].metadata[r]=a})},bt=e=>String(e?.attr_bid??e?.bid??``).trim(),St=e=>String(e?.attr_name??e?.name??``).trim(),Ct=e=>String(e?.attr_abbr??e?.abbr??``).trim(),wt=e=>String(e?.attr_type??e?.type??``).trim().toLowerCase(),Tt=e=>{let t=e?.attr_func??e?.func??``;return typeof t==`string`?t.trim():``},Et=e=>e?.attr_meta??e?.meta??{},Dt=e=>o.find(t=>bt(t)===e)||null,Ot=e=>Tt(Dt(e)).length>0,kt=e=>at(o,t=>e.attributes?.[`${z}/${t}`],bt,wt,Tt,St,Ct),At=(e,t)=>{let n=Array.from(e.matchAll(Sg));if(n.length!==1)return null;let r=n[0],i=r[0]||``,a=r[1]||``,o=r[2]||``,s=r[3]||``,c=r.index;if(!i||!a||!o||typeof c!=`number`)return null;let l=Number(a);if(!Number.isFinite(l)||l!==1||s)return null;let u=`2d${o}${t===`advantage`?`kh1`:`kl1`}`;return`${e.slice(0,c)}${u}${e.slice(c+i.length)}`},jt=(e,t)=>{let n=Tt(Dt(t));if(n.length===0)return null;let r=kt(e),i=Le(n,{bidValueMap:r.bidValueMap,nameValueMap:r.nameValueMap,onMissingBid:`error`});return!i.valid||!i.notation?(A.warn(`Could not resolve notation for initiative list value-column`,{unitId:e.id,bid:t,error:i.error}),null):{notation:i.notation,actionName:St(Dt(t))||t}},Mt=(e,t)=>{let n=Dt(t),r=Et(n)?.derived?.formula,i=typeof r==`string`&&r.trim().length>0?r:Tt(n);if(typeof i!=`string`||i.trim().length===0)return`-`;let a=kt(e),o=Le(i,{bidValueMap:a.bidValueMap,nameValueMap:a.nameValueMap,onMissingBid:`error`});if(!o.valid||!o.notation)return A.warn(`Could not resolve derived formula for initiative list derived-column`,{unitId:e.id,bid:t,error:o.error}),`-`;let s=o.notation.trim(),c=Number(s);if(!Number.isFinite(c))return s||`-`;let l=Number(Et(n)?.derived?.precision),u=Number.isFinite(l)?Math.max(0,Math.min(Math.trunc(l),8)):0,d=Et(n)?.derived?.displayMode,f=u>0?c.toFixed(u):String(c);return d===`percent`?`${f}%`:f},Nt=async(e,t)=>{let n=jt(e,t);if(!n)return;let r=f.find(t=>t.id===e.createdUserId);await L({notation:n.notation,actionName:n.actionName,tokenName:e.name,senderId:e.createdUserId||m?.id||`unknown`,senderColor:r?.color||m?.color||`#ffffff`})},Pt=async(e,t,n)=>{let i=jt(e,t);if(!i)return;let a=n===`normal`?i.notation:At(i.notation,n);if(!a)return;let o=f.find(t=>t.id===e.createdUserId),s=n===`normal`?``:r(n===`advantage`?`initiative.modeSuffixAdvantage`:`initiative.modeSuffixDisadvantage`);await L({notation:a,actionName:`${i.actionName}${s}`,tokenName:e.name,senderId:e.createdUserId||m?.id||`unknown`,senderColor:o?.color||m?.color||`#ffffff`})},Ft=async(e,t)=>{let n=t===`normal`?e.notation:At(e.notation,t);if(!n)return;let i=t===`normal`?``:r(t===`advantage`?`initiative.modeSuffixAdvantage`:`initiative.modeSuffixDisadvantage`);await L({notation:n,actionName:`${e.actionName}${i}`,tokenName:e.tokenName,senderId:e.senderId,senderColor:e.senderColor})};(0,B.useEffect)(()=>()=>{Object.values(Pe.current).forEach(e=>{window.clearTimeout(e)})},[]),(0,B.useEffect)(()=>{if(!j&&!M)return;let e=e=>{e.key===`Escape`&&(Se(null),Ce(null))};return window.addEventListener(`keydown`,e),()=>{window.removeEventListener(`keydown`,e)}},[j,M]);let It=(e,t)=>`value-column:${e}:${t}`,Rt=(e,t)=>`${e}:${t}`,zt=e=>!!ve[e],Bt=(e,t)=>{ye(t=>({...t,[e]:!0})),window.setTimeout(()=>{t?.focus(),t?.select()},0)},Vt=e=>{Se(e)},Ht=()=>{Se(null)},Ut=()=>{Ce(null)},Wt=e=>{ye(t=>{let{[e]:n,...r}=t;return r})},Gt=(e,t)=>{let n=Pe.current[e];n&&window.clearTimeout(n),Pe.current[e]=window.setTimeout(()=>{Fe.current[e]=!0,Bt(e,t),delete Pe.current[e]},500)},Kt=e=>{let t=Pe.current[e];t&&(window.clearTimeout(t),delete Pe.current[e])},qt=e=>Fe.current[e]?(delete Fe.current[e],!0):!1,Jt=e=>{if(!P||F)return!0;let t=m?.id;return t?e.createdUserId===t:!1},Yt=e=>F?!0:e.isVisible,Xt=e=>F||Ue?!1:!e.isInParty;(0,B.useEffect)(()=>{s||b(P_(a,He,r))},[a,s,He]),(0,B.useEffect)(()=>{let e=u[O.CURRENT_TURN],t=u[O.CURRENT_ROUND];e?S(e):R.length>0&&S(R[0].id),t&&w(t)},[u,R]);let Zt=async()=>{if(R.length===0)return;x&&await $e.processEffectsForTurnEvent(`end`,x);let e=R.findIndex(e=>e.id===x)+1;if(e>=R.length){let e=C+1;w(e),S(R[0].id),await c.scene.setMetadata({[O.CURRENT_TURN]:R[0].id,[O.CURRENT_ROUND]:e}),await $e.processEffectsForTurnEvent(`start`,R[0].id)}else S(R[e].id),await c.scene.setMetadata({[O.CURRENT_TURN]:R[e].id}),await $e.processEffectsForTurnEvent(`start`,R[e].id)},Qt=async()=>{if(R.length===0)return;let e=R.findIndex(e=>e.id===x)-1;if(e<0){let e=Math.max(1,C-1);w(e),S(R[R.length-1].id),await c.scene.setMetadata({[O.CURRENT_TURN]:R[R.length-1].id,[O.CURRENT_ROUND]:e})}else S(R[e].id),await c.scene.setMetadata({[O.CURRENT_TURN]:R[e].id})},$t=async e=>{Ve&&(T.has(e)||(S(e),await c.scene.setMetadata({[O.CURRENT_TURN]:e}),await $e.processEffectsForTurnEvent(`start`,e)))},en=async()=>{x&&(await $e.processEffectsForTurnEvent(`end`,x),E(e=>new Set([...e,x])),T.size+1,R.length)},tn=async()=>{let e=C+1;w(e),E(new Set),S(null),await c.scene.setMetadata({[O.CURRENT_TURN]:null,[O.CURRENT_ROUND]:e})},nn=async e=>{Ee(!0);try{if(e===`clear-list`){let e=d.filter(e=>e.metadata?.[p.ON_LIST]===!0).map(e=>e.id);e.length>0&&(await c.scene.items.updateItems(e,e=>{e.forEach(e=>{e.metadata&&p.ON_LIST in e.metadata&&delete e.metadata[p.ON_LIST]})}),g(d.map(e=>{if(e.metadata?.[p.ON_LIST]!==!0)return e;let t={...e.metadata||{}};return delete t[p.ON_LIST],{...e,metadata:t}})))}if(e===`reset-initiative`){let e=d.filter(e=>e.metadata?.[p.ON_LIST]===!0).map(e=>e.id);e.length>0&&(await c.scene.items.updateItems(e,e=>{e.forEach(e=>{e.metadata[p.INITIATIVE]=0})}),g(d.map(e=>e.metadata?.[p.ON_LIST]===!0?{...e,metadata:{...e.metadata||{},[p.INITIATIVE]:0}}:e)),v(e=>e.map(e=>d.some(t=>t.id===e.id&&t.metadata?.[p.ON_LIST]===!0)?{...e,initiative:0}:e)),de({}))}let t=e===`clear-list`?null:e===`reset-initiative`?[...R].sort((e,t)=>e.name.localeCompare(t.name))[0]?.id??null:R[0]?.id??null;w(1),S(t),E(new Set),await c.scene.setMetadata({[O.CURRENT_TURN]:t,[O.CURRENT_ROUND]:1}),we(!1)}catch(t){A.error(`Failed to reset encounter state`,{mode:e,error:t})}finally{Ee(!1)}},rn=async e=>{let t=d.find(t=>t.id===e);if(t)try{await Ih.CenterViewportOnImage(t)}catch(t){A.error(`Failed to center viewport on unit`,e,t)}},an=async(e,n)=>{try{let r=await c.viewport.getHeight(),i=r>800?700:r-100;await c.popover.open({id:t.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(n)}`,height:i,width:350,anchorElementId:e,hidePaper:!0,disableClickAway:!0})}catch(e){A.error(`Failed to open cards popover`,e)}},on=(e,t)=>{e.preventDefault(),e.stopPropagation(),re(null),ee(t)},sn=async e=>{if(D){if(!d.find(e=>e.id===D)){re(r(`initiative.tokenNotFoundInCache`));return}ae(!0),re(null);try{await c.scene.items.updateItems([D],t=>{let n=t[0];n.createdUserId=e}),g(d.map(t=>t.id===D?{...t,createdUserId:e}:t)),ee(null)}catch(t){A.error(`Failed to reassign token owner`,D,e,t),re(r(`initiative.assignOwnerPermissionError`))}finally{ae(!1)}}},cn=async()=>{if(!D)return;let e=d.find(e=>e.id===D);if(!e){re(r(`initiative.tokenNotFoundInCache`));return}let t=e.metadata?.[p.BOSS_MODE]!==!0;if(t&&d.filter(e=>e.id!==D&&e.metadata?.[p.ON_LIST]===!0&&e.metadata?.[p.BOSS_MODE]===!0).length>=2){re(r(`initiative.maxBossesError`));return}se(!0),re(null);try{await c.scene.items.updateItems([D],e=>{let n={...e[0].metadata||{}};n[p.BOSS_MODE]=t,e[0].metadata=n}),g(d.map(e=>e.id===D?{...e,metadata:{...e.metadata||{},[p.BOSS_MODE]:t}}:e))}catch(e){A.error(`Failed to toggle boss mode`,D,e),re(r(`initiative.updateBossModeError`))}finally{se(!1)}},ln=async()=>{if(D){if(!d.find(e=>e.id===D)){re(r(`initiative.tokenNotFoundInCache`));return}le(!0),re(null);try{await c.scene.items.updateItems([D],e=>{let t={...e[0].metadata||{}};p.ON_LIST in t&&delete t[p.ON_LIST],e[0].metadata=t}),g(d.map(e=>{if(e.id!==D)return e;let t={...e.metadata||{}};return delete t[p.ON_LIST],{...e,metadata:t}})),ee(null)}catch(e){A.error(`Failed to remove token from initiative list`,D,e),re(r(`initiative.removeUnitError`))}finally{le(!1)}}},un=(0,B.useMemo)(()=>D&&R.find(e=>e.id===D)||null,[D,R]),dn=(0,B.useMemo)(()=>D&&d.find(e=>e.id===D)||null,[D,d]),fn=dn?.metadata?.[p.BOSS_MODE]===!0,U=(0,B.useMemo)(()=>ge&&R.find(e=>e.id===ge.unitId)||null,[ge,R]),pn=(0,B.useMemo)(()=>ge&&o.find(e=>e.attr_bid===ge.bid)||null,[o,ge]),mn=(0,B.useMemo)(()=>{if(!ge||!U)return[];let e=U.attributes[`${z}/${ge.bid}`];return Qe(e)},[ge,U]),hn=(0,B.useMemo)(()=>mn.some(e=>typeof e.inUse==`boolean`),[mn]),gn=(0,B.useMemo)(()=>j&&R.find(e=>e.id===j.unitId)||null,[j,R]),_n=(0,B.useMemo)(()=>De?y.filter(e=>e.type===`initiative`||e.type===`name`?!0:e.type===`card-column`&&He):y,[De,y,He]),vn=(0,B.useMemo)(()=>xt(ze,o),[o,ze]),yn=(0,B.useMemo)(()=>R.filter(e=>Yt(e)),[R,F]),bn=(0,B.useMemo)(()=>{if(!U)return{};let e={};for(let t of o){let n=`${z}/${t.attr_bid}`,r=U.attributes?.[n];if(r==null||r===``)continue;let i=Number(r);Number.isFinite(i)&&(e[t.attr_bid]=i)}return e},[U,o]),xn=(0,B.useMemo)(()=>{if(!U)return{};let e={};for(let t of o){let n=`${z}/${t.attr_bid}`,r=U.attributes?.[n];if(r==null||r===``)continue;let i=Number(r);Number.isFinite(i)&&(t.attr_name&&(e[t.attr_name]=i),t.attr_abbr&&(e[t.attr_abbr]=i))}return e},[U,o]),Sn=e=>{let t=[],n=e.matchAll(/\[([^\[\]]+)\]/g);for(let e of n){let n=(e[1]||``).trim();if(!n)continue;let r=Le(n,{bidValueMap:bn,nameValueMap:xn,onMissingBid:`error`});!r.valid||!r.notation||t.push(r.notation)}return t};(0,B.useEffect)(()=>{Ie.current&&_n.length>0&&(A.debug(`Adjusting window width based on table size`),setTimeout(()=>{if(Ie.current){let e=Ie.current.offsetWidth+4,t=Math.min(e,800);c.action.setWidth(t),A.log(`Adjusted window width to `+t)}},100))},[De,_n.length,R.length]);let Cn=e=>{if(!e)return null;let t=Cg[e.toLowerCase()];return t?(0,H.jsx)(t,{}):null},wn=(e,t)=>{let n=window.innerWidth-t-8,r=Math.min(Math.max(e-t/2,8),Math.max(8,n));return{left:r,arrowX:e-r}},Tn=e=>{let t=e.currentTarget.getBoundingClientRect(),n=`clientX`in e?e.clientX:t.left+t.width/2,r=t.top>72?`top`:`bottom`;return{anchorX:n,y:r===`top`?t.top:t.bottom,placement:r}},En=(e,t)=>{let n=Tn(e),r=Math.min(320,Math.max(140,t.length*7+28)),i=wn(n.anchorX,r);Me({text:t,...n,...i})},Dn=()=>{Me(null)};(0,B.useLayoutEffect)(()=>{if(!je||!Ne.current)return;let e=Ne.current.getBoundingClientRect().width,t=wn(je.anchorX,e);(Math.abs(t.left-je.left)>.5||Math.abs(t.arrowX-je.arrowX)>.5)&&Me(e=>e&&{...e,...t})},[je]);let On=e=>e.type===`initiative`?(0,H.jsx)(xe,{}):e.type===`roller`?null:e.type===`name`?r(`initiative.nameHeader`):e.type===`card-column`?(0,H.jsx)(af,{}):e.type===`divider-column`?null:e.useIcon?Cn(e.iconType||`star`):e.name||e.type,kn=e=>e.type===`divider-column`?{fixedWidth:yg}:e.type===`initiative`?{minWidth:_g}:e.type===`name`?{minWidth:vg}:{minWidth:gg},An=(e,t)=>{let n=Jt(t),a=Xt(t),s=!F&&!Ge;if(a&&e.type!==`initiative`&&e.type!==`name`&&e.type!==`divider-column`)return(0,H.jsx)(Vg,{theme:i,children:(0,H.jsx)(M_,{theme:i})});switch(e.type){case`initiative`:if(Ve)return(0,H.jsx)(Hg,{theme:i,children:(0,H.jsx)(Kg,{onClick:e=>{e.stopPropagation(),n&&(T.has(t.id)||(t.id===x?en():$t(t.id)))},children:T.has(t.id)?(0,H.jsx)(nf,{color:i.OFFSET}):t.id===x?(0,H.jsx)(tf,{color:i.PRIMARY}):(0,H.jsx)(rf,{color:i.BORDER})})});let a=`initiative:${t.id}`,l=zt(a);return(0,H.jsx)(Hg,{theme:i,children:(0,H.jsx)(qg,{theme:i,$isRollable:n&&!l,type:`text`,inputMode:`decimal`,value:ue[t.id]??String(t.initiative),readOnly:!n||!l,onChange:!n||!l?void 0:e=>lt(t.id,e.target.value),onBlur:!n||!l?void 0:e=>{ut(t.id,e.target.value),Wt(a)},onClick:()=>{n&&(l||qt(a)||ct(t.id))},onContextMenu:e=>{n&&(e.preventDefault(),Vt({kind:`initiative`,fieldKey:a,unitId:t.id,input:e.currentTarget}))},onTouchStart:e=>{n&&(l||Gt(a,e.currentTarget))},onTouchEnd:()=>{Kt(a)},onTouchCancel:()=>{Kt(a)},onKeyDown:e=>{if(n){if(!l&&(e.key===`Enter`||e.key===` `)){e.preventDefault(),ct(t.id);return}l&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}}})});case`name`:let u=Re.has(t.id);return(0,H.jsx)(Jg,{theme:i,title:r(`initiative.rightClickAssignOwner`),$outlineColor:t.ownerNameOutlineColor,$isSelected:u,onDoubleClick:()=>rn(t.id),onContextMenu:n?e=>on(e,t.id):void 0,children:t.isBoss?`💀 ${t.name}`:t.name});case`roller`:return(0,H.jsx)(Ug,{theme:i,children:(0,H.jsx)(Wg,{theme:i,disabled:!n,onClick:e=>{e.stopPropagation(),n&&ct(t.id)},title:r(`initiative.rollInitiativeTitle`,{max:rt(Ke)}),children:(0,H.jsx)(Gg,{src:`/dice.svg`,alt:r(`initiative.rollIconAlt`)})})});case`card-column`:return(0,H.jsx)(Vg,{theme:i,children:(0,H.jsx)($g,{id:`card-access-${t.id}`,theme:i,disabled:!n,onClick:e=>{e.stopPropagation(),n&&an(e.currentTarget.id,t.id)},title:r(`initiative.openCardTitle`,{unit:t.name}),children:(0,H.jsx)(tf,{})})});case`value-column`:return(0,H.jsx)(Vg,{theme:i,children:(0,H.jsx)(Qg,{children:e.styles?.bidList?.map((r,a)=>{let o=Ot(r),c=It(t.id,r),l=Rt(t.id,r),u=o&&zt(c),d=t.attributes[`${z}/${r}`],f=me[l]??(d==null||d===``?`0`:String(d)),p=r===vn.currentHpBid||r===vn.maxHpBid,m=!!Xe&&t.createdUserId===Xe,h=s&&p&&!m;return(0,H.jsxs)(B.Fragment,{children:[a>0&&(0,H.jsx)(Zg,{theme:i,children:e.styles?.dividers?.[a-1]||`/`}),h?(0,H.jsx)(N_,{theme:i,$small:e.styles?.bidList&&e.styles.bidList.length>2}):(0,H.jsx)(Yg,{theme:i,$isRollable:n&&o,value:f,$small:e.styles?.bidList&&e.styles.bidList.length>2,readOnly:!n||o&&!u,onChange:!n||o&&!u?void 0:e=>{let t=e.target.value;he(e=>({...e,[l]:t}))},onBlur:!n||o&&!u?void 0:e=>{yt(t.id,r,e.target.value),he(e=>{let{[l]:t,...n}=e;return n}),o&&Wt(c)},onClick:o?()=>{n&&(u||qt(c)||Nt(t,r))}:void 0,onContextMenu:o?e=>{n&&(e.preventDefault(),Vt({kind:`attribute`,fieldKey:c,unitId:t.id,bid:r,input:e.currentTarget}))}:void 0,onTouchStart:o?e=>{n&&(u||Gt(c,e.currentTarget))}:void 0,onTouchEnd:o?()=>{Kt(c)}:void 0,onTouchCancel:o?()=>{Kt(c)}:void 0,onKeyDown:e=>{if(n){if(o&&!u&&(e.key===`Enter`||e.key===` `)){e.preventDefault(),Nt(t,r);return}(u||!o)&&e.key===`Enter`&&(e.preventDefault(),e.currentTarget.blur())}}})]},r)})})});case`list-column`:return(0,H.jsx)(Vg,{theme:i,children:(0,H.jsx)($g,{theme:i,disabled:!n,onClick:r=>{if(r.stopPropagation(),!n)return;let i=e.styles?.bidList?.[0];i&&_e({unitId:t.id,bid:i})},title:r(`initiative.openListReference`),children:(0,H.jsx)(Qd,{})})});case`checkbox-column`:return(0,H.jsx)(Vg,{theme:i,children:(0,H.jsx)(Qg,{children:e.styles?.bidList?.map(r=>{let a=!!t.attributes[`${z}/${r}`],o=e.styles?.inputType===`slider`,s=e=>{v(n=>n.map(n=>n.id===t.id?{...n,attributes:{...n.attributes,[`${z}/${r}`]:e}}:n)),g(d.map(n=>n.id===t.id?{...n,metadata:{...n.metadata,[`${z}/${r}`]:e}}:n)),c.scene.items.updateItems([t.id],t=>{t[0].metadata[`${z}/${r}`]=e})};return o?(0,H.jsx)(i_,{type:`button`,theme:i,$active:a,disabled:!n,onClick:n?()=>{s(!a)}:void 0,children:(0,H.jsx)(a_,{theme:i,$active:a})},r):(0,H.jsx)(e_,{theme:i,type:`checkbox`,checked:a,disabled:!n,onChange:n?e=>{s(e.target.checked)}:void 0},r)})})});case`derived-column`:{let n=e.styles?.bidList||[];return n.length===0?(0,H.jsx)(Vg,{theme:i,children:`-`}):(0,H.jsx)(Vg,{theme:i,children:(0,H.jsx)(Qg,{children:n.map((n,a)=>(0,H.jsxs)(B.Fragment,{children:[a>0&&(0,H.jsx)(Zg,{theme:i,children:e.styles?.dividers?.[a-1]||`/`}),(0,H.jsx)(t_,{theme:i,title:r(`initiative.derivedValueFormula`),children:Mt(t,n)})]},n))})})}case`enum-column`:{let r=e.styles?.bidList?.[0];if(!r)return(0,H.jsx)(Vg,{theme:i,children:`-`});let a=Et(Dt(r)),o=Array.isArray(a.enum?.options)?a.enum.options.map(e=>String(e||``).trim()).filter(e=>e.length>0):[],s=`${z}/${r}`,l=t.attributes[s],u=typeof l==`string`?l.trim():``,f=o.includes(u)?u:o[0]||``,p=e=>{v(n=>n.map(n=>n.id===t.id?{...n,attributes:{...n.attributes,[s]:e}}:n)),g(d.map(n=>n.id===t.id?{...n,metadata:{...n.metadata,[s]:e}}:n)),c.scene.items.updateItems([t.id],t=>{t[0].metadata[s]=e})};return(0,H.jsx)(Vg,{theme:i,children:(0,H.jsx)(Qg,{children:(0,H.jsx)(Xg,{theme:i,disabled:!n,value:f,onClick:e=>e.stopPropagation(),onChange:n?e=>{p(e.target.value)}:void 0,children:o.length===0?(0,H.jsx)(`option`,{value:``,children:`No options`}):o.map(e=>(0,H.jsx)(`option`,{value:e,children:e},e))})})})}case`resource-column`:{let r=e.styles?.bidList?.[0];if(!r)return(0,H.jsx)(Vg,{theme:i,children:`-`});let a=t.attributes[`${z}/${r}`],s=o.find(e=>bt(e)===r&&wt(e)===`resource`),l=a&&typeof a==`object`&&!Array.isArray(a)?a:null,u=l?Number(l.current??0):0,f=l?Number(l.max??0):0,p=(e,n)=>{let i=`${z}/${r}`,a={current:e,max:n};v(e=>e.map(e=>e.id===t.id?{...e,attributes:{...e.attributes,[i]:a}}:e)),g(d.map(e=>e.id===t.id?{...e,metadata:{...e.metadata,[i]:a}}:e)),c.scene.items.updateItems([t.id],e=>{e[0].metadata[i]=a})};if(Et(s)?.resource?.showPips){let e=Number(Et(s)?.resource?.pipCap),t=(Number.isFinite(e)&&e>0?Math.round(e):void 0)??f;if(t<=0)return(0,H.jsx)(Vg,{theme:i,children:`-`});let r=Math.max(1,Math.min(t,15)),a=Math.max(0,Math.min(u,r));return(0,H.jsx)(Vg,{theme:i,children:(0,H.jsx)(n_,{children:Array.from({length:r}).map((e,t)=>(0,H.jsx)(r_,{theme:i,$filled:t<a,disabled:!n,onClick:n?()=>{p(t+1===a?t:t+1,f)}:void 0},t))})})}return(0,H.jsx)(Vg,{theme:i,children:(0,H.jsxs)(Qg,{children:[(0,H.jsx)(Yg,{theme:i,$isRollable:!1,value:String(u),$small:!1,readOnly:!n,onChange:n?e=>{let t=Number(e.target.value);isNaN(t)||p(t,f)}:void 0}),(0,H.jsx)(Zg,{theme:i,children:`/`}),(0,H.jsx)(Yg,{theme:i,$isRollable:!1,value:String(f),$small:!1,readOnly:!n,onChange:n?e=>{let t=Number(e.target.value);isNaN(t)||p(u,t)}:void 0})]})})}case`special-column`:let f=Cn(e.iconType);if(e.styles?.specialType===`elevation`){let e=fe[t.id];return(0,H.jsx)(ug,{theme:i,unit:t,canInteract:n,elevationDraftValue:e,onElevationDraftChange:mt,onCommitElevationChange:gt})}else{let e=$e.getEffectsForUnit(t.id).length;return(0,H.jsx)(dg,{theme:i,canInteract:n,icon:f||(0,H.jsx)(ie,{}),activeEffectsCount:e,onOpen:()=>$e.handleOpenEffectsModal(t.id)})}case`divider-column`:return(0,H.jsx)(o_,{theme:i,children:(0,H.jsx)(s_,{children:e.styles?.styleDesign===`zigzag`?(0,H.jsx)(l_,{children:(0,H.jsx)(u_,{theme:i})}):(0,H.jsx)(c_,{theme:i,$style:e.styles?.styleDesign})})});default:return(0,H.jsx)(Vg,{theme:i,children:`-`})}};if(s)return(0,H.jsx)(wg,{children:(0,H.jsx)(Tg,{theme:i,children:`Loading...`})});let jn=De||ke,W=jn?`R:${C}`:`Round: ${C}`,Mn=!De&&jn;return(0,H.jsxs)(wg,{children:[(0,H.jsx)(Eg,{children:(0,H.jsxs)(Pg,{ref:Ie,theme:i,$compact:De,children:[(0,H.jsx)(Fg,{theme:i,children:(0,H.jsx)(Ig,{children:_n.map(e=>{let t=e.description??`This has no description.`,n=kn(e);return(0,H.jsx)(Lg,{theme:i,$minWidth:n.minWidth,$fixedWidth:n.fixedWidth,onMouseEnter:e=>En(e,t),onMouseMove:e=>En(e,t),onMouseLeave:Dn,onFocus:e=>En(e,t),onBlur:Dn,children:On(e)},e.id)})})}),(0,H.jsx)(zg,{children:yn.map(e=>(0,H.jsx)(Bg,{$isCurrentTurn:e.id===x,theme:i,children:_n.map(t=>(0,H.jsx)(B.Fragment,{children:An(t,e)},t.id))},e.id))})]})}),(0,H.jsxs)(Dg,{theme:i,$compactMode:jn,children:[(0,H.jsxs)(Og,{$compactMode:jn,children:[De?(0,H.jsxs)(H.Fragment,{children:[F&&(0,H.jsx)(kg,{theme:i,$compact:!0,onClick:Qt,children:(0,H.jsx)(Xd,{})}),F&&(0,H.jsx)(kg,{theme:i,$compact:!0,onClick:Zt,children:(0,H.jsx)(Zd,{})})]}):Ve?(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(kg,{theme:i,onClick:en,disabled:!x||T.has(x),children:`End Turn`}),(0,H.jsx)(Ng,{theme:i,$compactMode:jn,children:W}),(0,H.jsx)(kg,{theme:i,$compact:jn,onClick:tn,disabled:T.size<R.length,children:jn?(0,H.jsx)(Zd,{}):r(`initiative.next`)})]}):(0,H.jsxs)(H.Fragment,{children:[F&&(0,H.jsx)(kg,{theme:i,$compact:!0,onClick:Qt,children:(0,H.jsx)(Xd,{})}),(0,H.jsx)(Ng,{theme:i,$compactMode:jn,children:W}),F&&(0,H.jsx)(kg,{theme:i,$compact:!0,onClick:Zt,children:(0,H.jsx)(Zd,{})})]}),Mn&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(jg,{theme:i,onClick:()=>{Ze()},title:r(`initiative.switchToCompactList`),children:(0,H.jsx)(cf,{})}),F&&(0,H.jsx)(jg,{theme:i,onClick:()=>we(!0),disabled:Te,title:r(`initiative.resetRoundTurnState`),children:(0,H.jsx)(lf,{})})]}),De&&(0,H.jsx)(jg,{theme:i,onClick:()=>{Ze()},title:r(`initiative.switchToFullsizeList`),children:(0,H.jsx)(sf,{})})]}),!De&&!Mn&&(0,H.jsx)(Mg,{theme:i,$hasReset:F,onClick:()=>{Ze()},title:r(`initiative.switchToCompactList`),children:(0,H.jsx)(cf,{})}),F&&!De&&!Mn&&(0,H.jsx)(Ag,{theme:i,onClick:()=>we(!0),disabled:Te,title:r(`initiative.resetRoundTurnState`),children:(0,H.jsx)(lf,{})})]}),je&&(0,H.jsx)(Rg,{ref:Ne,theme:i,$left:je.left,$y:je.y,$placement:je.placement,$arrowX:je.arrowX,role:`tooltip`,children:je.text}),(0,H.jsxs)(Am,{isOpen:!!D,title:un?r(`initiative.unitTitle`,{unit:un.name}):r(`initiative.unitFallbackTitle`),onClose:()=>{k||oe||ce||(ee(null),re(null))},closeOnOverlayClick:!k&&!oe&&!ce,maxWidth:`520px`,children:[(0,H.jsx)(p_,{theme:i,children:r(`initiative.selectOwnerHint`)}),(0,H.jsxs)(d_,{children:[et.map(e=>(0,H.jsxs)(f_,{theme:i,$isCurrent:dn?.createdUserId===e.id,onClick:()=>sn(e.id),disabled:k||oe||ce,children:[e.name,dn?.createdUserId===e.id?r(`initiative.currentSuffix`):``]},e.id)),(0,H.jsx)(f_,{theme:i,onClick:()=>{ln()},disabled:k||oe||ce,children:r(ce?`initiative.removing`:`initiative.removeUnitFromList`)})]}),(0,H.jsx)(h_,{theme:i}),(0,H.jsxs)(g_,{theme:i,children:[(0,H.jsxs)(`div`,{children:[(0,H.jsx)(__,{theme:i,children:r(`initiative.bossMode`)}),(0,H.jsx)(v_,{theme:i,children:r(`initiative.bossModeHint`)})]}),(0,H.jsx)(y_,{children:(0,H.jsx)(b_,{type:`button`,theme:i,$active:fn,disabled:k||oe||ce,"aria-label":r(`initiative.toggleBossModeAria`),"aria-pressed":fn,onClick:()=>{cn()}})})]}),te&&(0,H.jsx)(m_,{theme:i,children:te})]}),(0,H.jsxs)(Am,{isOpen:!!j,title:j?.kind===`initiative`?r(`initiative.initiativeTitle`,{unit:gn?.name||r(`initiative.unitFallbackTitle`)}):Dt(j?.bid||``)?.attr_name||r(`initiative.rollOptionsTitle`),onClose:Ht,maxWidth:`460px`,children:[(0,H.jsx)(p_,{theme:i,children:r(`initiative.chooseRollableAction`)}),(0,H.jsxs)(d_,{children:[(0,H.jsx)(f_,{theme:i,onClick:()=>{j&&(Ht(),Bt(j.fieldKey,j.input))},children:r(`initiative.editValue`)}),(()=>{if(!j||!gn)return null;if(j.kind===`initiative`)return(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(f_,{theme:i,onClick:()=>{Ht(),ct(j.unitId,`advantage`)},children:r(`initiative.rollWithAdvantage`)}),(0,H.jsx)(f_,{theme:i,onClick:()=>{Ht(),ct(j.unitId,`disadvantage`)},children:r(`initiative.rollWithDisadvantage`)})]});let e=j.bid||``,t=jt(gn,e);if(!t)return null;let n=At(t.notation,`advantage`),a=At(t.notation,`disadvantage`);return!n||!a?null:(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(f_,{theme:i,onClick:()=>{Ht(),Pt(gn,e,`advantage`)},children:r(`initiative.rollWithAdvantage`)}),(0,H.jsx)(f_,{theme:i,onClick:()=>{Ht(),Pt(gn,e,`disadvantage`)},children:r(`initiative.rollWithDisadvantage`)})]})})()]})]}),(0,H.jsx)(og,{manager:$e}),(0,H.jsxs)(Am,{isOpen:N,title:r(`initiative.resetEncounterTitle`),onClose:()=>{Te||we(!1)},closeOnOverlayClick:!Te,maxWidth:`460px`,children:[(0,H.jsx)(p_,{theme:i,children:r(`initiative.chooseResetMode`)}),(0,H.jsxs)(d_,{children:[(0,H.jsx)(f_,{theme:i,onClick:()=>{nn(`round`)},disabled:Te,children:r(Te?`initiative.resetting`:`initiative.resetRound`)}),(0,H.jsx)(f_,{theme:i,onClick:()=>{nn(`reset-initiative`)},disabled:Te,children:r(Te?`initiative.resetting`:`initiative.resetRoundAndInitiative`)}),(0,H.jsx)(f_,{theme:i,onClick:()=>{nn(`clear-list`)},disabled:Te,children:r(Te?`initiative.resetting`:`initiative.resetRoundAndClearList`)})]})]}),(0,H.jsx)(Am,{isOpen:!!ge,title:U?r(`initiative.listReferenceTitle`,{attribute:pn?.attr_name||r(`initiative.listReferenceFallback`),unit:U.name}):r(`initiative.listReferenceFallback`),onClose:()=>{_e(null)},maxWidth:`620px`,children:(0,H.jsxs)(x_,{children:[(0,H.jsx)(S_,{theme:i}),mn.length===0?(0,H.jsx)(j_,{theme:i,children:r(`initiative.noEntries`)}):(0,H.jsx)(C_,{children:mn.map(e=>(0,H.jsxs)(w_,{theme:i,children:[(0,H.jsxs)(T_,{children:[hn?(0,H.jsx)(E_,{type:`checkbox`,checked:!!e.inUse,readOnly:!0,tabIndex:-1}):null,(0,H.jsx)(D_,{theme:i,children:e.name||r(`initiative.unnamed`)})]}),e.description?(0,H.jsx)(O_,{theme:i,children:e.description}):null,(()=>{let t=Sn(e.description||``);return t.length===0?null:(0,H.jsx)(k_,{children:t.map((t,n)=>(0,H.jsx)(A_,{type:`button`,theme:i,onClick:()=>{let n=U?.createdUserId?f.find(e=>e.id===U.createdUserId):null;L({notation:t,actionName:e.name||pn?.attr_name||r(`initiative.listRoll`),tokenName:U?.name||r(`initiative.unknown`),senderId:U?.createdUserId||m?.id||`unknown`,senderColor:n?.color||m?.color||`#ffffff`})},onContextMenu:n=>{n.preventDefault();let i=U?.createdUserId?f.find(e=>e.id===U.createdUserId):null;Ce({notation:t,actionName:e.name||pn?.attr_name||r(`initiative.listRoll`),tokenName:U?.name||r(`initiative.unknown`),senderId:U?.createdUserId||m?.id||`unknown`,senderColor:i?.color||m?.color||`#ffffff`})},title:t,children:t},`${e.id}-inline-notation-${n}`))})})()]},e.id))})]})}),(0,H.jsxs)(Am,{isOpen:!!M,title:M?.actionName||r(`initiative.rollOptionsTitle`),onClose:Ut,maxWidth:`460px`,zIndexBase:12e3,children:[(0,H.jsx)(p_,{theme:i,children:r(`initiative.chooseRollMode`)}),(0,H.jsx)(d_,{children:(()=>{if(!M)return null;let e=At(M.notation,`advantage`),t=At(M.notation,`disadvantage`);return!e||!t?null:(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(f_,{theme:i,onClick:()=>{M&&(Ut(),Ft(M,`advantage`))},children:r(`initiative.rollWithAdvantage`)}),(0,H.jsx)(f_,{theme:i,onClick:()=>{M&&(Ut(),Ft(M,`disadvantage`))},children:r(`initiative.rollWithDisadvantage`)})]})})()})]})]})},I_=`${t.EXTENSIONID}-partyhud`,L_=async()=>{await c.modal.open({id:I_,url:`/pages/forgeparty.html`,fullScreen:!0,hideBackdrop:!0,hidePaper:!0,disablePointerEvents:!0})},R_=async()=>{await c.modal.close(I_)};var z_=`forge:party_save`,B_=T.div`
  display: flex;
  flex-direction: column;
  gap: 8px;
`,V_=T.div`
...
`,rv=T.span`
  ...
  text-align: center;
  margin-top: 4px;
`,iv=e=>{switch(e){case`bottom`:return`left`;case`left`:return`top`;case`top`:return`right`;case`right`:default:return`bottom`}},av=e=>e===`bottom`||e===`left`||e===`top`||e===`right`,ov=e=>e===`default`||e===`plate`||e===`tech`||e===`deco`,sv=e=>e===`deco`?`plate`:e===`tech`?`tech`:e===`plate`?`plate`:`default`;const cv=()=>{let t=(0,B.useRef)(!1),[n,r]=(0,B.useState)(null),{theme:i}=Lt(),{t:a}=vt(),{attributes:o}=Mm(),s=V(e=>e.items);V(e=>e.sceneMetadata);let l=V(e=>e.roomMetadata),u=V(e=>e.playerData),d=l,f=String(u?.role||``).toUpperCase()===`GM`,m=u?.id,h=ne(O.PARTY_HUD_OPEN,m),g=ne(O.PARTY_HUD_ORIENTATION,m),_=(d[h]??d[O.PARTY_HUD_OPEN])===!0,v=d[g]??d[O.PARTY_HUD_ORIENTATION],y=av(v)?v:`bottom`,b=d[O.PARTY_HUD_ATTR_ONE]||``,x=d[O.PARTY_HUD_ATTR_TWO]||``,S=d[O.PARTY_HUD_SHOW_HP_BARS]===!0,C=d[O.PARTY_HUD_SHOW_HP_NUMBERS]===!0&&!S,w=d[O.PARTY_HUD_BORDER_STYLE],T=ov(w)?sv(w):`default`,E=s.filter(e=>e.metadata[p.IN_PARTY]===!0),D=a(`common.orientation.${y}`);(0,B.useEffect)(()=>{try{let e=localStorage.getItem(z_);e&&r(JSON.parse(e).savedAt??null)}catch{}},[]);let ee=()=>{let e={savedAt:new Date().toISOString(),items:E};localStorage.setItem(z_,JSON.stringify(e)),r(e.savedAt)},te=async()=>{let e=localStorage.getItem(z_);if(e)try{let t=JSON.parse(e);if(!t.items.length)return;let n=new Set(t.items.map(e=>e.id)),r=s.filter(e=>n.has(e.id)).map(e=>e.id);r.length>0&&await c.scene.items.deleteItems(r);let[i,a]=await Promise.all([c.viewport.getWidth(),c.viewport.getHeight()]),o={x:i*.75,y:a*.6},l=await c.viewport.inverseTransformPoint(o),u={x:o.x-75,y:o.y-75},d=await c.viewport.inverseTransformPoint(u),f=d.x-l.x,p=d.y-l.y,m=t.items.map((e,t)=>({...e,position:{x:l.x+f*t,y:l.y+p*t}}));await c.scene.items.addItems(m)}catch{}},re=(0,B.useMemo)(()=>o.filter(e=>{let t=String(e.attr_type||``).toLowerCase();return t===`text`||t===`numb`||t===`bool`}),[o]),k=async(e,t)=>{await c.room.setMetadata({[e]:t})},A=async e=>{await c.room.setMetadata(e)},ie=async()=>{let e=!_;if(await k(h,e),!e){await R_(),t.current=!1;return}await L_(),t.current=!0},ae=async()=>{await k(g,iv(y))},oe=async(e,t)=>{let n=t.trim();await c.scene.items.updateItems([e],e=>{let t={...e[0].metadata||{}};n?t[p.PORTRAIT_URL]=n:delete t[p.PORTRAIT_URL],e[0].metadata=t})};return(0,H.jsx)(Yd.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},exit:{opacity:0,y:-20},style:{height:`100%`},children:(0,H.jsxs)(ym,{theme:i,children:[(0,H.jsx)(bm,{theme:i,children:a(`party.pageTitle`)}),(0,H.jsxs)(V_,{theme:i,children:[(0,H.jsxs)(H_,{children:[(0,H.jsx)(G_,{theme:i,onClick:()=>void ae(),children:a(`party.display`,{orientation:D})}),(0,H.jsx)(G_,{theme:i,onClick:()=>void ie(),children:a(_?`party.closeHud`:`party.openHud`)})]}),f&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsxs)(U_,{children:[(0,H.jsx)(W_,{theme:i,children:a(`party.showInHud`)}),(0,H.jsxs)(J_,{$disabled:!f,children:[(0,H.jsx)(Y_,{theme:i,children:a(`party.showHpBars`)}),(0,H.jsx)(Z,{label:a(`party.toggleHpBarsLabel`),isOn:S,onChange:e=>{if(f){if(e){A({[O.PARTY_HUD_SHOW_HP_BARS]:!0,[O.PARTY_HUD_SHOW_HP_NUMBERS]:!1});return}k(O.PARTY_HUD_SHOW_HP_BARS,!1)}}})]}),(0,H.jsxs)(J_,{$disabled:!f,children:[(0,H.jsx)(Y_,{theme:i,children:a(`party.showHpNumbers`)}),(0,H.jsx)(Z,{label:a(`party.toggleHpNumbersLabel`),isOn:C,onChange:e=>{if(f){if(e){A({[O.PARTY_HUD_SHOW_HP_NUMBERS]:!0,[O.PARTY_HUD_SHOW_HP_BARS]:!1});return}k(O.PARTY_HUD_SHOW_HP_NUMBERS,!1)}}})]}),(0,H.jsxs)(K_,{theme:i,disabled:!f,value:b,onChange:e=>{let t=e.target.value;k(O.PARTY_HUD_ATTR_ONE,t),t&&t===x&&k(O.PARTY_HUD_ATTR_TWO,``)},children:[(0,H.jsx)(`option`,{value:``,children:a(`party.extraSlotNone`,{slot:1})}),re.map(e=>(0,H.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]}),(0,H.jsxs)(K_,{theme:i,disabled:!f,value:x,onChange:e=>{let t=e.target.value;k(O.PARTY_HUD_ATTR_TWO,t),t&&t===b&&k(O.PARTY_HUD_ATTR_ONE,``)},children:[(0,H.jsx)(`option`,{value:``,children:a(`party.extraSlotNone`,{slot:2})}),re.map(e=>(0,H.jsx)(`option`,{value:e.attr_bid,children:e.attr_name||e.attr_bid},e.attr_bid))]}),(0,H.jsxs)(K_,{theme:i,disabled:!f,value:T,onChange:e=>{let t=e.target.value;ov(t)&&k(O.PARTY_HUD_BORDER_STYLE,t)},children:[(0,H.jsx)(`option`,{value:`default`,children:a(`party.portraitBorderDefault`)}),(0,H.jsx)(`option`,{value:`plate`,children:a(`party.portraitBorderPlate`)}),(0,H.jsx)(`option`,{value:`tech`,children:a(`party.portraitBorderTech`)})]})]}),(0,H.jsx)(q_,{theme:i,children:(0,H.jsxs)(H.Fragment,{children:[a(`party.configureHint`),(0,H.jsx)(`br`,{}),a(`party.listAttributesExcluded`)]})})]})]}),f&&(0,H.jsxs)(V_,{theme:i,children:[(0,H.jsxs)(U_,{children:[(0,H.jsx)(G_,{theme:i,onClick:ee,disabled:E.length===0,children:a(`party.saveParty`)}),(0,H.jsx)(G_,{theme:i,onClick:()=>void te(),disabled:n===null,children:a(`party.loadParty`)})]}),(0,H.jsx)(rv,{theme:i,children:n?a(`party.lastSaved`,{value:new Date(n).toLocaleString()}):a(`party.noSaveAvailable`)})]}),E.length===0?(0,H.jsx)(nv,{theme:i,children:a(`party.emptyState`)}):(0,H.jsx)(B_,{theme:i,children:E.map(t=>{let n=t.metadata?.[p.PORTRAIT_URL]||``,r=e(t)?t.image.url:void 0,o=t.metadata[p.UNIT_NAME]||t.name||a(`party.unknownUnit`),s=t.createdUserId===u?.id,c=f||s,l=r||`/logo.png`,d=!!n;return(0,H.jsxs)(X_,{theme:i,children:[(0,H.jsxs)(Z_,{children:[(0,H.jsx)(Q_,{theme:i,src:l,alt:o,$full:!d}),d&&(0,H.jsx)(Q_,{theme:i,src:d?n:``,alt:a(`party.overrideAlt`,{unit:o}),$overlay:!0})]}),(0,H.jsxs)($_,{children:[(0,H.jsx)(ev,{theme:i,title:o,children:o}),c&&(0,H.jsx)(tv,{theme:i,defaultValue:n,placeholder:a(`party.portraitUrlPlaceholder`),onBlur:e=>{oe(t.id,e.target.value)}})]})]},t.id)})})]})})};var lv=`${z}/hp-bar-effect`,uv=`${z}/hp-bar-owner`,dv=`${z}/hp-number-text`,fv=`${z}/hp-number-owner`,pv=e=>`HPB${e.slice(3)}`,mv=e=>`HPN${e.slice(3)}`,hv=(e,t,n)=>Math.max(t,Math.min(n,e)),gv=(e,t,n,r)=>{let i=bt(e.metadata,t,r,`current`),a=bt(e.metadata,n,r,`max`);return a===null||a<=0||i===null?null:hv(i/a*100,0,100)},_v=(e,t,n,r)=>{let i=bt(e.metadata,t,r,`current`),a=bt(e.metadata,n,r,`max`);return i===null?null:{currentHp:Math.trunc(i),maxHp:a===null?null:Math.trunc(a)}},vv=e=>{let t=String(e||`bottom`).toLowerCase();return t===`top`||t===`bottom`||t===`left`||t===`right`?t:`bottom`},yv=e=>{switch(vv(e)){case`top`:return 0;case`bottom`:return 1;case`left`:return 2;case`right`:return 3;default:return 1}},bv=(e,t)=>{let n=t/e.grid.dpi,r=e.image.width*n,i=e.image.height*n,a=e.grid.offset.x/e.image.width*r,o=e.grid.offset.y/e.image.height*i;return{minX:e.position.x-a,minY:e.position.y-o,width:r,height:i}},xv=(e,t,n)=>{let r=bv(e,t),i=r.minX+r.width*.5,a=r.minY+r.height*.5,o;switch(n){case`top`:o={x:i,y:r.minY+r.height*.18};break;case`bottom`:o={x:i,y:r.minY+r.height*.82};break;case`left`:o={x:r.minX+r.width*.18,y:a};break;case`right`:o={x:r.minX+r.width*.82,y:a};break}let s=r.width*.25,c=r.height*.18;return{x:o.x-s,y:o.y-c}};const Sv=()=>{let t=V(e=>e.cacheReady),i=V(e=>e.sceneReady),a=V(e=>e.items),o=V(e=>e.localItems),s=V(e=>e.gridDpi),l=V(e=>e.roomMetadata),u=V(e=>e.sceneMetadata),d=V(e=>e.systemData);return(0,B.useEffect)(()=>{if(!t||!i)return;let u=!1;return(async()=>{let t=l,i=t[O.SHOW_HP_BARS]??!1,f=t[O.SHOW_HP_NUMBERS]??!1,m=i,h=!i&&f,g=vv(t[O.HP_BAR_ORIENTATION]),_=yv(t[O.HP_BAR_ORIENTATION]),v=d?.attributes||[],{currentHpBid:x,maxHpBid:S}=xt(t,v),C=o.filter(e=>y(e)&&e.metadata?.[lv]===!0),w=o.filter(e=>b(e)&&e.metadata?.[dv]===!0);if(!m&&C.length>0)try{await c.scene.local.deleteItems(C.map(e=>e.id))}catch(e){A.error(`Failed to remove HP bar effects`,e)}if(!h&&w.length>0)try{await c.scene.local.deleteItems(w.map(e=>e.id))}catch(e){A.error(`Failed to remove HP number texts`,e)}if(!m&&!h)return;let T=a.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),E=new Map,D=new Map;for(let t of T){if(m){let e=gv(t,x,S,v);e!==null&&E.set(pv(t.id),{unitId:t.id,hpPercent:e,visible:t.visible})}if(h&&e(t)){let e=_v(t,x,S,v);if(e){let n=e.maxHp===null?`${e.currentHp}`:`${e.currentHp}/${e.maxHp}`;D.set(mv(t.id),{unitId:t.id,text:n,position:xv(t,s,g)})}}}if(m){let e=new Map(C.map(e=>[e.id,e])),t=Array.from(E.entries()).filter(([t])=>!e.has(t)),n=C.filter(e=>!E.has(e.id)),i=C.filter(e=>{let t=E.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`orientation`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return e.attachedTo!==t.unitId||!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-_)>.001});if(u)return;if(n.length>0)try{await c.scene.local.deleteItems(n.map(e=>e.id))}catch(e){A.error(`Failed to remove stale HP bar effects`,e)}if(t.length>0){let e=t.map(([e,t])=>r().id(e).name(`HP Bar Effect`).effectType(`ATTACHMENT`).attachedTo(t.unitId).layer(`ATTACHMENT`).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).visible(t.visible).uniforms([{name:`hpPercent`,value:t.hpPercent},{name:`orientation`,value:_}]).sksl(`
uniform vec2 size;
uniform float time;
...
`).visible(t.visible).metadata({[Cv]:!0,[wv]:t.ownerId}).build());try{await c.scene.local.addItems(e)}catch(e){A.error(`Failed to add death token effects`,e)}}if(b.length>0)try{await c.scene.local.updateItems(b.map(e=>e.id),e=>{e.forEach(e=>{let t=h.get(e.id);t&&(e.attachedTo=t.ownerId,e.metadata={...e.metadata,[Cv]:!0,[wv]:t.ownerId})})})}catch(e){A.error(`Failed to update death token effects`,e)}}})(),()=>{s=!0}},[t,n,i,a,o,s,l]),null};var Ov=`${z}/buff-effect-token`,kv=`${z}/buff-effect-owner`,Av=`${z}/debuff-effect-token`,jv=`${z}/debuff-effect-owner`,Mv=`${z}/effect-preset`,Nv=e=>`EFB${e.slice(3)}`,Pv=e=>`EFD${e.slice(3)}`,Fv=e=>Array.isArray(e)?e.reduce((e,t)=>{if(!t||typeof t!=`object`)return e;let n=t,r=typeof n.name==`string`?n.name.trim():``,i=Number(n.remaining),a=Number.isFinite(i)?Math.max(0,Math.trunc(i)):0,o=n.durationType===`turns`?`turns`:`rounds`,s=n.endTiming===`end`?`end`:`start`,c=n.effectType===`buff`?`buff`:n.effectType===`debuff`?`debuff`:`neutral`,l=Array.isArray(n.targets)?Array.from(new Set(n.targets.filter(e=>typeof e==`string`&&e.length>0))):[];return!r||!a||e.push({id:typeof n.id==`string`&&n.id?n.id:crypto.randomUUID(),name:r,remaining:a,durationType:o,endTiming:s,effectType:c,targets:l,createdByName:typeof n.createdByName==`string`&&n.createdByName?n.createdByName:`Unknown`,createdById:typeof n.createdById==`string`?n.createdById:void 0}),e},[]):[];const Iv=()=>{let t=V(e=>e.cacheReady),n=V(e=>e.sceneReady),i=V(e=>e.items),a=V(e=>e.localItems),o=V(e=>e.roomMetadata),s=V(e=>e.sceneMetadata);return(0,B.useEffect)(()=>{if(!t||!n)return;let s=!1;return(async()=>{let t=o,n=t[O.BUFF_VISUAL_PRESET],l=t[O.DEBUFF_VISUAL_PRESET],u=eh(n)?n:Xm,d=th(l)?l:Zm,f=nh(u),m=rh(d),h=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0),g=new Set(h.map(e=>e.id)),_=new Map,v=(e,t)=>{let n=_.get(e)||{hasBuff:!1,hasDebuff:!1};t===`buff`?n.hasBuff=!0:n.hasDebuff=!0,_.set(e,n)};i.forEach(e=>{if(e.metadata?.[p.ON_LIST]!==!0)return;let t=Fv(e.metadata?.[Lh]);t.length!==0&&t.forEach(t=>{t.effectType!==`neutral`&&(t.targets.length>0?t.targets:[e.id]).forEach(e=>{g.has(e)&&(t.effectType===`buff`||t.effectType===`debuff`)&&v(e,t.effectType)})})});let b=new Map,x=new Map;h.forEach(e=>{let t=_.get(e.id);t?.hasBuff&&b.set(Nv(e.id),e.id),t?.hasDebuff&&x.set(Pv(e.id),e.id)});let S=a.filter(e=>y(e)&&e.metadata?.[Ov]===!0),C=a.filter(e=>y(e)&&e.metadata?.[Av]===!0),w=async e=>{let{existing:t,desiredByOverlayId:n,preset:i,shader:a,name:o,flagKey:l,ownerKey:u}=e,d=new Map(t.map(e=>[e.id,e])),f=Array.from(n.entries()).filter(([e])=>!d.has(e)),p=t.filter(e=>!n.has(e.id)),m=t.filter(e=>{let t=n.get(e.id);if(!t)return!1;let r=e.metadata?.[Mv];return e.attachedTo!==t||r!==i});if(!s){if(p.length>0)try{await c.scene.local.deleteItems(p.map(e=>e.id))}catch(e){A.error(`Failed to remove stale ${o.toLowerCase()} overlays`,e)}if(f.length>0){let e=f.map(([e,t])=>r().id(e).name(o).effectType(`ATTACHMENT`).layer(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).disableAttachmentBehavior([`ROTATION`,`SCALE`]).sksl(a).metadata({[l]:!0,[u]:t,[Mv]:i}).build());try{await c.scene.local.addItems(e)}catch(e){A.error(`Failed to add ${o.toLowerCase()} overlays`,e)}}if(m.length>0)try{await c.scene.local.updateItems(m.map(e=>e.id),e=>{e.forEach(e=>{let t=n.get(e.id);if(!t)return;e.attachedTo=t;let r=e;r.sksl=a,e.metadata={...e.metadata,[l]:!0,[u]:t,[Mv]:i}})})}catch(e){A.error(`Failed to update ${o.toLowerCase()} overlays`,e)}}};await w({existing:S,desiredByOverlayId:b,preset:u,shader:f,name:`Buff Token Effect`,flagKey:Ov,ownerKey:kv}),await w({existing:C,desiredByOverlayId:x,preset:d,shader:m,name:`Debuff Token Effect`,flagKey:Av,ownerKey:jv})})(),()=>{s=!0}},[t,n,i,a,o,s]),null};var Lv=`${z}/boss-hp-effect`,Rv=`${z}/boss-hp-owner`,zv=`${z}/boss-hp-slot`,Bv=e=>`BOSSHP${e}`,Vv=(e,t,n)=>Math.max(t,Math.min(n,e)),Hv=(e,t,n,r)=>{let i=bt(e.metadata,t,r,`current`),a=bt(e.metadata,n,r,`max`);return a===null||a<=0||i===null?null:Vv(i/a*100,0,100)};const Uv=()=>{let t=V(e=>e.cacheReady),n=V(e=>e.sceneReady),i=V(e=>e.items),a=V(e=>e.localItems),o=V(e=>e.roomMetadata),s=V(e=>e.sceneMetadata),l=V(e=>e.systemData);return(0,B.useEffect)(()=>{if(!t||!n)return;let s=!1;return(async()=>{let t=o,n=l?.attributes||[],{currentHpBid:u,maxHpBid:d}=xt(t,n),f=a.filter(e=>y(e)&&e.metadata?.[Lv]===!0),m=i.filter(t=>e(t)&&t.metadata?.[p.ON_LIST]===!0&&t.metadata?.[p.BOSS_MODE]===!0).sort((e,t)=>{let n=Number(e.metadata?.[p.INITIATIVE]??0);return Number(t.metadata?.[p.INITIATIVE]??0)-n}).slice(0,2).map((e,t)=>{let r=Hv(e,u,d,n);return r===null?null:{id:Bv(t),unitId:e.id,slot:t,hpPercent:r}}).filter(e=>e!==null),h=new Map(m.map(e=>[e.id,e])),g=new Map(f.map(e=>[e.id,e])),_=f.filter(e=>!h.has(e.id)),v=m.filter(e=>!g.has(e.id)),b=f.filter(e=>{let t=h.get(e.id);if(!t)return!1;let n=e,r=n.uniforms?.find(e=>e.name===`hpPercent`),i=n.uniforms?.find(e=>e.name===`slot`),a=typeof r?.value==`number`?r.value:NaN,o=typeof i?.value==`number`?i.value:NaN;return!Number.isFinite(a)||Math.abs(a-t.hpPercent)>.001||!Number.isFinite(o)||Math.abs(o-t.slot)>.001||e.metadata?.[Rv]!==t.unitId});if(!s){if(_.length>0)try{await c.scene.local.deleteItems(_.map(e=>e.id))}catch(e){A.error(`Failed to remove stale boss HP viewport effects`,e)}if(v.length>0){let e=v.map(e=>r().id(e.id).name(`Boss HP Bar`).effectType(`VIEWPORT`).locked(!0).disableHit(!0).uniforms([{name:`hpPercent`,value:e.hpPercent},{name:`slot`,value:e.slot}]).sksl(`
uniform float2 size;
...
`).metadata({[Lv]:!0,[Rv]:e.unitId,[zv]:e.slot}).build());try{await c.scene.local.addItems(e)}catch(e){A.error(`Failed to add boss HP viewport effects`,e)}}if(b.length>0)try{await c.scene.local.updateItems(b.map(e=>e.id),e=>{e.forEach(e=>{let t=h.get(e.id);if(!t)return;let n=e;n.uniforms=[{name:`hpPercent`,value:t.hpPercent},{name:`slot`,value:t.slot}],e.metadata={...e.metadata,[Lv]:!0,[Rv]:t.unitId,[zv]:t.slot}})})}catch(e){A.error(`Failed to update boss HP viewport effects`,e)}}})(),()=>{s=!0}},[t,n,i,a,o,s,l]),null};var Wv=`${z}/current-turn-effect`;const Gv=()=>{let e=V(e=>e.cacheReady),t=V(e=>e.sceneReady),n=V(e=>e.items),i=V(e=>e.roomMetadata),a=V(e=>e.sceneMetadata);return(0,B.useEffect)(()=>{if(!e||!t)return;let o=!1;return(async()=>{let e=i[O.SHOW_TURN_EFFECT]===!0,t=a[O.CURRENT_TURN];if(!e||!t){try{await c.scene.local.deleteItems([Wv])}catch{}return}if(!n.find(e=>e.id===t)){try{await c.scene.local.deleteItems([Wv])}catch{}return}if(!o){try{let e=!1;if(await c.scene.local.updateItems([Wv],n=>{let r=n[0];r&&(r.attachedTo=t,e=!0)}),e)return}catch{}if(!o)try{let e=r().id(Wv).name(`Current Turn Effect`).effectType(`ATTACHMENT`).attachedTo(t).locked(!0).disableHit(!0).sksl(`
uniform vec2 size;
uniform float time;
...
`).build();await c.scene.local.addItems([e])}catch(e){A.error(`Failed to sync current turn effect`,e)}}})(),()=>{o=!0}},[e,t,n,i,a]),null},Kv=()=>{let[e,t]=(0,B.useState)(!1),{updateThemeFromSystem:n}=Lt(),r=V(e=>e.roomMetadata),i=V(e=>e.cacheReady),a=V(e=>e.systemData),o=V(e=>e.setSystemData),s=()=>({theme:{primary:E.theme_primary,offset:E.theme_offset,background:E.theme_background,border:E.theme_border,background_url:E.background_url},cardLayout:E.card_layout,listLayout:E.list_layout,attributes:E.attributes,systemName:E.name,importDate:null,snapshotPublicId:null});return(0,B.useEffect)(()=>{!i&&e&&(t(!1),o(null))},[i,e,o]),(0,B.useEffect)(()=>{!i||!a||n(a.theme.primary,a.theme.offset,a.theme.background,a.theme.border,a.theme.background_url)},[i,a,n]),(0,B.useEffect)(()=>{if(e)return;let n=!0,a=async()=>{if(i)try{A.log(`Starting app initialization...`),await c(),n&&(t(!0),A.log(`App initialization complete`))}catch(e){A.error(`Error during app initialization:`,e),n&&t(!0)}},c=async()=>{let e=(e,t)=>{if(Array.isArray(e))return e;if(typeof e==`string`){let n;try{n=JSON.parse(e)}catch{throw Error(`Snapshot ${t} is not valid JSON`)}if(!Array.isArray(n))throw Error(`Snapshot ${t} is not a JSON array`);return n}throw Error(`Snapshot ${t} has invalid type`)},t=async t=>{let{data:n,error:r}=await C.rpc(`bs_forge_get_snapshot_for_room`,{p_snapshot_public_id:t});if(r)return A.error(`Failed to load room snapshot:`,r),!1;let i=Array.isArray(n)?n[0]:n;if(!i||typeof i.snapshot_public_id!=`string`)return A.warn(`Room snapshot reference was set, but no snapshot record was returned`),!1;let a=e(i.card_layout,`card_layout`),s=e(i.list_layout,`list_layout`),c=e(i.attributes,`attributes`);return o({theme:{primary:i.theme_primary,offset:i.theme_offset,background:i.theme_background,border:i.theme_border,background_url:i.background_url},cardLayout:a,listLayout:s,attributes:c,systemName:i.system_name,importDate:i.imported_at,snapshotPublicId:i.snapshot_public_id}),A.log(`System data hydrated from room snapshot`,{snapshotPublicId:i.snapshot_public_id,systemName:i.system_name}),!0};try{let e=r[oh.SNAPSHOT_PUBLIC_ID];if(typeof e==`string`&&e.trim().length>0&&await t(e))return;A.log(`Room snapshot reference missing or unavailable, initializing defaults`),await l()}catch(e){A.error(`Error loading system data:`,e),await l()}},l=async()=>{o(s()),A.log(`Default system initialized`)};return a(),()=>{n=!1}},[i,e,r,o,n]),(0,B.useEffect)(()=>{if(!i||!e)return;let t=e=>{if(Array.isArray(e))return e;if(typeof e==`string`)try{let t=JSON.parse(e);return Array.isArray(t)?t:null}catch{return null}return null},n=r[oh.SNAPSHOT_PUBLIC_ID],c=typeof n==`string`&&n.trim().length>0?n.trim():null;if(c===(a?.snapshotPublicId??null))return;let l=!1;return(async()=>{if(!c){l||(o(s()),A.log(`Room snapshot reference cleared, reverted runtime system to defaults`));return}let{data:e,error:n}=await C.rpc(`bs_forge_get_snapshot_for_room`,{p_snapshot_public_id:c});if(n){A.error(`Failed to refresh system from room snapshot change:`,n);return}let r=Array.isArray(e)?e[0]:e;if(!r||typeof r.snapshot_public_id!=`string`){A.warn(`Room snapshot reference changed, but snapshot record was not found`);return}let i=t(r.card_layout),a=t(r.list_layout),u=t(r.attributes);if(!i||!a||!u){A.warn(`Room snapshot refresh returned invalid payload arrays`);return}l||(o({theme:{primary:r.theme_primary,offset:r.theme_offset,background:r.theme_background,border:r.theme_border,background_url:r.background_url},cardLayout:i,listLayout:a,attributes:u,systemName:r.system_name,importDate:r.imported_at,snapshotPublicId:r.snapshot_public_id}),A.log(`Runtime system refreshed from room snapshot change`,{snapshotPublicId:r.snapshot_public_id,systemName:r.system_name}))})(),()=>{l=!0}},[i,e,r,a,o]),{isInitialized:e}};var qv=m`
...
`;function Zv(){let{sceneReady:e,cacheReady:n,playerData:r,roomMetadata:i,sceneMetadata:a}=V(),{isInitialized:o}=Kv(),{theme:s}=Lt(),{t:l}=vt(),[u,d]=(0,B.useState)(`ForgeMain`),[f,p]=(0,B.useState)(!1),m=(0,B.useRef)(!1),h=String(r?.role||``).toUpperCase()===`GM`,g=i,_=r?.id,v=(g[ne(O.PARTY_HUD_OPEN,_)]??g[O.PARTY_HUD_OPEN])===!0,y=g[O.SHOW_PLAYER_VIEW]||!1,b=h||y,x=e&&n&&o;return(0,B.useEffect)(()=>{x&&(async()=>{await Me(),ut()&&await c.broadcast.sendMessage(t.AUTHSYNCCHANNEL,{type:`BS_AUTH_STATE`,source:t.EXTENSIONID,snapshot:Ze()},{destination:`LOCAL`})})()},[x]),(0,B.useEffect)(()=>{if(!x)return;let e=c.broadcast.onMessage(t.AUTHSYNCCHANNEL,e=>{let n=e.data;if(!(!n||typeof n!=`object`||n.source===t.EXTENSIONID)){if(n.type===`BS_AUTH_REQUEST`){if(!ut())return;c.broadcast.sendMessage(t.AUTHSYNCCHANNEL,{type:`BS_AUTH_STATE`,source:t.EXTENSIONID,snapshot:Ze()},{destination:`LOCAL`});return}n.type!==`BS_AUTH_STATE`||ut()||!n.snapshot||ct(n.snapshot)}});return c.broadcast.sendMessage(t.AUTHSYNCCHANNEL,{type:`BS_AUTH_REQUEST`,source:t.EXTENSIONID},{destination:`LOCAL`}),()=>{e()}},[x]),(0,B.useEffect)(()=>{if(!x)return;let e=!0;return(async()=>{if(v&&!m.current){await L_(),e&&(m.current=!0);return}!v&&m.current&&(await R_(),e&&(m.current=!1))})(),()=>{e=!1}},[x,v]),(0,B.useEffect)(()=>{x&&!b&&u===`ForgeMain`&&d(`Party`)},[x,b,u]),(0,B.useEffect)(()=>{u!==`ForgeMain`&&c.action.setWidth(350)},[u]),(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(qv,{theme:s}),!e||!n||!o?(0,H.jsxs)(Jv,{children:[(0,H.jsx)(Yv,{}),(0,H.jsx)(Xv,{children:l(e?n?o?`app.loadingFallback`:`app.initializingSystem`:`app.loadingCache`:`app.connectingScene`)})]}):(0,H.jsxs)(tm,{children:[(0,H.jsx)(Sv,{}),(0,H.jsx)(Dv,{}),(0,H.jsx)(Iv,{}),(0,H.jsx)(Uv,{}),(0,H.jsx)(Gv,{}),(0,H.jsx)(nm,{theme:s,$backgroundUrl:s.BACKGROUND_URL,children:(0,H.jsx)(iu,{mode:`wait`,children:(()=>{switch(u){case`ForgeMain`:return b?(0,H.jsx)(F_,{},`main`):(0,H.jsx)(cv,{},`party`);case`Settings`:return h?(0,H.jsx)(Um,{},`settings`):(0,H.jsx)(F_,{},`main`);case`Party`:return(0,H.jsx)(cv,{},`party`);case`System`:return h?(0,H.jsx)(Ph,{},`system`):(0,H.jsx)(F_,{},`main`);case`ChatLog`:return(0,H.jsx)(Ym,{},`chatlog`)}})()})}),(0,H.jsx)(vm,{isOpen:f,currentPage:u,onToggle:()=>p(!f),onNavigate:e=>{if(!b&&e===`ForgeMain`){d(`Party`),p(!1);return}if(!h&&(e===`Settings`||e===`System`)){d(`ForgeMain`),p(!1);return}d(e),p(!1)},canAccessInitiativeList:b})]})]})}var Qv=Zv,$v=class{static{this.ALPHANUMERICTEXTMATCH=/\s[\da-zA-Z]$/}};function ey(e){for(let t of ny)if(e.includes(t)){let n=ny[Math.floor(Math.random()*ny.length)];return e.replace(t,n)}return ty(e)}function ty(e){return`${ny[Math.floor(Math.random()*ny.length)]} ${e}`}const ny=`Grizzled.Wily.Stoic.Mellow.Pensive.Shrewd.Cautious.Hardy.Nimble.Tenacious.Gritty.Tolerant.Hardy.Adroit.Resilient.Slight.Stout.Durable.Subtle.Sober.Clever.Brave.Calm.Wise.Cunning.Alert.Swift.Agile.Loyal.Sturdy.Stable.Sneaky.Clever.Resourceful.Shady.Stalwart.Vigilant.Staunch.Fierce.Vigorous.Robust.Fearless.Dauntless.Resolute.Sagacious.Prudent.Judicious.Astute.Savvy.Sharp.Quick.Witty.Smart.Snippy.Crafty.Deft.Sly.Artful.Clever.Sneering.Tough.Rugged.Solid.Strong.Sturdy.Tough.Gritty.Rough.Hardened.Burly.Muscular.Brawny.Rowdy.Forceful.Snorting.Potent.Martial.Speckled.Mottled.Disheveled`.split(`.`);var ry=`com.battle-system.forge/view-unit`,iy=`com.battle-system.forge/view-unit-player`,ay=e=>e.trim().toLowerCase(),oy=e=>{if(typeof e!=`string`)return null;let t=e.trim();return t.length>0?t:null},sy=e=>{let t=e.trim();return t?$v.ALPHANUMERICTEXTMATCH.test(t)?t.slice(0,-2):t:e},cy=e=>{let t=typeof e.text?.plainText==`string`?e.text.plainText.trim():``;if(t.length>0)return t;let n=e.metadata?.[p.UNIT_NAME],r=typeof n==`string`?n.trim():``;if(r.length>0)return r;let i=typeof e.name==`string`?e.name.trim():``;return i.length>0?i:typeof e.name==`string`?e.name:``},ly=async e=>{let n=await c.viewport.getHeight(),r=n>800?700:n-100;await c.popover.open({id:t.CARDSID,url:`/pages/forgecard.html?unitid=${encodeURIComponent(e)}`,height:r,width:350,anchorReference:`POSITION`,anchorPosition:{left:await c.viewport.getWidth()/2,top:await c.viewport.getHeight()/2},anchorOrigin:{horizontal:`CENTER`,vertical:`CENTER`},transformOrigin:{horizontal:`CENTER`,vertical:`CENTER`},hidePaper:!0,disableClickAway:!0})},uy=async e=>{let t=Array.from(new Set(e.map(e=>e.trim()).filter(e=>e.length>0))),n=new Map;if(t.length===0)return n;let r=await se(),i=new Map;for(let e of r){let t=ay(e.name);if(!t)continue;let n=i.get(t);n?n.push(e):i.set(t,[e])}for(let e of t){let t=ay(e),r=i.get(t)?.[0];!r||!r.metadata||n.set(t,le(r.metadata))}try{let e=await Qe(t);for(let t of e){let e=ay(t.name);!e||n.has(e)||!t.metadata||n.set(e,le(t.metadata))}let r=await rt(t);for(let e of r){let t=ay(e.name);!t||n.has(t)||!e.metadata||n.set(t,le(e.metadata))}}catch(e){A.log(`Remote collection lookup failed, using local collection only`,e)}return n};function dy({children:e}){let t=V(e=>e.roomMetadata);V(e=>e.sceneMetadata);let n=V(e=>e.items),r=V(e=>e.playerData),i=V(e=>e.systemData),a=t,o=i?.attributes??[],s=oy(a[O.HP_CURRENT_BID]),l=oy(a[O.HP_MAX_BID]),u=xt(a,o),d=s||u.currentHpBid,f=l||u.maxHpBid,m=!!(d&&f),h=a[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===void 0?!0:a[O.SHOW_MODIFY_UNIT_CONTEXT_MENU]===!0,g=a[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===void 0?!0:a[O.SHOW_VIEW_UNIT_CONTEXT_MENU_FOR_PLAYERS]===!0;return(0,B.useEffect)(()=>{c.onReady(()=>{c.contextMenu.create({id:p.ON_LIST,icons:[{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Enter Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`!=`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Exit Combat`,filter:{every:[{key:[`metadata`,p.ON_LIST],operator:`==`,value:!0},{key:`type`,operator:`==`,value:`IMAGE`},{key:`createdUserId`,operator:`==`,value:r?.id}],roles:[`PLAYER`]}}],async onClick(e){if(A.info(`Add to Combat Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[p.ON_LIST]===!0))await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[p.ON_LIST],delete t.metadata[p.INITIATIVE]});else{let t=[],r=[],i=new Set(e.items.map(e=>e.id)),o=a[O.USE_DESCRIPTIVE_DUPLICATES]===!0,s=new Set(n.filter(e=>{if(i.has(e.id))return!1;let t=e.metadata[p.UNIT_NAME];return typeof t==`string`&&t.trim().length>0}).map(e=>ay(String(e.metadata[p.UNIT_NAME]))));for(let n of e.items){if(n.metadata[p.FABRICATED]===!0)continue;let e=sy(n.text?.plainText||n.name);t.push(e)}await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let l=await uy(t);await c.action.setBadgeText(void 0);for(let t of e.items){let e={},n=t,i=cy(n);if(t.metadata[p.FABRICATED]!==!0){let r=sy(n.text?.plainText||t.name),a=l.get(ay(r));a&&Object.assign(e,a),(typeof e[p.UNIT_NAME]!=`string`||!String(e[p.UNIT_NAME]).trim())&&(e[p.UNIT_NAME]=i),e[p.FABRICATED]=!0}if(o){let r=typeof t.metadata[p.UNIT_NAME]==`string`?String(t.metadata[p.UNIT_NAME]).trim():``,a=sy(n.text?.plainText||t.name).trim(),o=String(e[p.UNIT_NAME]||r||i||a||t.name).trim(),c=ay(o);if(c){let e=0;for(;s.has(c)&&e<20;)o=ey(o),c=ay(o),e+=1;c&&s.add(c)}e[p.UNIT_NAME]=o}(typeof e[p.UNIT_NAME]!=`string`||!String(e[p.UNIT_NAME]).trim())&&(e[p.UNIT_NAME]=i),e[p.ON_LIST]=!0,e[p.INITIATIVE]=0,r.push({id:t.id,metadata:e})}await c.scene.items.updateItems(e.items,e=>{for(let t of e){let e=r.find(e=>e.id===t.id);if(e&&(Object.assign(t.metadata,e.metadata),a[O.SHOW_NAMES]===!0)){let n=t,r=typeof e.metadata[p.UNIT_NAME]==`string`&&String(e.metadata[p.UNIT_NAME]).trim().length>0?String(e.metadata[p.UNIT_NAME]).trim():cy(n);n.text&&(n.text.plainText=r)}}})}}}),c.contextMenu.create({id:p.IN_PARTY,icons:[{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`!=`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Add to Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`!=`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`==`,value:!0}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Remove from Party`,filter:{every:[{key:[`metadata`,p.IN_PARTY],operator:`==`,value:!0},{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){A.info(`Add to Party Clicked: ${e.items[0].name}`),e.items.every(e=>e.metadata[p.IN_PARTY]===!0)?await c.scene.items.updateItems(e.items,e=>{for(let t of e)delete t.metadata[p.IN_PARTY]}):await c.scene.items.updateItems(e.items,e=>{for(let t of e)t.metadata[p.IN_PARTY]=!0})}}),c.contextMenu.create({id:ry,icons:[{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}}],async onClick(e){A.info(`View Unit Clicked: ${e.items[0].name}`);let t=e.items[0];if(!t)return;let r={};if(t.metadata[p.FABRICATED]!==!0){let e=t,i=cy(e),o=sy(e.text?.plainText||t.name);await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let s=await uy([o]);await c.action.setBadgeText(void 0);let l=s.get(ay(o));l&&Object.assign(r,l),(typeof r[p.UNIT_NAME]!=`string`||!String(r[p.UNIT_NAME]).trim())&&(r[p.UNIT_NAME]=i),r[p.FABRICATED]=!0,a[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[p.UNIT_NAME]!=null&&e.id!==t.id).map(e=>e.metadata[p.UNIT_NAME]).includes(o)&&(r[p.UNIT_NAME]=ey(o)),await c.scene.items.updateItems([t],e=>{let t=e[0];if(Object.assign(t.metadata,r),a[O.SHOW_NAMES]===!0){let e=t,n=typeof r[p.UNIT_NAME]==`string`&&String(r[p.UNIT_NAME]).trim().length>0?String(r[p.UNIT_NAME]).trim():cy(e);e.text&&(e.text.plainText=n)}})}await ly(t.id)}}),g?c.contextMenu.create({id:iy,icons:[{icon:`/icon.svg`,label:`View Unit`,filter:{max:1,every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e){A.info(`View Unit Clicked: ${e.items[0].name}`);let t=e.items[0];if(!t)return;let r={};if(t.metadata[p.FABRICATED]!==!0){let e=t,i=cy(e),o=sy(e.text?.plainText||t.name);await c.action.setBadgeText(`Retrieving Data.. ⏱️`);let s=await uy([o]);await c.action.setBadgeText(void 0);let l=s.get(ay(o));l&&Object.assign(r,l),(typeof r[p.UNIT_NAME]!=`string`||!String(r[p.UNIT_NAME]).trim())&&(r[p.UNIT_NAME]=i),r[p.FABRICATED]=!0,a[O.USE_DESCRIPTIVE_DUPLICATES]!==void 0&&n.filter(e=>e.metadata[p.UNIT_NAME]!=null&&e.id!==t.id).map(e=>e.metadata[p.UNIT_NAME]).includes(o)&&(r[p.UNIT_NAME]=ey(o)),await c.scene.items.updateItems([t],e=>{let t=e[0];if(Object.assign(t.metadata,r),a[O.SHOW_NAMES]===!0){let e=t,n=typeof r[p.UNIT_NAME]==`string`&&String(r[p.UNIT_NAME]).trim().length>0?String(r[p.UNIT_NAME]).trim():cy(e);e.text&&(e.text.plainText=n)}})}await ly(t.id)}}):c.contextMenu.remove(iy).catch(()=>{}),m&&h?c.contextMenu.create({id:p.MODIFY_UNIT,icons:[{icon:`/icon.svg`,label:`Adjust HP`,filter:{some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`GM`]}},{icon:`/icon.svg`,label:`Adjust HP`,filter:{every:[{key:`createdUserId`,operator:`==`,value:r?.id}],some:[{key:`layer`,value:`CHARACTER`,coordinator:`||`},{key:`layer`,value:`MOUNT`}],roles:[`PLAYER`]}}],async onClick(e,t){A.info(`Adjust HP Clicked: ${e.items[0].name}`),await c.popover.open({id:ee.CONTEXT_MENU,url:`/pages/forgecontext.html`,height:50,width:180,anchorElementId:t,hidePaper:!0})},embed:{url:`/pages/forgecontext.html?contextmenu=true`,height:70}}):c.contextMenu.remove(p.MODIFY_UNIT).catch(()=>{})})},[a,m,h,g]),(0,H.jsx)(H.Fragment,{children:e})}Ot.createRoot(document.getElementById(`root`)).render((0,H.jsx)(B.StrictMode,{children:(0,H.jsx)(te,{children:(0,H.jsx)(Pt,{children:(0,H.jsx)(dy,{children:(0,H.jsx)(It,{children:(0,H.jsx)(Qv,{})})})})})}));